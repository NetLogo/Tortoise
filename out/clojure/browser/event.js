...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj5055 = {};return obj5055;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3612__auto__ = this$;if(and__3612__auto__)
...
{var x__4251__auto__ = (((this$ == null))?null:this$);return (function (){var or__3624__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4251__auto__)]);if(or__3624__auto__)
{return or__3624__auto__;
} else
{var or__3624__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3624__auto____$1)
...
return (function (p__5056){var vec__5057 = p__5056;var k = cljs.core.nth.call(null,vec__5057,(0),null);var v = cljs.core.nth.call(null,vec__5057,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__5058){var vec__5059 = p__5058;var k = cljs.core.nth.call(null,vec__5059,(0),null);var v = cljs.core.nth.call(null,vec__5059,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
