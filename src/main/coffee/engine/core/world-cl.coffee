...
goog.require('engine.core.linkset')
...
goog.require('engine.core.structure.builtins')
goog.require('engine.core.structure.idmanager')
goog.require('engine.core.structure.ticker')
goog.require('engine.core.structure.worldlinks')
