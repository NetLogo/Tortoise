...
var procedures = (function() {
  ...
  var updateVariables = function() {
    ...
    world.observer.setGlobal("slow", world.turtleManager.turtlesOfBreed("PARTICLES").agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 105); }).size());
    world.observer.setGlobal("fast", world.turtleManager.turtlesOfBreed("PARTICLES").agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 15); }).size());
    world.observer.setGlobal("avg-speed", ListPrims.mean(world.turtleManager.turtlesOfBreed("PARTICLES").projectionBy(function() { return SelfPrims.getVariable("speed"); })));
  ...
  var go = function() {
    ...
    if (Prims.gt(NLMath.floor(world.ticker.tickCount()), NLMath.floor((world.ticker.tickCount() - world.observer.getGlobal("tick-length"))))) {
      if (world.turtleManager.turtlesOfBreed("PARTICLES").nonEmpty()) {
        world.observer.setGlobal("wall-hits-per-particle", ListPrims.mean(world.turtleManager.turtlesOfBreed("PARTICLES").projectionBy(function() { return SelfPrims.getVariable("wall-hits"); })));
      }
      else {
  ...
  var calculateTickLength = function() {
    if (world.turtleManager.turtlesOfBreed("PARTICLES").agentFilter(function() { return Prims.gt(SelfPrims.getVariable("speed"), 0); }).nonEmpty()) {
  ...
  var calculatePressure = function() {
    world.observer.setGlobal("pressure", (15 * ListPrims.sum(world.turtleManager.turtlesOfBreed("PARTICLES").projectionBy(function() { return SelfPrims.getVariable("momentum-difference"); }))));
  ...
  var plotHistograms = function() {
    plotManager.setCurrentPlot("Energy histogram");
    plotManager.setCurrentPen("fast");
    plotManager.drawHistogramFrom(world.turtleManager.turtlesOfBreed("PARTICLES").agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 15); }).projectionBy(function() { return SelfPrims.getVariable("energy"); }));
    plotManager.setCurrentPen("medium");
    plotManager.drawHistogramFrom(world.turtleManager.turtlesOfBreed("PARTICLES").agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 55); }).projectionBy(function() { return SelfPrims.getVariable("energy"); }));
    plotManager.setCurrentPen("slow");
    ...
    plotManager.setCurrentPen("medium");
    plotManager.drawHistogramFrom(world.turtleManager.turtlesOfBreed("PARTICLES").agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 55); }).projectionBy(function() { return SelfPrims.getVariable("speed"); }));
    plotManager.setCurrentPen("slow");
