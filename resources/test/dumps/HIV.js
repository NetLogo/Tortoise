    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'HIV+')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("known?"); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'HIV?')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.minus(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("known?"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', undefined)(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.setYRange(0, PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("initial-people")), 50));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-people"), "").ask(function() {
        ...
        SelfManager.self().setVariable("infected?", Prims.lt(SelfManager.self().getVariable("who"), PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("initial-people")), 0.025)));
        if (SelfManager.self().getVariable("infected?")) {
          SelfManager.self().setVariable("infection-length", PrimChecks.math.randomFloat(PrimChecks.validator.checkArg('RANDOM-FLOAT', 1, world.observer.getGlobal("symptoms-show"))));
        }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("infected?")))) {
  ...
  temp = (function(center) {
    try {
      ...
      for (let _index_3704_3710 = 0, _repeatcount_3704_3710 = StrictMath.floor(40); _index_3704_3710 < _repeatcount_3704_3710; _index_3704_3710++){
        result = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, result), PrimChecks.math.randomFloat(PrimChecks.validator.checkArg('RANDOM-FLOAT', 1, center))); letVars['result'] = result;
      }
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, result), 20);
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (PrimChecks.agentset.all(world.turtles(), function() { return SelfManager.self().getVariable("known?"); })) {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        ...
        if (SelfManager.self().getVariable("coupled?")) {
          SelfManager.self().setVariable("couple-length", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("couple-length")), 1));
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("coupled?")))) {
          procedures["MOVE"]();
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("coupled?"))) && Prims.equality(SelfManager.self().getVariable("shape"), "person righty")) && Prims.lt(PrimChecks.math.randomFloat(10), SelfManager.self().getVariable("coupling-tendency")))) {
          procedures["COUPLE"]();
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["UNCOUPLE"](); }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["INFECT"](); }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["TEST"](); }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["ASSIGN-COLOR"](); }, true);
      world.ticker.tick();
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (!Prims.equality(world.observer.getGlobal("slider-check-1"), world.observer.getGlobal("average-commitment"))) {
        Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["ASSIGN-COMMITMENT"](); }, true);
        world.observer.setGlobal("slider-check-1", world.observer.getGlobal("average-commitment"));
      }
      if (!Prims.equality(world.observer.getGlobal("slider-check-2"), world.observer.getGlobal("average-coupling-tendency"))) {
        Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["ASSIGN-COUPLING-TENDENCY"](); }, true);
        world.observer.setGlobal("slider-check-2", world.observer.getGlobal("average-coupling-tendency"));
      }
      if (!Prims.equality(world.observer.getGlobal("slider-check-3"), world.observer.getGlobal("average-condom-use"))) {
        Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["ASSIGN-CONDOM-USE"](); }, true);
        world.observer.setGlobal("slider-check-3", world.observer.getGlobal("average-condom-use"));
      }
      if (!Prims.equality(world.observer.getGlobal("slider-check-4"), world.observer.getGlobal("average-test-frequency"))) {
        Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["ASSIGN-TEST-FREQUENCY"](); }, true);
        world.observer.setGlobal("slider-check-4", world.observer.getGlobal("average-test-frequency"));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let potentialPartner = PrimChecks.agentset.oneOfWith(SelfManager.self().turtlesAt(-1, 0), function() {
        return (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("coupled?"))) && Prims.equality(SelfManager.self().getVariable("shape"), "person lefty"));
      }); letVars['potentialPartner'] = potentialPartner;
      if (!Prims.equality(potentialPartner, Nobody)) {
        if (Prims.lt(PrimChecks.math.randomFloat(10), PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, potentialPartner), function() { return SelfManager.self().getVariable("coupling-tendency"); }))) {
          ...
          Errors.askNobodyCheck(SelfManager.self().getVariable("partner")).ask(function() { SelfManager.self().setVariable("partner", SelfManager.myself()); }, true);
          SelfManager.self().moveTo(SelfManager.self().getPatchHere());
          Errors.askNobodyCheck(potentialPartner).ask(function() { SelfManager.self().moveTo(SelfManager.self().getPatchHere()); }, true);
          SelfManager.self().setPatchVariable("pcolor", PrimChecks.math.minus(5, 3));
          Errors.askNobodyCheck(SelfManager.self()._optimalPatchWest()).ask(function() { SelfManager.self().setPatchVariable("pcolor", PrimChecks.math.minus(5, 3)); }, true);
        }
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if ((PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("coupled?")) && Prims.equality(SelfManager.self().getVariable("shape"), "person righty"))) {
        if ((Prims.gt(SelfManager.self().getVariable("couple-length"), SelfManager.self().getVariable("commitment")) || Prims.gt(PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, SelfManager.self().getVariable("partner")), function() { return SelfManager.self().getVariable("couple-length"); }), PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, SelfManager.self().getVariable("partner")), function() { return SelfManager.self().getVariable("commitment"); })))) {
          SelfManager.self().setVariable("coupled?", false);
          SelfManager.self().setVariable("couple-length", 0);
          Errors.askNobodyCheck(SelfManager.self().getVariable("partner")).ask(function() { SelfManager.self().setVariable("couple-length", 0); }, true);
          SelfManager.self().setPatchVariable("pcolor", 0);
          Errors.askNobodyCheck(SelfManager.self()._optimalPatchWest()).ask(function() { SelfManager.self().setPatchVariable("pcolor", 0); }, true);
          Errors.askNobodyCheck(SelfManager.self().getVariable("partner")).ask(function() { SelfManager.self().setVariable("partner", Nobody); }, true);
          Errors.askNobodyCheck(SelfManager.self().getVariable("partner")).ask(function() { SelfManager.self().setVariable("coupled?", false); }, true);
          SelfManager.self().setVariable("partner", Nobody);
        }
      }
    } catch (e) {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (((PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("coupled?")) && PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("infected?"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("known?"))))) {
        if ((Prims.gt(PrimChecks.math.randomFloat(10), SelfManager.self().getVariable("condom-use")) || Prims.gt(PrimChecks.math.randomFloat(10), PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, SelfManager.self().getVariable("partner")), function() { return SelfManager.self().getVariable("condom-use"); })))) {
  ...
  temp = (function() {
    try {
      ...
      if (PrimChecks.agentset.any(world.turtles())) {
        Errors.reportInContextCheck(reporterContext);
        return PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), PrimChecks.agentset.count(world.turtles())), 100);
      }
      else {
        Errors.reportInContextCheck(reporterContext);
        return 0;
