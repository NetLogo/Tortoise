    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'HIV?')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.minus_unchecked(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("known?"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', undefined)(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.setYRange(0, PrimChecks.math.plus(world.observer.getGlobal("initial-people"), 50));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-people"), "").ask(function() {
        ...
        SelfManager.self().setVariable("infected?", Prims.lt(SelfManager.self().getVariable("who"), PrimChecks.math.mult(world.observer.getGlobal("initial-people"), 0.025)));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (PrimChecks.math.not(SelfManager.self().getVariable("infected?"))) {
  ...
  temp = (function(center) {
    try {
      ...
      for (let _index_3704_3710 = 0, _repeatcount_3704_3710 = StrictMath.floor(40); _index_3704_3710 < _repeatcount_3704_3710; _index_3704_3710++){
        result = PrimChecks.math.plus(result, PrimChecks.math.randomFloat(center)); letVars['result'] = result;
      }
    ...
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        ...
        if (SelfManager.self().getVariable("coupled?")) {
          SelfManager.self().setVariable("couple-length", PrimChecks.math.plus(SelfManager.self().getVariable("couple-length"), 1));
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (PrimChecks.math.not(SelfManager.self().getVariable("coupled?"))) {
          procedures["MOVE"]();
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (((PrimChecks.math.not(SelfManager.self().getVariable("coupled?")) && Prims.equality(SelfManager.self().getVariable("shape"), "person righty")) && Prims.lt(PrimChecks.math.randomFloat_unchecked(10), SelfManager.self().getVariable("coupling-tendency")))) {
          procedures["COUPLE"]();
        }
      }, true);
  ...
  temp = (function() {
    try {
      ...
      let potentialPartner = PrimChecks.agentset.oneOfWith(SelfManager.self().turtlesAt(-1, 0), function() {
        return (PrimChecks.math.not(SelfManager.self().getVariable("coupled?")) && Prims.equality(SelfManager.self().getVariable("shape"), "person lefty"));
      }); letVars['potentialPartner'] = potentialPartner;
      if (!Prims.equality(potentialPartner, Nobody)) {
        if (Prims.lt(PrimChecks.math.randomFloat_unchecked(10), PrimChecks.agentset.of(potentialPartner, function() { return SelfManager.self().getVariable("coupling-tendency"); }))) {
          ...
          Errors.askNobodyCheck(SelfManager.self()._optimalPatchWest()).ask(function() { SelfManager.self().setPatchVariable("pcolor", PrimChecks.math.minus_unchecked(5, 3)); }, true);
        }
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (PrimChecks.math.bool('AND', SelfManager.self().getVariable("coupled?")) && PrimChecks.math.bool('AND', Prims.equality(SelfManager.self().getVariable("shape"), "person righty"))) {
        if ((Prims.gt(SelfManager.self().getVariable("couple-length"), SelfManager.self().getVariable("commitment")) || Prims.gt(PrimChecks.agentset.of(SelfManager.self().getVariable("partner"), function() { return SelfManager.self().getVariable("couple-length"); }), PrimChecks.agentset.of(SelfManager.self().getVariable("partner"), function() { return SelfManager.self().getVariable("commitment"); })))) {
          SelfManager.self().setVariable("coupled?", false);
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if ((PrimChecks.math.bool('AND', SelfManager.self().getVariable("coupled?")) && PrimChecks.math.bool('AND', SelfManager.self().getVariable("infected?")) && PrimChecks.math.not(SelfManager.self().getVariable("known?")))) {
        if ((Prims.gt(PrimChecks.math.randomFloat_unchecked(10), SelfManager.self().getVariable("condom-use")) || Prims.gt(PrimChecks.math.randomFloat_unchecked(10), PrimChecks.agentset.of(SelfManager.self().getVariable("partner"), function() { return SelfManager.self().getVariable("condom-use"); })))) {
          if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("infection-chance"))) {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.lt(PrimChecks.math.randomFloat_unchecked(52), SelfManager.self().getVariable("test-frequency"))) {
        if (SelfManager.self().getVariable("infected?")) {
  ...
  temp = (function() {
    try {
      ...
      if (PrimChecks.agentset.any_unchecked(world.turtles())) {
        Errors.reportInContextCheck(reporterContext);
        return PrimChecks.math.mult_unchecked(PrimChecks.math.div_unchecked(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), PrimChecks.agentset.count_unchecked(world.turtles())), 100);
      }
      else {
        Errors.reportInContextCheck(reporterContext);
        return 0;
