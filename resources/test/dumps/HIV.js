    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'HIV+')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("known?"); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'HIV?')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("infected?"); }) - world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("known?"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  temp = (function() {
    try {
      ...
      if (!world.turtles().isEmpty()) {
        Errors.reportInContextCheck(reporterContext);
        return (PrimChecks.math.div(world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("infected?"); }), world.turtles().size()) * 100);
      }
      else {
        Errors.reportInContextCheck(reporterContext);
        return 0;
