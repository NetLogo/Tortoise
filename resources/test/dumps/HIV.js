    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'HIV?')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }) - PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("known?"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  temp = (function() {
    try {
      ...
      if (!Prims.equality(potentialPartner, Nobody)) {
        if (Prims.lt(PrimChecks.math.randomFloat(10), PrimChecks.agentset.of(potentialPartner, function() { return SelfManager.self().getVariable("coupling-tendency"); }))) {
          ...
          Errors.askNobodyCheck(SelfManager.self()._optimalPatchWest()).ask(function() { SelfManager.self().setPatchVariable("pcolor", (5 - 3)); }, true);
        }
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      ...
      if (((SelfManager.self().getVariable("coupled?") && SelfManager.self().getVariable("infected?")) && !SelfManager.self().getVariable("known?"))) {
        if ((Prims.gt(PrimChecks.math.randomFloat(10), SelfManager.self().getVariable("condom-use")) || Prims.gt(PrimChecks.math.randomFloat(10), PrimChecks.agentset.of(SelfManager.self().getVariable("partner"), function() { return SelfManager.self().getVariable("condom-use"); })))) {
