    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Distance from the origin', 'distance')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.of(world.turtleManager.getTurtle(0), function() { return SelfManager.self().distanceXY(0, 0); }));
        } catch (e) {
