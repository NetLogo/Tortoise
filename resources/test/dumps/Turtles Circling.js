...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('distance', plotOps.makePenOps, false, new PenBundle.State(55, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Distance from the origin', 'distance')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, world.turtleManager.getTurtle(0)), function() { return SelfManager.self().distanceXY(0, 0); }));
        } catch (e) {
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(1, "").ask(function() {
        ...
        SelfManager.self().setVariable("size", PrimChecks.math.mult(2, PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("draw-radius"))));
