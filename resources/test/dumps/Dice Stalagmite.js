...
var workspace = tortoise_require('engine/workspace')(modelConfig)([{ name: "PAIRED-DICE", singular: "paired-die", varNames: ["pair-sum"] }, { name: "SINGLE-DICE", singular: "single-die", varNames: [] }, { name: "STACKED-DICE", singular: "stacked-die", varNames: [] }])(["die-value"], [])(tortoise_require("extensions/all").dumpers())(["stop-at-top?", "generators", "top-row", "single-outcomes", "pair-outcomes"], ["stop-at-top?"], ["column"], -10, 26, 0, 51, 10.0, true, true, turtleShapes, linkShapes, function(){});
