...
var linkShapes = {"default":{"name":"default","direction-indicator":{"name":"link direction","editableColorIndex":0,"rotate":true,"elements":[{"x1":150,"y1":150,"x2":90,"y2":180,"type":"line","color":"rgba(141, 141, 141, 1.0)","filled":false,"marked":true},{"x1":150,"y1":150,"x2":210,"y2":180,"type":"line","color":"rgba(141, 141, 141, 1.0)","filled":false,"marked":true}]},"curviness":0.0,"lines":[{"x-offset":-0.2,"is-visible":false,"dash-pattern":[0.0,1.0]},{"x-offset":0.0,"is-visible":true,"dash-pattern":[1.0,0.0]},{"x-offset":0.2,"is-visible":false,"dash-pattern":[0.0,1.0]}]},"curved":{"name":"curved","direction-indicator":{"name":"link direction","editableColorIndex":0,"rotate":true,"elements":[{"x1":150,"y1":150,"x2":105,"y2":210,"type":"line","color":"rgba(141, 141, 141, 1.0)","filled":false,"marked":true},{"x1":150,"y1":150,"x2":195,"y2":210,"type":"line","color":"rgba(141, 141, 141, 1.0)","filled":false,"marked":true}]},"curviness":1.0,"lines":[{"x-offset":-0.2,"is-visible":false,"dash-pattern":[0.0,1.0]},{"x-offset":0.0,"is-visible":true,"dash-pattern":[1.0,0.0]},{"x-offset":0.2,"is-visible":false,"dash-pattern":[0.0,1.0]}]}};
...
var procedures = (function() {
  ...
  var createNetworkExample1 = function() {
    ...
    world.turtleManager.turtlesOfBreed("PAGES").agentFilter(function() { return Prims.gt(SelfPrims.getVariable("who"), 5); }).ask(function() { SelfPrims.setVariable("color", 115); }, true);
  };
  var createNetworkExample2 = function() {
    world.turtleManager.createTurtles(8, "PAGES").ask(function() {}, true);
    world.turtleManager.getTurtleOfBreed("PAGES", 0).ask(function() { SelfPrims.die(); }, true);
    world.turtleManager.getTurtleOfBreed("PAGES", 1).ask(function() {
  ...
  var go = function() {
    if (Prims.equality(world.observer.getGlobal("calculation-method"), "diffusion")) {
      if (world.turtleManager.turtlesOfBreed("SURFERS").nonEmpty()) {
        world.turtleManager.turtlesOfBreed("SURFERS").ask(function() { SelfPrims.die(); }, true);
      }
      world.links().ask(function() {
        SelfPrims.setVariable("color", 5);
        SelfPrims.setVariable("thickness", 0);
      }, true);
      world.turtleManager.turtlesOfBreed("PAGES").ask(function() { SelfPrims.setVariable("new-rank", 0); }, true);
      world.turtleManager.turtlesOfBreed("PAGES").ask(function() {
        if (LinkPrims.outLinkNeighbors("LINKS").nonEmpty()) {
          ...
          LinkPrims.outLinkNeighbors("LINKS").ask(function() { SelfPrims.setVariable("new-rank", (SelfPrims.getVariable("new-rank") + rankIncrement)); }, true);
        }
        else {
          var rankIncrement = (SelfPrims.getVariable("rank") / world.turtleManager.turtlesOfBreed("PAGES").size());
          world.turtleManager.turtlesOfBreed("PAGES").ask(function() { SelfPrims.setVariable("new-rank", (SelfPrims.getVariable("new-rank") + rankIncrement)); }, true);
        }
      }, true);
      world.turtleManager.turtlesOfBreed("PAGES").ask(function() {
      ...
      if (Prims.gt(world.turtleManager.turtlesOfBreed("SURFERS").size(), world.observer.getGlobal("number-of-surfers"))) {
        ListPrims.nOf((world.turtleManager.turtlesOfBreed("SURFERS").size() - world.observer.getGlobal("number-of-surfers")), world.turtleManager.turtlesOfBreed("SURFERS")).ask(function() { SelfPrims.die(); }, true);
      }
      world.links().ask(function() {
        SelfPrims.setVariable("color", 5);
        SelfPrims.setVariable("thickness", 0);
      ...
      world.turtleManager.turtlesOfBreed("SURFERS").ask(function() {
        ...
        SelfPrims.getVariable("current-page").ask(function() { SelfPrims.setVariable("visits", (SelfPrims.getVariable("visits") + 1)); }, true);
        if ((Prims.lte(Prims.randomFloat(1), world.observer.getGlobal("damping-factor")) && SelfPrims.getVariable("current-page").projectionBy(function() { return LinkPrims.myOutLinks("LINKS"); }).nonEmpty())) {
          SelfPrims.setVariable("current-page", ListPrims.oneOf(SelfPrims.getVariable("current-page").projectionBy(function() { return LinkPrims.outLinkNeighbors("LINKS"); })));
        }
        else {
          SelfPrims.setVariable("current-page", ListPrims.oneOf(world.turtleManager.turtlesOfBreed("PAGES")));
        }
  ...
  var updateGlobals = function() {
    world.observer.setGlobal("total-rank", ListPrims.sum(world.turtleManager.turtlesOfBreed("PAGES").projectionBy(function() { return SelfPrims.getVariable("rank"); })));
    world.observer.setGlobal("max-rank", ListPrims.max(world.turtleManager.turtlesOfBreed("PAGES").projectionBy(function() { return SelfPrims.getVariable("rank"); })));
  };
