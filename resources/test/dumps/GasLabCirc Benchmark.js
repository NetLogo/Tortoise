...
function makeParticles() {
  AgentSet.ask(world.createOrderedTurtles(world.observer.getGlobal('number'), "PARTICLES"), true, function() {
    ...
    AgentSet.setTurtleVariable(10, (world.observer.getGlobal('smallest-particle-size') + Prims.randomFloat((world.observer.getGlobal('largest-particle-size') - world.observer.getGlobal('smallest-particle-size')))));
...
function overlapping_p() {
  return AgentSet.any(AgentSet.other(AgentSet.agentFilter(AgentSet.self().inRadius(world.turtlesOfBreed("PARTICLES"), ((AgentSet.getTurtleVariable(10) + world.observer.getGlobal('largest-particle-size')) / 2)), function() {
...
function randomPosition() {
  Prims.setXY((AgentSet.oneOf([1, -1]) * Prims.randomFloat(((world.observer.getGlobal('box-edge') - 0.5) - (AgentSet.getTurtleVariable(10) / 2)))), (AgentSet.oneOf([1, -1]) * Prims.randomFloat(((world.observer.getGlobal('box-edge') - 0.5) - (AgentSet.getTurtleVariable(10) / 2)))));
}
