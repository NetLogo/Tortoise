      ...
      return plotManager.withTemporaryContext('Leaf averages', 'chlorophyll')(function() {
        try {
          ...
          if (!world.turtleManager.turtlesOfBreed("LEAVES").isEmpty()) {
            plotManager.plotValue(PrimChecks.list.mean(world.turtleManager.turtlesOfBreed("LEAVES").projectionBy(function() { return SelfManager.self().getVariable("chlorophyll"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'water')(function() {
        try {
          ...
          var letVars = { };
          if (!world.turtleManager.turtlesOfBreed("LEAVES").isEmpty()) {
            plotManager.plotValue(PrimChecks.list.mean(world.turtleManager.turtlesOfBreed("LEAVES").projectionBy(function() { return SelfManager.self().getVariable("water-level"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'sugar')(function() {
        try {
          ...
          var letVars = { };
          if (!world.turtleManager.turtlesOfBreed("LEAVES").isEmpty()) {
            plotManager.plotValue(PrimChecks.list.mean(world.turtleManager.turtlesOfBreed("LEAVES").projectionBy(function() { return SelfManager.self().getVariable("sugar-level"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'carotene')(function() {
        try {
          ...
          var letVars = { };
          if (!world.turtleManager.turtlesOfBreed("LEAVES").isEmpty()) {
            plotManager.plotValue(PrimChecks.list.mean(world.turtleManager.turtlesOfBreed("LEAVES").projectionBy(function() { return SelfManager.self().getVariable("carotene"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'anthocyanin')(function() {
        try {
          ...
          var letVars = { };
          if (!world.turtleManager.turtlesOfBreed("LEAVES").isEmpty()) {
            plotManager.plotValue(PrimChecks.list.mean(world.turtleManager.turtlesOfBreed("LEAVES").projectionBy(function() { return SelfManager.self().getVariable("anthocyanin"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'attachedness')(function() {
        try {
          ...
          var letVars = { };
          if (!world.turtleManager.turtlesOfBreed("LEAVES").isEmpty()) {
            plotManager.plotValue(PrimChecks.list.mean(world.turtleManager.turtlesOfBreed("LEAVES").projectionBy(function() { return SelfManager.self().getVariable("attachedness"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("RAINDROPS").agentFilter(function() {
        return ((Prims.equality(SelfManager.self().getVariable("location"), "in trunk") || Prims.equality(SelfManager.self().getVariable("location"), "in leaves")) && ((Prims.gt(SelfManager.self().getVariable("ycor"), PrimChecks.list.max(world.turtleManager.turtlesOfBreed("LEAVES").projectionBy(function() { return SelfManager.self().getVariable("ycor"); }))) || Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.list.max(world.turtleManager.turtlesOfBreed("LEAVES").projectionBy(function() { return SelfManager.self().getVariable("xcor"); })))) || Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.list.min(world.turtleManager.turtlesOfBreed("LEAVES").projectionBy(function() { return SelfManager.self().getVariable("xcor"); })))));
      })).ask(function() { SelfManager.self().die(); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gt(SelfManager.self().getVariable("ycor"), world.observer.getGlobal("bottom-line"))) {
        ...
        SelfManager.self().fd(RandomPrims.randomFloat((0.7 * PrimChecks.list.max(ListPrims.list(world.observer.getGlobal("wind-factor"), 0.5)))));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
