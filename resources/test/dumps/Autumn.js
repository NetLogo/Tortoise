    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaves', 'leaves')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("LEAVES")));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaves', 'dead leaves')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("DEAD-LEAVES")));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
      ...
      return plotManager.withTemporaryContext('Leaf averages', 'chlorophyll')(function() {
        try {
          ...
          if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("chlorophyll"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'water')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("water-level"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'sugar')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("sugar-level"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'carotene')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("carotene"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'anthocyanin')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("anthocyanin"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'attachedness')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("attachedness"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return Prims.lte(SelfManager.self().getVariable("ycor"), world.observer.getGlobal("bottom-line")); })).ask(function() { SelfManager.self().setVariable("breed", world.turtleManager.turtlesOfBreed("DEAD-LEAVES")); }, true);
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return Prims.lt(SelfManager.self().getVariable("water-level"), 1); })).ask(function() { SelfManager.self().setVariable("attachedness", 0); }, true);
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("RAINDROPS"), function() {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("RAINDROPS"), function() {
        return ((Prims.equality(SelfManager.self().getVariable("location"), "in trunk") || Prims.equality(SelfManager.self().getVariable("location"), "in leaves")) && ((Prims.gt(SelfManager.self().getVariable("ycor"), PrimChecks.list.max(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("ycor"); }))) || Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.list.max(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("xcor"); })))) || Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.list.min(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("xcor"); })))));
      })).ask(function() { SelfManager.self().die(); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      let nearbyRaindrops = PrimChecks.agentset.with_unchecked(SelfManager.self().inRadius(world.turtleManager.turtlesOfBreed("RAINDROPS"), 2), function() {
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return Prims.gt(SelfManager.self().getVariable("attachedness"), 0); });
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
