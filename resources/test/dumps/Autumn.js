      ...
      return plotManager.withTemporaryContext('Leaf averages', 'chlorophyll')(function() {
        try {
          ...
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("chlorophyll"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'water')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("water-level"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'sugar')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("sugar-level"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'carotene')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("carotene"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'anthocyanin')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("anthocyanin"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'attachedness')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("attachedness"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.patches(), function() { return Prims.lt(SelfManager.self().getPatchVariable("pycor"), (world.topology.minPycor + 2)); })).ask(function() { SelfManager.self().setPatchVariable("pcolor", 55); }, true);
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("RAINDROPS"), function() {
        return ((Prims.equality(SelfManager.self().getVariable("location"), "in trunk") || Prims.equality(SelfManager.self().getVariable("location"), "in leaves")) && ((Prims.gt(SelfManager.self().getVariable("ycor"), PrimChecks.list.max(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("ycor"); }))) || Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.list.max(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("xcor"); })))) || Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.list.min(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("xcor"); })))));
      })).ask(function() { SelfManager.self().die(); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
