    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaves', 'leaves')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("LEAVES")));
        } catch (e) {
      ...
      return plotManager.withTemporaryContext('Leaf averages', 'chlorophyll')(function() {
        try {
          ...
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("chlorophyll"); }))));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'water')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("water-level"); }))));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'sugar')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("sugar-level"); }))));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'carotene')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("carotene"); }))));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'anthocyanin')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("anthocyanin"); }))));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Leaf averages', 'attachedness')(function() {
        try {
          ...
          var letVars = { };
          if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("LEAVES"))) {
            plotManager.plotValue(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("attachedness"); }))));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      world.clearAll();
      world.observer.setGlobal("bottom-line", PrimChecks.math.plus(world.topology.minPycor, 1));
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() { SelfManager.self().setPatchVariable("pcolor", PrimChecks.math.minus(105, 2)); }, true);
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("number-of-leaves"), "LEAVES").ask(function() {
        SelfManager.self().setVariable("chlorophyll", PrimChecks.math.plus(50, RandomPrims.randomLong(50)));
        SelfManager.self().setVariable("water-level", PrimChecks.math.plus(75, RandomPrims.randomLong(25)));
        SelfManager.self().setVariable("sugar-level", PrimChecks.math.randomNormal(PrimChecks.validator.checkArg('RANDOM-NORMAL', 1, world.observer.getGlobal("start-sugar-mean")), PrimChecks.validator.checkArg('RANDOM-NORMAL', 1, world.observer.getGlobal("start-sugar-stddev"))));
        SelfManager.self().setVariable("carotene", RandomPrims.randomLong(100));
        procedures["CHANGE-COLOR"]();
        SelfManager.self().setVariable("attachedness", PrimChecks.math.plus(100, RandomPrims.randomLong(50)));
      ...
      world.turtleManager.createTurtles(1, "SUNS").ask(function() {
        SelfManager.self().setXY(PrimChecks.math.minus(world.topology.maxPxcor, 2), PrimChecks.math.minus(world.topology.maxPycor, 3));
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return Prims.lte(SelfManager.self().getVariable("ycor"), world.observer.getGlobal("bottom-line")); })).ask(function() { SelfManager.self().setVariable("breed", world.turtleManager.turtlesOfBreed("DEAD-LEAVES")); }, true);
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return Prims.lt(SelfManager.self().getVariable("water-level"), 1); })).ask(function() { SelfManager.self().setVariable("attachedness", 0); }, true);
    ...
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("LEAVES")).ask(function() {
        if (Prims.equality(RandomPrims.randomLong(2), 1)) {
          SelfManager.self().right(PrimChecks.math.mult(10, PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("wind-factor"))));
        }
        else {
          SelfManager.self().right(-(PrimChecks.math.mult(10, PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("wind-factor")))));
        }
        SelfManager.self().setVariable("attachedness", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("attachedness")), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("wind-factor"))));
      }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("RAINDROPS"), function() {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("RAINDROPS"), function() {
        return ((Prims.equality(SelfManager.self().getVariable("location"), "in trunk") || Prims.equality(SelfManager.self().getVariable("location"), "in leaves")) && ((Prims.gt(SelfManager.self().getVariable("ycor"), PrimChecks.list.max(PrimChecks.validator.checkArg('MAX', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("ycor"); })))) || Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.list.max(PrimChecks.validator.checkArg('MAX', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("xcor"); }))))) || Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.list.min(PrimChecks.validator.checkArg('MIN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return SelfManager.self().getVariable("xcor"); }))))));
      })).ask(function() { SelfManager.self().die(); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      SelfManager.self().setVariable("size", PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("sun-intensity")), 10));
  ...
  temp = (function() {
    try {
      ...
      let nearbyRaindrops = PrimChecks.agentset.with(SelfManager.self().inRadius(world.turtleManager.turtlesOfBreed("RAINDROPS"), 2), function() {
      ...
      if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, nearbyRaindrops))) {
        let myRaindrop = PrimChecks.agentset.minOneOf(PrimChecks.validator.checkArg('MIN-ONE-OF', 112, nearbyRaindrops), function() { return SelfManager.self().distance(SelfManager.myself()); }); letVars['myRaindrop'] = myRaindrop;
        SelfManager.self().setVariable("water-level", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("water-level")), PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, myRaindrop), function() { return SelfManager.self().getVariable("amount-of-water"); })), 0.2)));
        Errors.askNobodyCheck(myRaindrop).ask(function() {
          SelfManager.self().setVariable("amount-of-water", PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("amount-of-water")), 0.8));
        }, true);
      }
      if (Prims.gt(world.observer.getGlobal("temperature"), world.observer.getGlobal("evaporation-temp"))) {
        SelfManager.self().setVariable("water-level", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("water-level")), PrimChecks.math.mult(0.5, PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("temperature")), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("evaporation-temp"))))));
      }
      if (Prims.lt(SelfManager.self().getVariable("water-level"), 25)) {
        SelfManager.self().setVariable("attachedness", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("attachedness")), 1));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.lt(world.observer.getGlobal("temperature"), 15)) {
        SelfManager.self().setVariable("chlorophyll", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("chlorophyll")), PrimChecks.math.mult(0.5, PrimChecks.math.minus(15, PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("temperature"))))));
      }
      if (Prims.gt(world.observer.getGlobal("sun-intensity"), 75)) {
        SelfManager.self().setVariable("chlorophyll", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("chlorophyll")), PrimChecks.math.mult(0.5, PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("sun-intensity")), 75))));
      }
      if ((Prims.gt(world.observer.getGlobal("temperature"), 15) && Prims.gt(world.observer.getGlobal("sun-intensity"), 20))) {
        SelfManager.self().setVariable("chlorophyll", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("chlorophyll")), 1));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (((Prims.gt(SelfManager.self().getVariable("water-level"), 1) && Prims.gt(world.observer.getGlobal("sun-intensity"), 20)) && Prims.gt(SelfManager.self().getVariable("chlorophyll"), 1))) {
        SelfManager.self().setVariable("water-level", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("water-level")), 0.5));
        SelfManager.self().setVariable("chlorophyll", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("chlorophyll")), 0.5));
        SelfManager.self().setVariable("sugar-level", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("sugar-level")), 1));
        SelfManager.self().setVariable("attachedness", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("attachedness")), 5));
      }
      SelfManager.self().setVariable("sugar-level", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("sugar-level")), 0.5));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gt(SelfManager.self().getVariable("ycor"), world.observer.getGlobal("bottom-line"))) {
        let targetXcor = PrimChecks.math.minus(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("xcor")), PrimChecks.math.randomFloat(PrimChecks.validator.checkArg('RANDOM-FLOAT', 1, world.observer.getGlobal("wind-factor")))), PrimChecks.math.randomFloat(PrimChecks.validator.checkArg('RANDOM-FLOAT', 1, world.observer.getGlobal("wind-factor")))); letVars['targetXcor'] = targetXcor;
  ...
  temp = (function() {
    try {
      ...
      if (((Prims.lt(world.observer.getGlobal("temperature"), 20) && Prims.gt(SelfManager.self().getVariable("sugar-level"), 0)) && Prims.gt(SelfManager.self().getVariable("water-level"), 0))) {
        SelfManager.self().setVariable("sugar-level", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("sugar-level")), 1));
        SelfManager.self().setVariable("water-level", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("water-level")), 1));
        SelfManager.self().setVariable("anthocyanin", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("anthocyanin")), 1));
      }
      if (Prims.gt(SelfManager.self().getVariable("chlorophyll"), 50)) {
        ...
        if (Prims.lt(PrimChecks.math.abs(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("anthocyanin")), PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("carotene")))), 10)) {
          SelfManager.self().setVariable("color", ColorModel.scaleColor(25, SelfManager.self().getVariable("carotene"), 150, -50));
        }
        if (Prims.gt(SelfManager.self().getVariable("anthocyanin"), PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("carotene")), 10))) {
          SelfManager.self().setVariable("color", ColorModel.scaleColor(15, SelfManager.self().getVariable("anthocyanin"), 170, -50));
        }
        if (Prims.gt(SelfManager.self().getVariable("carotene"), PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("anthocyanin")), 10))) {
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("LEAVES"), function() { return Prims.gt(SelfManager.self().getVariable("attachedness"), 0); });
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
