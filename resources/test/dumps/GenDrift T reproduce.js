...
var workspace = tortoise_require('engine/workspace')(modelConfig)([])([], [])(tortoise_require("extensions/all").dumpers())(["colors", "number"], ["colors", "number"], [], -22, 22, -22, 22, 9.0, true, true, turtleShapes, linkShapes, function(){});
