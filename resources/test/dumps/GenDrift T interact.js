...
var workspace = tortoise_require('engine/workspace')(modelConfig)([])([], [])(tortoise_require("extensions/all").dumpers())(["colors", "number", "max-percent"], ["colors", "number"], [], -17, 17, -17, 17, 12.0, true, true, turtleShapes, linkShapes, function(){});
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      let candidate = ListPrims.oneOf(SelfManager.self().turtlesAt(1, 0));
  ...
  temp = (function() {
    try {
      ...
      var _foreach_1075_1082 = Tasks.forEach(Tasks.commandTask(function(c) {
        ...
        let howMany = world.turtles().agentFilter(function() { return Prims.equality(SelfManager.self().getVariable("color"), c); }).size();
