...
var procedures = (function() {
  ...
  var meet = function() {
    ...
    if (!Prims.equality(candidate, Nobody)) {
      SelfPrims.setVariable("color", candidate.projectionBy(function() { return SelfPrims.getVariable("color"); }));
    }
  };
  var findTopSpecies = function() {
    ...
    Tasks.forEach(Tasks.commandTask(function() {
      ...
      var howMany = world.turtles().agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), taskArguments[0]); }).size();
  ...
  var removeWall = function() {
    if (MousePrims.isDown()) {
      world.patches().agentFilter(function() { return Prims.equality(SelfPrims.getPatchVariable("pycor"), NLMath.round(MousePrims.getY())); }).ask(function() { SelfPrims.setPatchVariable("pcolor", 0); }, true);
      notImplemented('display', undefined)();
    }
  };
