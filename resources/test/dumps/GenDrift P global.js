...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.askNobodyCheck(world.patches()).ask(function() {
        SelfManager.self().setPatchVariable("pcolor", PrimChecks.agentset.of(PrimChecks.list.oneOf_unchecked(world.patches()), function() { return SelfManager.self().getPatchVariable("pcolor"); }));
      }, true);
      world.ticker.tick();
    } catch (e) {
      return Errors.stopInCommandCheck(e)
