...
var procedures = (function() {
  ...
  var go = function() {
    world.patches().ask(function() {
      SelfPrims.setPatchVariable("pcolor", ListPrims.oneOf(world.patches()).projectionBy(function() { return SelfPrims.getPatchVariable("pcolor"); }));
    }, true);
    world.ticker.tick();
  };
  return {
