...
var procedures = (function() {
    ...
    world.patches().agentFilter(function() {
      ...
      SelfPrims.sprout(1, "COLUMN-COUNTERS").ask(function() {
        ...
        SelfPrims.setVariable("my-column-patches", world.patches().agentFilter(function() {
          return Prims.equality(SelfPrims.getPatchVariable("pxcor"), SelfManager.myself().projectionBy(function() { return SelfPrims.getPatchVariable("pxcor"); }));
        }));
      }, true);
    }, true);
  };
  ...
  var sendMessengerToItsColumn = function() {
    var it = ListPrims.oneOf(world.turtleManager.turtlesOfBreed("COLUMN-COUNTERS").agentFilter(function() {
      return Prims.equality(SelfPrims.getVariable("my-column"), world.observer.getGlobal("the-messenger").projectionBy(function() { return SelfPrims.getVariable("label"); }));
    }));
  ...
  var paint = function() {
    world.turtleManager.turtlesOfBreed("COLUMN-COUNTERS").ask(function() {
      if (Prims.lte(SelfPrims.getVariable("my-column"), ((world.observer.getGlobal("red-green") * world.observer.getGlobal("sample-space")) / 100))) {
        ...
        }).ask(function() { SelfPrims.setPatchVariable("pcolor", 15); }, true);
      }
      else {
        SelfPrims.getVariable("my-column-patches").agentFilter(function() {
          return Prims.lt(SelfPrims.getPatchVariable("pycor"), SelfManager.myself().projectionBy(function() { return SelfPrims.getPatchVariable("pycor"); }));
        }).ask(function() { SelfPrims.setPatchVariable("pcolor", 55); }, true);
      }
    }, true);
  };
