  ...
  AgentSet.ask(world.patches(), true, function() {
    if (Globals.getGlobal(2)) {
      if (Globals.getGlobal(4)) {
        ...
        AgentSet.setPatchVariable(5, Prims.random(125));
      }
    }
    else {
      AgentSet.setPatchVariable(5, 100);
    }
    AgentSet.setPatchVariable(6, 0);
    AgentSet.setPatchVariable(7, false);
  });
  if (Globals.getGlobal(2)) {
    Prims.repeat(Globals.getGlobal(0), function () {
...
function recolor() {
  if ((Prims.equality(AgentSet.getPatchVariable(6), 0) || !(Globals.getGlobal(5)))) {
    ...
    AgentSet.setPatchVariable(2, Prims.scaleColor(105, Prims.min(Prims.list(AgentSet.getPatchVariable(6), 75)), 100, -10));
  }
}
function showWater() {
  Globals.setGlobal(5, true);
...
function go() {
  ...
  AgentSet.ask(Globals.getGlobal(6), true, function() {
    AgentSet.setPatchVariable(6, 0);
    AgentSet.setPatchVariable(5, -10000000);
  });
  AgentSet.ask(Globals.getGlobal(7), true, function() {
