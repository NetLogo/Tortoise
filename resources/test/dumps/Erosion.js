...
var procedures = (function() {
  var setup = function() {
    ...
    world.patches().agentFilter(function() { return !Prims.equality(SelfPrims.getNeighbors().size(), 8); }).ask(function() {
  ...
  var flow = function() {
    var target = SelfPrims.getNeighbors().minOneOf(function() { return (SelfPrims.getPatchVariable("elevation") + SelfPrims.getPatchVariable("water")); });
    var amount = ListPrims.min(ListPrims.list(SelfPrims.getPatchVariable("water"), (0.5 * (((SelfPrims.getPatchVariable("elevation") + SelfPrims.getPatchVariable("water")) - target.projectionBy(function() { return SelfPrims.getPatchVariable("elevation"); })) - target.projectionBy(function() { return SelfPrims.getPatchVariable("water"); })))));
    if (Prims.gt(amount, 0)) {
      ...
      amount = ListPrims.min(ListPrims.list(SelfPrims.getPatchVariable("water"), (0.5 * (((SelfPrims.getPatchVariable("elevation") + SelfPrims.getPatchVariable("water")) - target.projectionBy(function() { return SelfPrims.getPatchVariable("elevation"); })) - target.projectionBy(function() { return SelfPrims.getPatchVariable("water"); })))));
      SelfPrims.setPatchVariable("water", (SelfPrims.getPatchVariable("water") - amount));
      target.ask(function() { SelfPrims.setPatchVariable("water", (SelfPrims.getPatchVariable("water") + amount)); }, true);
    }
  };
  return {
    "FLOW":flow,
