    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('watching v.s. working', 'working bees')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("SCOUTS")) - PrimChecks.agentset.countWith(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return Prims.equality(SelfManager.self().getVariable("task-string"), "watching-dance"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.list.nOf(world.observer.getGlobal("hive-number"), PrimChecks.agentset.with(world.patches(), function() {
    ...
    try {
      ...
      world.observer.setGlobal("watch-dance-task", Tasks.commandTask(function() {
        if (PrimChecks.agentset.optimizeCount(SelfManager.self().inRadius(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return SelfManager.self().getVariable("piping?"); }), 3), 0, (a, b) => a > b)) {
          SelfManager.self().setVariable("target", PrimChecks.agentset.of(PrimChecks.agentset.oneOfWith(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return SelfManager.self().getVariable("piping?"); }), function() { return SelfManager.self().getVariable("target"); }));
    ...
    try {
      ...
      world.observer.setGlobal("inspect-hive-task", Tasks.commandTask(function() {
        if (Prims.lt(SelfManager.self().getVariable("bee-timer"), 0)) {
          ...
          let nearbyScouts = SelfManager.self().inRadius(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("SCOUTS"), function() {
            return (SelfManager.self().getVariable("on-site?") && Prims.equality(SelfManager.self().getVariable("target"), PrimChecks.agentset.of(SelfManager.myself(), function() { return SelfManager.self().getVariable("target"); })));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if ((PrimChecks.agentset.all(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return SelfManager.self().getVariable("on-site?"); }) && Prims.equality(PrimChecks.list.length(PrimChecks.list.removeDuplicates(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return SelfManager.self().getVariable("target"); }))), 1))) {
