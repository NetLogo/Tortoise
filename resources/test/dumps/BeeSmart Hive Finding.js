...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('default', plotOps.makePenOps, false, new PenBundle.State(0, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('piping-scouts', 'default')(function() {
        try {
  ...
  var pens    = [new PenBundle.Pen('watching bees', plotOps.makePenOps, false, new PenBundle.State(136.7, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('watching v.s. working', 'watching bees')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
  ...
  new PenBundle.Pen('working bees', plotOps.makePenOps, false, new PenBundle.State(56.8, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('watching v.s. working', 'working bees')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.minus_unchecked(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("SCOUTS")), PrimChecks.agentset.countWith(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return Prims.equality(SelfManager.self().getVariable("task-string"), "watching-dance"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.list.nOf(world.observer.getGlobal("hive-number"), PrimChecks.agentset.with_unchecked(world.patches(), function() {
        return ((Prims.gt(SelfManager.self().distanceXY(0, 0), 16) && Prims.lt(PrimChecks.math.abs(SelfManager.self().getPatchVariable("pxcor")), PrimChecks.math.minus_unchecked(world.topology.maxPxcor, 2))) && Prims.lt(PrimChecks.math.abs(SelfManager.self().getPatchVariable("pycor")), PrimChecks.math.minus_unchecked(world.topology.maxPycor, 2)));
      }))).ask(function() {
      ...
      let i = 0; letVars['i'] = i;
      for (let _index_3202_3208 = 0, _repeatcount_3202_3208 = StrictMath.floor(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("SITES"))); _index_3202_3208 < _repeatcount_3202_3208; _index_3202_3208++){
        ...
        plotManager.setPenColor(PrimChecks.list.item(i, world.observer.getGlobal("color-list")));
        i = PrimChecks.math.plus(i, 1); letVars['i'] = i;
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(100, "SCOUTS").ask(function() {
        SelfManager.self().fd(PrimChecks.math.randomFloat_unchecked(4));
    ...
    try {
      ...
      world.observer.setGlobal("watch-dance-task", Tasks.commandTask(function() {
        if (PrimChecks.agentset.optimizeCount(SelfManager.self().inRadius(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return SelfManager.self().getVariable("piping?"); }), 3), 0, (a, b) => a > b)) {
          SelfManager.self().setVariable("target", PrimChecks.agentset.of_unchecked(PrimChecks.agentset.oneOfWith(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return SelfManager.self().getVariable("piping?"); }), function() { return SelfManager.self().getVariable("target"); }));
          SelfManager.self().setVariable("color", PrimChecks.agentset.of(SelfManager.self().getVariable("target"), function() { return SelfManager.self().getVariable("color"); }));
        ...
        if (PrimChecks.math.bool('AND', SelfManager.self().getVariable("initial-scout?")) && PrimChecks.math.bool('AND', Prims.lt(SelfManager.self().getVariable("bee-timer"), 0))) {
        ...
        if (PrimChecks.math.not(SelfManager.self().getVariable("initial-scout?"))) {
          if (Prims.lt(SelfManager.self().getVariable("bee-timer"), 0)) {
            if (Prims.gt(SelfPrims._optimalCountOther(SelfManager.self().inCone(world.turtleManager.turtlesOfBreed("SCOUTS"), 3, 60)), 0)) {
              let observed = PrimChecks.list.oneOf_unchecked(SelfManager.self().inCone(world.turtleManager.turtlesOfBreed("SCOUTS"), 3, 60)); letVars['observed'] = observed;
              if (Prims.equality(PrimChecks.agentset.of(observed, function() { return SelfManager.self().getVariable("next-task"); }), world.observer.getGlobal("dance-task"))) {
                if (Prims.lt(PrimChecks.math.random_unchecked(PrimChecks.math.mult_unchecked(PrimChecks.math.div(1, PrimChecks.agentset.of(observed, function() { return SelfManager.self().getVariable("interest"); })), 1000)), 1)) {
                  SelfManager.self().setVariable("target", PrimChecks.agentset.of(observed, function() { return SelfManager.self().getVariable("target"); }));
        ...
        SelfManager.self().setVariable("bee-timer", PrimChecks.math.minus(SelfManager.self().getVariable("bee-timer"), 1));
      ...
      world.observer.setGlobal("discover-task", Tasks.commandTask(function() {
        if (Prims.lt(SelfManager.self().getVariable("bee-timer"), 0)) {
          ...
          if (PrimChecks.agentset.optimizeCount(SelfManager.self().inRadius(world.turtleManager.turtlesOfBreed("SITES"), 3), 0, (a, b) => a > b)) {
            let tempTarget = PrimChecks.list.oneOf_unchecked(SelfManager.self().inRadius(world.turtleManager.turtlesOfBreed("SITES"), 3)); letVars['tempTarget'] = tempTarget;
            if (PrimChecks.math.not(PrimChecks.agentset.of(tempTarget, function() { return SelfManager.self().getVariable("discovered?"); }))) {
              ...
              SelfManager.self().setVariable("interest", PrimChecks.agentset.of(SelfManager.self().getVariable("target"), function() { return SelfManager.self().getVariable("quality"); }));
              SelfManager.self().setVariable("color", PrimChecks.agentset.of(SelfManager.self().getVariable("target"), function() { return SelfManager.self().getVariable("color"); }));
              ...
              SelfManager.self().right(PrimChecks.math.minus_unchecked(RandomPrims.randomLong(60), RandomPrims.randomLong(60)));
              procedures["PROCEED"]();
              SelfManager.self().setVariable("bee-timer", PrimChecks.math.minus(SelfManager.self().getVariable("bee-timer"), 1));
            }
          }
    ...
    try {
      ...
      world.observer.setGlobal("inspect-hive-task", Tasks.commandTask(function() {
        if (Prims.lt(SelfManager.self().getVariable("bee-timer"), 0)) {
          ...
          SelfManager.self().setVariable("task-string", "going-home");
          SelfManager.self().setVariable("on-site?", false);
          SelfManager.self().setVariable("trips", PrimChecks.math.plus(SelfManager.self().getVariable("trips"), 1));
        }
        else {
          ...
          let nearbyScouts = SelfManager.self().inRadius(PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("SCOUTS"), function() {
            return PrimChecks.math.bool('AND', SelfManager.self().getVariable("on-site?")) && PrimChecks.math.bool('AND', Prims.equality(SelfManager.self().getVariable("target"), PrimChecks.agentset.of_unchecked(SelfManager.myself(), function() { return SelfManager.self().getVariable("target"); })));
          }), 3); letVars['nearbyScouts'] = nearbyScouts;
          if (Prims.gt(PrimChecks.agentset.count(nearbyScouts), world.observer.getGlobal("quorum"))) {
            SelfManager.self().setVariable("next-task", world.observer.getGlobal("go-home-task"));
            SelfManager.self().setVariable("task-string", "going-home");
            SelfManager.self().setVariable("on-site?", false);
            SelfManager.self().setVariable("piping?", true);
    ...
    try {
      ...
      world.observer.setGlobal("dance-task", Tasks.commandTask(function() {
        if (PrimChecks.agentset.optimizeCount(SelfManager.self().inRadius(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return SelfManager.self().getVariable("piping?"); }), 3), 0, (a, b) => a > b)) {
          ...
          if ((Prims.gt(SelfManager.self().getVariable("bee-timer"), PrimChecks.math.minus(SelfManager.self().getVariable("interest"), PrimChecks.math.mult_unchecked(PrimChecks.math.minus(SelfManager.self().getVariable("trips"), 1), PrimChecks.math.plus_unchecked(15, RandomPrims.randomLong(5))))) && Prims.gt(SelfManager.self().getVariable("interest"), 0))) {
            SelfManager.self().setVariable("next-task", world.observer.getGlobal("re-visit-task"));
            SelfManager.self().setVariable("task-string", "revisiting");
            SelfManager.self().penManager.raisePen();
            SelfManager.self().setVariable("interest", PrimChecks.math.minus(SelfManager.self().getVariable("interest"), PrimChecks.math.plus_unchecked(15, RandomPrims.randomLong(5))));
            SelfManager.self().setVariable("bee-timer", 25);
          }
          if ((Prims.gt(SelfManager.self().getVariable("bee-timer"), PrimChecks.math.minus(SelfManager.self().getVariable("interest"), PrimChecks.math.mult_unchecked(PrimChecks.math.minus(SelfManager.self().getVariable("trips"), 1), PrimChecks.math.plus_unchecked(15, RandomPrims.randomLong(5))))) && Prims.lte(SelfManager.self().getVariable("interest"), 0))) {
            SelfManager.self().setVariable("next-task", world.observer.getGlobal("watch-dance-task"));
            SelfManager.self().setVariable("task-string", "watching-dance");
            SelfManager.self().setVariable("target", Nobody);
          ...
          if (Prims.lte(SelfManager.self().getVariable("bee-timer"), PrimChecks.math.minus(SelfManager.self().getVariable("interest"), PrimChecks.math.mult_unchecked(PrimChecks.math.minus(SelfManager.self().getVariable("trips"), 1), PrimChecks.math.plus_unchecked(15, RandomPrims.randomLong(5)))))) {
          ...
          SelfManager.self().setVariable("bee-timer", PrimChecks.math.plus(SelfManager.self().getVariable("bee-timer"), 1));
        }
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("pipe-task", Tasks.commandTask(function() {
        procedures["MOVE-AROUND"]();
        if (Prims.equality(PrimChecks.agentset.count_unchecked(SelfManager.self().inRadius(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return SelfManager.self().getVariable("piping?"); }), 5)), PrimChecks.agentset.count_unchecked(SelfManager.self().inRadius(world.turtleManager.turtlesOfBreed("SCOUTS"), 5)))) {
          SelfManager.self().setVariable("bee-timer", PrimChecks.math.minus(SelfManager.self().getVariable("bee-timer"), 1));
        }
        if (Prims.lt(SelfManager.self().getVariable("bee-timer"), 0)) {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if ((PrimChecks.agentset.all(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return SelfManager.self().getVariable("on-site?"); }) && Prims.equality(PrimChecks.list.length_unchecked(PrimChecks.list.removeDuplicates(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return SelfManager.self().getVariable("target"); }))), 1))) {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let numOfTurns = PrimChecks.math.mult_unchecked(PrimChecks.math.div(1, SelfManager.self().getVariable("interest")), 2600); letVars['numOfTurns'] = numOfTurns;
      let anglePerTurn = PrimChecks.math.div(180, numOfTurns); letVars['anglePerTurn'] = anglePerTurn;
      let semicircle = PrimChecks.math.div_unchecked(PrimChecks.math.mult_unchecked(PrimChecks.math.mult(0.5, SelfManager.self().getVariable("dist-to-hive")), 3.141592653589793), 5); letVars['semicircle'] = semicircle;
      if (Prims.equality(SelfManager.self().getVariable("circle-switch"), 1)) {
        ...
        for (let _index_17080_17086 = 0, _repeatcount_17080_17086 = StrictMath.floor(numOfTurns); _index_17080_17086 < _repeatcount_17080_17086; _index_17080_17086++){
          ...
          SelfManager.self().fd(PrimChecks.math.mult(PrimChecks.math.div(semicircle, 180), anglePerTurn));
        }
      }
      if (Prims.equality(SelfManager.self().getVariable("circle-switch"), -1)) {
        SelfManager.self().face(SelfManager.self().getVariable("target"));
      ...
      SelfManager.self().setVariable("circle-switch", PrimChecks.math.mult(SelfManager.self().getVariable("circle-switch"), -1));
  ...
  temp = (function() {
    try {
      ...
      for (let _index_17897_17903 = 0, _repeatcount_17897_17903 = StrictMath.floor(PrimChecks.math.div_unchecked(PrimChecks.math.minus(SelfManager.self().getVariable("dist-to-hive"), 2), 2)); _index_17897_17903 < _repeatcount_17897_17903; _index_17897_17903++){
        ...
        waggleSwitch = PrimChecks.math.mult(waggleSwitch, -1); letVars['waggleSwitch'] = waggleSwitch;
      }
      if (Prims.equality(waggleSwitch, -1)) {
        SelfManager.self().right(-(120));
        SelfManager.self()._optimalFdLessThan1(0.4);
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().right(PrimChecks.math.minus_unchecked(RandomPrims.randomLong(20), RandomPrims.randomLong(20)));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      SelfManager.self().right(PrimChecks.math.minus_unchecked(RandomPrims.randomLong(60), RandomPrims.randomLong(60)));
      SelfManager.self().fd(PrimChecks.math.randomFloat_unchecked(0.1));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      let i = 0; letVars['i'] = i;
      for (let _index_18472_18478 = 0, _repeatcount_18472_18478 = StrictMath.floor(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("SITES"))); _index_18472_18478 < _repeatcount_18472_18478; _index_18472_18478++){
        plotManager.setCurrentPlot("on-site");
        ...
        plotManager.plotValue(PrimChecks.agentset.countWith(world.turtleManager.turtlesOfBreed("SCOUTS"), function() {
          return PrimChecks.math.bool('AND', SelfManager.self().getVariable("on-site?")) && PrimChecks.math.bool('AND', Prims.equality(SelfManager.self().getVariable("target"), world.turtleManager.getTurtleOfBreed("SITES", i)));
        }));
        plotManager.setCurrentPlot("committed");
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("show-dance-path?", PrimChecks.math.not(world.observer.getGlobal("show-dance-path?")));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      if (world.observer.getGlobal("scouts-visible?")) {
        Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("SCOUTS")).ask(function() { SelfManager.self().hideTurtle(true);; }, true);
      }
      else {
        Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("SCOUTS")).ask(function() { SelfManager.self().hideTurtle(false);; }, true);
      }
      world.observer.setGlobal("scouts-visible?", PrimChecks.math.not(world.observer.getGlobal("scouts-visible?")));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
