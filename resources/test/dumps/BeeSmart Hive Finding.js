...
ProcedurePrims.defineCommand("setup", (function() {
  world.clearAll();
  R = ProcedurePrims.callCommand("setup-hives"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("setup-tasks"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("setup-bees"); if (R === DeathInterrupt) { return R; }
...
ProcedurePrims.defineCommand("setup-hives", (function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.list.nOf(PrimChecks.validator.checkArg('N-OF', 1, world.observer.getGlobal("hive-number")), PrimChecks.agentset.with(world.patches(), function() {
    ...
    R = ProcedurePrims.ask(SelfManager.self().sprout(1, "SITES"), function() {
  ...
  for (let _index_3202_3208 = 0, _repeatcount_3202_3208 = StrictMath.floor(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("SITES"))); _index_3202_3208 < _repeatcount_3202_3208; _index_3202_3208++){
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.turtleManager.getTurtleOfBreed("SITES", i)), function() {
...
ProcedurePrims.defineCommand("setup-bees", (function() {
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(100, "SCOUTS"), function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.list.nOf(PrimChecks.validator.checkArg('N-OF', 1, world.observer.getGlobal("initial-percentage")), world.turtleManager.turtlesOfBreed("SCOUTS"))), function() {
...
ProcedurePrims.defineCommand("setup-tasks", (function() {
  R = ProcedurePrims.callCommand("watch-dance"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("discover"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("inspect-hive"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("go-home"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("dance"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("re-visit"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("pipe"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("take-off"); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("watch-dance", (function() {
  world.observer.setGlobal("watch-dance-task", Tasks.commandTask(function() {
    ...
    R = ProcedurePrims.callCommand("move-around"); if (R === DeathInterrupt) { return R; }
    ...
    if (Prims.lt(SelfManager.self().getVariable("bee-timer"), 0)) {
      ...
      if (PrimChecks.agentset.optimizeCount(SelfManager.self().inRadius(world.turtleManager.turtlesOfBreed("SITES"), 3), 0, (a, b) => a > b)) {
        ...
        if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, tempHtarget), function() { return SelfManager.self().getVariable("discovered?"); })))) {
          ...
          R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self().getVariable("target")), function() {
          ...
          R = ProcedurePrims.callCommand("proceed"); if (R === DeathInterrupt) { return R; }
          SelfManager.self().setVariable("bee-timer", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("bee-timer")), 1));
        }
      }
      else {
      ...
      if (Prims.lte(SelfManager.self().getVariable("bee-timer"), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("interest")), PrimChecks.math.mult(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("trips")), 1), PrimChecks.math.plus(15, RandomPrims.randomLong(5)))))) {
        if ((Prims.lte(SelfManager.self().getVariable("interest"), 50) && Prims.lt(RandomPrims.randomLong(100), 43))) {
          ...
          for (let _index_14583_14589 = 0, _repeatcount_14583_14589 = StrictMath.floor(2); _index_14583_14589 < _repeatcount_14583_14589; _index_14583_14589++){
            R = ProcedurePrims.callCommand("waggle"); if (R === DeathInterrupt) { return R; }
            R = ProcedurePrims.callCommand("make-semicircle"); if (R === DeathInterrupt) { return R; }
          }
        }
      }
...
ProcedurePrims.defineCommand("go", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SCOUTS"), function() {
    R = PrimChecks.procedure.run(PrimChecks.validator.checkArg('RUN', 2052, SelfManager.self().getVariable("next-task"))); if (R !== undefined) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.callCommand("plot-on-site-scouts"); if (R === DeathInterrupt) { return R; }
  world.ticker.tick();
}))
...
ProcedurePrims.defineCommand("show-hide-scouts", (function() {
  if (world.observer.getGlobal("scouts-visible?")) {
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { SelfManager.self().hideTurtle(true); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  else {
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { SelfManager.self().hideTurtle(false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
