...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('default', plotOps.makePenOps, false, new PenBundle.State(0, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('piping-scouts', 'default', function() {
      plotManager.plotValue(PrimChecks.agentset.countWith(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return PrimChecks.turtle.getVariable("piping?"); }));;
    });
  })];
  var setup   = function() {};
  var update  = function() {};
  ...
  var pens    = [new PenBundle.Pen('watching bees', plotOps.makePenOps, false, new PenBundle.State(136.7, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('watching v.s. working', 'watching bees', function() {
      plotManager.plotValue(PrimChecks.agentset.countWith(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return Prims.equality(PrimChecks.turtle.getVariable("task-string"), "watching-dance"); }));;
    });
  }),
  new PenBundle.Pen('working bees', plotOps.makePenOps, false, new PenBundle.State(56.8, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('watching v.s. working', 'working bees', function() {
      plotManager.plotValue(PrimChecks.math.minus(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("SCOUTS")), PrimChecks.agentset.countWith(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return Prims.equality(PrimChecks.turtle.getVariable("task-string"), "watching-dance"); })));;
    });
  })];
  var setup   = function() {};
  var update  = function() {};
...
ProcedurePrims.defineCommand("setup-bees", 3572, 4206, (function() {
  var R = ProcedurePrims.ask(world.turtleManager.createTurtles(100, "SCOUTS"), function() {
    ...
    PrimChecks.turtle.setVariable("no-discovery?", false);
    PrimChecks.turtle.setVariable("on-site?", false);
    PrimChecks.turtle.setVariable("piping?", false);
    PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("watch-dance-task"));
    PrimChecks.turtle.setVariable("task-string", "watching-dance");
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  var R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.list.nOf(PrimChecks.validator.checkArg('N-OF', 1, world.observer.getGlobal("initial-percentage")), world.turtleManager.turtlesOfBreed("SCOUTS"))), function() {
    PrimChecks.turtle.setVariable("initial-scout?", true);
    PrimChecks.turtle.setVariable("bee-timer", RandomPrims.randomLong(100));
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
...
ProcedurePrims.defineCommand("watch-dance", 4439, 7166, (function() {
  world.observer.setGlobal("watch-dance-task", PrimChecks.task.checked(function() {
    ...
    if ((PrimChecks.validator.checkArg('AND', 2, PrimChecks.turtle.getVariable("initial-scout?")) && Prims.lt(PrimChecks.turtle.getVariable("bee-timer"), 0))) {
      PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("discover-task"));
      PrimChecks.turtle.setVariable("task-string", "discovering");
      PrimChecks.turtle.setVariable("bee-timer", world.observer.getGlobal("initial-explore-time"));
      PrimChecks.turtle.setVariable("initial-scout?", false);
    }
    if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, PrimChecks.turtle.getVariable("initial-scout?")))) {
      if (Prims.lt(PrimChecks.turtle.getVariable("bee-timer"), 0)) {
    ...
    PrimChecks.turtle.setVariable("bee-timer", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("bee-timer")), 1));
...
ProcedurePrims.defineCommand("discover", 7292, 8833, (function() {
  world.observer.setGlobal("discover-task", PrimChecks.task.checked(function() {
    if (Prims.lt(PrimChecks.turtle.getVariable("bee-timer"), 0)) {
      PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("go-home-task"));
      PrimChecks.turtle.setVariable("task-string", "going-home");
      PrimChecks.turtle.setVariable("no-discovery?", true);
    }
    else {
      if (PrimChecks.agentset.optimizeCount(SelfManager.self().inRadius(world.turtleManager.turtlesOfBreed("SITES"), 3), 0, (a, b) => a > b)) {
        ...
        if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, tempHtarget), function() { return PrimChecks.turtle.getVariable("discovered?"); })))) {
...
ProcedurePrims.defineCommand("inspect-hive", 8958, 10360, (function() {
  world.observer.setGlobal("inspect-hive-task", PrimChecks.task.checked(function() {
    if (Prims.lt(PrimChecks.turtle.getVariable("bee-timer"), 0)) {
      PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("go-home-task"));
      PrimChecks.turtle.setVariable("task-string", "going-home");
      PrimChecks.turtle.setVariable("on-site?", false);
      PrimChecks.turtle.setVariable("trips", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, PrimChecks.turtle.getVariable("trips")), 1));
    }
    else {
      if (Prims.gt(SelfManager.self().distance(PrimChecks.turtle.getVariable("target")), 2)) {
        SelfManager.self().face(PrimChecks.validator.checkArg('FACE', 768, PrimChecks.turtle.getVariable("target")));
        SelfManager.self()._optimalFdOne();
      }
      PrimChecks.turtle.setVariable("on-site?", true);
      let nearbyHscouts = SelfManager.self().inRadius(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("SCOUTS"), function() {
        return (PrimChecks.validator.checkArg('AND', 2, PrimChecks.turtle.getVariable("on-site?")) && Prims.equality(PrimChecks.turtle.getVariable("target"), PrimChecks.agentset.of(SelfManager.myself(), function() { return PrimChecks.turtle.getVariable("target"); })));
      ...
      PrimChecks.turtle.setVariable("dist-to-hive", SelfManager.self().distanceXY(0, 0));
      PrimChecks.turtle.setVariable("bee-timer", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("bee-timer")), 1));
    }
...
ProcedurePrims.defineCommand("go-home", 10485, 11507, (function() {
  world.observer.setGlobal("go-home-task", PrimChecks.task.checked(function() {
    if (Prims.lt(SelfManager.self().distance(PrimChecks.turtle.getVariable("my-home")), 1)) {
      if (PrimChecks.turtle.getVariable("no-discovery?")) {
        PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("watch-dance-task"));
        PrimChecks.turtle.setVariable("task-string", "watching-dance");
        PrimChecks.turtle.setVariable("no-discovery?", false);
        PrimChecks.turtle.setVariable("initial-scout?", false);
        ...
        if (PrimChecks.turtle.getVariable("piping?")) {
          PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("pipe-task"));
          PrimChecks.turtle.setVariable("task-string", "piping");
          PrimChecks.turtle.setVariable("bee-timer", 20);
        }
        else {
          PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("dance-task"));
          PrimChecks.turtle.setVariable("task-string", "dancing");
          PrimChecks.turtle.setVariable("bee-timer", 0);
        }
      }
    }
    else {
      SelfManager.self().face(PrimChecks.validator.checkArg('FACE', 768, PrimChecks.turtle.getVariable("my-home")));
      var R = ProcedurePrims.callCommand("proceed"); if (R === DeathInterrupt) { return R; }
    }
...
ProcedurePrims.defineCommand("dance", 12817, 14704, (function() {
  world.observer.setGlobal("dance-task", PrimChecks.task.checked(function() {
    if (PrimChecks.agentset.optimizeCount(SelfManager.self().inRadius(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return PrimChecks.turtle.getVariable("piping?"); }), 3), 0, (a, b) => a > b)) {
      ...
      if ((Prims.gt(PrimChecks.turtle.getVariable("bee-timer"), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("interest")), PrimChecks.math.mult(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("trips")), 1), PrimChecks.math.plus(15, RandomPrims.randomLong(5))))) && Prims.gt(PrimChecks.turtle.getVariable("interest"), 0))) {
        PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("re-visit-task"));
        PrimChecks.turtle.setVariable("task-string", "revisiting");
        SelfManager.self().penManager.raisePen();
        PrimChecks.turtle.setVariable("interest", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("interest")), PrimChecks.math.plus(15, RandomPrims.randomLong(5))));
        PrimChecks.turtle.setVariable("bee-timer", 25);
      }
      if ((Prims.gt(PrimChecks.turtle.getVariable("bee-timer"), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("interest")), PrimChecks.math.mult(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("trips")), 1), PrimChecks.math.plus(15, RandomPrims.randomLong(5))))) && Prims.lte(PrimChecks.turtle.getVariable("interest"), 0))) {
        PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("watch-dance-task"));
        PrimChecks.turtle.setVariable("task-string", "watching-dance");
        PrimChecks.turtle.setVariable("target", Nobody);
      ...
      if (Prims.lte(PrimChecks.turtle.getVariable("bee-timer"), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("interest")), PrimChecks.math.mult(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("trips")), 1), PrimChecks.math.plus(15, RandomPrims.randomLong(5)))))) {
        if ((Prims.lte(PrimChecks.turtle.getVariable("interest"), 50) && Prims.lt(RandomPrims.randomLong(100), 43))) {
          PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("re-visit-task"));
          PrimChecks.turtle.setVariable("task-string", "revisiting");
          PrimChecks.turtle.setVariable("interest", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("interest")), PrimChecks.math.plus(15, RandomPrims.randomLong(5))));
          PrimChecks.turtle.setVariable("bee-timer", 10);
        }
        else {
      ...
      PrimChecks.turtle.setVariable("bee-timer", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, PrimChecks.turtle.getVariable("bee-timer")), 1));
    }
...
ProcedurePrims.defineCommand("re-visit", 14829, 15429, (function() {
  world.observer.setGlobal("re-visit-task", PrimChecks.task.checked(function() {
    if (Prims.gt(PrimChecks.turtle.getVariable("bee-timer"), 0)) {
      PrimChecks.turtle.setVariable("bee-timer", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("bee-timer")), 1));
    }
    else {
      SelfManager.self().penManager.raisePen();
...
ProcedurePrims.defineCommand("pipe", 15554, 16001, (function() {
  world.observer.setGlobal("pipe-task", PrimChecks.task.checked(function() {
    var R = ProcedurePrims.callCommand("move-around"); if (R === DeathInterrupt) { return R; }
    if (Prims.equality(PrimChecks.agentset.count(SelfManager.self().inRadius(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return PrimChecks.turtle.getVariable("piping?"); }), 5)), PrimChecks.agentset.count(SelfManager.self().inRadius(world.turtleManager.turtlesOfBreed("SCOUTS"), 5)))) {
      PrimChecks.turtle.setVariable("bee-timer", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("bee-timer")), 1));
    }
    if (Prims.lt(PrimChecks.turtle.getVariable("bee-timer"), 0)) {
      PrimChecks.turtle.setVariable("next-task", world.observer.getGlobal("take-off-task"));
      PrimChecks.turtle.setVariable("task-string", "taking-off");
    }
...
ProcedurePrims.defineCommand("take-off", 16126, 16258, (function() {
  world.observer.setGlobal("take-off-task", PrimChecks.task.checked(function() {
    if (Prims.gt(SelfManager.self().distance(PrimChecks.turtle.getVariable("target")), 1)) {
      SelfManager.self().face(PrimChecks.validator.checkArg('FACE', 768, PrimChecks.turtle.getVariable("target")));
      SelfManager.self()._optimalFdOne();
    }
    else {
...
ProcedurePrims.defineCommand("go", 16383, 16622, (function() {
  if ((PrimChecks.agentset.all(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return PrimChecks.turtle.getVariable("on-site?"); }) && Prims.equality(PrimChecks.list.length(PrimChecks.list.removeDuplicates(PrimChecks.validator.checkArg('REMOVE-DUPLICATES', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("SCOUTS"), function() { return PrimChecks.turtle.getVariable("target"); })))), 1))) {
    return PrimChecks.procedure.stop();
  }
  var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SCOUTS"), function() {
    var R = PrimChecks.procedure.run(PrimChecks.validator.checkArg('RUN', 2052, PrimChecks.turtle.getVariable("next-task"))); if (R !== undefined) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineCommand("make-semicircle", 16747, 17408, (function() {
  let numHofHturns = PrimChecks.math.mult(PrimChecks.math.div(1, PrimChecks.validator.checkArg('/', 1, PrimChecks.turtle.getVariable("interest"))), 2600); ProcedurePrims.stack().currentContext().registerStringRunVar("NUM-OF-TURNS", numHofHturns);
  ...
  let semicircle = PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.math.mult(0.5, PrimChecks.validator.checkArg('*', 1, PrimChecks.turtle.getVariable("dist-to-hive"))), 3.141592653589793), 5); ProcedurePrims.stack().currentContext().registerStringRunVar("SEMICIRCLE", semicircle);
  if (Prims.equality(PrimChecks.turtle.getVariable("circle-switch"), 1)) {
    SelfManager.self().face(PrimChecks.validator.checkArg('FACE', 768, PrimChecks.turtle.getVariable("target")));
  ...
  PrimChecks.turtle.setVariable("circle-switch", PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, PrimChecks.turtle.getVariable("circle-switch")), -1));
  PrimChecks.turtle.setXY(PrimChecks.validator.checkArg('SETXY', 1, PrimChecks.turtle.getVariable("temp-x-dance")), PrimChecks.validator.checkArg('SETXY', 1, PrimChecks.turtle.getVariable("temp-y-dance")));
}))
ProcedurePrims.defineCommand("waggle", 17416, 18238, (function() {
  SelfManager.self().face(PrimChecks.validator.checkArg('FACE', 768, PrimChecks.turtle.getVariable("target")));
  PrimChecks.turtle.setVariable("temp-x-dance", PrimChecks.turtle.getVariable("xcor"));
  PrimChecks.turtle.setVariable("temp-y-dance", PrimChecks.turtle.getVariable("ycor"));
  ...
  for (let _index_17897_17903 = 0, _repeatcount_17897_17903 = StrictMath.floor(PrimChecks.math.div(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.turtle.getVariable("dist-to-hive")), 2), 2)); _index_17897_17903 < _repeatcount_17897_17903; _index_17897_17903++) {
