    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('piping-scouts', 'default')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(world.turtleManager.turtlesOfBreed("SCOUTS")._optimalCountWith(function() { return SelfManager.self().getVariable("piping?"); }));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('watching v.s. working', 'watching bees')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(world.turtleManager.turtlesOfBreed("SCOUTS")._optimalCountWith(function() { return Prims.equality(SelfManager.self().getVariable("task-string"), "watching-dance"); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('watching v.s. working', 'working bees')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((world.turtleManager.turtlesOfBreed("SCOUTS").size() - world.turtleManager.turtlesOfBreed("SCOUTS")._optimalCountWith(function() { return Prims.equality(SelfManager.self().getVariable("task-string"), "watching-dance"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  temp = (function() {
    try {
      ...
      for (let _index_18472_18478 = 0, _repeatcount_18472_18478 = StrictMath.floor(world.turtleManager.turtlesOfBreed("SITES").size()); _index_18472_18478 < _repeatcount_18472_18478; _index_18472_18478++){
        ...
        plotManager.plotValue(world.turtleManager.turtlesOfBreed("SCOUTS")._optimalCountWith(function() {
