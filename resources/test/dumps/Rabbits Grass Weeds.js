...
var procedures = (function() {
  ...
  var reproduce = function() {
    if (Prims.gt(SelfPrims.getVariable("energy"), world.observer.getGlobal("birth-threshold"))) {
      ...
      SelfPrims.hatch(1, "").ask(function() { SelfPrims.fd(1); }, true);
    }
  };
  var death = function() {
