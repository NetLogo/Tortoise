...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('grass', plotOps.makePenOps, false, new PenBundle.State(55, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'grass')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.div_unchecked(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 55); }), 4));
        } catch (e) {
  ...
  new PenBundle.Pen('rabbits', plotOps.makePenOps, false, new PenBundle.State(15, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'rabbits')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("RABBITS")));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  new PenBundle.Pen('weeds', plotOps.makePenOps, false, new PenBundle.State(115, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'weeds')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.div_unchecked(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 115); }), 4));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("number"), "RABBITS").ask(function() {
        ...
        SelfManager.self().setVariable("energy", RandomPrims.randomLong(10));
      }, true);
      world.ticker.reset();
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (PrimChecks.math.not_unchecked(PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("RABBITS")))) {
    ...
    try {
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() {
        if (Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 0)) {
          if (Prims.lt(PrimChecks.math.randomFloat_unchecked(1000), world.observer.getGlobal("weeds-grow-rate"))) {
            SelfManager.self().setPatchVariable("pcolor", 115);
          }
          if (Prims.lt(PrimChecks.math.randomFloat_unchecked(1000), world.observer.getGlobal("grass-grow-rate"))) {
  ...
  temp = (function() {
    try {
      ...
      SelfManager.self().setVariable("energy", PrimChecks.math.minus(SelfManager.self().getVariable("energy"), 0.5));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 55)) {
        ...
        SelfManager.self().setVariable("energy", PrimChecks.math.plus(SelfManager.self().getVariable("energy"), world.observer.getGlobal("grass-energy")));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 115)) {
        SelfManager.self().setPatchVariable("pcolor", 0);
        SelfManager.self().setVariable("energy", PrimChecks.math.plus(SelfManager.self().getVariable("energy"), world.observer.getGlobal("weed-energy")));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gt(SelfManager.self().getVariable("energy"), world.observer.getGlobal("birth-threshold"))) {
        SelfManager.self().setVariable("energy", PrimChecks.math.div(SelfManager.self().getVariable("energy"), 2));
