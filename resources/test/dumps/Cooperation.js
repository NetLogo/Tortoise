    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cows over time', 'greedy')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("GREEDY-COWS")));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cows over time', 'cooperative')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("COOPERATIVE-COWS")));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
