    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cows over time', 'greedy')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("GREEDY-COWS")));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cows over time', 'cooperative')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("COOPERATIVE-COWS")));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-cows"), "").ask(function() {
        ...
        SelfManager.self().setVariable("energy", PrimChecks.math.mult(world.observer.getGlobal("metabolism"), 4));
        if (Prims.lt(PrimChecks.math.randomFloat_unchecked(1), world.observer.getGlobal("cooperative-probability"))) {
          SelfManager.self().setVariable("breed", world.turtleManager.turtlesOfBreed("COOPERATIVE-COWS"));
          SelfManager.self().setVariable("color", PrimChecks.math.minus_unchecked(15, 1.5));
        }
        else {
          SelfManager.self().setVariable("breed", world.turtleManager.turtlesOfBreed("GREEDY-COWS"));
          SelfManager.self().setVariable("color", PrimChecks.math.minus_unchecked(95, 2));
        }
      }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gt(SelfManager.self().getVariable("energy"), world.observer.getGlobal("reproduction-threshold"))) {
        SelfManager.self().setVariable("energy", PrimChecks.math.minus(SelfManager.self().getVariable("energy"), world.observer.getGlobal("reproduction-cost")));
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gte(SelfManager.self().getPatchVariable("grass"), world.observer.getGlobal("low-high-threshold"))) {
        if (Prims.gte(world.observer.getGlobal("high-growth-chance"), PrimChecks.math.randomFloat_unchecked(100))) {
          SelfManager.self().setPatchVariable("grass", PrimChecks.math.plus(SelfManager.self().getPatchVariable("grass"), 1));
        }
      }
      else {
        if (Prims.gte(world.observer.getGlobal("low-growth-chance"), PrimChecks.math.randomFloat_unchecked(100))) {
          SelfManager.self().setPatchVariable("grass", PrimChecks.math.plus(SelfManager.self().getPatchVariable("grass"), 1));
        }
      }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().setPatchVariable("pcolor", ColorModel.scaleColor(PrimChecks.math.minus_unchecked(55, 1), SelfManager.self().getPatchVariable("grass"), 0, PrimChecks.math.mult(2, world.observer.getGlobal("max-grass-height"))));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      SelfManager.self().setVariable("energy", PrimChecks.math.minus(SelfManager.self().getVariable("energy"), world.observer.getGlobal("metabolism")));
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gt(SelfManager.self().getPatchVariable("grass"), world.observer.getGlobal("low-high-threshold"))) {
        SelfManager.self().setPatchVariable("grass", PrimChecks.math.minus(SelfManager.self().getPatchVariable("grass"), 1));
