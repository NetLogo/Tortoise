...
modelConfig.plots = [];
var workspace = tortoise_require('engine/workspace')(modelConfig)([])([], [])(tortoise_require("extensions/all").dumpers())(["initial-density", "ratio", "inner-radius-x", "inner-radius-y", "outer-radius-x", "outer-radius-y"], ["initial-density", "ratio", "inner-radius-x", "inner-radius-y", "outer-radius-x", "outer-radius-y"], ["new-color", "inner-neighbors", "outer-neighbors"], -30, 30, -30, 30, 5.0, true, true, turtleShapes, linkShapes, function(){});
