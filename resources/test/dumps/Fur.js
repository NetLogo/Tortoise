...
var procedures = (function() {
  ...
  var pickNewColor = function() {
    var activator = SelfPrims.getPatchVariable("inner-neighbors").agentFilter(function() { return Prims.equality(SelfPrims.getPatchVariable("pcolor"), 9.9); }).size();
    var inhibitor = SelfPrims.getPatchVariable("outer-neighbors").agentFilter(function() { return Prims.equality(SelfPrims.getPatchVariable("pcolor"), 9.9); }).size();
