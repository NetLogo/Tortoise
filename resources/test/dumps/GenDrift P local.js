...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('color5', plotOps.makePenOps, false, new PenBundle.State(5, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Patch Colors', 'color5')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 5); }));
        } catch (e) {
  ...
  new PenBundle.Pen('color15', plotOps.makePenOps, false, new PenBundle.State(15, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Patch Colors', 'color15')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
  ...
  new PenBundle.Pen('color25', plotOps.makePenOps, false, new PenBundle.State(25, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Patch Colors', 'color25')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 25); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  new PenBundle.Pen('color35', plotOps.makePenOps, false, new PenBundle.State(35, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Patch Colors', 'color35')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 35); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  new PenBundle.Pen('color45', plotOps.makePenOps, false, new PenBundle.State(45, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Patch Colors', 'color45')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 45); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  new PenBundle.Pen('color55', plotOps.makePenOps, false, new PenBundle.State(55, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Patch Colors', 'color55')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
  ...
  new PenBundle.Pen('color65', plotOps.makePenOps, false, new PenBundle.State(65, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Patch Colors', 'color65')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 65); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  new PenBundle.Pen('color125', plotOps.makePenOps, false, new PenBundle.State(125, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Patch Colors', 'color125')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 125); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  new PenBundle.Pen('color85', plotOps.makePenOps, false, new PenBundle.State(85, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Patch Colors', 'color85')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
  ...
  new PenBundle.Pen('color95', plotOps.makePenOps, false, new PenBundle.State(95, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Patch Colors', 'color95')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() {
        SelfManager.self().setPatchVariable("pcolor", PrimChecks.agentset.of(PrimChecks.list.oneOf(SelfManager.self().getNeighbors()), function() { return SelfManager.self().getPatchVariable("pcolor"); }));
      }, true);
      world.ticker.tick();
    } catch (e) {
      return Errors.stopInCommandCheck(e)
