...
modelConfig.plots = [(function() {
  ...
  var setup   = function() {};
  var update  = function() {};
  return new Plot(name, pens, plotOps, "time", "vision", false, true, true, 0, 1000, 0, 10, setup, update);
})(), (function() {
  ...
  var setup   = function() {};
  var update  = function() {};
  return new Plot(name, pens, plotOps, "speed", "frequency", false, true, true, 0, 10, 0, 50, setup, update);
})(), (function() {
  ...
  var setup   = function() {};
  var update  = function() {};
  return new Plot(name, pens, plotOps, "time", "rate", false, true, true, 0, 1000, 0, 10, setup, update);
})(), (function() {
  ...
  var setup   = function() {};
  var update  = function() {};
  return new Plot(name, pens, plotOps, "speed", "frequency", false, true, true, 0, 10, 0, 10, setup, update);
})(), (function() {
  ...
  var setup   = function() {};
  var update  = function() {};
  return new Plot(name, pens, plotOps, "vision", "frequency", false, true, true, 0, 10, 0, 50, setup, update);
})(), (function() {
...
ProcedurePrims.defineCommand("reproduce-birds", 3425, 3715, (function() {
  ...
  if (((Prims.equality(PrimChecks.math.mod(3484, 3487, PrimChecks.validator.checkArg('MOD', 3484, 3487, 1, world.observer.getGlobal("total-caught")), PrimChecks.validator.checkArg('MOD', 3484, 3487, 1, world.observer.getGlobal("reproduce-birds-after-eating"))), 0) && Prims.gt(world.observer.getGlobal("total-caught"), 0)) && PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("BIRDS")))) {
    ...
    var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 3609, 3612, 1904, worstHbird), 3609, 3612), function() {
      PrimChecks.context.assertKind(2, 'ask', 3633, 3675);
...
ProcedurePrims.defineCommand("check-player-caught", 6528, 7830, (function() {
  ...
  if ((MousePrims.isDown() && MousePrims.isInside())) {
    ...
    if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 6929, 6933, 112, localHbugs))) {
      ...
      var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 7052, 7055, 1904, PrimChecks.list.oneOf(7056, 7062, PrimChecks.validator.checkArg('ONE-OF', 7056, 7062, 120, localHbugs))), 7052, 7055), function() {
