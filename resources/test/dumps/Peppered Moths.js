    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Moth Colors Over Time', 'Pollution')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.div_unchecked(PrimChecks.math.mult(PrimChecks.math.div(procedures["UPPER-BOUND"](), 3), world.observer.getGlobal("darkness")), 8));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      return PrimChecks.math.minus(9, world.observer.getGlobal("darkness"));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.plus_unchecked(RandomPrims.randomLong(9), 1);
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.mult(4, world.observer.getGlobal("num-moths"));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
    ...
    try {
      ...
      if ((Prims.equality(SelfManager.self().getVariable("age"), 2) || Prims.equality(SelfManager.self().getVariable("age"), 3))) {
        SelfManager.self().hatch(2, "").ask(function() {
          if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("mutation"))) {
            if (Prims.equality(RandomPrims.randomLong(2), 0)) {
              SelfManager.self().setVariable("color", PrimChecks.math.round_unchecked(PrimChecks.math.plus(SelfManager.self().getVariable("color"), PrimChecks.math.div_unchecked(PrimChecks.math.randomFloat(world.observer.getGlobal("mutation")), 12.5))));
              if (Prims.gte(SelfManager.self().getVariable("color"), 9)) {
                SelfManager.self().setVariable("color", 9);
              }
            }
            else {
              SelfManager.self().setVariable("color", PrimChecks.math.round_unchecked(PrimChecks.math.minus(SelfManager.self().getVariable("color"), PrimChecks.math.div_unchecked(PrimChecks.math.randomFloat(world.observer.getGlobal("mutation")), 12.5))));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.lt(PrimChecks.math.randomFloat_unchecked(1000), PrimChecks.math.plus_unchecked(PrimChecks.math.mult(world.observer.getGlobal("selection"), PrimChecks.math.abs_unchecked(PrimChecks.math.minus(procedures["ENV-COLOR"](), SelfManager.self().getVariable("color")))), 200))) {
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gt(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("MOTHS")), procedures["UPPER-BOUND"]())) {
        if (Prims.equality(RandomPrims.randomLong(2), 0)) {
          SelfManager.self().die();
        }
      }
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("medium-moths", PrimChecks.math.minus_unchecked(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("MOTHS")), PrimChecks.math.plus(world.observer.getGlobal("light-moths"), world.observer.getGlobal("dark-moths"))));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.lte(world.observer.getGlobal("darkness"), PrimChecks.math.minus(8, procedures["DELTA-ENV"]()))) {
        world.observer.setGlobal("darkness", PrimChecks.math.plus(world.observer.getGlobal("darkness"), procedures["DELTA-ENV"]()));
        Errors.askNobodyCheck(world.patches()).ask(function() { SelfManager.self().setPatchVariable("pcolor", procedures["ENV-COLOR"]()); }, true);
      }
      else {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.gte(world.observer.getGlobal("darkness"), PrimChecks.math.plus(0, procedures["DELTA-ENV"]()))) {
        world.observer.setGlobal("darkness", PrimChecks.math.minus(world.observer.getGlobal("darkness"), procedures["DELTA-ENV"]()));
        Errors.askNobodyCheck(world.patches()).ask(function() { SelfManager.self().setPatchVariable("pcolor", procedures["ENV-COLOR"]()); }, true);
      }
      else {
        world.observer.setGlobal("darkening?", true);
