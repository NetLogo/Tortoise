...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("medium-moths", (PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("MOTHS")) - (world.observer.getGlobal("light-moths") + world.observer.getGlobal("dark-moths"))));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
