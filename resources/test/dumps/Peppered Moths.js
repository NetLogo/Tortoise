    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Moth Colors Over Time', 'Pollution')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, procedures["UPPER-BOUND"]()), 3), PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("darkness"))), 8));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      return PrimChecks.math.minus(9, PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("darkness")));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("speed")), 100);
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.plus(RandomPrims.randomLong(9), 1);
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.mult(4, PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("num-moths")));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.lte(world.observer.getGlobal("darkness"), PrimChecks.math.minus(8, PrimChecks.validator.checkArg('-', 1, procedures["DELTA-ENV"]())))) {
        world.observer.setGlobal("darkness", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("darkness")), PrimChecks.validator.checkArg('+', 1, procedures["DELTA-ENV"]())));
        Errors.askNobodyCheck(world.patches()).ask(function() { SelfManager.self().setPatchVariable("pcolor", procedures["ENV-COLOR"]()); }, true);
      }
      else {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.gte(world.observer.getGlobal("darkness"), PrimChecks.math.plus(0, PrimChecks.validator.checkArg('+', 1, procedures["DELTA-ENV"]())))) {
        world.observer.setGlobal("darkness", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("darkness")), PrimChecks.validator.checkArg('-', 1, procedures["DELTA-ENV"]())));
        Errors.askNobodyCheck(world.patches()).ask(function() { SelfManager.self().setPatchVariable("pcolor", procedures["ENV-COLOR"]()); }, true);
      }
      else {
        world.observer.setGlobal("darkening?", true);
