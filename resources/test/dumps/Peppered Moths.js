...
new PenBundle.Pen('Pollution', plotOps.makePenOps, false, new PenBundle.State(5.0, 1.0, PenBundle.DisplayMode.Line), function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Moth Colors Over Time', 'Pollution')(function() {}); }); }, function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Moth Colors Over Time', 'Pollution')(function() { plotManager.plotValue((((Call(procedures.upperBound) / 3) * world.observer.getGlobal("darkness")) / 8));; }); }); })];
  var setup   = function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Moth Colors Over Time', undefined)(function() { plotManager.setYRange(0, Call(procedures.upperBound));; }); }); };
...
var procedures = (function() {
  ...
  var setupWorld = function() {
    ...
    world.patches().ask(function() {
      SelfPrims.setPatchVariable("pcolor", Call(procedures.envColor));
    }, true);
  };
