...
var procedures = (function() {
  ...
  var mothsAge = function() { SelfPrims.setVariable("age", (SelfPrims.getVariable("age") + 1)); };
  ...
  var updateMonitors = function() {
    world.observer.setGlobal("light-moths", world.turtleManager.turtlesOfBreed("MOTHS").agentFilter(function() { return Prims.gte(SelfPrims.getVariable("color"), 7); }).size());
    world.observer.setGlobal("dark-moths", world.turtleManager.turtlesOfBreed("MOTHS").agentFilter(function() { return Prims.lte(SelfPrims.getVariable("color"), 3); }).size());
