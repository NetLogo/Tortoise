...
function printBlock(state) {
  ...
  Prims.repeat(4, function () {
    AgentSet.setPatchVariable(2, AgentSet.getTurtleVariable('color'));
    Prims.right(90);
    Prims.fd(1);
  });
}
