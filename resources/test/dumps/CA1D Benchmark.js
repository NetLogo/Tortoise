...
function singleCell() {
  return Procedures.stoppably(function() {
    ...
    AgentSet.ask(Prims.patch(0, Globals.getGlobal(13)), true, function() {
...
function calculateRule() {
  return Procedures.stoppably(function() {
    ...
    if (Globals.getGlobal(5)) {
      rresult = (rresult + 32);
    }
    if (Globals.getGlobal(6)) {
      rresult = (rresult + 64);
    }
    if (Globals.getGlobal(7)) {
      rresult = (rresult + 128);
    }
    return rresult;
  });
...
function printBlock(state) {
  return Procedures.stoppably(function() {
    if (state) {
      AgentSet.setTurtleVariable(1, Globals.getGlobal(8));
    }
    else {
      AgentSet.setTurtleVariable(1, Globals.getGlobal(9));
    }
    AgentSet.setTurtleVariable(2, 90);
...
function listRules() {
  return Procedures.stoppably(function() {
    var rules = [];
    rules = Prims.lput(Prims.lput(Globals.getGlobal(0), [false, false, false]), rules);
    rules = Prims.lput(Prims.lput(Globals.getGlobal(1), [false, false, true]), rules);
    rules = Prims.lput(Prims.lput(Globals.getGlobal(2), [false, true, false]), rules);
    rules = Prims.lput(Prims.lput(Globals.getGlobal(3), [false, true, true]), rules);
    rules = Prims.lput(Prims.lput(Globals.getGlobal(4), [true, false, false]), rules);
    rules = Prims.lput(Prims.lput(Globals.getGlobal(5), [true, false, true]), rules);
    rules = Prims.lput(Prims.lput(Globals.getGlobal(6), [true, true, false]), rules);
    rules = Prims.lput(Prims.lput(Globals.getGlobal(7), [true, true, true]), rules);
    return rules;
  });
}
Procedures.stoppably(function() {Globals.setGlobal(0, true);
Globals.setGlobal(1, false);
Globals.setGlobal(2, false);
Globals.setGlobal(3, true);
Globals.setGlobal(4, false);
Globals.setGlobal(5, true);
Globals.setGlobal(6, true);
Globals.setGlobal(7, false);
Globals.setGlobal(8, 55);
Globals.setGlobal(9, 0);
Globals.setGlobal(10, 105);
Globals.setGlobal(11, 10);
