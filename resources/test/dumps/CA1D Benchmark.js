...
function benchmark() {
  ...
  var _index_415_421, _repeatcount_415_421;
  for (_index_415_421 = 0, _repeatcount_415_421 = Math.floor((10 * world.topology.height)); _index_415_421 < _repeatcount_415_421; _index_415_421++){
    Call(go);
  }
...
function printBlock(state) {
  ...
  SelfPrims.setVariable('heading', 90);
  var _index_5599_5605, _repeatcount_5599_5605;
  for (_index_5599_5605 = 0, _repeatcount_5599_5605 = Math.floor(4); _index_5599_5605 < _repeatcount_5599_5605; _index_5599_5605++){
