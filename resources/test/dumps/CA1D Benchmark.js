...
var procedures = (function() {
  ...
  var doRule = function() {
    ...
    var rightOn_p = SelfManager.self().patchAt(1, 0).projectionBy(function() { return SelfPrims.getPatchVariable("on?"); });
    ...
    SelfManager.self().patchAt(0, -1).ask(function() { SelfPrims.setPatchVariable("on?", newValue); }, true);
  };
