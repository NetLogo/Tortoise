...
modelConfig.plots = [];
var workspace = tortoise_require('engine/workspace')(modelConfig)([{ name: "FIRES", singular: "fire", varNames: [] }, { name: "EMBERS", singular: "ember", varNames: [] }])([], [])(tortoise_require("extensions/all").dumpers())(["density", "initial-trees", "burned-trees"], ["density"], [], -125, 125, -125, 125, 2.0, false, false, turtleShapes, linkShapes, function(){});
