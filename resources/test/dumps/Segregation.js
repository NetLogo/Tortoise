...
modelConfig.plots = [(function() {
  ...
  var plotOps = (typeof modelPlotOps[name] !== "undefined" && modelPlotOps[name] !== null) ? modelPlotOps[name] : new PlotOps(function() {}, function() {}, function() {}, function() { return function() {}; }, function() { return function() {}; }, function() { return function() {}; }, function() { return function() {}; });
  var pens    = [new PenBundle.Pen('percent', plotOps.makePenOps, false, new PenBundle.State(55.0, 1.0, PenBundle.DisplayMode.Line), function() {
    workspace.rng.withAux(function() { plotManager.withTemporaryContext('Percent Unhappy', 'percent')(function() {}); });
  }, function() {
    workspace.rng.withAux(function() {
      plotManager.withTemporaryContext('Percent Unhappy', 'percent')(function() { plotManager.plotValue(world.observer.getGlobal("percent-unhappy"));; });
    });
  })];
  var setup   = function() {
    workspace.rng.withAux(function() { plotManager.withTemporaryContext('Percent Unhappy', undefined)(function() {}); });
  };
  var update  = function() {
    workspace.rng.withAux(function() { plotManager.withTemporaryContext('Percent Unhappy', undefined)(function() {}); });
  };
...
var workspace = tortoise_require('engine/workspace')(modelConfig)([])(["happy?", "similar-nearby", "other-nearby", "total-nearby"], [])(["number", "%-similar-wanted", "percent-similar", "percent-unhappy"], ["number", "%-similar-wanted"], [], -25, 25, -25, 25, 7.0, true, true, turtleShapes, linkShapes, function(){});
...
var procedures = (function() {
  var setup = function() {
    ...
    ListPrims.nOf(world.observer.getGlobal("number"), world.patches()).ask(function() { SelfPrims.sprout(1, "TURTLES").ask(function() { SelfPrims.setVariable("color", 15); }, true); }, true);
    ListPrims.nOf((world.observer.getGlobal("number") / 2), world.turtles()).ask(function() { SelfPrims.setVariable("color", 55); }, true);
  ...
  var updateTurtles = function() {
    world.turtles().ask(function() {
      SelfPrims.setVariable("similar-nearby", Prims.turtlesOn(SelfPrims.getNeighbors()).agentFilter(function() {
        return Prims.equality(SelfPrims.getVariable("color"), SelfManager.myself().projectionBy(function() { return SelfPrims.getVariable("color"); }));
      }).size());
  ...
  var updateGlobals = function() {
    var similarNeighbors = ListPrims.sum(world.turtles().projectionBy(function() { return SelfPrims.getVariable("similar-nearby"); }));
    var totalNeighbors = ListPrims.sum(world.turtles().projectionBy(function() { return SelfPrims.getVariable("total-nearby"); }));
    world.observer.setGlobal("percent-similar", ((similarNeighbors / totalNeighbors) * 100));
    world.observer.setGlobal("percent-unhappy", ((world.turtles().agentFilter(function() { return !SelfPrims.getVariable("happy?"); }).size() / world.turtles().size()) * 100));
  };
  return {
