...
var procedures = (function() {
  var setup = function() {
    ...
    world.turtleManager.createTurtles(world.observer.getGlobal("num-lipids"), "OILS").ask(function() {
      ...
      partner.ask(function() { SelfPrims.setVariable("color", 115); }, true);
    }, true);
    world.ticker.reset();
  };
  var go = function() {
  ...
  var interactWithNeighbor = function() {
    ...
    if (!Prims.equality(near, Nobody)) {
      ...
      if (Prims.equality(near.projectionBy(function() { return SelfPrims.getVariable("breed"); }), SelfPrims.getVariable("breed"))) {
