...
modelConfig.plots = [(function() {
  ...
  return new Plot(name, pens, plotOps, 'clock', 'NIL', false, 0.0, 10.0, 0.0, 150.0, setup, update);
})(), (function() {
