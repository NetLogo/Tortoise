    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Number Happy', 'Happy')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("happy?"); }));
        } catch (e) {
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      world.clearAll();
      world.observer.setGlobal("group-sites", PrimChecks.agentset.with(world.patches(), function() { return procedures["GROUP-SITE?"](); }));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (PrimChecks.agentset.all(world.turtles(), function() { return SelfManager.self().getVariable("happy?"); })) {
