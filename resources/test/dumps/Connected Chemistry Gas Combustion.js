...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      openPatch = PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, openPatches)); letVars['openPatch'] = openPatch;
  ...
  temp = (function() {
    try {
      ...
      if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("GAS-MOLECULES"))) {
        world.observer.setGlobal("avg-speed", PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("GAS-MOLECULES"), function() { return SelfManager.self().getVariable("speed"); }))));
        world.observer.setGlobal("avg-energy", PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("GAS-MOLECULES"), function() { return SelfManager.self().getVariable("energy"); }))));
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("FLASHES")).ask(function() {
        if (Prims.gt(PrimChecks.math.minus(world.ticker.tickCount(), PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("birthday"))), 0.4)) {
          SelfManager.self().die();
        }
        SelfManager.self().setVariable("color", PrimChecks.list.lput(PrimChecks.math.minus(255, PrimChecks.math.div(PrimChecks.math.mult(255, PrimChecks.math.minus(world.ticker.tickCount(), PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("birthday")))), 0.4)), [20, 20, 20]));
      }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      let newPx = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, newPatch), function() { return SelfManager.self().getPatchVariable("pxcor"); }); letVars['newPx'] = newPx;
      let newPy = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, newPatch), function() { return SelfManager.self().getPatchVariable("pycor"); }); letVars['newPy'] = newPy;
      if ((!Prims.equality(PrimChecks.math.abs(PrimChecks.validator.checkArg('ABS', 1, newPx)), world.observer.getGlobal("box-edge")) && !Prims.equality(PrimChecks.math.abs(PrimChecks.validator.checkArg('ABS', 1, newPy)), world.observer.getGlobal("box-edge")))) {
        throw new Exception.StopInterrupt;
      }
      if (Prims.equality(PrimChecks.math.abs(PrimChecks.validator.checkArg('ABS', 1, newPx)), world.observer.getGlobal("box-edge"))) {
        ...
        SelfManager.self().setVariable("momentum-instant", PrimChecks.math.div(PrimChecks.math.abs(PrimChecks.math.mult(PrimChecks.math.mult(PrimChecks.math.mult(PrimChecks.math.sin(PrimChecks.validator.checkArg('SIN', 1, SelfManager.self().getVariable("heading"))), 2), PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("mass"))), PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed")))), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("length-vertical-surface"))));
        SelfManager.self().setVariable("momentum-difference", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("momentum-difference")), PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("momentum-instant"))));
      }
      if (Prims.equality(PrimChecks.math.abs(PrimChecks.validator.checkArg('ABS', 1, newPy)), world.observer.getGlobal("box-edge"))) {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      world.observer.setGlobal("pressure", PrimChecks.math.mult(100, PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("GAS-MOLECULES"), function() { return SelfManager.self().getVariable("momentum-difference"); })))));
  ...
  temp = (function() {
    try {
      ...
      if (PrimChecks.agentset.anyWith(world.turtleManager.turtlesOfBreed("GAS-MOLECULES"), function() { return Prims.gt(SelfManager.self().getVariable("speed"), 0); })) {
        world.observer.setGlobal("tick-advance-amount", PrimChecks.list.min(ListPrims.list(PrimChecks.math.div(1, PrimChecks.math.ceil(PrimChecks.list.max(PrimChecks.validator.checkArg('MAX', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("GAS-MOLECULES"), function() { return SelfManager.self().getVariable("speed"); }))))), world.observer.getGlobal("max-tick-advance-amount"))));
      }
      else {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.list.oneOf(world.turtleManager.turtlesOfBreed("GAS-MOLECULES"))).ask(function() {
        SelfManager.self().setVariable("speed", PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed")), 10));
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gte(PrimChecks.agentset.count(PrimChecks.validator.checkArg('COUNT', 112, hitHydrogen)), 2)) {
        if (Prims.lt(SelfManager.self().getVariable("speed"), 0)) {
          SelfManager.self().setVariable("speed", 0);
        }
        let hydrogenReactants = PrimChecks.list.nOf(2, PrimChecks.validator.checkArg('N-OF', 120, hitHydrogen)); letVars['hydrogenReactants'] = hydrogenReactants;
        let totalEnergyAllReactants = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, thisInitialOxygenMoleculesEnergy), PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, hydrogenReactants), function() { return SelfManager.self().getVariable("energy"); })))); letVars['totalEnergyAllReactants'] = totalEnergyAllReactants;
        if (Prims.gt(totalEnergyAllReactants, world.observer.getGlobal("activation-energy"))) {
          Errors.askNobodyCheck(hydrogenReactants).ask(function() {
            ...
            let totalEnergyProducts = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, totalEnergyAllReactants), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("bond-energy-released"))); letVars['totalEnergyProducts'] = totalEnergyProducts;
            SelfManager.self().setVariable("energy", PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, totalEnergyProducts), 2));
            SelfManager.self().setVariable("speed", procedures["SPEED-FROM-ENERGY"]());
          }, true);
          SelfManager.self().die();
        }
  ...
  temp = (function(otherGasMolecules) {
    try {
      var reporterContext = false;
      var letVars = { };
      let mass2 = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, otherGasMolecules), function() { return SelfManager.self().getVariable("mass"); }); letVars['mass2'] = mass2;
      let speed2 = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, otherGasMolecules), function() { return SelfManager.self().getVariable("speed"); }); letVars['speed2'] = speed2;
      let heading2 = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, otherGasMolecules), function() { return SelfManager.self().getVariable("heading"); }); letVars['heading2'] = heading2;
