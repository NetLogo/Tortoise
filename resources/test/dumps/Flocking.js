...
function flock() {
  ...
  if (AgentSet.any(AgentSet.getTurtleVariable(13))) {
    ...
    if (Prims.lt(AgentSet.self().distance(AgentSet.getTurtleVariable(14)), world.observer.getGlobal('minimum-separation'))) {
      Call(separate);
    }
    else {
      Call(align);
