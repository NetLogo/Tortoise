    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Food in each pile', 'food-in-pile1')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotPoint(world.ticker.tickCount(), PrimChecks.list.sum(PrimChecks.agentset.of_unchecked(PrimChecks.agentset.with_unchecked(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 85); }), function() { return SelfManager.self().getPatchVariable("food"); })));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Food in each pile', 'food-in-pile2')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotPoint(world.ticker.tickCount(), PrimChecks.list.sum(PrimChecks.agentset.of_unchecked(PrimChecks.agentset.with_unchecked(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 95); }), function() { return SelfManager.self().getPatchVariable("food"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Food in each pile', 'food-in-pile3')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotPoint(world.ticker.tickCount(), PrimChecks.list.sum(PrimChecks.agentset.of_unchecked(PrimChecks.agentset.with_unchecked(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 105); }), function() { return SelfManager.self().getPatchVariable("food"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
