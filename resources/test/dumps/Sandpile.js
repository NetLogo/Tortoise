  ...
  var pens    = [new PenBundle.Pen('default', plotOps.makePenOps, false, new PenBundle.State(0, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Avalanche sizes', 'default', function() {
      if ((Prims.equality(PrimChecks.math.mod(world.ticker.tickCount(), 100), 0) && PrimChecks.math.not(PrimChecks.list.empty(PrimChecks.validator.checkArg('EMPTY?', 12, world.observer.getGlobal("sizes")))))) {
        ...
        let counts = Tasks.nValues(PrimChecks.math.plus(1, PrimChecks.list.max(PrimChecks.validator.checkArg('MAX', 8, world.observer.getGlobal("sizes")))), Tasks.reporterTask(function() { return 0; }, "[ 0 ]")); ProcedurePrims.stack().currentContext().registerStringRunVar("COUNTS", counts);
        R = Tasks.forEach(Tasks.commandTask(function(theHsize) {
        ...
        }, "[ the-size -> set counts replace-item the-size counts 1 + item the-size counts ]"), world.observer.getGlobal("sizes")); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
        let s = 0; ProcedurePrims.stack().currentContext().registerStringRunVar("S", s);
        R = Tasks.forEach(Tasks.commandTask(function(c) {
          PrimChecks.procedure.runArgCountCheck(1, arguments.length);
        ...
        }, "[ c -> if s > 0 and c > 0 [ plotxy log s 10 log c 10 ] set s s + 1 ]"), counts); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
      };
    });
  })];
  var setup   = function() {};
  ...
  var pens    = [new PenBundle.Pen('default', plotOps.makePenOps, false, new PenBundle.State(0, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Avalanche lifetimes', 'default', function() {
      if ((Prims.equality(PrimChecks.math.mod(world.ticker.tickCount(), 100), 0) && PrimChecks.math.not(PrimChecks.list.empty(PrimChecks.validator.checkArg('EMPTY?', 12, world.observer.getGlobal("lifetimes")))))) {
        plotManager.resetPen();
        let counts = Tasks.nValues(PrimChecks.math.plus(1, PrimChecks.list.max(PrimChecks.validator.checkArg('MAX', 8, world.observer.getGlobal("lifetimes")))), Tasks.reporterTask(function() { return 0; }, "[ 0 ]")); ProcedurePrims.stack().currentContext().registerStringRunVar("COUNTS", counts);
        R = Tasks.forEach(Tasks.commandTask(function(lifetime) {
          PrimChecks.procedure.runArgCountCheck(1, arguments.length);
        ...
        }, "[ lifetime -> set counts replace-item lifetime counts 1 + item lifetime counts ]"), world.observer.getGlobal("lifetimes")); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
        ...
        }, "[ c -> if l > 0 and c > 0 [ plotxy log l 10 log c 10 ] set l l + 1 ]"), counts); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
      };
    });
  })];
  var setup   = function() {};
...
ProcedurePrims.defineCommand("setup", (function(setupHtask) {
  ...
  R = ProcedurePrims.ask(world.patches(), function() {
    SelfManager.self().setPatchVariable("n", (ProcedurePrims.stack().currentContext().registerStringRunArg("SETUP-TASK", setupHtask),
  ...
  R = ProcedurePrims.ask(world.patches(), function() { R = ProcedurePrims.callCommand("recolor"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineCommand("setup-uniform", (function(initial) {
  R = ProcedurePrims.callCommand("setup", Tasks.reporterTask(function() { return initial; }, "[ -> initial ]")); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("setup-random", (function() {
  R = ProcedurePrims.callCommand("setup", Tasks.reporterTask(function() { return RandomPrims.randomLong(4); }, "[ -> random 4 ]")); if (R === DeathInterrupt) { return R; }
}))
...
ProcedurePrims.defineCommand("go", (function() {
  ...
  if (!Prims.equality(drop, Nobody)) {
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, drop), function() {
      R = ProcedurePrims.callCommand("update-n", 1); if (R === DeathInterrupt) { return R; }
      R = ProcedurePrims.callCommand("recolor"); if (R === DeathInterrupt) { return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    ...
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, avalancheHpatches), function() {
      R = ProcedurePrims.callCommand("recolor"); if (R === DeathInterrupt) { return R; }
      R = ProcedurePrims.ask(SelfManager.self().getNeighbors4(), function() { R = ProcedurePrims.callCommand("recolor"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineCommand("explore", (function() {
  if (MousePrims.isInside()) {
    ...
    R = ProcedurePrims.ask(world.patches(), function() { R = ProcedurePrims.callCommand("push-n"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("selected-patch")), function() { R = ProcedurePrims.callCommand("update-n", 1); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    ...
    R = ProcedurePrims.ask(world.patches(), function() { R = ProcedurePrims.callCommand("pop-n"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    R = ProcedurePrims.ask(world.patches(), function() {
      SelfManager.self().setPatchVariable("base-color", world.observer.getGlobal("default-color"));
      R = ProcedurePrims.callCommand("recolor"); if (R === DeathInterrupt) { return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineReporter("stabilize", (function(animate_Q) {
  ...
  while (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, activeHpatches))) {
    ...
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, overloadedHpatches), function() {
      SelfManager.self().setPatchVariable("base-color", world.observer.getGlobal("fired-color"));
      R = ProcedurePrims.callCommand("update-n", -4); if (R === DeathInterrupt) { return R; }
      if (animate_Q) {
        R = ProcedurePrims.callCommand("recolor"); if (R === DeathInterrupt) { return R; }
      }
      R = ProcedurePrims.ask(SelfManager.self().getNeighbors4(), function() {
        R = ProcedurePrims.callCommand("update-n", 1); if (R === DeathInterrupt) { return R; }
        if (animate_Q) {
          R = ProcedurePrims.callCommand("recolor"); if (R === DeathInterrupt) { return R; }
        }
...
ProcedurePrims.defineCommand("pop-n", (function() {
  R = ProcedurePrims.callCommand("update-n", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.list.first(PrimChecks.validator.checkArg('FIRST', 12, SelfManager.self().getPatchVariable("n-stack")))), PrimChecks.validator.checkArg('-', 1, SelfManager.self().getPatchVariable("n")))); if (R === DeathInterrupt) { return R; }
