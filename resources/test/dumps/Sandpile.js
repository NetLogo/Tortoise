...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('average', plotOps.makePenOps, false, new PenBundle.State(0, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Average grain count', 'average', function() {
      plotManager.plotValue(PrimChecks.math.div(11, 12, PrimChecks.validator.checkArg('/', 11, 12, 1, world.observer.getGlobal("total")), PrimChecks.agentset.count(world.patches())));;
    });
  })];
  var setup   = function() {};
  var update  = function() {};
  return new Plot(name, pens, plotOps, "ticks", "grains", false, true, true, 0, 1, 2, 2.1, setup, update);
})(), (function() {
  ...
  var pens    = [new PenBundle.Pen('default', plotOps.makePenOps, false, new PenBundle.State(0, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Avalanche lifetimes', 'default', function() {
      if ((Prims.equality(PrimChecks.math.mod(9, 12, world.ticker.tickCount(), 100), 0) && PrimChecks.math.not(PrimChecks.list.empty(PrimChecks.validator.checkArg('EMPTY?', 29, 35, 12, world.observer.getGlobal("lifetimes")))))) {
        plotManager.resetPen();
        let counts = PrimChecks.task.nValues(78, 86, PrimChecks.math.plus(90, 91, 1, PrimChecks.list.max(92, 95, PrimChecks.validator.checkArg('MAX', 92, 95, 8, world.observer.getGlobal("lifetimes")))), PrimChecks.task.checked(107, 108, function() { return 0; }, "[ 0 ]", true, false)); ProcedurePrims.stack().currentContext().registerStringRunVar("COUNTS", counts);
        var R = PrimChecks.task.forEach(113, 120, PrimChecks.validator.checkArg('FOREACH', 113, 120, 8, world.observer.getGlobal("lifetimes")), PrimChecks.task.checked(131, 132, function(lifetime) {
          PrimChecks.procedure.runArgCountCheck('run', 131, 219, 1, arguments.length);
          counts = PrimChecks.list.replaceItem(160, 172, PrimChecks.validator.checkArg('REPLACE-ITEM', 160, 172, 1, lifetime), PrimChecks.validator.checkArg('REPLACE-ITEM', 160, 172, 12, counts), PrimChecks.math.plus(192, 193, 1, PrimChecks.validator.checkArg('+', 192, 193, 1, PrimChecks.list.item(194, 198, PrimChecks.validator.checkArg('ITEM', 194, 198, 1, lifetime), PrimChecks.validator.checkArg('ITEM', 194, 198, 12, counts))))); ProcedurePrims.stack().currentContext().updateStringRunVar("COUNTS", counts);
        }, "[ lifetime -> set counts replace-item lifetime counts 1 + item lifetime counts ]", false, false)); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(113, 120, R); return R; }
        let l = 0; ProcedurePrims.stack().currentContext().registerStringRunVar("L", l);
        var R = PrimChecks.task.forEach(232, 239, PrimChecks.validator.checkArg('FOREACH', 232, 239, 8, counts), PrimChecks.task.checked(247, 248, function(c) {
          PrimChecks.procedure.runArgCountCheck('run', 247, 488, 1, arguments.length);
          if ((Prims.gt(l, 0) && Prims.gt(c, 0))) {
            plotManager.plotPoint(PrimChecks.math.log(442, 445, PrimChecks.validator.checkArg('LOG', 442, 445, 1, l), 10), PrimChecks.math.log(453, 456, PrimChecks.validator.checkArg('LOG', 453, 456, 1, c), 10));
          }
          l = PrimChecks.math.plus(481, 482, PrimChecks.validator.checkArg('+', 481, 482, 1, l), 1); ProcedurePrims.stack().currentContext().updateStringRunVar("L", l);
        }, "[ c -> if l > 0 and c > 0 [ plotxy log l 10 log c 10 ] set l l + 1 ]", false, false)); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(232, 239, R); return R; }
      };
    });
  })];
  var setup   = function() {};
  var update  = function() {};
  return new Plot(name, pens, plotOps, "log lifetime", "log count", false, true, true, 0, 1, 0, 1, setup, update);
})(), (function() {
  var name    = 'Avalanche sizes';
  var plotOps = (typeof modelPlotOps[name] !== "undefined" && modelPlotOps[name] !== null) ? modelPlotOps[name] : new PlotOps(function() {}, function() {}, function() {}, function() { return function() {}; }, function() { return function() {}; }, function() { return function() {}; }, function() { return function() {}; });
  var pens    = [new PenBundle.Pen('default', plotOps.makePenOps, false, new PenBundle.State(0, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Avalanche sizes', 'default', function() {
      if ((Prims.equality(PrimChecks.math.mod(9, 12, world.ticker.tickCount(), 100), 0) && PrimChecks.math.not(PrimChecks.list.empty(PrimChecks.validator.checkArg('EMPTY?', 29, 35, 12, world.observer.getGlobal("sizes")))))) {
        plotManager.resetPen();
        let counts = PrimChecks.task.nValues(74, 82, PrimChecks.math.plus(86, 87, 1, PrimChecks.list.max(88, 91, PrimChecks.validator.checkArg('MAX', 88, 91, 8, world.observer.getGlobal("sizes")))), PrimChecks.task.checked(99, 100, function() { return 0; }, "[ 0 ]", true, false)); ProcedurePrims.stack().currentContext().registerStringRunVar("COUNTS", counts);
        var R = PrimChecks.task.forEach(105, 112, PrimChecks.validator.checkArg('FOREACH', 105, 112, 8, world.observer.getGlobal("sizes")), PrimChecks.task.checked(119, 120, function(theHsize) {
          PrimChecks.procedure.runArgCountCheck('run', 119, 207, 1, arguments.length);
          counts = PrimChecks.list.replaceItem(148, 160, PrimChecks.validator.checkArg('REPLACE-ITEM', 148, 160, 1, theHsize), PrimChecks.validator.checkArg('REPLACE-ITEM', 148, 160, 12, counts), PrimChecks.math.plus(180, 181, 1, PrimChecks.validator.checkArg('+', 180, 181, 1, PrimChecks.list.item(182, 186, PrimChecks.validator.checkArg('ITEM', 182, 186, 1, theHsize), PrimChecks.validator.checkArg('ITEM', 182, 186, 12, counts))))); ProcedurePrims.stack().currentContext().updateStringRunVar("COUNTS", counts);
        }, "[ the-size -> set counts replace-item the-size counts 1 + item the-size counts ]", false, false)); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(105, 112, R); return R; }
        let s = 0; ProcedurePrims.stack().currentContext().registerStringRunVar("S", s);
        var R = PrimChecks.task.forEach(220, 227, PrimChecks.validator.checkArg('FOREACH', 220, 227, 8, counts), PrimChecks.task.checked(235, 236, function(c) {
          PrimChecks.procedure.runArgCountCheck('run', 235, 476, 1, arguments.length);
          if ((Prims.gt(s, 0) && Prims.gt(c, 0))) {
            plotManager.plotPoint(PrimChecks.math.log(430, 433, PrimChecks.validator.checkArg('LOG', 430, 433, 1, s), 10), PrimChecks.math.log(441, 444, PrimChecks.validator.checkArg('LOG', 441, 444, 1, c), 10));
          }
          s = PrimChecks.math.plus(469, 470, PrimChecks.validator.checkArg('+', 469, 470, 1, s), 1); ProcedurePrims.stack().currentContext().updateStringRunVar("S", s);
        }, "[ c -> if s > 0 and c > 0 [ plotxy log s 10 log c 10 ] set s s + 1 ]", false, false)); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(220, 227, R); return R; }
      };
    });
  })];
  var setup   = function() {};
  var update  = function() {};
  return new Plot(name, pens, plotOps, "log size", "log count", false, true, true, 0, 1, 0, 1, setup, update);
})()];
var workspace = tortoise_require('engine/workspace')(modelConfig)([])([], [])('globals [   ;; By always keeping track of how much sand is on the table, we can compute the   ;; average number of grains per patch instantly, without having to count.   total   ;; We don\'t want the average monitor to updating wildly, so we only have it   ;; update every tick.   total-on-tick   ;; Keep track of avalanche sizes so we can histogram them   sizes   ;; Size of the most recent run   last-size   ;; Keep track of avalanche lifetimes so we can histogram them   lifetimes   ;; Lifetime of the most recent run   last-lifetime   ;; The patch the mouse hovers over while exploring   selected-patch   ;; These colors define how the patches look normally, after being fired, and in   ;; explore mode.   default-color   fired-color   selected-color ]  patches-own [   ;; how many grains of sand are on this patch   n   ;; A list of stored n so that we can easily pop back to a previous state. See   ;; the NETLOGO FEATURES section of the Info tab for a description of how stacks   ;; work   n-stack   ;; Determines what color to scale when coloring the patch.   base-color ]  ;; The input task says what each patch should do at setup time ;; to compute its initial value for n.  (See the Tasks section ;; of the Programming Guide for information on tasks.) to setup [setup-task]   clear-all    set default-color blue   set fired-color red   set selected-color green    set selected-patch nobody   ask patches [     set n runresult setup-task     set n-stack []     set base-color default-color   ]   let ignore stabilize false   ask patches [ recolor ]   set total sum [ n ] of patches   ;; set this to the empty list so we can add items to it later   set sizes []   set lifetimes []   reset-ticks end  ;; For example, \"setup-uniform 2\" gives every patch a task which reports 2. to setup-uniform [initial]   setup [ -> initial ] end  ;; Every patch uses a task which reports a random value. to setup-random   setup [ -> random 4 ] end  ;; patch procedure; the colors are like a stoplight to recolor   set pcolor scale-color base-color n 0 4 end  to go   let drop drop-patch   if drop != nobody [     ask drop [       update-n 1       recolor     ]     let results stabilize animate-avalanches?     let avalanche-patches first results     let lifetime last results      ;; compute the size of the avalanche and throw it on the end of the sizes list     if any? avalanche-patches [       set sizes lput (count avalanche-patches) sizes       set lifetimes lput lifetime lifetimes     ]     ;; Display the avalanche and guarantee that the border of the avalanche is updated     ask avalanche-patches [ recolor ask neighbors4 [ recolor ] ]     display     ;; Erase the avalanche     ask avalanche-patches [ set base-color default-color recolor ]     ;; Updates the average monitor     set total-on-tick total     tick   ] end  to explore   ifelse mouse-inside? [     let p patch mouse-xcor mouse-ycor     set selected-patch p     ask patches [ push-n ]     ask selected-patch [ update-n 1 ]     let results stabilize false     ask patches [ pop-n ]     ask patches [ set base-color default-color recolor ]     let avalanche-patches first results     ask avalanche-patches [ set base-color selected-color recolor ]     display   ] [     if selected-patch != nobody [       set selected-patch nobody       ask patches [ set base-color default-color recolor ]     ]   ] end  ;; Stabilizes the sandpile. Reports which sites fired and how many iterations it took to ;; stabilize. to-report stabilize [animate?]   let active-patches patches with [ n > 3 ]    ;; The number iterations the avalanche has gone for. Use to calculate lifetimes.   let iters 0    ;; we want to count how many patches became overloaded at some point   ;; during the avalanche, and also flash those patches. so as we go, we\'ll   ;; keep adding more patches to to this initially empty set.   let avalanche-patches no-patches    while [ any? active-patches ] [     let overloaded-patches active-patches with [ n > 3 ]     if any? overloaded-patches [       set iters iters + 1     ]     ask overloaded-patches [       set base-color fired-color       ;; subtract 4 from this patch       update-n -4       if animate? [ recolor ]       ;; edge patches have less than four neighbors, so some sand may fall off the edge       ask neighbors4 [         update-n 1         if animate? [ recolor ]       ]     ]     if animate? [ display ]     ;; add the current round of overloaded patches to our record of the avalanche     ;; the patch-set primitive combines agentsets, removing duplicates     set avalanche-patches (patch-set avalanche-patches overloaded-patches)     ;; find the set of patches which *might* be overloaded, so we will check     ;; them the next time through the loop     set active-patches patch-set [ neighbors4 ] of overloaded-patches   ]   report (list avalanche-patches iters) end  ;; patch procedure. input might be positive or negative, to add or subtract sand to update-n [ how-much ]   set n n + how-much   set total total + how-much end  to-report drop-patch   if drop-location = \"center\" [ report patch 0 0 ]   if drop-location = \"random\" [ report one-of patches ]   if drop-location = \"mouse-click\" and mouse-down? [     every 0.3 [ report patch mouse-xcor mouse-ycor ]   ]   report nobody end  ;; Save the patches state to push-n ;; patch procedure   set n-stack fput n n-stack end  ;; restore the patches state to pop-n ;; patch procedure   ; need to go through update-n to keep total statistic correct   update-n ((first n-stack) - n)   set n-stack but-last n-stack end   ; Public Domain: ; To the extent possible under law, Uri Wilensky has waived all ; copyright and related or neighboring rights to this model.')([{"x":435,"y":10,"width":408,"height":408,"dimensions":{"minPxcor":-50,"maxPxcor":50,"minPycor":-50,"maxPycor":50,"patchSize":4,"wrappingAllowedInX":false,"wrappingAllowedInY":false},"fontSize":10,"updateMode":"TickBased","showTickCounter":true,"tickCounterLabel":"ticks","frameRate":90,"type":"view","compilation":{"success":true,"messages":[]}}, {"compiledSource":"var R = ProcedurePrims.callCommand(\"setup-uniform\", world.observer.getGlobal(\"grains-per-patch\")); if (R === StopInterrupt) { return R; }","type":"button","source":"setup-uniform grains-per-patch","x":5,"y":47,"width":145,"height":35,"oldSize":false,"display":"setup uniform","forever":false,"buttonKind":"Observer","disableUntilTicksStart":false,"compilation":{"success":true,"messages":[]}}, {"variable":"drop-location","x":5,"y":159,"width":250,"height":60,"oldSize":false,"display":"drop-location","choices":["center","random","mouse-click"],"currentChoice":1,"type":"chooser","compilation":{"success":true,"messages":[]}}, {"compiledSource":"var R = ProcedurePrims.callCommand(\"setup-random\"); if (R === StopInterrupt) { return R; }","type":"button","source":"setup-random","x":5,"y":10,"width":145,"height":35,"oldSize":false,"display":"setup random","forever":false,"buttonKind":"Observer","disableUntilTicksStart":false,"compilation":{"success":true,"messages":[]}}, {"compiledMin":"ProcedurePrims.rng.withAux(function() { return 0; })","compiledMax":"ProcedurePrims.rng.withAux(function() { return 3; })","compiledStep":"ProcedurePrims.rng.withAux(function() { return 1; })","type":"slider","variable":"grains-per-patch","x":155,"y":10,"width":275,"height":55,"oldSize":false,"display":"grains-per-patch","min":"0","max":"3","default":1,"step":"1","direction":"horizontal","compilation":{"success":true,"messages":[]}}, {"compiledSource":"var R = ProcedurePrims.callCommand(\"go\"); if (R === StopInterrupt) { return R; }","type":"button","source":"go","x":5,"y":95,"width":105,"height":50,"oldSize":false,"forever":true,"buttonKind":"Observer","disableUntilTicksStart":true,"compilation":{"success":true,"messages":[]}}, {"compiledSource":"var R = ProcedurePrims.callCommand(\"go\"); if (R === StopInterrupt) { return R; }","type":"button","source":"go","x":115,"y":95,"width":115,"height":50,"oldSize":false,"display":"go once","forever":false,"buttonKind":"Observer","disableUntilTicksStart":true,"compilation":{"success":true,"messages":[]}}, {"variable":"animate-avalanches?","x":260,"y":160,"width":170,"height":60,"oldSize":false,"display":"animate-avalanches?","on":false,"type":"switch","compilation":{"success":true,"messages":[]}}, {"compiledSource":"var R = ProcedurePrims.callCommand(\"explore\"); if (R === StopInterrupt) { return R; }","type":"button","source":"explore","x":5,"y":230,"width":145,"height":55,"oldSize":false,"forever":true,"buttonKind":"Observer","disableUntilTicksStart":false,"compilation":{"success":true,"messages":[]}}, {"compiledSource":"ProcedurePrims.rng.withAux(function() {   return PrimChecks.math.div(14, 15, PrimChecks.validator.checkArg('/', 14, 15, 1, world.observer.getGlobal(\"total-on-tick\")), PrimChecks.agentset.count(world.patches())); })","type":"monitor","source":"total-on-tick / count patches","x":160,"y":230,"width":115,"height":60,"oldSize":false,"display":"average","precision":4,"fontSize":11,"compilation":{"success":true,"messages":[]}}, {"compiledSetupCode":"function() {}","compiledUpdateCode":"function() {}","compiledPens":[{"compiledSetupCode":"function() {}","compiledUpdateCode":"function() {   return ProcedurePrims.runInPlotContext('Average grain count', 'average', function() {     plotManager.plotValue(PrimChecks.math.div(11, 12, PrimChecks.validator.checkArg('/', 11, 12, 1, world.observer.getGlobal(\"total\")), PrimChecks.agentset.count(world.patches())));;   }); }","type":"pen","display":"average","interval":1,"mode":0,"color":-16777216,"inLegend":true,"setupCode":"","updateCode":"plot total / count patches","compilation":{"success":true,"messages":[]}}],"type":"plot","display":"Average grain count","x":5,"y":295,"width":375,"height":185,"oldSize":false,"xAxis":"ticks","yAxis":"grains","xmin":0,"xmax":1,"ymin":2,"ymax":2.1,"autoPlotX":true,"autoPlotY":true,"legendOn":false,"setupCode":"","updateCode":"","pens":[{"display":"average","interval":1,"mode":0,"color":-16777216,"inLegend":true,"setupCode":"","updateCode":"plot total / count patches","type":"pen"}],"compilation":{"success":true,"messages":[]}}, {"compiledSetupCode":"function() {}","compiledUpdateCode":"function() {}","compiledPens":[{"compiledSetupCode":"function() {}","compiledUpdateCode":"function() {   return ProcedurePrims.runInPlotContext('Avalanche lifetimes', 'default', function() {     if ((Prims.equality(PrimChecks.math.mod(9, 12, world.ticker.tickCount(), 100), 0) && PrimChecks.math.not(PrimChecks.list.empty(PrimChecks.validator.checkArg('EMPTY?', 29, 35, 12, world.observer.getGlobal(\"lifetimes\")))))) {       plotManager.resetPen();       let counts = PrimChecks.task.nValues(78, 86, PrimChecks.math.plus(90, 91, 1, PrimChecks.list.max(92, 95, PrimChecks.validator.checkArg('MAX', 92, 95, 8, world.observer.getGlobal(\"lifetimes\")))), PrimChecks.task.checked(107, 108, function() { return 0; }, \"[ 0 ]\", true, false)); ProcedurePrims.stack().currentContext().registerStringRunVar(\"COUNTS\", counts);       var R = PrimChecks.task.forEach(113, 120, PrimChecks.validator.checkArg('FOREACH', 113, 120, 8, world.observer.getGlobal(\"lifetimes\")), PrimChecks.task.checked(131, 132, function(lifetime) {         PrimChecks.procedure.runArgCountCheck('run', 131, 219, 1, arguments.length);         counts = PrimChecks.list.replaceItem(160, 172, PrimChecks.validator.checkArg('REPLACE-ITEM', 160, 172, 1, lifetime), PrimChecks.validator.checkArg('REPLACE-ITEM', 160, 172, 12, counts), PrimChecks.math.plus(192, 193, 1, PrimChecks.validator.checkArg('+', 192, 193, 1, PrimChecks.list.item(194, 198, PrimChecks.validator.checkArg('ITEM', 194, 198, 1, lifetime), PrimChecks.validator.checkArg('ITEM', 194, 198, 12, counts))))); ProcedurePrims.stack().currentContext().updateStringRunVar(\"COUNTS\", counts);       }, \"[ lifetime -> set counts replace-item lifetime counts 1 + item lifetime counts ]\", false, false)); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(113, 120, R); return R; }       let l = 0; ProcedurePrims.stack().currentContext().registerStringRunVar(\"L\", l);       var R = PrimChecks.task.forEach(232, 239, PrimChecks.validator.checkArg('FOREACH', 232, 239, 8, counts), PrimChecks.task.checked(247, 248, function(c) {         PrimChecks.procedure.runArgCountCheck('run', 247, 488, 1, arguments.length);         if ((Prims.gt(l, 0) && Prims.gt(c, 0))) {           plotManager.plotPoint(PrimChecks.math.log(442, 445, PrimChecks.validator.checkArg('LOG', 442, 445, 1, l), 10), PrimChecks.math.log(453, 456, PrimChecks.validator.checkArg('LOG', 453, 456, 1, c), 10));         }         l = PrimChecks.math.plus(481, 482, PrimChecks.validator.checkArg('+', 481, 482, 1, l), 1); ProcedurePrims.stack().currentContext().updateStringRunVar(\"L\", l);       }, \"[ c -> if l > 0 and c > 0 [ plotxy log l 10 log c 10 ] set l l + 1 ]\", false, false)); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(232, 239, R); return R; }     };   }); }","type":"pen","display":"default","interval":1,"mode":0,"color":-16777216,"inLegend":true,"setupCode":"","updateCode":"if ticks mod 100 = 0 and not empty? lifetimes [   plot-pen-reset   let counts n-values (1 + max lifetimes) [0]   foreach lifetimes [ lifetime ->     set counts replace-item lifetime counts (1 + item lifetime counts)   ]   let l 0   foreach counts [ c ->     ; We only care about plotting avalanches (l > 0), but dropping l = 0     ; from the counts list is actually more awkward than just ignoring it     if (l > 0 and c > 0) [       plotxy (log l 10) (log c 10)     ]     set l l + 1   ] ]","compilation":{"success":true,"messages":[]}}],"type":"plot","display":"Avalanche lifetimes","x":885,"y":10,"width":355,"height":185,"oldSize":false,"xAxis":"log lifetime","yAxis":"log count","xmin":0,"xmax":1,"ymin":0,"ymax":1,"autoPlotX":true,"autoPlotY":true,"legendOn":false,"setupCode":"","updateCode":"","pens":[{"display":"default","interval":1,"mode":0,"color":-16777216,"inLegend":true,"setupCode":"","updateCode":"if ticks mod 100 = 0 and not empty? lifetimes [   plot-pen-reset   let counts n-values (1 + max lifetimes) [0]   foreach lifetimes [ lifetime ->     set counts replace-item lifetime counts (1 + item lifetime counts)   ]   let l 0   foreach counts [ c ->     ; We only care about plotting avalanches (l > 0), but dropping l = 0     ; from the counts list is actually more awkward than just ignoring it     if (l > 0 and c > 0) [       plotxy (log l 10) (log c 10)     ]     set l l + 1   ] ]","type":"pen"}],"compilation":{"success":true,"messages":[]}}, {"compiledSetupCode":"function() {}","compiledUpdateCode":"function() {}","compiledPens":[{"compiledSetupCode":"function() {}","compiledUpdateCode":"function() {   return ProcedurePrims.runInPlotContext('Avalanche sizes', 'default', function() {     if ((Prims.equality(PrimChecks.math.mod(9, 12, world.ticker.tickCount(), 100), 0) && PrimChecks.math.not(PrimChecks.list.empty(PrimChecks.validator.checkArg('EMPTY?', 29, 35, 12, world.observer.getGlobal(\"sizes\")))))) {       plotManager.resetPen();       let counts = PrimChecks.task.nValues(74, 82, PrimChecks.math.plus(86, 87, 1, PrimChecks.list.max(88, 91, PrimChecks.validator.checkArg('MAX', 88, 91, 8, world.observer.getGlobal(\"sizes\")))), PrimChecks.task.checked(99, 100, function() { return 0; }, \"[ 0 ]\", true, false)); ProcedurePrims.stack().currentContext().registerStringRunVar(\"COUNTS\", counts);       var R = PrimChecks.task.forEach(105, 112, PrimChecks.validator.checkArg('FOREACH', 105, 112, 8, world.observer.getGlobal(\"sizes\")), PrimChecks.task.checked(119, 120, function(theHsize) {         PrimChecks.procedure.runArgCountCheck('run', 119, 207, 1, arguments.length);         counts = PrimChecks.list.replaceItem(148, 160, PrimChecks.validator.checkArg('REPLACE-ITEM', 148, 160, 1, theHsize), PrimChecks.validator.checkArg('REPLACE-ITEM', 148, 160, 12, counts), PrimChecks.math.plus(180, 181, 1, PrimChecks.validator.checkArg('+', 180, 181, 1, PrimChecks.list.item(182, 186, PrimChecks.validator.checkArg('ITEM', 182, 186, 1, theHsize), PrimChecks.validator.checkArg('ITEM', 182, 186, 12, counts))))); ProcedurePrims.stack().currentContext().updateStringRunVar(\"COUNTS\", counts);       }, \"[ the-size -> set counts replace-item the-size counts 1 + item the-size counts ]\", false, false)); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(105, 112, R); return R; }       let s = 0; ProcedurePrims.stack().currentContext().registerStringRunVar(\"S\", s);       var R = PrimChecks.task.forEach(220, 227, PrimChecks.validator.checkArg('FOREACH', 220, 227, 8, counts), PrimChecks.task.checked(235, 236, function(c) {         PrimChecks.procedure.runArgCountCheck('run', 235, 476, 1, arguments.length);         if ((Prims.gt(s, 0) && Prims.gt(c, 0))) {           plotManager.plotPoint(PrimChecks.math.log(430, 433, PrimChecks.validator.checkArg('LOG', 430, 433, 1, s), 10), PrimChecks.math.log(441, 444, PrimChecks.validator.checkArg('LOG', 441, 444, 1, c), 10));         }         s = PrimChecks.math.plus(469, 470, PrimChecks.validator.checkArg('+', 469, 470, 1, s), 1); ProcedurePrims.stack().currentContext().updateStringRunVar(\"S\", s);       }, \"[ c -> if s > 0 and c > 0 [ plotxy log s 10 log c 10 ] set s s + 1 ]\", false, false)); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(220, 227, R); return R; }     };   }); }","type":"pen","display":"default","interval":1,"mode":0,"color":-16777216,"inLegend":true,"setupCode":"","updateCode":"if ticks mod 100 = 0 and not empty? sizes [   plot-pen-reset   let counts n-values (1 + max sizes) [0]   foreach sizes [ the-size ->     set counts replace-item the-size counts (1 + item the-size counts)   ]   let s 0   foreach counts [ c ->     ; We only care about plotting avalanches (s > 0), but dropping s = 0     ; from the counts list is actually more awkward than just ignoring it     if (s > 0 and c > 0) [       plotxy (log s 10) (log c 10)     ]     set s s + 1   ] ]","compilation":{"success":true,"messages":[]}}],"type":"plot","display":"Avalanche sizes","x":885,"y":200,"width":355,"height":185,"oldSize":false,"xAxis":"log size","yAxis":"log count","xmin":0,"xmax":1,"ymin":0,"ymax":1,"autoPlotX":true,"autoPlotY":true,"legendOn":false,"setupCode":"","updateCode":"","pens":[{"display":"default","interval":1,"mode":0,"color":-16777216,"inLegend":true,"setupCode":"","updateCode":"if ticks mod 100 = 0 and not empty? sizes [   plot-pen-reset   let counts n-values (1 + max sizes) [0]   foreach sizes [ the-size ->     set counts replace-item the-size counts (1 + item the-size counts)   ]   let s 0   foreach counts [ c ->     ; We only care about plotting avalanches (s > 0), but dropping s = 0     ; from the counts list is actually more awkward than just ignoring it     if (s > 0 and c > 0) [       plotxy (log s 10) (log c 10)     ]     set s s + 1   ] ]","type":"pen"}],"compilation":{"success":true,"messages":[]}}, {"compiledSource":"world.observer.setGlobal(\"sizes\", []); world.observer.setGlobal(\"lifetimes\", []); plotManager.setCurrentPlot(\"Avalanche lifetimes\"); plotManager.setYRange(0, 1); plotManager.setXRange(0, 1); plotManager.setCurrentPlot(\"Avalanche sizes\"); plotManager.setYRange(0, 1); plotManager.setXRange(0, 1);","type":"button","source":"set sizes [] set lifetimes [] set-current-plot \"Avalanche lifetimes\" set-plot-y-range 0 1 set-plot-x-range 0 1 set-current-plot \"Avalanche sizes\" set-plot-y-range 0 1 set-plot-x-range 0 1","x":885,"y":400,"width":200,"height":50,"oldSize":false,"display":"clear size and lifetime data","forever":false,"buttonKind":"Observer","disableUntilTicksStart":false,"compilation":{"success":true,"messages":[]}}])(resources)(tortoise_require("extensions/all").porters())(["drop-location", "grains-per-patch", "animate-avalanches?", "total", "total-on-tick", "sizes", "last-size", "lifetimes", "last-lifetime", "selected-patch", "default-color", "fired-color", "selected-color"], ["drop-location", "grains-per-patch", "animate-avalanches?"], ["n", "n-stack", "base-color"], -50, 50, -50, 50, 4, false, false, turtleShapes, linkShapes, function(){});
...
ProcedurePrims.defineCommand("explore", 2830, 3367, (function() {
  if (MousePrims.isInside()) {
    ...
    var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(world.patches(), 2930, 2933), function() { var R = ProcedurePrims.callCommand("push-n"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(2930, 2933, R); return R; }
    var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 2957, 2960, 1904, world.observer.getGlobal("selected-patch")), 2957, 2960), function() {
      PrimChecks.context.assertKind(6, 'update-n', 2978, 2988);
      var R = ProcedurePrims.callCommand("update-n", 1); if (R === DeathInterrupt) { return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(2957, 2960, R); return R; }
    ...
    var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(world.patches(), 3027, 3030), function() { var R = ProcedurePrims.callCommand("pop-n"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(3027, 3030, R); return R; }
    var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(world.patches(), 3053, 3056), function() {
    ...
    if (!Prims.equality(world.observer.getGlobal("selected-patch"), Nobody)) {
      world.observer.setGlobal("selected-patch", Nobody);
      var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(world.patches(), 3304, 3307), function() {
...
ProcedurePrims.defineReporter("stabilize", 3485, 4862, (function(animate_Q) {
  ...
  while (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 3904, 3908, 112, activeHpatches))) {
    let overloadedHpatches = PrimChecks.agentset.with(3970, 3974, PrimChecks.context.assertAgentSetKind(6, PrimChecks.validator.checkArg('WITH', 3970, 3974, 112, activeHpatches), 'with', 3955, 3984), function() { return Prims.gt(PrimChecks.patch.getVariable(3977, 3978, "n"), 3); }); ProcedurePrims.stack().currentContext().registerStringRunVar("OVERLOADED-PATCHES", overloadedHpatches);
    ...
    activeHpatches = PrimChecks.agentset.patchSet(4771, 4780, PrimChecks.agentset.of(PrimChecks.context.assertAgentSetKind(6, PrimChecks.validator.checkArg('OF', 4796, 4798, 1904, overloadedHpatches), 'of', 4781, 4817), function() { return SelfManager.self().getNeighbors4(); })); ProcedurePrims.stack().currentContext().updateStringRunVar("ACTIVE-PATCHES", activeHpatches);
  }
...
world.observer.setGlobal("grains-per-patch", 1);
