    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average grain count', 'average')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.div(world.observer.getGlobal("total"), world.patches().size()));
        } catch (e) {
...
var procedures = (function() {
  ...
  temp = (function(setupTask) {
    try {
      ...
      world.observer.setGlobal("total", PrimChecks.list.sum(world.patches().projectionBy(function() { return SelfManager.self().getPatchVariable("n"); })));
    ...
    try {
      ...
      if (!Prims.equality(drop, Nobody)) {
        ...
        if (!avalanchePatches.isEmpty()) {
          world.observer.setGlobal("sizes", PrimChecks.list.lput(avalanchePatches.size(), world.observer.getGlobal("sizes")));
