    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average grain count', 'average')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.div(world.observer.getGlobal("total"), PrimChecks.agentset.count(world.patches())));
        } catch (e) {
...
var procedures = (function() {
  ...
  temp = (function(setupTask) {
    try {
      ...
      world.observer.setGlobal("total", PrimChecks.list.sum(PrimChecks.agentset.of(world.patches(), function() { return SelfManager.self().getPatchVariable("n"); })));
