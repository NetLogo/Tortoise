    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Degree Distribution (log-log)', 'default')(function() {
        try {
          ...
          let maxDegree = PrimChecks.list.max(PrimChecks.agentset.of(world.turtles(), function() { return PrimChecks.agentset.count(LinkPrims.linkNeighbors("LINKS")); })); letVars['maxDegree'] = maxDegree;
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      let xOffset = (PrimChecks.list.max(PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("xcor"); })) + PrimChecks.list.min(PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("xcor"); }))); letVars['xOffset'] = xOffset;
      let yOffset = (PrimChecks.list.max(PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("ycor"); })) + PrimChecks.list.min(PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("ycor"); }))); letVars['yOffset'] = yOffset;
