...
while (Prims.lte(degree, maxDegree)) {
  ...
  var setup   = function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Degree Distribution (log-log)', undefined)(function() {}); }); };
  var update  = function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Degree Distribution (log-log)', undefined)(function() {}); }); };
  return new Plot(name, pens, plotOps, 0.0, 0.3, 0.0, 0.3, setup, update);
})(), (function() {
...
plotManager.drawHistogramFrom(world.turtles().projectionBy(function() {
  ...
  return new Plot(name, pens, plotOps, 1.0, 10.0, 0.0, 10.0, setup, update);
})()];
