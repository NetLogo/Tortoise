    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'healthy')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() { return (!SelfManager.self().getVariable("sick?") && !procedures["IMMUNE?"]()); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      if (PrimChecks.agentset.optimizeCount(world.turtles(), 0, (a, b) => a > b)) {
        world.observer.setGlobal("%infected", (PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("sick?"); }), PrimChecks.agentset.count_unchecked(world.turtles())) * 100));
        world.observer.setGlobal("%immune", (PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return procedures["IMMUNE?"](); }), PrimChecks.agentset.count_unchecked(world.turtles())) * 100));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.otherWith(SelfManager.self().turtlesHere(), function() { return (!SelfManager.self().getVariable("sick?") && !procedures["IMMUNE?"]()); })).ask(function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if ((Prims.lt(PrimChecks.agentset.count_unchecked(world.turtles()), world.observer.getGlobal("carrying-capacity")) && Prims.lt(PrimChecks.math.randomFloat(100), world.observer.getGlobal("chance-reproduce")))) {
