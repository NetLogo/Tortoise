  ...
  temp = (function() {
    try {
      ...
      if (world.turtles()._optimalCheckCount(0, (a, b) => a > b)) {
        world.observer.setGlobal("%infected", (Prims.div(world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("sick?"); }), world.turtles().size()) * 100));
        world.observer.setGlobal("%immune", (Prims.div(world.turtles()._optimalCountWith(function() { return procedures["IMMUNE?"](); }), world.turtles().size()) * 100));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
