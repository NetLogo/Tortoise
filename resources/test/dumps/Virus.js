  ...
  temp = (function() {
    try {
      ...
      if (PrimChecks.agentset.optimizeCount(world.turtles(), 0, (a, b) => a > b)) {
        world.observer.setGlobal("%infected", (PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("sick?"); }), PrimChecks.agentset.count(world.turtles())) * 100));
        world.observer.setGlobal("%immune", (PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return procedures["IMMUNE?"](); }), PrimChecks.agentset.count(world.turtles())) * 100));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
