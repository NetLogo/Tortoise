      ...
      return plotManager.withTemporaryContext('Populations', 'healthy')(function() {
        try {
          ...
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() {
            return (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("sick?"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, procedures["IMMUNE?"]())));
          }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'total')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count(world.turtles()));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("number-people"), "").ask(function() {
        ...
        SelfManager.self().setVariable("age", PrimChecks.math.random(PrimChecks.validator.checkArg('RANDOM', 1, world.observer.getGlobal("lifespan"))));
  ...
  temp = (function() {
    try {
      ...
      if (PrimChecks.agentset.optimizeCount(world.turtles(), 0, (a, b) => a > b)) {
        world.observer.setGlobal("%infected", PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("sick?"); }), PrimChecks.agentset.count(world.turtles())), 100));
        world.observer.setGlobal("%immune", PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return procedures["IMMUNE?"](); }), PrimChecks.agentset.count(world.turtles())), 100));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (procedures["IMMUNE?"]()) {
        SelfManager.self().setVariable("remaining-immunity", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("remaining-immunity")), 1));
      }
      if (SelfManager.self().getVariable("sick?")) {
        SelfManager.self().setVariable("sick-time", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("sick-time")), 1));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
