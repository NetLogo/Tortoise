    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'sick')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("sick?"); }));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'immune')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(world.turtles()._optimalCountWith(function() { return procedures["IMMUNE?"](); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'healthy')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(world.turtles()._optimalCountWith(function() { return (!SelfManager.self().getVariable("sick?") && !procedures["IMMUNE?"]()); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  temp = (function() {
    try {
      ...
      if (world.turtles()._optimalCheckCount(0, (a, b) => a > b)) {
        world.observer.setGlobal("%infected", (PrimChecks.math.div(world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("sick?"); }), world.turtles().size()) * 100));
        world.observer.setGlobal("%immune", (PrimChecks.math.div(world.turtles()._optimalCountWith(function() { return procedures["IMMUNE?"](); }), world.turtles().size()) * 100));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
