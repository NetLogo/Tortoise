    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'sick')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("sick?"); }));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'immune')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() { return procedures["IMMUNE?"](); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
      ...
      return plotManager.withTemporaryContext('Populations', 'healthy')(function() {
        try {
          ...
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() {
            return (PrimChecks.math.not(SelfManager.self().getVariable("sick?")) && PrimChecks.math.not(procedures["IMMUNE?"]()));
          }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'total')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count_unchecked(world.turtles()));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.list.nOf_unchecked(10, world.turtles())).ask(function() { procedures["GET-SICK"](); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      world.observer.setGlobal("lifespan", PrimChecks.math.mult_unchecked(50, 52));
  ...
  temp = (function() {
    try {
      ...
      if (PrimChecks.agentset.optimizeCount(world.turtles(), 0, (a, b) => a > b)) {
        world.observer.setGlobal("%infected", PrimChecks.math.mult_unchecked(PrimChecks.math.div_unchecked(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("sick?"); }), PrimChecks.agentset.count_unchecked(world.turtles())), 100));
        world.observer.setGlobal("%immune", PrimChecks.math.mult_unchecked(PrimChecks.math.div_unchecked(PrimChecks.agentset.countWith(world.turtles(), function() { return procedures["IMMUNE?"](); }), PrimChecks.agentset.count_unchecked(world.turtles())), 100));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (procedures["IMMUNE?"]()) {
        SelfManager.self().setVariable("remaining-immunity", PrimChecks.math.minus(SelfManager.self().getVariable("remaining-immunity"), 1));
      }
      if (SelfManager.self().getVariable("sick?")) {
        SelfManager.self().setVariable("sick-time", PrimChecks.math.plus(SelfManager.self().getVariable("sick-time"), 1));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.otherWith(SelfManager.self().turtlesHere(), function() {
        return (PrimChecks.math.not(SelfManager.self().getVariable("sick?")) && PrimChecks.math.not(procedures["IMMUNE?"]()));
      })).ask(function() {
        if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("infectiousness"))) {
          procedures["GET-SICK"]();
        }
      }, true);
    } catch (e) {
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gt(SelfManager.self().getVariable("sick-time"), world.observer.getGlobal("duration"))) {
        if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("chance-recover"))) {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if ((Prims.lt(PrimChecks.agentset.count_unchecked(world.turtles()), world.observer.getGlobal("carrying-capacity")) && Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("chance-reproduce")))) {
