    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Avg. # of flagella per bacteria', 'pen 1')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("BACTERIA"))) {
            plotManager.plotPoint(world.ticker.tickCount(), PrimChecks.list.mean(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("BACTERIA"), function() { return SelfManager.self().getVariable("variation"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
