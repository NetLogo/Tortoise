...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      let flagellaShape = (workspace.dump('') + workspace.dump("flagella-") + workspace.dump(SelfManager.self().getVariable("variation")));
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.turtlesOfBreed("BACTERIA").ask(function() {
        ...
        let predatorsInFrontOfMe = SelfManager.self().inCone(world.turtleManager.turtlesOfBreed("PREDATORS"), 2, 120);
