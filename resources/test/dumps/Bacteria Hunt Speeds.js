      ...
      return plotManager.withTemporaryContext('# of bacteria for each variation', undefined)(function() {
        try {
          ...
          var _foreach_153_160 = Tasks.forEach(Tasks.commandTask(function(thisVariation) {
            ...
            plotManager.plotPoint(thisVariation, world.turtleManager.turtlesOfBreed("BACTERIA")._optimalCountWith(function() { return Prims.equality(SelfManager.self().getVariable("variation"), thisVariation); }));
      ...
      return plotManager.withTemporaryContext('Avg. # of flagella per bacteria', 'pen 1')(function() {
        try {
          ...
          if (!world.turtleManager.turtlesOfBreed("BACTERIA").isEmpty()) {
            plotManager.plotPoint(world.ticker.tickCount(), PrimChecks.list.mean(world.turtleManager.turtlesOfBreed("BACTERIA").projectionBy(function() { return SelfManager.self().getVariable("variation"); })));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      let prey = PrimChecks.list.oneOf(world.turtleManager.turtlesOfBreed("PREDATORS")).projectionBy(function() {
