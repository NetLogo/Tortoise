...
modelConfig.plots = [];
var workspace = tortoise_require('engine/workspace')(modelConfig)([])([], [])(tortoise_require("extensions/all").dumpers())(["num-vants"], ["num-vants"], [], -120, 120, -120, 120, 2.0, true, true, turtleShapes, linkShapes, function(){});
