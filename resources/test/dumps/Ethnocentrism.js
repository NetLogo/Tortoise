...
var procedures = (function() {
  ...
  var interact = function() {
    Prims.turtlesOn(SelfPrims.getNeighbors4()).ask(function() {
      ...
      if (Prims.equality(SelfPrims.getVariable("color"), SelfManager.myself().projectionBy(function() { return SelfPrims.getVariable("color"); }))) {
        ...
        if (SelfManager.myself().projectionBy(function() { return SelfPrims.getVariable("cooperate-with-same?"); })) {
      ...
      if (!Prims.equality(SelfPrims.getVariable("color"), SelfManager.myself().projectionBy(function() { return SelfPrims.getVariable("color"); }))) {
        ...
        if (SelfManager.myself().projectionBy(function() { return SelfPrims.getVariable("cooperate-with-different?"); })) {
  ...
  var reproduce = function() {
    if (Prims.lt(Prims.randomFloat(1), SelfPrims.getVariable("ptr"))) {
      var destination = ListPrims.oneOf(SelfPrims.getNeighbors4().agentFilter(function() { return !SelfManager.self().turtlesHere().nonEmpty(); }));
