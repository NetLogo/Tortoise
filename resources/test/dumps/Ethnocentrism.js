...
function initializeVariables() {
  ...
  Globals.setGlobal(12, 0);
  Globals.setGlobal(8, 0);
  Globals.setGlobal(9, 0);
  Globals.setGlobal(17, 0);
  Globals.setGlobal(18, 0);
  Globals.setGlobal(22, 0);
  Globals.setGlobal(23, 0);
  Globals.setGlobal(14, 0);
  Globals.setGlobal(15, 0);
  Globals.setGlobal(20, 0);
  Globals.setGlobal(21, 0);
  Globals.setGlobal(28, []);
  Globals.setGlobal(26, []);
  Globals.setGlobal(25, []);
  Globals.setGlobal(27, []);
  Globals.setGlobal(19, []);
  Globals.setGlobal(24, []);
  Globals.setGlobal(29, []);
  Globals.setGlobal(13, []);
  Globals.setGlobal(16, []);
  Globals.setGlobal(10, []);
  Globals.setGlobal(30, []);
}
function createTurtle() {
  AgentSet.ask(Prims.sprout(1, ""), true, function() {
    AgentSet.setTurtleVariable(1, Call(randomColor));
    AgentSet.setTurtleVariable(14, Prims.lt(Prims.randomFloat(1), Globals.getGlobal(6)));
    AgentSet.setTurtleVariable(15, Prims.lt(Prims.randomFloat(1), Globals.getGlobal(7)));
    Call(updateShape);
  });
}
...
function go() {
  ...
  AgentSet.ask(world.turtles(), true, function() {
    AgentSet.setTurtleVariable(13, Globals.getGlobal(3));
  });
  AgentSet.ask(world.turtles(), true, function() {
    Call(interact);
  });
...
function immigrate() {
  ...
  var howMany = Prims.min(Prims.list(Globals.getGlobal(2), AgentSet.count(emptyPatches)));
  AgentSet.ask(AgentSet.nOf(howMany, emptyPatches), true, function() {
    Call(createTurtle);
  });
}
function interact() {
  AgentSet.ask(AgentSet.turtlesOn(Prims.getNeighbors4()), true, function() {
    Globals.setGlobal(8, (Globals.getGlobal(8) + 1));
    Globals.setGlobal(9, (Globals.getGlobal(9) + 1));
    if (Prims.equality(AgentSet.getTurtleVariable(1), AgentSet.of(AgentSet.myself(), function() {
      return AgentSet.getTurtleVariable(1);
    }))) {
      Globals.setGlobal(11, (Globals.getGlobal(11) + 1));
      Globals.setGlobal(12, (Globals.getGlobal(12) + 1));
      if (AgentSet.of(AgentSet.myself(), function() {
        return AgentSet.getTurtleVariable(14);
      })) {
        Globals.setGlobal(17, (Globals.getGlobal(17) + 1));
        Globals.setGlobal(18, (Globals.getGlobal(18) + 1));
        AgentSet.ask(AgentSet.myself(), true, function() {
          AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) - Globals.getGlobal(4)));
        });
        AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) + Globals.getGlobal(5)));
      }
    }
    if (!Prims.equality(AgentSet.getTurtleVariable(1), AgentSet.of(AgentSet.myself(), function() {
      return AgentSet.getTurtleVariable(1);
    }))) {
      Globals.setGlobal(14, (Globals.getGlobal(14) + 1));
      Globals.setGlobal(15, (Globals.getGlobal(15) + 1));
      if (AgentSet.of(AgentSet.myself(), function() {
        return AgentSet.getTurtleVariable(15);
      })) {
        Globals.setGlobal(20, (Globals.getGlobal(20) + 1));
        Globals.setGlobal(21, (Globals.getGlobal(21) + 1));
        AgentSet.ask(AgentSet.myself(), true, function() {
          AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) - Globals.getGlobal(4)));
        });
        AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) + Globals.getGlobal(5)));
        ...
        Globals.setGlobal(22, (Globals.getGlobal(22) + 1));
        Globals.setGlobal(23, (Globals.getGlobal(23) + 1));
      }
    }
  });
}
...
function mutate() {
  if (Prims.lt(Prims.randomFloat(1), Globals.getGlobal(0))) {
...
function death() {
  AgentSet.ask(world.turtles(), true, function() {
    if (Prims.lt(Prims.randomFloat(1), Globals.getGlobal(1))) {
      AgentSet.die();
    }
  });
}
...
function updateStats() {
  Globals.setGlobal(28, Call(shorten, Prims.lput(AgentSet.count(AgentSet.agentFilter(world.turtles(), function() {
    return Prims.equality(AgentSet.getTurtleVariable(5), "square 2");
  })), Globals.getGlobal(28))));
  Globals.setGlobal(25, Call(shorten, Prims.lput(AgentSet.count(AgentSet.agentFilter(world.turtles(), function() {
    return Prims.equality(AgentSet.getTurtleVariable(5), "circle");
  })), Globals.getGlobal(25))));
  Globals.setGlobal(26, Call(shorten, Prims.lput(AgentSet.count(AgentSet.agentFilter(world.turtles(), function() {
    return Prims.equality(AgentSet.getTurtleVariable(5), "circle 2");
  })), Globals.getGlobal(26))));
  Globals.setGlobal(27, Call(shorten, Prims.lput(AgentSet.count(AgentSet.agentFilter(world.turtles(), function() {
    return Prims.equality(AgentSet.getTurtleVariable(5), "square");
  })), Globals.getGlobal(27))));
  Globals.setGlobal(19, Call(shorten, Prims.lput(Globals.getGlobal(17), Globals.getGlobal(19))));
  Globals.setGlobal(24, Call(shorten, Prims.lput(Globals.getGlobal(22), Globals.getGlobal(24))));
  Globals.setGlobal(13, Call(shorten, Prims.lput(Globals.getGlobal(11), Globals.getGlobal(13))));
  Globals.setGlobal(30, Call(shorten, Prims.lput((Globals.getGlobal(17) + Globals.getGlobal(20)), Globals.getGlobal(30))));
  Globals.setGlobal(10, Call(shorten, Prims.lput(Globals.getGlobal(8), Globals.getGlobal(10))));
  Globals.setGlobal(16, Call(shorten, Prims.lput(Globals.getGlobal(14), Globals.getGlobal(16))));
}
...
function meetownPercent() {
  return (Globals.getGlobal(11) / Prims.max(Prims.list(1, Globals.getGlobal(8))));
}
function meetownAggPercent() {
  return (Globals.getGlobal(12) / Prims.max(Prims.list(1, Globals.getGlobal(9))));
}
function coopownPercent() {
  return (Globals.getGlobal(17) / Prims.max(Prims.list(1, Globals.getGlobal(11))));
}
function coopownAggPercent() {
  return (Globals.getGlobal(18) / Prims.max(Prims.list(1, Globals.getGlobal(12))));
}
function defotherPercent() {
  return (Globals.getGlobal(22) / Prims.max(Prims.list(1, Globals.getGlobal(14))));
}
function defotherAggPercent() {
  return (Globals.getGlobal(23) / Prims.max(Prims.list(1, Globals.getGlobal(15))));
}
function consistEthnoPercent() {
  return ((Globals.getGlobal(22) + Globals.getGlobal(17)) / Prims.max(Prims.list(1, Globals.getGlobal(8))));
}
function consistEthnoAggPercent() {
  return ((Globals.getGlobal(23) + Globals.getGlobal(18)) / Prims.max(Prims.list(1, Globals.getGlobal(9))));
}
function coopPercent() {
  return ((Globals.getGlobal(17) + Globals.getGlobal(20)) / Prims.max(Prims.list(1, Globals.getGlobal(8))));
}
function coopAggPercent() {
  return ((Globals.getGlobal(18) + Globals.getGlobal(21)) / Prims.max(Prims.list(1, Globals.getGlobal(9))));
}
function ccCount() {
  return (Prims.sum(Globals.getGlobal(25)) / Prims.max(Prims.list(1, Prims.length(Globals.getGlobal(25)))));
}
function cdCount() {
  return (Prims.sum(Globals.getGlobal(26)) / Prims.max(Prims.list(1, Prims.length(Globals.getGlobal(26)))));
}
function dcCount() {
  return (Prims.sum(Globals.getGlobal(27)) / Prims.max(Prims.list(1, Prims.length(Globals.getGlobal(27)))));
}
function ddCount() {
  return (Prims.sum(Globals.getGlobal(28)) / Prims.max(Prims.list(1, Prims.length(Globals.getGlobal(28)))));
}
function ccPercent() {
...
function last100coopownPercent() {
  return (Prims.sum(Globals.getGlobal(19)) / Prims.max(Prims.list(1, Prims.sum(Globals.getGlobal(13)))));
}
function last100defotherPercent() {
  return (Prims.sum(Globals.getGlobal(24)) / Prims.max(Prims.list(1, Prims.sum(Globals.getGlobal(16)))));
}
function last100consistEthnoPercent() {
  return ((Prims.sum(Globals.getGlobal(24)) + Prims.sum(Globals.getGlobal(19))) / Prims.max(Prims.list(1, Prims.sum(Globals.getGlobal(10)))));
}
function last100meetownPercent() {
  return (Prims.sum(Globals.getGlobal(13)) / Prims.max(Prims.list(1, Prims.sum(Globals.getGlobal(10)))));
}
function last100coopPercent() {
  return (Prims.sum(Globals.getGlobal(30)) / Prims.max(Prims.list(1, Prims.sum(Globals.getGlobal(10)))));
}
Globals.setGlobal(0, 0.005);
Globals.setGlobal(1, 0.1);
Globals.setGlobal(2, 1);
Globals.setGlobal(3, 0.12);
Globals.setGlobal(4, 0.01);
Globals.setGlobal(5, 0.03);
Globals.setGlobal(6, 0.5);
Globals.setGlobal(7, 0.5);
