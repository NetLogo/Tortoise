...
function createTurtle() {
  AgentSet.ask(Prims.sprout(1, ""), true, function() {
    ...
    AgentSet.setTurtleVariable(14, Prims.lt(Prims.randomFloat(1), world.observer.getGlobal('immigrant-chance-cooperate-with-same')));
    AgentSet.setTurtleVariable(15, Prims.lt(Prims.randomFloat(1), world.observer.getGlobal('immigrant-chance-cooperate-with-different')));
    Call(updateShape);
  });
}
...
function go() {
  ...
  AgentSet.ask(world.turtles(), true, function() {
    AgentSet.setTurtleVariable(13, world.observer.getGlobal('initial-ptr'));
  });
  AgentSet.ask(world.turtles(), true, function() {
    Call(interact);
  });
    ...
    if (Prims.equality(AgentSet.getTurtleVariable(1), AgentSet.of(AgentSet.myself(), function() {
      ...
      if (AgentSet.of(AgentSet.myself(), function() {
        ...
        AgentSet.ask(AgentSet.myself(), true, function() {
          AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) - world.observer.getGlobal('cost-of-giving')));
        });
        AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) + world.observer.getGlobal('gain-of-receiving')));
      }
    }
    if (!Prims.equality(AgentSet.getTurtleVariable(1), AgentSet.of(AgentSet.myself(), function() {
      return AgentSet.getTurtleVariable(1);
