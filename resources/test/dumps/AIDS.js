...
function setupGlobals() {
  Globals.setGlobal(5, 50);
  Globals.setGlobal(6, 200);
  Globals.setGlobal(7, Globals.getGlobal(1));
  Globals.setGlobal(8, Globals.getGlobal(2));
  Globals.setGlobal(9, Globals.getGlobal(3));
  Globals.setGlobal(10, Globals.getGlobal(4));
}
function setupPeople() {
  AgentSet.ask(world.createTurtles(Globals.getGlobal(0), ""), true, function() {
    ...
    AgentSet.setTurtleVariable(22, Nobody);
    if (Prims.equality(Prims.random(2), 0)) {
      AgentSet.setTurtleVariable(5, "person righty");
    }
    else {
      AgentSet.setTurtleVariable(5, "person lefty");
    }
    AgentSet.setTurtleVariable(13, Prims.lt(AgentSet.getTurtleVariable(0), (Globals.getGlobal(0) * 0.025)));
    if (AgentSet.getTurtleVariable(13)) {
      AgentSet.setTurtleVariable(15, Prims.randomFloat(Globals.getGlobal(6)));
    }
...
function assignCommitment() {
  AgentSet.setTurtleVariable(18, Call(randomNear, Globals.getGlobal(1)));
}
function assignCouplingTendency() {
  AgentSet.setTurtleVariable(19, Call(randomNear, Globals.getGlobal(2)));
}
function assignCondomUse() {
  AgentSet.setTurtleVariable(20, Call(randomNear, Globals.getGlobal(3)));
}
function assignTestFrequency() {
  AgentSet.setTurtleVariable(21, Call(randomNear, Globals.getGlobal(4)));
}
...
function go() {
  if (AgentSet.all(world.turtles(), function(){ return AgentSet.getTurtleVariable(14) })) {
  ...
  AgentSet.ask(world.turtles(), true, function() {
    ...
    if (AgentSet.getTurtleVariable(16)) {
      AgentSet.setTurtleVariable(17, (AgentSet.getTurtleVariable(17) + 1));
    }
  });
  AgentSet.ask(world.turtles(), true, function() {
    if (!(AgentSet.getTurtleVariable(16))) {
  ...
  AgentSet.ask(world.turtles(), true, function() {
    if (((!(AgentSet.getTurtleVariable(16)) && Prims.equality(AgentSet.getTurtleVariable(5), "person righty")) && Prims.lt(Prims.randomFloat(10), AgentSet.getTurtleVariable(19)))) {
      Call(couple);
    }
  });
  AgentSet.ask(world.turtles(), true, function() {
...
function checkSliders() {
  if (!Prims.equality(Globals.getGlobal(7), Globals.getGlobal(1))) {
    AgentSet.ask(world.turtles(), true, function() {
      Call(assignCommitment);
    });
    Globals.setGlobal(7, Globals.getGlobal(1));
  }
  if (!Prims.equality(Globals.getGlobal(8), Globals.getGlobal(2))) {
    AgentSet.ask(world.turtles(), true, function() {
      Call(assignCouplingTendency);
    });
    Globals.setGlobal(8, Globals.getGlobal(2));
  }
  if (!Prims.equality(Globals.getGlobal(9), Globals.getGlobal(3))) {
    AgentSet.ask(world.turtles(), true, function() {
      Call(assignCondomUse);
    });
    Globals.setGlobal(9, Globals.getGlobal(3));
  }
  if (!Prims.equality(Globals.getGlobal(10), Globals.getGlobal(4))) {
    AgentSet.ask(world.turtles(), true, function() {
      Call(assignTestFrequency);
    });
    Globals.setGlobal(10, Globals.getGlobal(4));
...
function test() {
  if (Prims.lt(Prims.randomFloat(52), AgentSet.getTurtleVariable(21))) {
    if (AgentSet.getTurtleVariable(13)) {
      AgentSet.setTurtleVariable(14, true);
    }
  }
  if (Prims.gt(AgentSet.getTurtleVariable(15), Globals.getGlobal(6))) {
...
Globals.setGlobal(0, 300);
Globals.setGlobal(1, 50);
Globals.setGlobal(2, 5);
