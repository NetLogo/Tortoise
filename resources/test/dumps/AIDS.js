...
function setupPeople() {
  AgentSet.ask(world.createTurtles(world.observer.getGlobal('initial-people'), ""), true, function() {
    ...
    AgentSet.setTurtleVariable(13, Prims.lt(AgentSet.getTurtleVariable(0), (world.observer.getGlobal('initial-people') * 0.025)));
    if (AgentSet.getTurtleVariable(13)) {
      AgentSet.setTurtleVariable(15, Prims.randomFloat(world.observer.getGlobal('symptoms-show')));
    }
...
function assignCommitment() {
  AgentSet.setTurtleVariable(18, Call(randomNear, world.observer.getGlobal('average-commitment')));
}
function assignCouplingTendency() {
  AgentSet.setTurtleVariable(19, Call(randomNear, world.observer.getGlobal('average-coupling-tendency')));
}
function assignCondomUse() {
  AgentSet.setTurtleVariable(20, Call(randomNear, world.observer.getGlobal('average-condom-use')));
}
function assignTestFrequency() {
  AgentSet.setTurtleVariable(21, Call(randomNear, world.observer.getGlobal('average-test-frequency')));
}
...
function test() {
  ...
  if (Prims.gt(AgentSet.getTurtleVariable(15), world.observer.getGlobal('symptoms-show'))) {
