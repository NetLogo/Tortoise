    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Car speeds', 'red car')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.of(world.observer.getGlobal("sample-car"), function() { return SelfManager.self().getVariable("speed"); }));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Car speeds', 'min speed')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.min(PrimChecks.agentset.of_unchecked(world.turtles(), function() { return SelfManager.self().getVariable("speed"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Car speeds', 'max speed')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.max(PrimChecks.agentset.of_unchecked(world.turtles(), function() { return SelfManager.self().getVariable("speed"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
