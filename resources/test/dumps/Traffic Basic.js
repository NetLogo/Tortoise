    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Car speeds', 'min speed')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.min(world.turtles().projectionBy(function() { return SelfManager.self().getVariable("speed"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Car speeds', 'max speed')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.max(world.turtles().projectionBy(function() { return SelfManager.self().getVariable("speed"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
