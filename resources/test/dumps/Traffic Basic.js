...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('red car', plotOps.makePenOps, false, new PenBundle.State(15, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Car speeds', 'red car')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, world.observer.getGlobal("sample-car")), function() { return SelfManager.self().getVariable("speed"); }));
        } catch (e) {
  ...
  new PenBundle.Pen('min speed', plotOps.makePenOps, false, new PenBundle.State(105, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Car speeds', 'min speed')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.min(PrimChecks.validator.checkArg('MIN', 8, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("speed"); }))));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  new PenBundle.Pen('max speed', plotOps.makePenOps, false, new PenBundle.State(55, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Car speeds', 'max speed')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.max(PrimChecks.validator.checkArg('MAX', 8, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("speed"); }))));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("number-of-cars"), "").ask(function() {
        ...
        SelfManager.self().setVariable("speed", PrimChecks.math.plus(0.1, PrimChecks.math.randomFloat(0.9)));
  ...
  temp = (function(carAhead) {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().setVariable("speed", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, carAhead), function() { return SelfManager.self().getVariable("speed"); })), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("deceleration"))));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
