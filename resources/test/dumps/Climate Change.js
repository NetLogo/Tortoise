...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      world.observer.setGlobal("sky-top", PrimChecks.math.minus_unchecked(world.topology.maxPycor, 5));
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() {
        ...
        if (Prims.lt(SelfManager.self().getPatchVariable("pycor"), world.observer.getGlobal("earth-top"))) {
          SelfManager.self().setPatchVariable("pcolor", PrimChecks.math.plus_unchecked(15, 3));
        }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let skyHeight = PrimChecks.math.minus(world.observer.getGlobal("sky-top"), world.observer.getGlobal("earth-top")); letVars['skyHeight'] = skyHeight;
      let y = PrimChecks.math.plus_unchecked(PrimChecks.math.plus(world.observer.getGlobal("earth-top"), PrimChecks.math.randomFloat_unchecked(PrimChecks.math.minus(skyHeight, 4))), 2); letVars['y'] = y;
      let speed = PrimChecks.math.plus_unchecked(PrimChecks.math.randomFloat_unchecked(0.1), 0.01); letVars['speed'] = speed;
      let x = RandomPrims.randomFloatInRange(world.topology.minPxcor, world.topology.maxPxcor); letVars['x'] = x;
      let id = 0; letVars['id'] = id;
      if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("CLOUDS"))) {
        id = PrimChecks.math.plus_unchecked(PrimChecks.list.max(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("CLOUDS"), function() { return SelfManager.self().getVariable("cloud-id"); })), 1); letVars['id'] = id;
      }
      world.turtleManager.createTurtles(PrimChecks.math.plus_unchecked(3, RandomPrims.randomLong(20)), "CLOUDS").ask(function() {
        SelfManager.self().setVariable("cloud-speed", speed);
        SelfManager.self().setVariable("cloud-id", id);
        SelfManager.self().setXY(PrimChecks.math.minus_unchecked(PrimChecks.math.plus(x, RandomPrims.randomLong(9)), 4), PrimChecks.math.minus_unchecked(PrimChecks.math.plus_unchecked(PrimChecks.math.plus(y, 2.5), PrimChecks.math.randomFloat_unchecked(2)), PrimChecks.math.randomFloat_unchecked(2)));
        SelfManager.self().setVariable("color", 9.9);
        SelfManager.self().setVariable("size", PrimChecks.math.plus_unchecked(2, RandomPrims.randomLong(2)));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("CLOUDS"))) {
        let doomedId = PrimChecks.list.oneOf_unchecked(PrimChecks.list.removeDuplicates(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("CLOUDS"), function() { return SelfManager.self().getVariable("cloud-id"); }))); letVars['doomedId'] = doomedId;
        Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("CLOUDS"), function() { return Prims.equality(SelfManager.self().getVariable("cloud-id"), doomedId); })).ask(function() { SelfManager.self().die(); }, true);
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("RAYS")).ask(function() {
        if (PrimChecks.math.not_unchecked(SelfManager.self().canMove(0.3))) {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.gt(PrimChecks.math.mult(10, world.observer.getGlobal("sun-brightness")), RandomPrims.randomLong(50))) {
        world.turtleManager.createTurtles(1, "RAYS").ask(function() {
          ...
          SelfManager.self().setXY(PrimChecks.math.plus_unchecked(RandomPrims.randomLong(10), world.topology.minPxcor), world.topology.maxPycor);
        }, true);
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("RAYS"), function() { return PrimChecks.agentset.any_unchecked(SelfManager.self().breedHere("CLOUDS")); })).ask(function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("RAYS"), function() { return Prims.lte(SelfManager.self().getVariable("ycor"), world.observer.getGlobal("earth-top")); })).ask(function() {
        if (Prims.gt(PrimChecks.math.mult(100, world.observer.getGlobal("albedo")), RandomPrims.randomLong(100))) {
          SelfManager.self().setVariable("heading", PrimChecks.math.minus(180, SelfManager.self().getVariable("heading")));
        }
        else {
          SelfManager.self().right(PrimChecks.math.minus_unchecked(RandomPrims.randomLong(45), RandomPrims.randomLong(45)));
          SelfManager.self().setVariable("color", PrimChecks.math.plus_unchecked(PrimChecks.math.minus_unchecked(15, 2), RandomPrims.randomLong(4)));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      world.observer.setGlobal("temperature", PrimChecks.math.plus_unchecked(PrimChecks.math.mult(0.99, world.observer.getGlobal("temperature")), PrimChecks.math.mult_unchecked(0.01, PrimChecks.math.plus_unchecked(12, PrimChecks.math.mult_unchecked(0.1, PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("HEATS")))))));
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("HEATS")).ask(function() {
        let dist = PrimChecks.math.mult_unchecked(0.5, PrimChecks.math.randomFloat_unchecked(1)); letVars['dist'] = dist;
        ...
        if (Prims.gte(SelfManager.self().getVariable("ycor"), world.observer.getGlobal("earth-top"))) {
          if (((Prims.gt(world.observer.getGlobal("temperature"), PrimChecks.math.plus_unchecked(20, RandomPrims.randomLong(40))) && Prims.gt(SelfManager.self().getVariable("xcor"), 0)) && Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.minus_unchecked(world.topology.maxPxcor, 8)))) {
            ...
            SelfManager.self().setVariable("heading", PrimChecks.math.plus_unchecked(100, RandomPrims.randomLong(160)));
          }
        }
      }, true);
    } catch (e) {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("IRS")).ask(function() {
        ...
        if (PrimChecks.agentset.any_unchecked(SelfManager.self().breedHere("CO2S"))) {
          SelfManager.self().setVariable("heading", PrimChecks.math.minus(180, SelfManager.self().getVariable("heading")));
        }
      }, true);
    } catch (e) {
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(25, "CO2S").ask(function() {
        ...
        SelfManager.self().setXY(RandomPrims.randomFloatInRange(world.topology.minPxcor, world.topology.maxPxcor), PrimChecks.math.plus(world.observer.getGlobal("earth-top"), PrimChecks.math.randomFloat(skyHeight)));
      }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      for (let _index_5794_5800 = 0, _repeatcount_5794_5800 = StrictMath.floor(25); _index_5794_5800 < _repeatcount_5794_5800; _index_5794_5800++){
        if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("CO2S"))) {
          Errors.askNobodyCheck(PrimChecks.list.oneOf_unchecked(world.turtleManager.turtlesOfBreed("CO2S"))).ask(function() { SelfManager.self().die(); }, true);
        }
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("CO2S")).ask(function() {
        SelfManager.self().right(PrimChecks.math.minus_unchecked(RandomPrims.randomLong(51), 25));
        let dist = PrimChecks.math.plus_unchecked(0.05, PrimChecks.math.randomFloat_unchecked(0.1)); letVars['dist'] = dist;
        if (PrimChecks.agentset.of_unchecked(SelfManager.self().patchAhead(dist), function() {
          return PrimChecks.math.not_unchecked(ColorModel.areRelatedByShade(105, SelfManager.self().getPatchVariable("pcolor")));
        })) {
          SelfManager.self().setVariable("heading", PrimChecks.math.minus(180, SelfManager.self().getVariable("heading")));
        }
        SelfManager.self().fd(dist);
