...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      let y = ((world.observer.getGlobal("earth-top") + PrimChecks.math.randomFloat((skyHeight - 4))) + 2); letVars['y'] = y;
      let speed = (PrimChecks.math.randomFloat(0.1) + 0.01); letVars['speed'] = speed;
      ...
      if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("CLOUDS"))) {
        id = (PrimChecks.list.max(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("CLOUDS"), function() { return SelfManager.self().getVariable("cloud-id"); })) + 1); letVars['id'] = id;
      }
      world.turtleManager.createTurtles((3 + RandomPrims.randomLong(20)), "CLOUDS").ask(function() {
        ...
        SelfManager.self().setXY(((x + RandomPrims.randomLong(9)) - 4), (((y + 2.5) + PrimChecks.math.randomFloat(2)) - PrimChecks.math.randomFloat(2)));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      if (PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("CLOUDS"))) {
        let doomedId = PrimChecks.list.oneOf(PrimChecks.list.removeDuplicates(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("CLOUDS"), function() { return SelfManager.self().getVariable("cloud-id"); }))); letVars['doomedId'] = doomedId;
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("RAYS"), function() { return PrimChecks.agentset.any_unchecked(SelfManager.self().breedHere("CLOUDS")); })).ask(function() { SelfManager.self().setVariable("heading", (180 - SelfManager.self().getVariable("heading"))); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      world.observer.setGlobal("temperature", ((0.99 * world.observer.getGlobal("temperature")) + (0.01 * (12 + (0.1 * PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("HEATS")))))));
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("HEATS")).ask(function() {
        let dist = (0.5 * PrimChecks.math.randomFloat(1)); letVars['dist'] = dist;
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(25, "CO2S").ask(function() {
        ...
        SelfManager.self().setXY(RandomPrims.randomFloatInRange(world.topology.minPxcor, world.topology.maxPxcor), (world.observer.getGlobal("earth-top") + PrimChecks.math.randomFloat(skyHeight)));
      }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("CO2S")).ask(function() {
        ...
        let dist = (0.05 + PrimChecks.math.randomFloat(0.1)); letVars['dist'] = dist;
        if (PrimChecks.agentset.of_unchecked(SelfManager.self().patchAhead(dist), function() { return !ColorModel.areRelatedByShade(105, SelfManager.self().getPatchVariable("pcolor")); })) {
          SelfManager.self().setVariable("heading", (180 - SelfManager.self().getVariable("heading")));
        }
        SelfManager.self().fd(dist);
      }, true);
