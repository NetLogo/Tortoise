...
var procedures = (function() {
  ...
  var addCloud = function() {
    ...
    if (world.turtleManager.turtlesOfBreed("CLOUDS").nonEmpty()) {
      id = (ListPrims.max(world.turtleManager.turtlesOfBreed("CLOUDS").projectionBy(function() { return SelfPrims.getVariable("cloud-id"); })) + 1);
    }
  ...
  var removeCloud = function() {
    if (world.turtleManager.turtlesOfBreed("CLOUDS").nonEmpty()) {
      var doomedId = ListPrims.oneOf(ListPrims.removeDuplicates(world.turtleManager.turtlesOfBreed("CLOUDS").projectionBy(function() { return SelfPrims.getVariable("cloud-id"); })));
      world.turtleManager.turtlesOfBreed("CLOUDS").agentFilter(function() { return Prims.equality(SelfPrims.getVariable("cloud-id"), doomedId); }).ask(function() { SelfPrims.die(); }, true);
    }
  };
  ...
  var reflectRaysFromClouds = function() {
    world.turtleManager.turtlesOfBreed("RAYS").agentFilter(function() { return SelfManager.self().breedHere("CLOUDS").nonEmpty(); }).ask(function() { SelfPrims.setVariable("heading", (180 - SelfPrims.getVariable("heading"))); }, true);
  };
  var encounterEarth = function() {
    world.turtleManager.turtlesOfBreed("RAYS").agentFilter(function() { return Prims.lte(SelfPrims.getVariable("ycor"), world.observer.getGlobal("earth-top")); }).ask(function() {
  ...
  var removeCo2 = function() {
    for (var _index_5794_5800 = 0, _repeatcount_5794_5800 = StrictMath.floor(25); _index_5794_5800 < _repeatcount_5794_5800; _index_5794_5800++){
      if (world.turtleManager.turtlesOfBreed("CO2S").nonEmpty()) {
        ListPrims.oneOf(world.turtleManager.turtlesOfBreed("CO2S")).ask(function() { SelfPrims.die(); }, true);
      }
    }
  };
  var runCo2 = function() {
    world.turtleManager.turtlesOfBreed("CO2S").ask(function() {
      ...
      if (SelfManager.self().patchAhead(dist).projectionBy(function() { return !ColorModel.areRelatedByShade(105, SelfPrims.getPatchVariable("pcolor")); })) {
        SelfPrims.setVariable("heading", (180 - SelfPrims.getVariable("heading")));
      }
      SelfPrims.fd(dist);
    }, true);
  ...
  return {
    ...
    "GO":go,
    "REFLECT-RAYS-FROM-CLOUDS":reflectRaysFromClouds,
    ...
    "go":go,
    "reflectRaysFromClouds":reflectRaysFromClouds,
