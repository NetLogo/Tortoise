...
function encounterEarth() {
  AgentSet.ask(AgentSet.agentFilter(world.turtlesOfBreed("RAYS"), function() {
    return Prims.lte(AgentSet.getTurtleVariable(4), world.observer.getGlobal('earth-top'));
  }), true, function() {
...
function runHeat() {
  ...
  AgentSet.ask(world.turtlesOfBreed("HEATS"), true, function() {
    ...
    if (Prims.gte(AgentSet.getTurtleVariable(4), world.observer.getGlobal('earth-top'))) {
...
function runIr() {
  AgentSet.ask(world.turtlesOfBreed("IRS"), true, function() {
    ...
    Prims.fd(0.3);
    if (Prims.lte(AgentSet.getTurtleVariable(4), world.observer.getGlobal('earth-top'))) {
      AgentSet.setBreed(world.turtlesOfBreed("HEATS"));
