        ...
        try {
          ...
          if ((world.turtles()._optimalAnyWith(function() {
            ...
            for (let _index_215_221 = 0, _repeatcount_215_221 = StrictMath.floor(500); _index_215_221 < _repeatcount_215_221; _index_215_221++){
              ...
              if (Prims.lt(PrimChecks.math.abs((r.projectionBy(function() { return SelfManager.self().getVariable("flower-time"); }) - s.projectionBy(function() { return SelfManager.self().getVariable("flower-time"); }))), world.observer.getGlobal("flower-duration"))) {
                m = (m + 1); letVars['m'] = m;
              }
              n = (n + 1); letVars['n'] = n;
            }
...
var procedures = (function() {
  ...
  temp = (function(t1, t2) {
    try {
      var reporterContext = true;
      var letVars = { };
      let diff = PrimChecks.math.abs((t1.projectionBy(function() { return SelfManager.self().getVariable("flower-time"); }) - t2.projectionBy(function() { return SelfManager.self().getVariable("flower-time"); }))); letVars['diff'] = diff;
