    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('tolerances', 'left')(function() {
        try {
          ...
          var letVars = { };
          plotManager.drawHistogramFrom(PrimChecks.agentset.of(PrimChecks.agentset.with(world.turtles(), function() {
            return Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div(PrimChecks.math.plus(world.topology.minPxcor, world.topology.maxPxcor), 2));
          }), function() { return SelfManager.self().getVariable("tolerance"); }));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('tolerances', 'right')(function() {
        try {
          ...
          var letVars = { };
          plotManager.drawHistogramFrom(PrimChecks.agentset.of(PrimChecks.agentset.with(world.turtles(), function() {
            return Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div(PrimChecks.math.plus(world.topology.minPxcor, world.topology.maxPxcor), 2));
          }), function() { return SelfManager.self().getVariable("tolerance"); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('flower-times', 'left')(function() {
        try {
          ...
          plotManager.drawHistogramFrom(PrimChecks.agentset.of(PrimChecks.agentset.with(world.turtles(), function() {
            return Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div(PrimChecks.math.plus(world.topology.minPxcor, world.topology.maxPxcor), 2));
          }), function() { return SelfManager.self().getVariable("flower-time"); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('avg. tolerance', 'left')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          if (PrimChecks.agentset.anyWith(world.turtles(), function() {
            return Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div(PrimChecks.math.plus(world.topology.minPxcor, world.topology.maxPxcor), 2));
          })) {
            plotManager.plotPoint(world.observer.getGlobal("year"), PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(PrimChecks.agentset.with(world.turtles(), function() {
              return Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div(PrimChecks.math.plus(world.topology.minPxcor, world.topology.maxPxcor), 2));
            }), function() { return SelfManager.self().getVariable("tolerance"); }))));
          }
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('simultaneous flowering', 'default')(function() {
        try {
          ...
          if ((PrimChecks.agentset.anyWith(world.turtles(), function() {
            return Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div(PrimChecks.math.plus(world.topology.minPxcor, world.topology.maxPxcor), 2));
          }) && PrimChecks.agentset.anyWith(world.turtles(), function() {
            return Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div(PrimChecks.math.plus(world.topology.minPxcor, world.topology.maxPxcor), 2));
          }))) {
            let n = 0; letVars['n'] = n;
            let m = 0; letVars['m'] = m;
            let avg = PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("tolerance"); }))); letVars['avg'] = avg;
            for (let _index_215_221 = 0, _repeatcount_215_221 = StrictMath.floor(500); _index_215_221 < _repeatcount_215_221; _index_215_221++){
              let r = PrimChecks.agentset.oneOfWith(world.turtles(), function() {
                return Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div(PrimChecks.math.plus(world.topology.minPxcor, world.topology.maxPxcor), 2));
              }); letVars['r'] = r;
              let s = PrimChecks.agentset.oneOfWith(world.turtles(), function() {
                return Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div(PrimChecks.math.plus(world.topology.minPxcor, world.topology.maxPxcor), 2));
              }); letVars['s'] = s;
              if (Prims.lt(PrimChecks.math.abs(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, r), function() { return SelfManager.self().getVariable("flower-time"); })), PrimChecks.validator.checkArg('-', 1, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, s), function() { return SelfManager.self().getVariable("flower-time"); })))), world.observer.getGlobal("flower-duration"))) {
                m = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, m), 1); letVars['m'] = m;
              }
              n = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, n), 1); letVars['n'] = n;
            }
            world.observer.setGlobal("percent-same-flowering-time", PrimChecks.math.precision(PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, m), PrimChecks.validator.checkArg('/', 1, n)), 100), 1));
            plotManager.plotPoint(world.observer.getGlobal("year"), PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, m), PrimChecks.validator.checkArg('/', 1, n)), 100));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pxcor"), world.topology.minPxcor); })).ask(function() {
        SelfManager.self().sprout(world.observer.getGlobal("plants-per-patch"), "TURTLES").ask(function() {
          ...
          if (Prims.equality(world.observer.getGlobal("initial-tolerance"), "random tolerances")) {
            SelfManager.self().setVariable("tolerance", PrimChecks.math.randomFloat(100));
          }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(world.observer.getGlobal("visualize-time-steps"), "years")) {
        world.observer.setGlobal("day", 0);
        world.observer.setGlobal("year", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("year")), 1));
        Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["REDRAW-PLANTS-AS-FULL-SIZED-PLANTS"](); }, true);
    ...
    try {
      ...
      if (Prims.equality(world.observer.getGlobal("day"), 365)) {
        ...
        if (world.observer.getGlobal("transition-time?")) {
          world.observer.setGlobal("end-of-days-counter", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("end-of-days-counter")), 1));
          Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtles(), function() { return SelfManager.self().getVariable("seedling?"); })).ask(function() { procedures["VISUALIZE-SEEDLING-GROWTH"](); }, true);
          Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtles(), function() { return SelfManager.self().getVariable("will-die?"); })).ask(function() {
            SelfManager.self().setVariable("size", PrimChecks.math.minus(1, PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("end-of-days-counter")), 10)));
          }, true);
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        ...
        if (Prims.lt(world.observer.getGlobal("pollen-radius"), PrimChecks.math.minus(world.topology.maxPxcor, world.topology.minPxcor))) {
        ...
        if (PrimChecks.agentset.optimizeCount(nearbyTurtles, 10, (a, b) => a < b)) {
          potentialMates = PrimChecks.list.sort(PrimChecks.validator.checkArg('SORT', 120, nearbyTurtles)); letVars['potentialMates'] = potentialMates;
        }
        else {
          potentialMates = PrimChecks.list.sort(PrimChecks.list.nOf(10, PrimChecks.validator.checkArg('N-OF', 120, nearbyTurtles))); letVars['potentialMates'] = potentialMates;
          potentialMates = PrimChecks.list.fput(SelfManager.self(), PrimChecks.validator.checkArg('FPUT', 8, potentialMates)); letVars['potentialMates'] = potentialMates;
        }
        ...
        SelfManager.self().hatch(PrimChecks.math.randomPoisson(PrimChecks.validator.checkArg('RANDOM-POISSON', 1, world.observer.getGlobal("average-number-offspring"))), "").ask(function() {
          ...
          if (Prims.equality(world.observer.getGlobal("genetics-model"), "avg. genotype")) {
            SelfManager.self().setVariable("tolerance", PrimChecks.math.div(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("tolerance")), PrimChecks.validator.checkArg('+', 1, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, mate), function() { return SelfManager.self().getVariable("tolerance"); }))), 2));
            SelfManager.self().setVariable("flower-time", PrimChecks.math.div(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("flower-time")), PrimChecks.validator.checkArg('+', 1, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, mate), function() { return SelfManager.self().getVariable("flower-time"); }))), 2));
          }
          if (Prims.lt(PrimChecks.math.randomFloat(100), world.observer.getGlobal("chance-tolerance-mutation"))) {
            SelfManager.self().setVariable("tolerance", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("tolerance")), PrimChecks.math.randomNormal(0, PrimChecks.validator.checkArg('RANDOM-NORMAL', 1, world.observer.getGlobal("tolerance-mutation-stdev")))));
          }
          if (Prims.lt(PrimChecks.math.randomFloat(100), world.observer.getGlobal("chance-flower-time-mutation"))) {
            SelfManager.self().setVariable("flower-time", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("flower-time")), PrimChecks.math.randomNormal(0, PrimChecks.validator.checkArg('RANDOM-NORMAL', 1, world.observer.getGlobal("flower-time-mutation-stdev")))));
          }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        let t = PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, SelfManager.self().getVariable("tolerance")), 100); letVars['t'] = t;
        let m = PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, SelfManager.self().getPatchVariable("metal")), 100); letVars['m'] = m;
        SelfManager.self().setVariable("fitness", PrimChecks.math.plus(PrimChecks.math.mult(PrimChecks.math.minus(1, PrimChecks.validator.checkArg('-', 1, m)), PrimChecks.math.minus(1, PrimChecks.math.mult(0.4, PrimChecks.validator.checkArg('*', 1, t)))), PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, m), PrimChecks.math.minus(1, PrimChecks.math.mult(0.4, PrimChecks.math.minus(1, PrimChecks.validator.checkArg('-', 1, t)))))));
        if (Prims.gt(PrimChecks.math.randomFloat(1), SelfManager.self().getVariable("fitness"))) {
          SelfManager.self().setVariable("will-die?", true);
        }
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() {
        let overpopulation = PrimChecks.math.minus(PrimChecks.agentset.count(SelfManager.self().turtlesHere()), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("plants-per-patch"))); letVars['overpopulation'] = overpopulation;
        if (Prims.gt(overpopulation, 0)) {
          Errors.askNobodyCheck(PrimChecks.agentset.minNOf(SelfManager.self().turtlesHere(), PrimChecks.validator.checkArg('MIN-N-OF', 1, overpopulation), function() { return SelfManager.self().getVariable("fitness"); })).ask(function() { SelfManager.self().setVariable("will-die?", true); }, true);
        }
      }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtles(), function() { return SelfManager.self().getVariable("will-die?"); })).ask(function() { SelfManager.self().die(); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
    ...
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (Prims.equality(world.observer.getGlobal("show-labels-as"), "metal tolerance")) {
          SelfManager.self().setVariable("label", PrimChecks.math.precision(PrimChecks.validator.checkArg('PRECISION', 1, SelfManager.self().getVariable("tolerance")), 0));
        }
        if (Prims.equality(world.observer.getGlobal("show-labels-as"), "flower time")) {
          SelfManager.self().setVariable("label", PrimChecks.math.precision(PrimChecks.validator.checkArg('PRECISION', 1, SelfManager.self().getVariable("flower-time")), 0));
        }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      if (SelfManager.self().getVariable("seedling?")) {
        SelfManager.self().setVariable("size", PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("end-of-days-counter")), 10));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if ((Prims.gte(world.observer.getGlobal("day"), SelfManager.self().getVariable("flower-time")) && Prims.lte(world.observer.getGlobal("day"), PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("flower-time")), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("flower-duration")))))) {
  ...
  temp = (function(options, weights) {
    try {
      ...
      var _foreach_11551_11558 = Tasks.forEach(Tasks.commandTask(function(weight) {
        Errors.procedureArgumentsCheck(1, arguments.length);
        wsum = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, wsum), PrimChecks.validator.checkArg('+', 1, weight)); letVars['wsum'] = wsum;
      }, "[ weight -> set wsum wsum + weight ]"), weights); if(reporterContext && _foreach_11551_11558 !== undefined) { return _foreach_11551_11558; }
      let wret = PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, wsum), PrimChecks.math.randomFloat(1)); letVars['wret'] = wret;
      ...
      var _foreach_11674_11681 = Tasks.forEach(Tasks.commandTask(function(weight) {
        ...
        if (Prims.gt(wsum, wret)) {
          ...
          return PrimChecks.list.item(PrimChecks.validator.checkArg('ITEM', 1, ret), PrimChecks.validator.checkArg('ITEM', 12, options));
        }
        ret = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, ret), 1); letVars['ret'] = ret;
  ...
  temp = (function(t1, t2) {
    try {
      var reporterContext = true;
      var letVars = { };
      let diff = PrimChecks.math.abs(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, t1), function() { return SelfManager.self().getVariable("flower-time"); })), PrimChecks.validator.checkArg('-', 1, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, t2), function() { return SelfManager.self().getVariable("flower-time"); })))); letVars['diff'] = diff;
      if (Prims.lt(diff, world.observer.getGlobal("flower-duration"))) {
        Errors.reportInContextCheck(reporterContext);
        return PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("flower-duration")), PrimChecks.validator.checkArg('-', 1, diff));
      }
      else {
        Errors.reportInContextCheck(reporterContext);
        return 0;
  ...
  temp = (function(m) {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return ColorModel.genRGBFromComponents(0, PrimChecks.math.div(PrimChecks.math.mult(255, PrimChecks.math.minus(1, PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, m), 100))), 2), PrimChecks.math.div(PrimChecks.math.mult(255, PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, m), 100)), 2));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function(t) {
    try {
      ...
      if (SelfManager.self().getPatchVariable("barrier?")) {
        ...
        Errors.reportInContextCheck(reporterContext);
        return ColorModel.genRGBFromComponents(0, PrimChecks.math.mult(255, PrimChecks.math.minus(1, PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, t), 100))), PrimChecks.math.mult(255, PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, t), 100)));
      }
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
