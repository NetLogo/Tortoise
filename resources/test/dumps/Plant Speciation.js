      ...
      return plotManager.withTemporaryContext('avg. tolerance', 'left')(function() {
        try {
          ...
          if (PrimChecks.agentset.anyWith(world.turtles(), function() {
            ...
            plotManager.plotPoint(world.observer.getGlobal("year"), PrimChecks.list.mean(PrimChecks.agentset.of(PrimChecks.agentset.with(world.turtles(), function() {
              return Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div((world.topology.minPxcor + world.topology.maxPxcor), 2));
            }), function() { return SelfManager.self().getVariable("tolerance"); })));
          }
        } catch (e) {
      ...
      return plotManager.withTemporaryContext('simultaneous flowering', 'default')(function() {
        try {
          ...
          if ((PrimChecks.agentset.anyWith(world.turtles(), function() {
            ...
            let n = 0; letVars['n'] = n;
            let m = 0; letVars['m'] = m;
            let avg = PrimChecks.list.mean(PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("tolerance"); })); letVars['avg'] = avg;
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() {
        let overpopulation = (PrimChecks.agentset.count(SelfManager.self().turtlesHere()) - world.observer.getGlobal("plants-per-patch")); letVars['overpopulation'] = overpopulation;
