    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('tolerances', 'left')(function() {
        try {
          ...
          var letVars = { };
          plotManager.drawHistogramFrom(PrimChecks.agentset.of_unchecked(PrimChecks.agentset.with_unchecked(world.turtles(), function() {
            return Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div_unchecked(PrimChecks.math.plus_unchecked(world.topology.minPxcor, world.topology.maxPxcor), 2));
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('tolerances', 'right')(function() {
        try {
          ...
          var letVars = { };
          plotManager.drawHistogramFrom(PrimChecks.agentset.of_unchecked(PrimChecks.agentset.with_unchecked(world.turtles(), function() {
            return Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div_unchecked(PrimChecks.math.plus_unchecked(world.topology.minPxcor, world.topology.maxPxcor), 2));
          }), function() { return SelfManager.self().getVariable("tolerance"); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      ...
      return plotManager.withTemporaryContext('avg. tolerance', 'left')(function() {
        try {
          ...
          if (PrimChecks.agentset.anyWith(world.turtles(), function() {
            ...
            plotManager.plotPoint(world.observer.getGlobal("year"), PrimChecks.list.mean(PrimChecks.agentset.of_unchecked(PrimChecks.agentset.with_unchecked(world.turtles(), function() {
              return Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.div_unchecked(PrimChecks.math.plus_unchecked(world.topology.minPxcor, world.topology.maxPxcor), 2));
            }), function() { return SelfManager.self().getVariable("tolerance"); })));
          }
        } catch (e) {
      ...
      return plotManager.withTemporaryContext('simultaneous flowering', 'default')(function() {
        try {
          ...
          if ((PrimChecks.agentset.anyWith(world.turtles(), function() {
            ...
            let n = 0; letVars['n'] = n;
            let m = 0; letVars['m'] = m;
            let avg = PrimChecks.list.mean(PrimChecks.agentset.of_unchecked(world.turtles(), function() { return SelfManager.self().getVariable("tolerance"); })); letVars['avg'] = avg;
            for (let _index_215_221 = 0, _repeatcount_215_221 = StrictMath.floor(500); _index_215_221 < _repeatcount_215_221; _index_215_221++){
              ...
              if (Prims.lt(PrimChecks.math.abs_unchecked(PrimChecks.math.minus(PrimChecks.agentset.of(r, function() { return SelfManager.self().getVariable("flower-time"); }), PrimChecks.agentset.of(s, function() { return SelfManager.self().getVariable("flower-time"); }))), world.observer.getGlobal("flower-duration"))) {
                m = PrimChecks.math.plus(m, 1); letVars['m'] = m;
              }
              n = PrimChecks.math.plus(n, 1); letVars['n'] = n;
            }
            world.observer.setGlobal("percent-same-flowering-time", PrimChecks.math.precision_unchecked(PrimChecks.math.mult_unchecked(PrimChecks.math.div(m, n), 100), 1));
            plotManager.plotPoint(world.observer.getGlobal("year"), PrimChecks.math.mult_unchecked(PrimChecks.math.div(m, n), 100));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pxcor"), world.topology.minPxcor); })).ask(function() {
        SelfManager.self().sprout(world.observer.getGlobal("plants-per-patch"), "TURTLES").ask(function() {
          ...
          if (Prims.equality(world.observer.getGlobal("initial-tolerance"), "random tolerances")) {
            SelfManager.self().setVariable("tolerance", PrimChecks.math.randomFloat_unchecked(100));
          }
          SelfManager.self().setVariable("flower-time", PrimChecks.math.div_unchecked(365, 2));
          SelfManager.self().setVariable("heading", RandomPrims.randomLong(360));
          SelfManager.self().fd(PrimChecks.math.randomFloat_unchecked(0.5));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().setPatchVariable("metal", PrimChecks.math.precision_unchecked(PrimChecks.math.div_unchecked(100, PrimChecks.math.plus_unchecked(1, PrimChecks.math.exp_unchecked(PrimChecks.math.mult(world.observer.getGlobal("frontier-sharpness"), PrimChecks.math.minus(PrimChecks.math.div_unchecked(PrimChecks.math.plus_unchecked(world.topology.maxPxcor, world.topology.minPxcor), 2), SelfManager.self().getPatchVariable("pxcor")))))), 0));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(world.observer.getGlobal("visualize-time-steps"), "years")) {
        world.observer.setGlobal("day", 0);
        world.observer.setGlobal("year", PrimChecks.math.plus(world.observer.getGlobal("year"), 1));
        Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["REDRAW-PLANTS-AS-FULL-SIZED-PLANTS"](); }, true);
    ...
    try {
      ...
      if (Prims.equality(world.observer.getGlobal("day"), 365)) {
        ...
        if (world.observer.getGlobal("transition-time?")) {
          world.observer.setGlobal("end-of-days-counter", PrimChecks.math.plus(world.observer.getGlobal("end-of-days-counter"), 1));
          ...
          Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtles(), function() { return SelfManager.self().getVariable("will-die?"); })).ask(function() {
            SelfManager.self().setVariable("size", PrimChecks.math.minus_unchecked(1, PrimChecks.math.div(world.observer.getGlobal("end-of-days-counter"), 10)));
          }, true);
        ...
        world.observer.setGlobal("day", PrimChecks.math.plus(world.observer.getGlobal("day"), 1));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        ...
        if (Prims.lt(world.observer.getGlobal("pollen-radius"), PrimChecks.math.minus_unchecked(world.topology.maxPxcor, world.topology.minPxcor))) {
        ...
        if (PrimChecks.agentset.optimizeCount(nearbyTurtles, 10, (a, b) => a < b)) {
          ...
          potentialMates = PrimChecks.list.sort_unchecked(PrimChecks.list.nOf(10, nearbyTurtles)); letVars['potentialMates'] = potentialMates;
          potentialMates = PrimChecks.list.fput(SelfManager.self(), potentialMates); letVars['potentialMates'] = potentialMates;
        }
        ...
        SelfManager.self().hatch(PrimChecks.math.randomPoisson(world.observer.getGlobal("average-number-offspring")), "").ask(function() {
          ...
          if (Prims.equality(world.observer.getGlobal("genetics-model"), "avg. genotype")) {
            SelfManager.self().setVariable("tolerance", PrimChecks.math.div_unchecked(PrimChecks.math.plus(SelfManager.self().getVariable("tolerance"), PrimChecks.agentset.of(mate, function() { return SelfManager.self().getVariable("tolerance"); })), 2));
            SelfManager.self().setVariable("flower-time", PrimChecks.math.div_unchecked(PrimChecks.math.plus(SelfManager.self().getVariable("flower-time"), PrimChecks.agentset.of(mate, function() { return SelfManager.self().getVariable("flower-time"); })), 2));
          }
          if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("chance-tolerance-mutation"))) {
            SelfManager.self().setVariable("tolerance", PrimChecks.math.plus(SelfManager.self().getVariable("tolerance"), PrimChecks.math.randomNormal(0, world.observer.getGlobal("tolerance-mutation-stdev"))));
          }
          if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("chance-flower-time-mutation"))) {
            SelfManager.self().setVariable("flower-time", PrimChecks.math.plus(SelfManager.self().getVariable("flower-time"), PrimChecks.math.randomNormal(0, world.observer.getGlobal("flower-time-mutation-stdev"))));
          }
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        ...
        SelfManager.self().setVariable("fitness", PrimChecks.math.plus_unchecked(PrimChecks.math.mult_unchecked(PrimChecks.math.minus(1, m), PrimChecks.math.minus_unchecked(1, PrimChecks.math.mult(0.4, t))), PrimChecks.math.mult(m, PrimChecks.math.minus_unchecked(1, PrimChecks.math.mult_unchecked(0.4, PrimChecks.math.minus(1, t))))));
        if (Prims.gt(PrimChecks.math.randomFloat_unchecked(1), SelfManager.self().getVariable("fitness"))) {
          SelfManager.self().setVariable("will-die?", true);
        }
        if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("chance-death-per-year"))) {
          SelfManager.self().setVariable("will-die?", true);
        }
      }, true);
      Errors.askNobodyCheck(world.patches()).ask(function() {
        let overpopulation = PrimChecks.math.minus(PrimChecks.agentset.count_unchecked(SelfManager.self().turtlesHere()), world.observer.getGlobal("plants-per-patch")); letVars['overpopulation'] = overpopulation;
        if (Prims.gt(overpopulation, 0)) {
          Errors.askNobodyCheck(PrimChecks.agentset.minNOf(SelfManager.self().turtlesHere(), overpopulation, function() { return SelfManager.self().getVariable("fitness"); })).ask(function() { SelfManager.self().setVariable("will-die?", true); }, true);
        }
      }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("chance-seed-dispersal"))) {
        ...
        SelfManager.self().fd(PrimChecks.math.randomFloat_unchecked(0.45));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
    ...
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (Prims.equality(world.observer.getGlobal("show-labels-as"), "metal tolerance")) {
          SelfManager.self().setVariable("label", PrimChecks.math.precision(SelfManager.self().getVariable("tolerance"), 0));
        }
        if (Prims.equality(world.observer.getGlobal("show-labels-as"), "flower time")) {
          SelfManager.self().setVariable("label", PrimChecks.math.precision(SelfManager.self().getVariable("flower-time"), 0));
        }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if ((Prims.gte(world.observer.getGlobal("day"), SelfManager.self().getVariable("flower-time")) && Prims.lte(world.observer.getGlobal("day"), PrimChecks.math.plus(SelfManager.self().getVariable("flower-time"), world.observer.getGlobal("flower-duration"))))) {
  ...
  temp = (function(options, weights) {
    try {
      ...
      var _foreach_11551_11558 = Tasks.forEach(Tasks.commandTask(function(weight) {
        Errors.procedureArgumentsCheck(1, arguments.length);
        wsum = PrimChecks.math.plus(wsum, weight); letVars['wsum'] = wsum;
      }, "[ weight -> set wsum wsum + weight ]"), weights); if(reporterContext && _foreach_11551_11558 !== undefined) { return _foreach_11551_11558; }
      let wret = PrimChecks.math.mult(wsum, PrimChecks.math.randomFloat_unchecked(1)); letVars['wret'] = wret;
      ...
      var _foreach_11674_11681 = Tasks.forEach(Tasks.commandTask(function(weight) {
        ...
        ret = PrimChecks.math.plus(ret, 1); letVars['ret'] = ret;
  ...
  temp = (function(t1, t2) {
    try {
      var reporterContext = true;
      var letVars = { };
      let diff = PrimChecks.math.abs_unchecked(PrimChecks.math.minus(PrimChecks.agentset.of(t1, function() { return SelfManager.self().getVariable("flower-time"); }), PrimChecks.agentset.of(t2, function() { return SelfManager.self().getVariable("flower-time"); }))); letVars['diff'] = diff;
      if (Prims.lt(diff, world.observer.getGlobal("flower-duration"))) {
        Errors.reportInContextCheck(reporterContext);
        return PrimChecks.math.minus(world.observer.getGlobal("flower-duration"), diff);
      }
      else {
        Errors.reportInContextCheck(reporterContext);
        return 0;
  ...
  temp = (function(m) {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return ColorModel.genRGBFromComponents(0, PrimChecks.math.div_unchecked(PrimChecks.math.mult_unchecked(255, PrimChecks.math.minus_unchecked(1, PrimChecks.math.div(m, 100))), 2), PrimChecks.math.div_unchecked(PrimChecks.math.mult_unchecked(255, PrimChecks.math.div(m, 100)), 2));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function(t) {
    try {
      ...
      if (SelfManager.self().getPatchVariable("barrier?")) {
        ...
        Errors.reportInContextCheck(reporterContext);
        return ColorModel.genRGBFromComponents(0, PrimChecks.math.mult_unchecked(255, PrimChecks.math.minus_unchecked(1, PrimChecks.math.div(t, 100))), PrimChecks.math.mult_unchecked(255, PrimChecks.math.div(t, 100)));
      }
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
