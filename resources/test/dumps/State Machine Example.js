...
modelConfig.plots = [];
var workspace = tortoise_require('engine/workspace')(modelConfig)([])(["next-task", "steps"], [])(tortoise_require("extensions/all").dumpers())(["number", "density"], ["number", "density"], [], -100, 100, -100, 100, 2.0, true, true, turtleShapes, linkShapes, function(){});
