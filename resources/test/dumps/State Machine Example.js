        ...
        try {
          ...
          if (Prims.gt(SelfManager.self().getVariable("steps"), 0)) {
            ...
            var _run_677_680 = Prims.runCode(
              false,
              (function() {
                let _run_677_680Vars = { }; for(var v in letVars) { _run_677_680Vars[v] = letVars[v]; }
                
                return _run_677_680Vars;
              })(),
              SelfManager.self().getVariable("next-task")
            )
            if(reporterContext && _run_677_680 !== undefined) { return _run_677_680; }
