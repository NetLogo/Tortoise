    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Turtle Count', 'unattached')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(world.turtles()._optimalCountWith(function() { return Prims.equality(SelfManager.self().getVariable("color"), 125); }));
        } catch (e) {
