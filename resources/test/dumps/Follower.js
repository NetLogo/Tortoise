...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      candidate.ask(function() { SelfManager.self().setVariable("follower", SelfManager.myself()); }, true);
