...
var procedures = (function() {
  ...
  var placeControlRods = function() {
    world.patches().agentFilter(function() { return SelfPrims.getPatchVariable("rod?"); }).ask(function() {
  ...
  var fission = function() {
    ...
    if (Prims.equality(SelfPrims.getPatchVariable("pcolor"), 15)) {
      ...
      SelfPrims.hatch(((2 + Prims.random(2)) * gain), "").ask(function() { SelfPrims.right(Prims.random(360)); }, true);
    }
  };
  return {
