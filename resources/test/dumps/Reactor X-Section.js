    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Power', undefined)(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.setYRange(0, PrimChecks.math.mult(3, world.observer.getGlobal("power-rated")));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("n-rods", PrimChecks.math.minus_unchecked(PrimChecks.math.div(world.observer.getGlobal("reactor-size"), PrimChecks.math.plus(world.observer.getGlobal("rod-spacing"), 1)), 1));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      let rodX = PrimChecks.math.plus(PrimChecks.math.minus(1, world.observer.getGlobal("r")), world.observer.getGlobal("rod-spacing")); letVars['rodX'] = rodX;
      if (((Prims.equality(world.observer.getGlobal("rod-spacing"), 2) && !Prims.equality(world.observer.getGlobal("reactor-size"), 30)) && !Prims.equality(world.observer.getGlobal("reactor-size"), 60))) {
        rodX = PrimChecks.math.plus(rodX, 1); letVars['rodX'] = rodX;
      }
      if ((Prims.equality(world.observer.getGlobal("rod-spacing"), 3) && !Prims.equality(PrimChecks.math.mod(world.observer.getGlobal("reactor-size"), 20), 0))) {
        world.observer.setGlobal("n-rods", PrimChecks.math.plus(world.observer.getGlobal("n-rods"), 1));
        rodX = PrimChecks.math.minus(rodX, 1); letVars['rodX'] = rodX;
      }
      if ((Prims.equality(world.observer.getGlobal("rod-spacing"), 5) && ((Prims.equality(world.observer.getGlobal("reactor-size"), 20) || Prims.equality(world.observer.getGlobal("reactor-size"), 40)) || Prims.equality(world.observer.getGlobal("reactor-size"), 70)))) {
        if (Prims.equality(world.observer.getGlobal("reactor-size"), 20)) {
          ...
          rodX = PrimChecks.math.plus(rodX, 2); letVars['rodX'] = rodX;
        }
      }
      if ((Prims.equality(world.observer.getGlobal("rod-spacing"), 6) && Prims.equality(PrimChecks.math.mod(world.observer.getGlobal("reactor-size"), 20), 0))) {
        ...
        if (Prims.equality(world.observer.getGlobal("reactor-size"), 80)) {
          rodX = PrimChecks.math.minus(rodX, 2); letVars['rodX'] = rodX;
        }
        else {
          rodX = PrimChecks.math.minus(rodX, 1); letVars['rodX'] = rodX;
        }
      ...
      for (let _index_1937_1943 = 0, _repeatcount_1937_1943 = StrictMath.floor(world.observer.getGlobal("n-rods")); _index_1937_1943 < _repeatcount_1937_1943; _index_1937_1943++){
        ...
        rodX = PrimChecks.math.plus_unchecked(PrimChecks.math.plus(rodX, world.observer.getGlobal("rod-spacing")), 1); letVars['rodX'] = rodX;
      }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gte(world.observer.getGlobal("power-change"), 0)) {
        if (Prims.gte(PrimChecks.math.minus(world.observer.getGlobal("power"), world.observer.getGlobal("power-rated")), 0)) {
          world.observer.setGlobal("rod-length", PrimChecks.math.plus(world.observer.getGlobal("rod-length"), 50));
        }
      }
      else {
        if (Prims.lt(PrimChecks.math.minus(world.observer.getGlobal("power"), world.observer.getGlobal("power-rated")), 0)) {
          world.observer.setGlobal("rod-length", PrimChecks.math.minus(world.observer.getGlobal("rod-length"), 10));
        }
      }
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("average-power", PrimChecks.math.div_unchecked(PrimChecks.math.plus(PrimChecks.math.plus(PrimChecks.math.plus(PrimChecks.math.plus(world.observer.getGlobal("power"), world.observer.getGlobal("old-power")), world.observer.getGlobal("old-power-2")), world.observer.getGlobal("old-power-3")), world.observer.getGlobal("old-power-4")), 5));
      world.observer.setGlobal("power-change", PrimChecks.math.minus(world.observer.getGlobal("power"), world.observer.getGlobal("old-power")));
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(1, "").ask(function() {
        ...
        SelfManager.self().setVariable("xcor", PrimChecks.math.minus(PrimChecks.math.random_unchecked(PrimChecks.math.minus(world.observer.getGlobal("reactor-size"), 2)), world.observer.getGlobal("r")));
        SelfManager.self().setVariable("ycor", PrimChecks.math.minus(PrimChecks.math.random_unchecked(PrimChecks.math.minus(world.observer.getGlobal("reactor-size"), 2)), world.observer.getGlobal("r")));
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.patches(), function() { return SelfManager.self().getPatchVariable("rod?"); })).ask(function() {
        if (Prims.gte(SelfManager.self().getPatchVariable("pycor"), PrimChecks.math.minus(world.observer.getGlobal("r"), world.observer.getGlobal("rod-length")))) {
          SelfManager.self().setPatchVariable("pcolor", 5);
        }
        else {
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 15)) {
        ...
        let gain = PrimChecks.math.div_unchecked(1, PrimChecks.agentset.count_unchecked(SelfManager.self().turtlesHere())); letVars['gain'] = gain;
        world.observer.setGlobal("power", PrimChecks.math.plus(world.observer.getGlobal("power"), gain));
        SelfManager.self().hatch(PrimChecks.math.mult(PrimChecks.math.plus_unchecked(2, RandomPrims.randomLong(2)), gain), "").ask(function() { SelfManager.self().right(RandomPrims.randomLong(360)); }, true);
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
