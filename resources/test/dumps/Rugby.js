...
var procedures = (function() {
  ...
  var setupField = function() {
    ...
    world.observer.getGlobal("try-line").ask(function() { SelfPrims.setPatchVariable("pcolor", 45); }, true);
  ...
  var checkPatch = function(thePatch) {
    if (Prims.equality(thePatch.projectionBy(function() { return SelfPrims.getPatchVariable("pcolor"); }), 15)) {
      SelfPrims.die();
    }
    if (Prims.equality(thePatch.projectionBy(function() { return SelfPrims.getPatchVariable("pcolor"); }), 55)) {
      SelfPrims.getVariable("start-patch").ask(function() { SelfPrims.setPatchVariable("score", (SelfPrims.getPatchVariable("score") + 1)); }, true);
      SelfPrims.die();
    }
  };
  ...
  var findAnalyticSolution = function() {
    ...
    world.observer.setGlobal("analytic", winningPatch.projectionBy(function() { return SelfPrims.getPatchVariable("pycor"); }));
  };
