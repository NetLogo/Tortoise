...
function nextPatch() {
  if (Prims.lt(AgentSet.getTurtleVariable('heading'), AgentSet.self().towardsXY((AgentSet.getPatchVariable(0) + 0.5), (AgentSet.getPatchVariable(1) + 0.5)))) {
