...
function setup() {
  ...
  Call(setupField);
  Call(setupBalls);
  Globals.setGlobal(4, 0);
  Globals.setGlobal(7, -1);
...
function setupField() {
  AgentSet.ask(world.patches(), true, function() {
    ...
    if (((Prims.equality(AgentSet.getPatchVariable(1), world.minPycor) && Prims.gte(AgentSet.getPatchVariable(0), Globals.getGlobal(2))) && Prims.lt(AgentSet.getPatchVariable(0), (Globals.getGlobal(2) + Globals.getGlobal(1))))) {
      AgentSet.setPatchVariable(2, 55);
    }
  });
  Globals.setGlobal(9, AgentSet.agentFilter(world.patches(), function() {
    return (Prims.equality(AgentSet.getPatchVariable(0), Globals.getGlobal(0)) && Prims.equality(AgentSet.getPatchVariable(2), 0));
  }));
  AgentSet.ask(Globals.getGlobal(9), true, function() {
    AgentSet.setPatchVariable(2, 45);
  });
  Globals.setGlobal(10, AgentSet.agentFilter(world.patches(), function() {
    return (Prims.lt(AgentSet.getPatchVariable(0), Globals.getGlobal(0)) && Prims.equality(AgentSet.getPatchVariable(2), 0));
  }));
}
function setupBalls() {
...
function plotScores() {
  Globals.setGlobal(4, Prims.max(AgentSet.of(Globals.getGlobal(9), function() {
    return AgentSet.getPatchVariable(5);
  })));
  if (Prims.equality(Globals.getGlobal(4), 0)) {
  ...
  AgentSet.ask(Globals.getGlobal(9), true, function() {
    if (Prims.equality(AgentSet.getPatchVariable(5), Globals.getGlobal(4))) {
      Globals.setGlobal(7, AgentSet.getPatchVariable(1));
  ...
  AgentSet.ask(Globals.getGlobal(10), true, function() {
    if (Prims.gt(AgentSet.getPatchVariable(0), (Globals.getGlobal(0) - ((AgentSet.of(AgentSet.self().patchAt((Globals.getGlobal(0) - AgentSet.getPatchVariable(0)), 0), function() {
      return AgentSet.getPatchVariable(5);
    }) * (Globals.getGlobal(0) - world.minPxcor)) / Globals.getGlobal(4))))) {
      if (Prims.equality(AgentSet.of(AgentSet.self().patchAt((Globals.getGlobal(0) - AgentSet.getPatchVariable(0)), 0), function() {
        return AgentSet.getPatchVariable(5);
      }), Globals.getGlobal(4))) {
        AgentSet.setPatchVariable(2, 45);
      }
...
function findAnalyticSolution() {
  ...
  var winningPatch = AgentSet.minOneOf(Globals.getGlobal(9), function() {
  ...
  Globals.setGlobal(8, AgentSet.of(winningPatch, function() {
    return AgentSet.getPatchVariable(1);
  }));
}
function drawLevelCurves() {
  AgentSet.ask(AgentSet.agentFilter(world.patches(), function() {
    return (Prims.gt(AgentSet.getPatchVariable(0), Globals.getGlobal(0)) && Prims.lt(AgentSet.getPatchVariable(2), 10));
  }), true, function() {
...
function calcGoalAngle() {
  AgentSet.setPatchVariable(6, AgentSet.self().towardsXY((Globals.getGlobal(2) - 0.5), (world.minPycor + 0.5)));
  AgentSet.setPatchVariable(7, AgentSet.self().towardsXY(((Globals.getGlobal(2) + Globals.getGlobal(1)) - 0.5), (world.minPycor + 0.5)));
  AgentSet.setPatchVariable(8, Prims.mod((AgentSet.getPatchVariable(7) - AgentSet.getPatchVariable(6)), 360));
}
Globals.setGlobal(0, 20);
Globals.setGlobal(1, 11);
Globals.setGlobal(2, 40);
Globals.setGlobal(3, false);
