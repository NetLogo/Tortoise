...
modelConfig.plots = [];
var workspace = tortoise_require('engine/workspace')(modelConfig)([])([], [])(tortoise_require("extensions/all").dumpers())(["population", "sniff-threshold", "sniff-angle", "wiggle-angle", "wiggle-bias"], ["population", "sniff-threshold", "sniff-angle", "wiggle-angle", "wiggle-bias"], ["chemical"], -40, 40, -40, 40, 5.0, true, true, turtleShapes, linkShapes, function(){});
