...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let ahead = SelfManager.self().patchAhead(1).projectionBy(function() { return SelfManager.self().getPatchVariable("chemical"); }); letVars['ahead'] = ahead;
      let myright = SelfManager.self().patchRightAndAhead(world.observer.getGlobal("sniff-angle"), 1).projectionBy(function() { return SelfManager.self().getPatchVariable("chemical"); }); letVars['myright'] = myright;
      let myleft = SelfManager.self().patchLeftAndAhead(world.observer.getGlobal("sniff-angle"), 1).projectionBy(function() { return SelfManager.self().getPatchVariable("chemical"); }); letVars['myleft'] = myleft;
