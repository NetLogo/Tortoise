...
plotManager.lowerPen();
plotManager.plotPoint(world.ticker.tickCount(), total);; }); }); };
  return new Plot(name, pens, plotOps, 0.0, 300.0, 0.0, 10.0, setup, update);
})(), (function() {
  ...
  return new Plot(name, pens, plotOps, 0.0, 10.0, 0.0, 1.0, setup, update);
})(), (function() {
