  ...
  var update  = function() {
    workspace.rng.withAux(function() {
      plotManager.withTemporaryContext('Link counts', undefined)(function() {
        ...
        total = (total + world.links().agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 15); }).size());
        plotManager.lowerPen();
        plotManager.plotPoint(world.ticker.tickCount(), total);
        plotManager.setCurrentPen("incumbent-incumbent");
        plotManager.raisePen();
        plotManager.plotPoint(world.ticker.tickCount(), total);
        total = (total + world.links().agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 45); }).size());
        plotManager.lowerPen();
        plotManager.plotPoint(world.ticker.tickCount(), total);
        plotManager.setCurrentPen("newcomer-incumbent");
        plotManager.raisePen();
        plotManager.plotPoint(world.ticker.tickCount(), total);
        total = (total + world.links().agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 55); }).size());
        plotManager.lowerPen();
        plotManager.plotPoint(world.ticker.tickCount(), total);
        plotManager.setCurrentPen("newcomer-newcomer");
        plotManager.raisePen();
        plotManager.plotPoint(world.ticker.tickCount(), total);
        total = (total + world.links().agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 105); }).size());
        plotManager.lowerPen();
        plotManager.plotPoint(world.ticker.tickCount(), total);;
      });
    });
...
var procedures = (function() {
  ...
  var go = function() {
    ...
    world.links().ask(function() { SelfPrims.setVariable("new-collaboration?", false); }, true);
    ...
    for (var _index_2105_2111 = 0, _repeatcount_2105_2111 = StrictMath.floor(world.observer.getGlobal("team-size")); _index_2105_2111 < _repeatcount_2105_2111; _index_2105_2111++){
      if (Prims.gte(Prims.randomFloat(100), world.observer.getGlobal("p"))) {
        ...
        if ((Prims.lt(Prims.randomFloat(100), world.observer.getGlobal("q")) && world.turtles().agentFilter(function() {
          return (SelfPrims.getVariable("in-team?") && LinkPrims.linkNeighbors("LINKS").agentFilter(function() { return !SelfPrims.getVariable("in-team?"); }).nonEmpty());
        }).nonEmpty())) {
          ...
          newTeamMember = ListPrims.oneOf(world.turtles().agentFilter(function() { return !SelfPrims.getVariable("in-team?"); }));
        }
      }
  ...
  var tieCollaborators = function() {
    world.turtles().agentFilter(function() { return SelfPrims.getVariable("in-team?"); }).ask(function() {
      LinkPrims.createLinksWith(SelfPrims.other(world.turtles().agentFilter(function() { return SelfPrims.getVariable("in-team?"); })), "LINKS").ask(function() {
  ...
  var colorCollaborations = function() {
    world.links().agentFilter(function() {
      return (SelfPrims.getVariable("end1").projectionBy(function() { return SelfPrims.getVariable("in-team?"); }) && SelfPrims.getVariable("end2").projectionBy(function() { return SelfPrims.getVariable("in-team?"); }));
    }).ask(function() {
      if (SelfPrims.getVariable("new-collaboration?")) {
        if ((SelfPrims.getVariable("end1").projectionBy(function() { return SelfPrims.getVariable("incumbent?"); }) && SelfPrims.getVariable("end2").projectionBy(function() { return SelfPrims.getVariable("incumbent?"); }))) {
  ...
  var findAllComponents = function() {
    ...
    world.turtles().ask(function() { SelfPrims.setVariable("explored?", false); }, true);
    while (true) {
      var start = ListPrims.oneOf(world.turtles().agentFilter(function() { return !SelfPrims.getVariable("explored?"); }));
      if (Prims.equality(start, Nobody)) {
        throw new Exception.StopInterrupt;
      }
      world.observer.setGlobal("component-size", 0);
      start.ask(function() { Call(procedures.explore); }, true);
  ...
  var explore = function() {
    ...
    LinkPrims.linkNeighbors("LINKS").ask(function() { Call(procedures.explore); }, true);
  };
  return {
