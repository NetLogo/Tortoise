...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('newcomer-newcomer', plotOps.makePenOps, false, new PenBundle.State(105.0, 1.0, PenBundle.DisplayMode.Line), function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Link counts', 'newcomer-newcomer')(function() {}); }); }, function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Link counts', 'newcomer-newcomer')(function() {}); }); }),
new PenBundle.Pen('newcomer-incumbent', plotOps.makePenOps, false, new PenBundle.State(55.0, 1.0, PenBundle.DisplayMode.Line), function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Link counts', 'newcomer-incumbent')(function() {}); }); }, function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Link counts', 'newcomer-incumbent')(function() {}); }); }),
new PenBundle.Pen('incumbent-incumbent', plotOps.makePenOps, false, new PenBundle.State(45.0, 1.0, PenBundle.DisplayMode.Line), function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Link counts', 'incumbent-incumbent')(function() {}); }); }, function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Link counts', 'incumbent-incumbent')(function() {}); }); }),
new PenBundle.Pen('previous collaborators', plotOps.makePenOps, false, new PenBundle.State(15.0, 1.0, PenBundle.DisplayMode.Line), function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Link counts', 'previous collaborators')(function() {}); }); }, function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Link counts', 'previous collaborators')(function() {}); }); })];
  var setup   = function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Link counts', undefined)(function() {}); }); };
  var update  = function() { workspace.rng.withAux(function() { plotManager.withTemporaryContext('Link counts', undefined)(function() { var total = 0;
...
function setup() {
  ...
  var _index_1053_1059, _repeatcount_1053_1059;
  for (_index_1053_1059 = 0, _repeatcount_1053_1059 = Math.floor(world.observer.getGlobal('team-size')); _index_1053_1059 < _repeatcount_1053_1059; _index_1053_1059++){
    Call(makeNewcomer);
  }
...
function pickTeamMembers() {
  ...
  var _index_2105_2111, _repeatcount_2105_2111;
  for (_index_2105_2111 = 0, _repeatcount_2105_2111 = Math.floor(world.observer.getGlobal('team-size')); _index_2105_2111 < _repeatcount_2105_2111; _index_2105_2111++){
...
function layout() {
  var _index_4155_4161, _repeatcount_4155_4161;
  for (_index_4155_4161 = 0, _repeatcount_4155_4161 = Math.floor(12); _index_4155_4161 < _repeatcount_4155_4161; _index_4155_4161++){
