...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() { SelfManager.self().setPatchVariable("live-neighbors", 0); }, true);
      world.ticker.reset();
    } catch (e) {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().sprout(1, "BABIES").ask(function() { SelfManager.self().setVariable("color", PrimChecks.math.plus_unchecked(65, 1)); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.turtleManager.turtlesOfBreed("CELLS"), function() { return Prims.equality(SelfManager.self().getVariable("color"), 5); })).ask(function() { SelfManager.self().die(); }, true);
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("BABIES")).ask(function() {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("CELLS")).ask(function() {
        Errors.askNobodyCheck(SelfManager.self().getNeighbors()).ask(function() {
          SelfManager.self().setPatchVariable("live-neighbors", PrimChecks.math.plus(SelfManager.self().getPatchVariable("live-neighbors"), 1));
        }, true);
      }, true);
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("CELLS")).ask(function() {
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() {
        if ((PrimChecks.math.not_unchecked(PrimChecks.agentset.any_unchecked(SelfManager.self().breedHere("CELLS"))) && Prims.equality(SelfManager.self().getPatchVariable("live-neighbors"), 3))) {
          procedures["BIRTH"]();
        }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let erasing_p = PrimChecks.agentset.any_unchecked(PrimChecks.agentset.breedOn("CELLS", world.getPatchAt(MousePrims.getX(), MousePrims.getY()))); letVars['erasing_p'] = erasing_p;
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (PrimChecks.math.not_unchecked(PrimChecks.agentset.any_unchecked(SelfManager.self().breedHere("CELLS")))) {
        Errors.askNobodyCheck(SelfManager.self().turtlesHere()).ask(function() { SelfManager.self().die(); }, true);
        SelfManager.self().sprout(1, "CELLS").ask(function() { SelfManager.self().setVariable("color", 9.9); }, true);
        procedures["UPDATE"]();
        Errors.askNobodyCheck(SelfManager.self().getNeighbors()).ask(function() { procedures["UPDATE"](); }, true);
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      let n = PrimChecks.agentset.count_unchecked(PrimChecks.agentset.breedOn_unchecked("CELLS", SelfManager.self().getNeighbors())); letVars['n'] = n;
      if (PrimChecks.agentset.any_unchecked(SelfManager.self().breedHere("CELLS"))) {
        if ((Prims.equality(n, 2) || Prims.equality(n, 3))) {
          ...
          Errors.askNobodyCheck(SelfManager.self().breedHere("CELLS")).ask(function() { SelfManager.self().setVariable("color", 5); }, true);
        }
      }
      else {
