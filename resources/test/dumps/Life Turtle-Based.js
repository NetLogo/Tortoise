...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().sprout(1, "BABIES").ask(function() { SelfManager.self().setVariable("color", PrimChecks.math.plus(65, 1)); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("CELLS"), function() { return Prims.equality(SelfManager.self().getVariable("color"), 5); })).ask(function() { SelfManager.self().die(); }, true);
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let erasing_p = PrimChecks.agentset.any(PrimChecks.agentset.breedOn("CELLS", PrimChecks.validator.checkArg('CELLS-ON', 816, world.getPatchAt(MousePrims.getX(), MousePrims.getY())))); letVars['erasing_p'] = erasing_p;
