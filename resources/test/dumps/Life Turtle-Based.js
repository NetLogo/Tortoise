...
modelConfig.plots = [];
var workspace = tortoise_require('engine/workspace')(modelConfig)([{ name: "CELLS", singular: "cell", varNames: [] }, { name: "BABIES", singular: "baby", varNames: [] }])([], [])(["initial-density"], ["initial-density"], ["live-neighbors"], -35, 35, -35, 35, 7.0, true, true, turtleShapes, linkShapes, function(){});
...
var procedures = (function() {
  ...
  var go = function() {
    world.turtleManager.turtlesOfBreed("CELLS").agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 5); }).ask(function() { SelfPrims.die(); }, true);
    ...
    world.turtleManager.turtlesOfBreed("CELLS").ask(function() {
      SelfPrims.getNeighbors().ask(function() { SelfPrims.setPatchVariable("live-neighbors", (SelfPrims.getPatchVariable("live-neighbors") + 1)); }, true);
    }, true);
    world.turtleManager.turtlesOfBreed("CELLS").ask(function() {
  ...
  var update = function() {
    ...
    if (SelfManager.self().breedHere("CELLS").nonEmpty()) {
      if ((Prims.equality(n, 2) || Prims.equality(n, 3))) {
        SelfManager.self().breedHere("CELLS").ask(function() { SelfPrims.setVariable("color", 9.9); }, true);
      }
      else {
        SelfManager.self().breedHere("CELLS").ask(function() { SelfPrims.setVariable("color", 5); }, true);
      }
    }
    else {
      if (Prims.equality(n, 3)) {
        SelfPrims.sprout(1, "BABIES").ask(function() { SelfPrims.setVariable("color", (65 + 1)); }, true);
      }
    }
    SelfPrims.setPatchVariable("live-neighbors", 0);
  };
