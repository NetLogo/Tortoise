...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("CELLS").agentFilter(function() { return Prims.equality(SelfManager.self().getVariable("color"), 5); })).ask(function() { SelfManager.self().die(); }, true);
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let erasing_p = !Prims.breedOn("CELLS", world.getPatchAt(MousePrims.getX(), MousePrims.getY())).isEmpty(); letVars['erasing_p'] = erasing_p;
  ...
  temp = (function() {
    try {
      ...
      let n = Prims.breedOn("CELLS", SelfManager.self().getNeighbors()).size(); letVars['n'] = n;
      if (!SelfManager.self().breedHere("CELLS").isEmpty()) {
