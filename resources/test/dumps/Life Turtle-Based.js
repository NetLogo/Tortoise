...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() {
        if ((!PrimChecks.agentset.any_unchecked(SelfManager.self().breedHere("CELLS")) && Prims.equality(SelfManager.self().getPatchVariable("live-neighbors"), 3))) {
          procedures["BIRTH"]();
        }
