...
modelConfig.plots = [];
var workspace = tortoise_require('engine/workspace')(modelConfig)([{ name: "CELLS", singular: "cell", varNames: [] }, { name: "BABIES", singular: "baby", varNames: [] }])([], [])(tortoise_require("extensions/all").dumpers())(["initial-density"], ["initial-density"], ["live-neighbors"], -35, 35, -35, 35, 7.0, true, true, turtleShapes, linkShapes, function(){});
