      ...
      return plotManager.withTemporaryContext('populations', 'grass / 4')(function() {
        try {
          ...
          if (Prims.equality(world.observer.getGlobal("model-version"), "sheep-wolves-grass")) {
            plotManager.plotValue(PrimChecks.math.div(PrimChecks.agentset.count(procedures["GRASS"]()), 4));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      if ((!PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("WOLVES")) && Prims.gt(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("SHEEP")), world.observer.getGlobal("max-sheep")))) {
