...
BreedManager.get("WOLVES").vars =[""];function setup() {
  ...
  AgentSet.ask(world.createTurtles(world.observer.getGlobal('initial-number-sheep'), "SHEEP"), true, function() {
    ...
    AgentSet.setTurtleVariable(13, Prims.random((2 * world.observer.getGlobal('sheep-gain-from-food'))));
  ...
  AgentSet.ask(world.createTurtles(world.observer.getGlobal('initial-number-wolves'), "WOLVES"), true, function() {
    ...
    AgentSet.setTurtleVariable(13, Prims.random((2 * world.observer.getGlobal('wolf-gain-from-food'))));
    Prims.setXY(Prims.randomXcor(), Prims.randomYcor());
  });
  Call(displayLabels);
...
function eatGrass() {
  if (Prims.equality(AgentSet.getPatchVariable(2), 55)) {
    ...
    AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) + world.observer.getGlobal('sheep-gain-from-food')));
  }
}
...
function catchSheep() {
  ...
  if (!Prims.equality(prey, Nobody)) {
    ...
    AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) + world.observer.getGlobal('wolf-gain-from-food')));
  }
}
function death() {
