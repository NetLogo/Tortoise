    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('populations', 'sheep')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("SHEEP")));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('populations', 'wolves')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("WOLVES")));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
      ...
      return plotManager.withTemporaryContext('populations', 'grass / 4')(function() {
        try {
          ...
          if (Prims.equality(world.observer.getGlobal("model-version"), "sheep-wolves-grass")) {
            plotManager.plotValue(PrimChecks.math.div_unchecked(PrimChecks.agentset.count(procedures["GRASS"]()), 4));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
...
var procedures = (function() {
    ...
    try {
      ...
      if (Prims.equality(world.observer.getGlobal("model-version"), "sheep-wolves-grass")) {
        Errors.askNobodyCheck(world.patches()).ask(function() {
          SelfManager.self().setPatchVariable("pcolor", PrimChecks.list.oneOf_unchecked([55, 35]));
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-number-sheep"), "SHEEP").ask(function() {
        ...
        SelfManager.self().setVariable("label-color", PrimChecks.math.minus_unchecked(105, 2));
        SelfManager.self().setVariable("energy", PrimChecks.math.random_unchecked(PrimChecks.math.mult(2, world.observer.getGlobal("sheep-gain-from-food"))));
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-number-wolves"), "WOLVES").ask(function() {
        ...
        SelfManager.self().setVariable("energy", PrimChecks.math.random_unchecked(PrimChecks.math.mult(2, world.observer.getGlobal("wolf-gain-from-food"))));
        SelfManager.self().setXY(RandomPrims.randomFloatInRange(world.topology.minPxcor, world.topology.maxPxcor), RandomPrims.randomFloatInRange(world.topology.minPycor, world.topology.maxPycor));
      }, true);
  ...
  temp = (function() {
    try {
      ...
      if ((PrimChecks.math.not_unchecked(PrimChecks.agentset.any_unchecked(world.turtleManager.turtlesOfBreed("WOLVES"))) && Prims.gt(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("SHEEP")), world.observer.getGlobal("max-sheep")))) {
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 55)) {
        ...
        SelfManager.self().setVariable("energy", PrimChecks.math.plus(SelfManager.self().getVariable("energy"), world.observer.getGlobal("sheep-gain-from-food")));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("sheep-reproduce"))) {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("wolf-reproduce"))) {
        SelfManager.self().setVariable("energy", PrimChecks.math.div(SelfManager.self().getVariable("energy"), 2));
        SelfManager.self().hatch(1, "").ask(function() {
          SelfManager.self().right(PrimChecks.math.randomFloat_unchecked(360));
          SelfManager.self()._optimalFdOne();
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let prey = PrimChecks.list.oneOf_unchecked(SelfManager.self().breedHere("SHEEP")); letVars['prey'] = prey;
      if (!Prims.equality(prey, Nobody)) {
        Errors.askNobodyCheck(prey).ask(function() { SelfManager.self().die(); }, true);
        SelfManager.self().setVariable("energy", PrimChecks.math.plus(SelfManager.self().getVariable("energy"), world.observer.getGlobal("wolf-gain-from-food")));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
    ...
    try {
      ...
      if (Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 35)) {
        if (Prims.lte(SelfManager.self().getPatchVariable("countdown"), 0)) {
          ...
          SelfManager.self().setPatchVariable("countdown", PrimChecks.math.minus(SelfManager.self().getPatchVariable("countdown"), 1));
        }
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(world.observer.getGlobal("model-version"), "sheep-wolves-grass")) {
        ...
        return PrimChecks.agentset.with_unchecked(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 55); });
      }
      else {
        Errors.reportInContextCheck(reporterContext);
        return 0;
