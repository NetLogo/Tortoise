    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('populations', 'sheep')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("SHEEP")));
        } catch (e) {
      ...
      return plotManager.withTemporaryContext('populations', 'grass / 4')(function() {
        try {
          ...
          if (Prims.equality(world.observer.getGlobal("model-version"), "sheep-wolves-grass")) {
            plotManager.plotValue(PrimChecks.math.div(PrimChecks.agentset.count(PrimChecks.validator.checkArg('COUNT', 112, procedures["GRASS"]())), 4));
          }
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(world.observer.getGlobal("model-version"), "sheep-wolves-grass")) {
        Errors.askNobodyCheck(world.patches()).ask(function() {
          ...
          if (Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 55)) {
            ...
            SelfManager.self().setPatchVariable("countdown", PrimChecks.math.random(PrimChecks.validator.checkArg('RANDOM', 1, world.observer.getGlobal("grass-regrowth-time"))));
          }
        }, true);
      }
      else {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-number-sheep"), "SHEEP").ask(function() {
        ...
        SelfManager.self().setVariable("label-color", PrimChecks.math.minus(105, 2));
        SelfManager.self().setVariable("energy", PrimChecks.math.random(PrimChecks.math.mult(2, PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("sheep-gain-from-food")))));
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-number-wolves"), "WOLVES").ask(function() {
        ...
        SelfManager.self().setVariable("energy", PrimChecks.math.random(PrimChecks.math.mult(2, PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("wolf-gain-from-food")))));
        SelfManager.self().setXY(RandomPrims.randomFloatInRange(world.topology.minPxcor, world.topology.maxPxcor), RandomPrims.randomFloatInRange(world.topology.minPycor, world.topology.maxPycor));
      }, true);
  ...
  temp = (function() {
    try {
      ...
      if ((PrimChecks.math.not(PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("WOLVES"))) && Prims.gt(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("SHEEP")), world.observer.getGlobal("max-sheep")))) {
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 55)) {
        ...
        SelfManager.self().setVariable("energy", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("energy")), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("sheep-gain-from-food"))));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (!Prims.equality(prey, Nobody)) {
        ...
        SelfManager.self().setVariable("energy", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("energy")), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("wolf-gain-from-food"))));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(world.observer.getGlobal("model-version"), "sheep-wolves-grass")) {
        ...
        return PrimChecks.agentset.with(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 55); });
      }
      else {
        Errors.reportInContextCheck(reporterContext);
        return 0;
