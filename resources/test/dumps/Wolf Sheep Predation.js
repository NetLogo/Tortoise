...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      if ((!PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("WOLVES")) && Prims.gt(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("SHEEP")), world.observer.getGlobal("max-sheep")))) {
