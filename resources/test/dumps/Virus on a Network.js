    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'susceptible')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue((PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'infected')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), PrimChecks.agentset.count_unchecked(world.turtles())) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'resistant')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("resistant?"); }), PrimChecks.agentset.count_unchecked(world.turtles())) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    try {
      ...
      while (Prims.lt(PrimChecks.agentset.count_unchecked(world.links()), numLinks)) {
        Errors.askNobodyCheck(PrimChecks.list.oneOf(world.turtles())).ask(function() {
          let choice = PrimChecks.agentset.minOneOf_unchecked(PrimChecks.agentset.otherWith(world.turtles(), function() { return !LinkPrims.isLinkNeighbor("LINKS", SelfManager.myself()); }), function() { return SelfManager.self().distance(SelfManager.myself()); }); letVars['choice'] = choice;
      ...
      for (let _index_1097_1103 = 0, _repeatcount_1097_1103 = StrictMath.floor(10); _index_1097_1103 < _repeatcount_1097_1103; _index_1097_1103++){
        LayoutManager.layoutSpring(world.turtles(), world.links(), 0.3, PrimChecks.math.div(world.topology.width, PrimChecks.math.sqrt(world.observer.getGlobal("number-of-nodes"))), 1);
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); })).ask(function() {
        Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(LinkPrims.linkNeighbors("LINKS"), function() { return !SelfManager.self().getVariable("resistant?"); })).ask(function() {
