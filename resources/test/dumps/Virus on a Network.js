    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'susceptible')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue((Prims.div(world.turtles()._optimalCountWith(function() {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'infected')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((Prims.div(world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("infected?"); }), world.turtles().size()) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'resistant')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((Prims.div(world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("resistant?"); }), world.turtles().size()) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
