    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'susceptible')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult_unchecked(PrimChecks.math.div_unchecked(PrimChecks.agentset.countWith(world.turtles(), function() {
            return (PrimChecks.math.not(SelfManager.self().getVariable("infected?")) && PrimChecks.math.not(SelfManager.self().getVariable("resistant?")));
          }), PrimChecks.agentset.count_unchecked(world.turtles())), 100));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'infected')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult_unchecked(PrimChecks.math.div_unchecked(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), PrimChecks.agentset.count_unchecked(world.turtles())), 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'resistant')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult_unchecked(PrimChecks.math.div_unchecked(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("resistant?"); }), PrimChecks.agentset.count_unchecked(world.turtles())), 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("number-of-nodes"), "").ask(function() {
        SelfManager.self().setXY(PrimChecks.math.mult_unchecked(RandomPrims.randomFloatInRange(world.topology.minPxcor, world.topology.maxPxcor), 0.95), PrimChecks.math.mult_unchecked(RandomPrims.randomFloatInRange(world.topology.minPycor, world.topology.maxPycor), 0.95));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let numLinks = PrimChecks.math.div_unchecked(PrimChecks.math.mult(world.observer.getGlobal("average-node-degree"), world.observer.getGlobal("number-of-nodes")), 2); letVars['numLinks'] = numLinks;
      while (Prims.lt(PrimChecks.agentset.count_unchecked(world.links()), numLinks)) {
        Errors.askNobodyCheck(PrimChecks.list.oneOf_unchecked(world.turtles())).ask(function() {
          let choice = PrimChecks.agentset.minOneOf_unchecked(PrimChecks.agentset.otherWith(world.turtles(), function() { return PrimChecks.math.not_unchecked(LinkPrims.isLinkNeighbor("LINKS", SelfManager.myself())); }), function() { return SelfManager.self().distance(SelfManager.myself()); }); letVars['choice'] = choice;
      ...
      for (let _index_1097_1103 = 0, _repeatcount_1097_1103 = StrictMath.floor(10); _index_1097_1103 < _repeatcount_1097_1103; _index_1097_1103++){
        LayoutManager.layoutSpring(world.turtles(), world.links(), 0.3, PrimChecks.math.div_unchecked(world.topology.width, PrimChecks.math.sqrt(world.observer.getGlobal("number-of-nodes"))), 1);
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        SelfManager.self().setVariable("virus-check-timer", PrimChecks.math.plus(SelfManager.self().getVariable("virus-check-timer"), 1));
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(LinkPrims.myLinks("LINKS")).ask(function() { SelfManager.self().setVariable("color", PrimChecks.math.minus_unchecked(5, 2)); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); })).ask(function() {
        Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(LinkPrims.linkNeighbors("LINKS"), function() { return PrimChecks.math.not(SelfManager.self().getVariable("resistant?")); })).ask(function() {
          if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("virus-spread-chance"))) {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.turtles(), function() {
        return PrimChecks.math.bool('AND', SelfManager.self().getVariable("infected?")) && PrimChecks.math.bool('AND', Prims.equality(SelfManager.self().getVariable("virus-check-timer"), 0));
      })).ask(function() {
