...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('susceptible', plotOps.makePenOps, false, new PenBundle.State(105, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'susceptible')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() {
            return (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("infected?"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("resistant?"))));
  ...
  new PenBundle.Pen('infected', plotOps.makePenOps, false, new PenBundle.State(15, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'infected')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), PrimChecks.agentset.count(world.turtles())), 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
  ...
  new PenBundle.Pen('resistant', plotOps.makePenOps, false, new PenBundle.State(5, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'resistant')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("resistant?"); }), PrimChecks.agentset.count(world.turtles())), 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.list.nOf(PrimChecks.validator.checkArg('N-OF', 1, world.observer.getGlobal("initial-outbreak-size")), world.turtles())).ask(function() { procedures["BECOME-INFECTED"](); }, true);
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("number-of-nodes"), "").ask(function() {
        SelfManager.self().setXY(PrimChecks.math.mult(RandomPrims.randomFloatInRange(world.topology.minPxcor, world.topology.maxPxcor), 0.95), PrimChecks.math.mult(RandomPrims.randomFloatInRange(world.topology.minPycor, world.topology.maxPycor), 0.95));
        procedures["BECOME-SUSCEPTIBLE"]();
        SelfManager.self().setVariable("virus-check-timer", PrimChecks.math.random(PrimChecks.validator.checkArg('RANDOM', 1, world.observer.getGlobal("virus-check-frequency"))));
      }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let numLinks = PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("average-node-degree")), PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("number-of-nodes"))), 2); letVars['numLinks'] = numLinks;
      while (Prims.lt(PrimChecks.agentset.count(world.links()), numLinks)) {
        Errors.askNobodyCheck(PrimChecks.list.oneOf(world.turtles())).ask(function() {
          let choice = PrimChecks.agentset.minOneOf(PrimChecks.agentset.otherWith(world.turtles(), function() { return PrimChecks.math.not(LinkPrims.isLinkNeighbor("LINKS", SelfManager.myself())); }), function() { return SelfManager.self().distance(SelfManager.myself()); }); letVars['choice'] = choice;
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        SelfManager.self().setVariable("virus-check-timer", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("virus-check-timer")), 1));
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(LinkPrims.myLinks("LINKS")).ask(function() { SelfManager.self().setVariable("color", PrimChecks.math.minus(5, 2)); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); })).ask(function() {
        Errors.askNobodyCheck(PrimChecks.agentset.with(LinkPrims.linkNeighbors("LINKS"), function() {
          return PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("resistant?")));
        })).ask(function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtles(), function() {
        return (PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("infected?")) && Prims.equality(SelfManager.self().getVariable("virus-check-timer"), 0));
      })).ask(function() {
        if (Prims.lt(RandomPrims.randomLong(100), world.observer.getGlobal("recovery-chance"))) {
          if (Prims.lt(RandomPrims.randomLong(100), world.observer.getGlobal("gain-resistance-chance"))) {
