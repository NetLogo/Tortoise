    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'infected')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), PrimChecks.agentset.count(world.turtles())) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Network Status', 'resistant')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("resistant?"); }), PrimChecks.agentset.count(world.turtles())) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    try {
      ...
      while (Prims.lt(PrimChecks.agentset.count(world.links()), numLinks)) {
        Errors.askNobodyCheck(PrimChecks.list.oneOf(world.turtles())).ask(function() {
          let choice = PrimChecks.agentset.minOneOf(PrimChecks.agentset.otherWith(world.turtles(), function() { return !LinkPrims.isLinkNeighbor("LINKS", SelfManager.myself()); }), function() { return SelfManager.self().distance(SelfManager.myself()); }); letVars['choice'] = choice;
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); })).ask(function() {
        Errors.askNobodyCheck(PrimChecks.agentset.with(LinkPrims.linkNeighbors("LINKS"), function() { return !SelfManager.self().getVariable("resistant?"); })).ask(function() {
