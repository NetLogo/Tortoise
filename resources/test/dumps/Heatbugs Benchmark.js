...
function setup() {
  ...
  AgentSet.ask(AgentSet.nOf(Globals.getGlobal(0), world.patches()), true, function() {
    AgentSet.ask(Prims.sprout(1, ""), true, function() {
      ...
      AgentSet.setTurtleVariable(13, (Globals.getGlobal(4) + Prims.random(StrictMath.abs((Globals.getGlobal(5) - Globals.getGlobal(4))))));
      AgentSet.setTurtleVariable(14, (Globals.getGlobal(7) + Prims.random(StrictMath.abs((Globals.getGlobal(6) - Globals.getGlobal(7))))));
...
function recolorPatches() {
  AgentSet.ask(world.patches(), true, function() {
    AgentSet.setPatchVariable(5, (AgentSet.getPatchVariable(5) * (1 - Globals.getGlobal(1))));
    AgentSet.setPatchVariable(2, Prims.scaleColor(15, AgentSet.getPatchVariable(5), 0, 500));
  });
}
function step() {
  AgentSet.setTurtleVariable(15, StrictMath.abs((AgentSet.getTurtleVariable(13) - AgentSet.getPatchVariable(5))));
  if (Prims.equality(AgentSet.getTurtleVariable(15), 0)) {
...
function bugMove(target) {
  var tries = 0;
  if (!(AgentSet.any(Prims.turtlesOn(target)))) {
...
Globals.setGlobal(1, 0.01);
Globals.setGlobal(2, 1);
Globals.setGlobal(3, 0);
Globals.setGlobal(4, 170);
Globals.setGlobal(5, 310);
Globals.setGlobal(6, 100);
