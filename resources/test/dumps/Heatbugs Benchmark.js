...
function setup() {
  ...
  AgentSet.ask(AgentSet.nOf(world.observer.getGlobal('bug-count'), world.patches()), true, function() {
    AgentSet.ask(Prims.sprout(1, ""), true, function() {
      ...
      AgentSet.setTurtleVariable(13, (world.observer.getGlobal('min-ideal-temp') + Prims.random(StrictMath.abs((world.observer.getGlobal('max-ideal-temp') - world.observer.getGlobal('min-ideal-temp'))))));
      AgentSet.setTurtleVariable(14, (world.observer.getGlobal('min-output-heat') + Prims.random(StrictMath.abs((world.observer.getGlobal('max-output-heat') - world.observer.getGlobal('min-output-heat'))))));
...
function go() {
  ...
  world.topology().diffuse(5, world.observer.getGlobal('diffusion-rate'));
...
function recolorPatches() {
  AgentSet.ask(world.patches(), true, function() {
    AgentSet.setPatchVariable(5, (AgentSet.getPatchVariable(5) * (1 - world.observer.getGlobal('evaporation-rate'))));
