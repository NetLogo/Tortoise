...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('flashing', plotOps.makePenOps, false, new PenBundle.State(15, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Flashing Fireflies', 'flashing')(function() {
        try {
  ...
  var setup   = function() {
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Flashing Fireflies', undefined)(function() {
        try {
          var reporterContext = false;
          var letVars = { };
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("number"), "").ask(function() {
        ...
        SelfManager.self().setVariable("clock", PrimChecks.math.random_unchecked(PrimChecks.math.round(world.observer.getGlobal("cycle-length"))));
        ...
        if (Prims.equality(world.observer.getGlobal("strategy"), "delay")) {
          ...
          SelfManager.self().setVariable("window", -1);
        }
        else {
          SelfManager.self().setVariable("reset-level", 0);
          SelfManager.self().setVariable("window", PrimChecks.math.plus(SelfManager.self().getVariable("threshold"), 1));
        }
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["RECOLOR"](); }, true);
      world.ticker.tick();
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().right(PrimChecks.math.minus_unchecked(PrimChecks.math.randomFloat_unchecked(90), PrimChecks.math.randomFloat_unchecked(90)));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().setVariable("clock", PrimChecks.math.plus(SelfManager.self().getVariable("clock"), 1));
