...
var procedures = (function() {
  ...
  var look = function() {
    if (Prims.gte(SelfManager.self().inRadius(world.turtles(), 1).agentFilter(function() { return Prims.equality(SelfPrims.getVariable("color"), 45); }).size(), world.observer.getGlobal("flashes-to-reset"))) {
