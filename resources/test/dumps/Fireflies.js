...
var workspace = tortoise_require('engine/workspace')(modelConfig)([])(["clock", "threshold", "reset-level", "window"], [])(tortoise_require("extensions/all").dumpers())(["number", "cycle-length", "flash-length", "flashes-to-reset", "show-dark-fireflies?", "strategy"], ["number", "cycle-length", "flash-length", "flashes-to-reset", "show-dark-fireflies?", "strategy"], [], -35, 35, -35, 35, 6.0, true, true, turtleShapes, linkShapes, function(){});
