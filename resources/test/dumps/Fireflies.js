...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.gte(SelfManager.self().inRadius(world.turtles(), 1)._optimalCountWith(function() { return Prims.equality(SelfManager.self().getVariable("color"), 45); }), world.observer.getGlobal("flashes-to-reset"))) {
