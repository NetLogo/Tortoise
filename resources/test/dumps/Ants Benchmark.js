...
function setupTurtles() {
  return Procedures.stoppably(function() {
    Breeds.setDefaultShape(world.turtles(), "bug");
  ...
  return Procedures.stoppably(function() {
    if (AgentSet.getPatchVariable(7)) {
      ...
      if (Prims.gt(AgentSet.getPatchVariable(6), 0)) {
        ...
        if (Prims.equality(AgentSet.getPatchVariable(9), 2)) {
          AgentSet.setPatchVariable(2, 95);
        }
        if (Prims.equality(AgentSet.getPatchVariable(9), 3)) {
          AgentSet.setPatchVariable(2, 105);
        }
      }
      else {
        AgentSet.setPatchVariable(2, Prims.scaleColor(55, AgentSet.getPatchVariable(5), 0.1, 5));
      }
    }
  });
}
...
Procedures.stoppably(function() {Globals.setGlobal(0, 53);
Globals.setGlobal(1, 10);
Globals.setGlobal(2, true);
Globals.setGlobal(3, 300);})
