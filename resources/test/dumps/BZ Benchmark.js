...
modelConfig.plots = [];
var workspace = tortoise_require('engine/workspace')(modelConfig)([])([], [])(["n", "k1", "k2", "g", "result"], ["n", "k1", "k2", "g"], ["state", "new-state"], -150, 150, -150, 150, 1.0, true, true, turtleShapes, linkShapes, function(){});
