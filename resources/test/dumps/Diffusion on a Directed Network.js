    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Histogram', 'default')(function() {
        try {
          ...
          plotManager.setHistogramBarCount(PrimChecks.math.ceil(PrimChecks.math.sqrt(world.turtles().size())));
    ...
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        ...
        if (!recipients.isEmpty()) {
          ...
          let valIncrement = PrimChecks.math.div((SelfManager.self().getVariable("val") - valToKeep), recipients.size()); letVars['valIncrement'] = valIncrement;
