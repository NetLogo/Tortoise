    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Histogram', 'default')(function() {
        try {
          ...
          plotManager.setHistogramBarCount(NLMath.ceil(PrimChecks.math.sqrt(world.turtles().size())));
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.patches().agentFilter(function() {
        return (Prims.lt(NLMath.abs(SelfManager.self().getPatchVariable("pxcor")), PrimChecks.math.div(world.observer.getGlobal("grid-size"), 2)) && Prims.lt(NLMath.abs(SelfManager.self().getPatchVariable("pycor")), PrimChecks.math.div(world.observer.getGlobal("grid-size"), 2)));
      })).ask(function() {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        ...
        LinkPrims.createLinksTo(neighborNodes, "ACTIVE-LINKS").ask(function() {
          ...
          if (Prims.gt(RandomPrims.randomFloat(100), world.observer.getGlobal("link-chance"))) {
