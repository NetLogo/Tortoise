    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Histogram', 'default')(function() {
        try {
          ...
          plotManager.setHistogramBarCount(PrimChecks.math.ceil(PrimChecks.math.sqrt(PrimChecks.agentset.count(world.turtles()))));
          plotManager.drawHistogramFrom(PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("val"); }));
        } catch (e) {
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      world.observer.setGlobal("total-val", PrimChecks.list.sum(PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("val"); })));
      world.observer.setGlobal("max-val", PrimChecks.list.max(PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("val"); })));
      if (PrimChecks.agentset.any(world.linkManager.linksOfBreed("ACTIVE-LINKS"))) {
        world.observer.setGlobal("max-flow", PrimChecks.list.max(PrimChecks.agentset.of(world.linkManager.linksOfBreed("ACTIVE-LINKS"), function() { return SelfManager.self().getVariable("current-flow"); })));
        world.observer.setGlobal("mean-flow", PrimChecks.list.mean(PrimChecks.agentset.of(world.linkManager.linksOfBreed("ACTIVE-LINKS"), function() { return SelfManager.self().getVariable("current-flow"); })));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
