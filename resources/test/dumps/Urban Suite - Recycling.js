    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Population', 'recyclers')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("RECYCLERS")));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Population', 'wastefuls')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("WASTEFULS")));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Land Use', 'new')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "new"); }), PrimChecks.agentset.count(world.patches())), 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Land Use', 'recycled')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "recycled"); }), PrimChecks.agentset.count(world.patches())), 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Land Use', 'waste')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.agentset.countWith(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "waste"); }), PrimChecks.agentset.count(world.patches())), 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        ...
        SelfManager.self().setVariable("energy", PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("max-stored-energy")), 2));
      }, true);
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("RECYCLERS")).ask(function() { procedures["RECYCLER-PROCESS-PATCH"](); }, true);
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("WASTEFULS")).ask(function() { procedures["WASTEFUL-PROCESS-PATCH"](); }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        procedures["MOVE"]();
      ...
      if (world.observer.getGlobal("show-energy?")) {
        Errors.askNobodyCheck(world.turtles()).ask(function() {
          SelfManager.self().setVariable("label", PrimChecks.math.round(PrimChecks.validator.checkArg('ROUND', 1, SelfManager.self().getVariable("energy"))));
        }, true);
      }
      else {
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() { procedures["UPDATE-PATCH"](); }, true);
      world.ticker.tick();
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (world.observer.getGlobal("agents-seek-resources?")) {
        let candidateMoves = PrimChecks.agentset.with(SelfManager.self().getNeighbors(), function() { return Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "new"); }); letVars['candidateMoves'] = candidateMoves;
        if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, candidateMoves))) {
          targetPatch = PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, candidateMoves)); letVars['targetPatch'] = targetPatch;
        }
        else {
          candidateMoves = PrimChecks.agentset.with(SelfManager.self().getNeighbors(), function() { return Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "recycled"); }); letVars['candidateMoves'] = candidateMoves;
          if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, candidateMoves))) {
            targetPatch = PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, candidateMoves)); letVars['targetPatch'] = targetPatch;
          }
        }
      ...
      SelfManager.self().setVariable("energy", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("energy")), 1));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "new")) {
        if (Prims.lte(SelfManager.self().getVariable("energy"), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("max-stored-energy")), 2))) {
          SelfManager.self().setVariable("energy", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("energy")), 2));
        }
      }
      else {
        if (Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "recycled")) {
          if (Prims.lte(SelfManager.self().getVariable("energy"), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("max-stored-energy")), 1))) {
            SelfManager.self().setVariable("energy", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("energy")), 1));
          }
        }
        else {
          SelfManager.self().setVariable("energy", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("energy")), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("recycling-waste-cost"))));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      if (Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "new")) {
        if (Prims.lte(SelfManager.self().getVariable("energy"), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("max-stored-energy")), 4))) {
          SelfManager.self().setVariable("energy", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("energy")), 4));
    ...
    try {
      ...
      if (Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "new")) {
        ...
        if (Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "recycled")) {
          ...
          SelfManager.self().setPatchVariable("pcolor", PrimChecks.math.minus(45, 1));
        }
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "recycled"); })).ask(function() {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "waste"); })).ask(function() {
        if ((Prims.equality(RandomPrims.randomLong(5), 0) && Prims.lt(RandomPrims.randomLong(100), PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("resource-regeneration")), 10)))) {
          SelfManager.self().setPatchVariable("resource-type", "new");
        }
      }, true);
    } catch (e) {
