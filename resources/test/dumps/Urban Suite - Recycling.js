    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Land Use', 'new')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((Prims.div(world.patches()._optimalCountWith(function() { return Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "new"); }), world.patches().size()) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Land Use', 'recycled')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((Prims.div(world.patches()._optimalCountWith(function() { return Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "recycled"); }), world.patches().size()) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Land Use', 'waste')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((Prims.div(world.patches()._optimalCountWith(function() { return Prims.equality(SelfManager.self().getPatchVariable("resource-type"), "waste"); }), world.patches().size()) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
