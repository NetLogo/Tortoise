    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average', 'average')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotPoint(world.ticker.tickCount(), PrimChecks.math.div(world.observer.getGlobal("total"), PrimChecks.agentset.count(world.patches())));
        } catch (e) {
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("total", (2 * PrimChecks.agentset.count(world.patches())));
      world.ticker.reset();
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
