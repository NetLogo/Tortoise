...
modelConfig.plots = [];
var workspace = tortoise_require('engine/workspace')(modelConfig)([{ name: "PHOSPHATES", singular: "phosphate", varNames: [] }, { name: "NUCLEOSIDES", singular: "nucleoside", varNames: ["class", "value", "place"] }, { name: "NUCLEOTIDES", singular: "nucleotide", varNames: ["class", "value", "place", "unwound?", "unzipped-stage"] }, { name: "POLYMERASES", singular: "polymerase", varNames: ["locked-state"] }, { name: "HELICASES", singular: "helicase", varNames: [] }, { name: "TOPOISOMERASES", singular: "topoisomerase", varNames: ["locked?"] }, { name: "TOPOISOMERASES-GEARS", singular: "topoisomerase-gear", varNames: [] }, { name: "PRIMASES", singular: "primase", varNames: [] }, { name: "NUCLEOTIDE-TAGS", singular: "nucleotide-tag", varNames: ["value"] }, { name: "ENZYME-TAGS", singular: "enzyme-tag", varNames: [] }, { name: "MOUSE-CURSORS", singular: "mouse-cursor", varNames: [] }, { name: "CHROMOSOME-BUILDERS", singular: "initial-chromosomes-builder", varNames: [] }, { name: "OLD-STAIRS", singular: "old-stair", varNames: [], isDirected: false }, { name: "NEW-STAIRS", singular: "new-stair", varNames: [], isDirected: false }, { name: "TAGLINES", singular: "tagline", varNames: [], isDirected: false }, { name: "GEARLINES", singular: "gearline", varNames: [], isDirected: true }, { name: "CURSOR-DRAGS", singular: "cursor-drag", varNames: [], isDirected: true }, { name: "BACKBONES", singular: "backbone", varNames: [], isDirected: true }])([], [])(tortoise_require("extensions/all").dumpers())(["dna-strand-length", "nucleo-labels?", "enzyme-labels?", "substitutions?", "free-nucleosides", "time-limit", "initial-length-dna", "mouse-continuous-down?", "instruction", "cursor-detect-color", "cursor-drag-color", "wound-dna-color", "unwound-dna-color", "nucleo-tag-color", "enzyme-tag-color", "nucleoside-color", "polymerase-color-0", "polymerase-color-1", "polymerase-color-2", "polymerase-color-3", "helicase-color-0", "helicase-color-1", "topoisomerase-color-0", "topoisomerase-color-1", "primase-color-0", "primase-color-1", "final-time", "total-deletion-mutations-top-strand", "total-substitution-mutations-top-strand", "total-correct-duplications-top-strand", "total-deletion-mutations-bottom-strand", "total-substitution-mutations-bottom-strand", "total-correct-duplications-bottom-strand", "lock-radius", "mouse-drag-radius", "molecule-step", "wind-angle", "length-of-simulation", "time-remaining", "current-instruction", "using-time-limit", "simulation-started?", "cell-divided?", "simulation-ended?", "cell-message-shown?", "timer-message-shown?"], ["dna-strand-length", "nucleo-labels?", "enzyme-labels?", "substitutions?", "free-nucleosides", "time-limit"], [], 0, 16, -5, 4, 50.0, true, true, turtleShapes, linkShapes, function(){});
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = true;
      if(!reporterContext) { throw new Error("REPORT can only be used inside TO-REPORT.") } else { return (Prims.equality(world.observer.getGlobal("current-instruction"), 0) ? "press setup" : (workspace.dump('') + workspace.dump(world.observer.getGlobal("current-instruction")) + workspace.dump(" / ") + workspace.dump(ListPrims.length(procedures["INSTRUCTIONS"]())))) }
      throw new Error("Reached end of reporter procedure without REPORT being called.");
    } catch (e) {
     if (e instanceof Exception.StopInterrupt) {
        throw new Error("STOP is not allowed inside TO-REPORT.");
