...
ProcedurePrims.defineCommand("setup", 7160, 9219, (function() {
  world.clearAll();
  world.observer.setVariable("polymerase-color-0", [150, 150, 150, 150]);
  world.observer.setVariable("polymerase-color-1", [75, 200, 75, 200]);
  world.observer.setVariable("polymerase-color-2", [0, 255, 0, 220]);
  world.observer.setVariable("polymerase-color-3", [255, 0, 0, 220]);
  world.observer.setVariable("nucleo-tag-color", [255, 255, 255, 200]);
  world.observer.setVariable("enzyme-tag-color", [255, 255, 255, 200]);
  world.observer.setVariable("primase-color-0", [255, 255, 255, 150]);
  world.observer.setVariable("primase-color-1", [255, 255, 255, 200]);
  world.observer.setVariable("helicase-color-1", [255, 255, 210, 200]);
  world.observer.setVariable("helicase-color-0", [255, 255, 210, 150]);
  world.observer.setVariable("topoisomerase-color-0", [210, 255, 255, 150]);
  world.observer.setVariable("topoisomerase-color-1", [180, 255, 180, 220]);
  world.observer.setVariable("nucleoside-color", [255, 255, 255, 150]);
  world.observer.setVariable("wound-dna-color", [255, 255, 255, 150]);
  world.observer.setVariable("unwound-dna-color", [255, 255, 255, 255]);
  world.observer.setVariable("cursor-detect-color", [255, 255, 255, 150]);
  world.observer.setVariable("cursor-drag-color", [255, 255, 255, 200]);
  world.observer.setVariable("instruction", 0);
  world.observer.setVariable("wind-angle", 25);
  world.observer.setVariable("lock-radius", 0.3);
  world.observer.setVariable("mouse-drag-radius", 0.4);
  world.observer.setVariable("molecule-step", 0.025);
  world.observer.setVariable("final-time", 0);
  world.observer.setVariable("current-instruction", 0);
  world.observer.setVariable("total-deletion-mutations-top-strand", "N/A");
  world.observer.setVariable("total-substitution-mutations-top-strand", "N/A");
  world.observer.setVariable("total-correct-duplications-top-strand", "N/A");
  world.observer.setVariable("total-deletion-mutations-bottom-strand", "N/A");
  world.observer.setVariable("total-substitution-mutations-bottom-strand", "N/A");
  world.observer.setVariable("total-correct-duplications-bottom-strand", "N/A");
  ...
  world.observer.setVariable("simulation-started?", false);
  world.observer.setVariable("length-of-simulation", 0);
  world.observer.setVariable("using-time-limit", false);
  world.observer.setVariable("cell-divided?", false);
  world.observer.setVariable("simulation-ended?", false);
  world.observer.setVariable("cell-message-shown?", false);
  world.observer.setVariable("timer-message-shown?", false);
  world.observer.setVariable("initial-length-dna", world.observer.getGlobal("dna-strand-length"));
...
ProcedurePrims.defineCommand("initialize-length-of-time", 9227, 9567, (function() {
  world.observer.setVariable("using-time-limit", !Prims.equality(world.observer.getGlobal("time-limit"), "none"));
  if (Prims.equality(world.observer.getGlobal("time-limit"), "2 minutes")) {
    world.observer.setVariable("length-of-simulation", 120);
    world.observer.setVariable("time-remaining", 120);
  }
  if (Prims.equality(world.observer.getGlobal("time-limit"), "5 minutes")) {
    world.observer.setVariable("length-of-simulation", 300);
    world.observer.setVariable("time-remaining", 300);
  }
}))
    ...
    for (let _index_11870_11876 = 0, _repeatcount_11870_11876 = StrictMath.floor(world.observer.getGlobal("initial-length-dna")); _index_11870_11876 < _repeatcount_11870_11876; _index_11870_11876++) {
      ...
      var R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
        ...
        var R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
          ...
          var R = ProcedurePrims.ask(LinkPrims.createLinkWith(lastHnucleotideHtopHstrand, "OLD-STAIRS"), function() { PrimChecks.turtleOrLink.setVariable(13038, 13045, "hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineCommand("go", 14461, 15852, (function() {
  ...
  if ((PrimChecks.validator.checkArg('AND', 15112, 15115, 2, world.observer.getGlobal("cell-divided?")) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 15116, 15119, 2, world.observer.getGlobal("cell-message-shown?"))))) {
    if (Prims.equality(world.observer.getGlobal("final-time"), 0)) {
      world.observer.setVariable("final-time", workspace.timer.elapsed());
    }
    ...
    world.observer.setVariable("cell-message-shown?", true);
  }
  if (((PrimChecks.validator.checkArg('AND', 15480, 15483, 2, world.observer.getGlobal("using-time-limit")) && Prims.lte(world.observer.getGlobal("time-remaining"), 0)) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 15509, 15512, 2, world.observer.getGlobal("timer-message-shown?"))))) {
    if (Prims.equality(world.observer.getGlobal("final-time"), 0)) {
      world.observer.setVariable("final-time", world.observer.getGlobal("length-of-simulation"));
    }
    var R = ProcedurePrims.callCommand("calculate-mutations"); if (R === DeathInterrupt) { return R; }
    ...
    world.observer.setVariable("timer-message-shown?", true);
  }
}))
ProcedurePrims.defineCommand("check-timer", 15860, 16030, (function() {
  if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 15877, 15880, 2, world.observer.getGlobal("simulation-started?")))) {
    world.observer.setVariable("simulation-started?", true);
    workspace.timer.reset();
  }
  if (world.observer.getGlobal("using-time-limit")) {
    world.observer.setVariable("time-remaining", PrimChecks.math.minus(16020, 16021, PrimChecks.validator.checkArg('-', 16020, 16021, 1, world.observer.getGlobal("length-of-simulation")), workspace.timer.elapsed()));
  }
}))
    ...
    if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 20410, 20414, 112, availableHnucleotides))) {
      ...
      var R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 20520, 20523, 1904, lowestHvalueHnucleotide), function() {
        ...
        if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 20679, 20683, 112, otherHbase))) {
          ...
          var R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 20739, 20742, 1904, otherHbase), function() { PrimChecks.turtle.setVariable(20759, 20773, "unzipped-stage", 1); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
        }
      }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineCommand("calculate-mutations", 27443, 28773, (function() {
  world.observer.setVariable("total-deletion-mutations-top-strand", 0);
  world.observer.setVariable("total-substitution-mutations-top-strand", 0);
  world.observer.setVariable("total-correct-duplications-top-strand", 0);
  world.observer.setVariable("total-deletion-mutations-bottom-strand", 0);
  world.observer.setVariable("total-substitution-mutations-bottom-strand", 0);
  world.observer.setVariable("total-correct-duplications-bottom-strand", 0);
  ...
  var R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 27825, 27828, 1904, originalHnucleotides), function() {
    if (PrimChecks.math.not(PrimChecks.agentset.any(LinkPrims.myLinks("NEW-STAIRS")))) {
      world.observer.setVariable("total-deletion-mutations-top-strand", PrimChecks.math.plus(27959, 27960, PrimChecks.validator.checkArg('+', 27959, 27960, 1, world.observer.getGlobal("total-deletion-mutations-top-strand")), 1));
    }
    if (Prims.gte(PrimChecks.agentset.count(LinkPrims.myLinks("NEW-STAIRS")), 1)) {
      if (PrimChecks.procedure.callReporter(28011, 28047, "is-this-nucleotide-paired-correctly?")) {
        world.observer.setVariable("total-correct-duplications-top-strand", PrimChecks.math.plus(28137, 28138, PrimChecks.validator.checkArg('+', 28137, 28138, 1, world.observer.getGlobal("total-correct-duplications-top-strand")), 1));
      }
      else {
        world.observer.setVariable("total-substitution-mutations-top-strand", PrimChecks.math.plus(28235, 28236, PrimChecks.validator.checkArg('+', 28235, 28236, 1, world.observer.getGlobal("total-substitution-mutations-top-strand")), 1));
      }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  ...
  var R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 28330, 28333, 1904, originalHnucleotides), function() {
    if (PrimChecks.math.not(PrimChecks.agentset.any(LinkPrims.myLinks("NEW-STAIRS")))) {
      world.observer.setVariable("total-deletion-mutations-bottom-strand", PrimChecks.math.plus(28470, 28471, PrimChecks.validator.checkArg('+', 28470, 28471, 1, world.observer.getGlobal("total-deletion-mutations-bottom-strand")), 1));
    }
    if (Prims.gte(PrimChecks.agentset.count(LinkPrims.myLinks("NEW-STAIRS")), 1)) {
      if (PrimChecks.procedure.callReporter(28522, 28558, "is-this-nucleotide-paired-correctly?")) {
        world.observer.setVariable("total-correct-duplications-bottom-strand", PrimChecks.math.plus(28654, 28655, PrimChecks.validator.checkArg('+', 28654, 28655, 1, world.observer.getGlobal("total-correct-duplications-bottom-strand")), 1));
      }
      else {
        world.observer.setVariable("total-substitution-mutations-bottom-strand", PrimChecks.math.plus(28758, 28759, PrimChecks.validator.checkArg('+', 28758, 28759, 1, world.observer.getGlobal("total-substitution-mutations-bottom-strand")), 1));
      }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
...
ProcedurePrims.defineCommand("show-instruction", 35027, 35213, (function(i) {
  if ((Prims.gte(i, 1) && Prims.lte(i, PrimChecks.list.length(PrimChecks.validator.checkArg('LENGTH', 35071, 35077, 12, PrimChecks.procedure.callReporter(35078, 35090, "instructions")))))) {
    world.observer.setVariable("current-instruction", i);
    OutputPrims.clear();
    ...
    }, "output-print", false, false)); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
}))
...
world.observer.setVariable("dna-strand-length", 30);
world.observer.setVariable("nucleo-labels?", true);
world.observer.setVariable("enzyme-labels?", true);
world.observer.setVariable("substitutions?", false);
world.observer.setVariable("free-nucleosides", 50);
world.observer.setVariable("time-limit", "none");