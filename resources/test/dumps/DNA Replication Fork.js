...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("ENZYME-TAGS")).ask(function() {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("NUCLEOTIDE-TAGS")).ask(function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let woundNucleotides = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
        return PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("unwound?")));
      }); letVars['woundNucleotides'] = woundNucleotides;
      if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, woundNucleotides))) {
        let maxWoundPlace = PrimChecks.list.max(PrimChecks.validator.checkArg('MAX', 8, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, woundNucleotides), function() { return SelfManager.self().getVariable("place"); }))); letVars['maxWoundPlace'] = maxWoundPlace;
        Errors.askNobodyCheck(PrimChecks.agentset.with(PrimChecks.validator.checkArg('WITH', 112, woundNucleotides), function() { return Prims.equality(SelfManager.self().getVariable("place"), maxWoundPlace); })).ask(function() {
  ...
  temp = (function() {
    try {
      ...
      if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, unwoundNucleotides))) {
        let minUnwoundPlace = PrimChecks.list.min(PrimChecks.validator.checkArg('MIN', 8, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, unwoundNucleotides), function() { return SelfManager.self().getVariable("place"); }))); letVars['minUnwoundPlace'] = minUnwoundPlace;
        Errors.askNobodyCheck(PrimChecks.agentset.with(PrimChecks.validator.checkArg('WITH', 112, unwoundNucleotides), function() { return Prims.equality(SelfManager.self().getVariable("place"), minUnwoundPlace); })).ask(function() {
          SelfManager.self().right(world.observer.getGlobal("wind-angle"));
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
        return (PrimChecks.validator.checkArg('AND', 2, procedures["NEXT-NUCLEOTIDE-UNZIPPED-THE-SAME?"]()) && Prims.gt(SelfManager.self().getVariable("unzipped-stage"), 0));
      })).ask(function() {
        let fractionalSeparation = PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, SelfManager.self().getVariable("unzipped-stage")), 2); letVars['fractionalSeparation'] = fractionalSeparation;
        ...
        if ((Prims.gt(SelfManager.self().getVariable("unzipped-stage"), 0) && Prims.lt(SelfManager.self().getVariable("unzipped-stage"), 4))) {
          ...
          if (Prims.equality(SelfManager.self().getVariable("class"), "original-dna-bottom")) {
            SelfManager.self().setVariable("ycor", PrimChecks.math.mult(-1, PrimChecks.validator.checkArg('*', 1, fractionalSeparation)));
          }
        }
      }, true);
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("HELICASES")).ask(function() {
        ...
        if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, unzippedNucleotides))) {
          lowestPlace = PrimChecks.agentset.minOneOf(PrimChecks.validator.checkArg('MIN-ONE-OF', 112, unzippedNucleotides), function() { return SelfManager.self().getVariable("place"); }); letVars['lowestPlace'] = lowestPlace;
        }
        let availableNucleotides = PrimChecks.agentset.with(PrimChecks.validator.checkArg('WITH', 112, unzippedNucleotides), function() {
          return (Prims.lt(SelfManager.self().distance(thisHelicase), 1) && PrimChecks.validator.checkArg('AND', 2, procedures["ARE-PREVIOUS-NUCLEOTIDES-UNZIPPED?"]()));
        }); letVars['availableNucleotides'] = availableNucleotides;
        if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, availableNucleotides))) {
          let lowestValueNucleotide = PrimChecks.agentset.minOneOf(PrimChecks.validator.checkArg('MIN-ONE-OF', 112, availableNucleotides), function() { return SelfManager.self().getVariable("place"); }); letVars['lowestValueNucleotide'] = lowestValueNucleotide;
          Errors.askNobodyCheck(lowestValueNucleotide).ask(function() {
            ...
            let otherBase = PrimChecks.agentset.otherWith(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() { return Prims.equality(SelfManager.self().getVariable("place"), basePlace); }); letVars['otherBase'] = otherBase;
            if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, otherBase))) {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(allMolecules).ask(function() {
        if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, procedures["BEING-DRAGGED-BY-CURSOR?"]()))) {
    ...
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("POLYMERASES")).ask(function() {
        ...
        if (PrimChecks.agentset.optimizeCount(nucleosidesReadyToGearToPolymerase, 1, (a, b) => a > b)) {
          potentialNucleosideReadyToGearToPolymerase = PrimChecks.agentset.minOneOf(PrimChecks.validator.checkArg('MIN-ONE-OF', 112, nucleosidesReadyToGearToPolymerase), function() { return SelfManager.self().distance(SelfManager.myself()); }); letVars['potentialNucleosideReadyToGearToPolymerase'] = potentialNucleosideReadyToGearToPolymerase;
        }
        if (PrimChecks.agentset.optimizeCount(nucleosidesReadyToGearToPolymerase, 1, (a, b) => a === b)) {
        ...
        if (((PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, nucleotidesReadyToGearToPolymerase)) && PrimChecks.validator.checkArg('AND', 2, procedures["ALL-BASE-PAIRS-UNWOUND?"]())) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, procedures["BEING-DRAGGED-BY-CURSOR?"]())))) {
          targetNucleotideReadyToGearToPolymerase = PrimChecks.agentset.minOneOf(PrimChecks.validator.checkArg('MIN-ONE-OF', 112, nucleotidesReadyToGearToPolymerase), function() { return SelfManager.self().distance(SelfManager.myself()); }); letVars['targetNucleotideReadyToGearToPolymerase'] = targetNucleotideReadyToGearToPolymerase;
          targetXcor = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, targetNucleotideReadyToGearToPolymerase), function() { return SelfManager.self().getVariable("xcor"); }); letVars['targetXcor'] = targetXcor;
          targetYcor = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, targetNucleotideReadyToGearToPolymerase), function() { return SelfManager.self().getVariable("ycor"); }); letVars['targetYcor'] = targetYcor;
          targetClass = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, targetNucleotideReadyToGearToPolymerase), function() { return SelfManager.self().getVariable("class"); }); letVars['targetClass'] = targetClass;
          SelfManager.self().setXY(targetXcor, targetYcor);
        }
        if ((PrimChecks.math.not(PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, nucleotidesReadyToGearToPolymerase))) || SelfPrims._optimalAnyOther(SelfManager.self().breedHere("POLYMERASES")))) {
          SelfManager.self().setVariable("locked-state", 0);
        }
        if ((((PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, nucleotidesReadyToGearToPolymerase)) && PrimChecks.validator.checkArg('AND', 2, procedures["ALL-BASE-PAIRS-UNWOUND?"]())) && Prims.equality(potentialNucleosideReadyToGearToPolymerase, Nobody)) && PrimChecks.math.not(SelfPrims._optimalAnyOther(SelfManager.self().breedHere("POLYMERASES"))))) {
          SelfManager.self().setVariable("locked-state", 1);
        }
        if ((((!Prims.equality(targetNucleotideReadyToGearToPolymerase, Nobody) && PrimChecks.validator.checkArg('AND', 2, procedures["ALL-BASE-PAIRS-UNWOUND?"]())) && !Prims.equality(potentialNucleosideReadyToGearToPolymerase, Nobody)) && PrimChecks.math.not(SelfPrims._optimalAnyOther(SelfManager.self().breedHere("POLYMERASES"))))) {
          SelfManager.self().setVariable("locked-state", 2);
          if ((PrimChecks.validator.checkArg('OR', 2, procedures["WOULD-THESE-NUCLEOTIDES-PAIR-CORRECTLY?"](targetNucleotideReadyToGearToPolymerase,potentialNucleosideReadyToGearToPolymerase)) || PrimChecks.validator.checkArg('OR', 2, world.observer.getGlobal("substitutions?")))) {
    ...
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("TOPOISOMERASES")).ask(function() {
        if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, woundNucleotides))) {
          ...
          if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, targetPrimasesReadyToGearToTopoisomerase))) {
            let targetPrimaseReadyToGearToTopoisomerase = PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, targetPrimasesReadyToGearToTopoisomerase)); letVars['targetPrimaseReadyToGearToTopoisomerase'] = targetPrimaseReadyToGearToTopoisomerase;
            SelfManager.self().setVariable("locked?", true);
            if (PrimChecks.math.not(MousePrims.isDown())) {
              procedures["UNWIND-DNA"]();
              Errors.askNobodyCheck(LinkPrims.myInLinks("CURSOR-DRAGS")).ask(function() { SelfManager.self().die(); }, true);
              targetXcor = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, targetPrimaseReadyToGearToTopoisomerase), function() { return SelfManager.self().getVariable("xcor"); }); letVars['targetXcor'] = targetXcor;
              targetYcor = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, targetPrimaseReadyToGearToTopoisomerase), function() { return SelfManager.self().getVariable("ycor"); }); letVars['targetYcor'] = targetYcor;
              SelfManager.self().setXY(targetXcor, targetYcor);
            }
          }
          else {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("MOUSE-CURSORS")).ask(function() {
        ...
        let draggableMolecules = PrimChecks.agentset.with(PrimChecks.validator.checkArg('WITH', 112, allMoveableMolecules), function() {
          return (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, procedures["BEING-DRAGGED-BY-CURSOR?"]())) && Prims.lte(SelfManager.self().distance(SelfManager.myself()), world.observer.getGlobal("mouse-drag-radius")));
        }); letVars['draggableMolecules'] = draggableMolecules;
        if (((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, currentMouseDown_p)) && MousePrims.isInside()) && PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, draggableMolecules)))) {
          SelfManager.self().setVariable("color", world.observer.getGlobal("cursor-detect-color"));
          SelfManager.self().setVariable("hidden?", false);
          SelfManager.self().right(4);
        }
        if ((PrimChecks.validator.checkArg('AND', 2, procedures["IS-THIS-CURSOR-DRAGGING-ANYTHING?"]()) && MousePrims.isInside())) {
          SelfManager.self().setVariable("color", world.observer.getGlobal("cursor-drag-color"));
          SelfManager.self().setVariable("hidden?", false);
        }
        if ((((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, world.observer.getGlobal("mouse-continuous-down?"))) && PrimChecks.validator.checkArg('AND', 2, currentMouseDown_p)) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, procedures["IS-THIS-CURSOR-DRAGGING-ANYTHING?"]()))) && PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, draggableMolecules)))) {
          targetTurtle = PrimChecks.agentset.minOneOf(PrimChecks.validator.checkArg('MIN-ONE-OF', 112, draggableMolecules), function() { return SelfManager.self().distance(SelfManager.myself()); }); letVars['targetTurtle'] = targetTurtle;
        ...
        if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, currentMouseDown_p))) {
          Errors.askNobodyCheck(LinkPrims.myOutLinks("CURSOR-DRAGS")).ask(function() { SelfManager.self().die(); }, true);
        }
      }, true);
      if ((PrimChecks.validator.checkArg('AND', 2, currentMouseDown_p) && MousePrims.isDown())) {
  ...
  temp = (function(nucleotide1, nucleotide2) {
    try {
      var reporterContext = true;
      var letVars = { };
      if (Prims.equality(procedures["COMPLEMENTARY-BASE"](PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, nucleotide1), function() { return SelfManager.self().getVariable("value"); })), PrimChecks.list.item(0, PrimChecks.validator.checkArg('ITEM', 12, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, nucleotide2), function() { return SelfManager.self().getVariable("value"); }))))) {
        Errors.reportInContextCheck(reporterContext);
        return true;
      }
      else {
    ...
    try {
      ...
      Errors.askNobodyCheck(thisStair).ask(function() {
        ...
        if (!Prims.equality(thisPairedNucleotide, Nobody)) {
          if ((!Prims.equality(PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, thisPairedNucleotide), function() { return SelfManager.self().getVariable("class"); }), "copy-of-dna-bottom") && !Prims.equality(PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, thisPairedNucleotide), function() { return SelfManager.self().getVariable("class"); }), "copy-of-dna-top"))) {
            overwrite_p = true; letVars['overwrite_p'] = overwrite_p;
          }
        }
      }, true);
      if ((Prims.equality(SelfManager.self().getVariable("value"), procedures["COMPLEMENTARY-BASE"](PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, thisPairedNucleotide), function() { return SelfManager.self().getVariable("value"); }))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, overwrite_p)))) {
        Errors.reportInContextCheck(reporterContext);
        return true;
      }
      else {
  ...
  temp = (function() {
    try {
      ...
      let nextNucleotidesAvailable = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
        return ((Prims.equality(SelfManager.self().getVariable("class"), myClass) && Prims.equality(SelfManager.self().getVariable("place"), PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, myPlace), 1))) && Prims.equality(SelfManager.self().getVariable("unzipped-stage"), myUnzippedStage));
      ...
      if (Prims.lt(myPlace, world.observer.getGlobal("dna-strand-length"))) {
        if ((PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, nextNucleotidesAvailable)) && PrimChecks.validator.checkArg('AND', 2, procedures["ARE-PREVIOUS-NUCLEOTIDES-UNZIPPED?"]()))) {
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      let myPlace = SelfManager.self().getVariable("place"); letVars['myPlace'] = myPlace;
      let previousNucleotides = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
        return Prims.equality(SelfManager.self().getVariable("place"), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, myPlace), 1));
      }); letVars['previousNucleotides'] = previousNucleotides;
      let valueToReturn = false; letVars['valueToReturn'] = valueToReturn;
      if (PrimChecks.math.not(PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, previousNucleotides)))) {
        valueToReturn = true; letVars['valueToReturn'] = valueToReturn;
      }
      else {
        let previousNucleotidesAreUnzipped = PrimChecks.agentset.with(PrimChecks.validator.checkArg('WITH', 112, previousNucleotides), function() { return Prims.gt(SelfManager.self().getVariable("unzipped-stage"), 0); }); letVars['previousNucleotidesAreUnzipped'] = previousNucleotidesAreUnzipped;
        if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, previousNucleotidesAreUnzipped))) {
          valueToReturn = true; letVars['valueToReturn'] = valueToReturn;
        }
        else {
  ...
  temp = (function() {
    try {
      var reporterContext = true;
      var letVars = { };
      let duplicationRate = PrimChecks.math.precision(PrimChecks.math.div(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("total-correct-duplications-top-strand")), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("total-correct-duplications-bottom-strand"))), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("final-time"))), 4); letVars['duplicationRate'] = duplicationRate;
      Errors.reportInContextCheck(reporterContext);
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return (Prims.ifElseValueBooleanCheck(Prims.equality(world.observer.getGlobal("current-instruction"), 0)) ? "press setup" : (workspace.dump('') + workspace.dump(world.observer.getGlobal("current-instruction")) + workspace.dump(" / ") + workspace.dump(PrimChecks.list.length(PrimChecks.validator.checkArg('LENGTH', 12, procedures["INSTRUCTIONS"]())))));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function(i) {
    try {
      ...
      if ((Prims.gte(i, 1) && Prims.lte(i, PrimChecks.list.length(PrimChecks.validator.checkArg('LENGTH', 12, procedures["INSTRUCTIONS"]()))))) {
        ...
        }, "output-print"), PrimChecks.list.item(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("current-instruction")), 1), PrimChecks.validator.checkArg('ITEM', 12, procedures["INSTRUCTIONS"]()))); if(reporterContext && _foreach_35144_35151 !== undefined) { return _foreach_35144_35151; }
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
