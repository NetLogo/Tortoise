...
ProcedurePrims.defineCommand("setup", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(1, "MOUSE-CURSORS"), function() {
  ...
  for (let _index_8948_8954 = 0, _repeatcount_8948_8954 = StrictMath.floor(world.observer.getGlobal("free-nucleosides")); _index_8948_8954 < _repeatcount_8948_8954; _index_8948_8954++){
    R = ProcedurePrims.callCommand("make-a-nucleoside"); if (R === DeathInterrupt) { return R; }
  }
  R = ProcedurePrims.callCommand("make-initial-dna-strip"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("make-polymerases"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("make-a-helicase"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("make-a-topoisomerase"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("wind-initial-dna-into-bundle"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("visualize-agents"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("initialize-length-of-time"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("show-instruction", 1); if (R === DeathInterrupt) { return R; }
  world.ticker.reset();
}))
ProcedurePrims.defineCommand("initialize-length-of-time", (function() {
...
ProcedurePrims.defineCommand("make-a-nucleoside", (function() {
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(1, "NUCLEOSIDES"), function() {
    SelfManager.self().setVariable("value", PrimChecks.procedure.callReporter("random-base-letter"));
    ...
    R = ProcedurePrims.callCommand("attach-nucleo-tag", 0, 0); if (R === DeathInterrupt) { return R; }
...
ProcedurePrims.defineCommand("make-polymerases", (function() {
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(1, "POLYMERASES"), function() {
    SelfManager.self().setVariable("heading", PrimChecks.math.random(PrimChecks.math.plus(PrimChecks.math.minus(180, RandomPrims.randomLong(20)), RandomPrims.randomLong(20))));
    SelfManager.self().setXY(PrimChecks.math.plus(PrimChecks.math.div(PrimChecks.math.minus(world.topology.maxPxcor, world.topology.minPxcor), 2), 3), PrimChecks.math.minus(world.topology.maxPycor, 1));
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(1, "POLYMERASES"), function() {
    SelfManager.self().setVariable("heading", PrimChecks.math.plus(PrimChecks.math.minus(90, RandomPrims.randomLong(20)), RandomPrims.randomLong(20)));
    SelfManager.self().setXY(PrimChecks.math.minus(PrimChecks.math.div(PrimChecks.math.minus(world.topology.maxPxcor, world.topology.minPxcor), 2), 5), PrimChecks.math.minus(world.topology.maxPycor, 1));
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("POLYMERASES"), function() {
    R = ProcedurePrims.callCommand("attach-enzyme-tag", 150, 0.85, "polymerase"); if (R === DeathInterrupt) { return R; }
...
ProcedurePrims.defineCommand("make-a-helicase", (function() {
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(1, "HELICASES"), function() {
    ...
    R = ProcedurePrims.callCommand("attach-enzyme-tag", 150, 0.85, "helicase"); if (R === DeathInterrupt) { return R; }
    SelfManager.self().setXY(PrimChecks.math.div(PrimChecks.math.minus(world.topology.maxPxcor, world.topology.minPxcor), 2), PrimChecks.math.minus(world.topology.maxPycor, 1));
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("make-a-topoisomerase", (function() {
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(1, "TOPOISOMERASES"), function() {
    ...
    SelfManager.self().setVariable("heading", PrimChecks.math.minus(PrimChecks.math.plus(-90, PrimChecks.math.randomFloat(10)), PrimChecks.math.randomFloat(10)));
    R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
      ...
      R = ProcedurePrims.ask(LinkPrims.createLinkFrom(SelfManager.myself(), "GEARLINES"), function() {
        SelfManager.self().setVariable("tie-mode", "fixed");
        SelfManager.self().setVariable("hidden?", true);
        SelfManager.self().tie();
      }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    R = ProcedurePrims.callCommand("attach-enzyme-tag", 150, 0.85, "topoisomerase"); if (R === DeathInterrupt) { return R; }
    SelfManager.self().setXY(PrimChecks.math.minus(PrimChecks.math.div(PrimChecks.math.minus(world.topology.maxPxcor, world.topology.minPxcor), 2), 3), PrimChecks.math.minus(world.topology.maxPycor, 1));
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("make-and-attach-a-primase", (function() {
  R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
    ...
    R = ProcedurePrims.callCommand("attach-enzyme-tag", 100, 0, "primase"); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("make-initial-dna-strip", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(1, ""), function() {
    SelfManager.self().setVariable("breed", world.turtleManager.turtlesOfBreed("CHROMOSOME-BUILDERS"));
    SelfManager.self().setVariable("heading", 90);
    SelfManager.self()._optimalFdOne();
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("CHROMOSOME-BUILDERS"), function() {
    for (let _index_11870_11876 = 0, _repeatcount_11870_11876 = StrictMath.floor(world.observer.getGlobal("initial-length-dna")); _index_11870_11876 < _repeatcount_11870_11876; _index_11870_11876++){
      ...
      R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
        ...
        SelfManager.self().setVariable("value", PrimChecks.procedure.callReporter("random-base-letter"));
        firstHbaseHpairHvalue = SelfManager.self().getVariable("value"); ProcedurePrims.stack().currentContext().updateStringRunVar("FIRST-BASE-PAIR-VALUE", firstHbaseHpairHvalue);
        ...
        SelfManager.self().setVariable("place", placeHcounter);
        SelfManager.self().setVariable("unzipped-stage", 0);
        R = ProcedurePrims.callCommand("attach-nucleo-tag", 5, 0.5); if (R === DeathInterrupt) { return R; }
        if (!Prims.equality(lastHnucleotideHtopHstrand, Nobody)) {
          R = ProcedurePrims.ask(LinkPrims.createLinkTo(lastHnucleotideHtopHstrand, "BACKBONES"), function() {
            SelfManager.self().setVariable("hidden?", true);
            SelfManager.self().tie();
          }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
        }
        ...
        if (IS_HthisHtheHfirstHbase_Q) {
          R = ProcedurePrims.callCommand("make-and-attach-a-primase"); if (R === DeathInterrupt) { return R; }
        }
        ...
        R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
          ...
          SelfManager.self().setVariable("value", PrimChecks.procedure.callReporter("complementary-base", firstHbaseHpairHvalue));
          SelfManager.self().setVariable("shape", (workspace.dump('') + workspace.dump("nucleotide-") + workspace.dump(SelfManager.self().getVariable("value"))));
          SelfManager.self().setVariable("class", "original-dna-bottom");
          R = ProcedurePrims.ask(LinkPrims.createLinkWith(lastHnucleotideHtopHstrand, "OLD-STAIRS"), function() { SelfManager.self().setVariable("hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
          R = ProcedurePrims.callCommand("attach-nucleo-tag", 175, 0.7); if (R === DeathInterrupt) { return R; }
          if (!Prims.equality(lastHnucleotideHbottomHstrand, Nobody)) {
            R = ProcedurePrims.ask(LinkPrims.createLinkTo(lastHnucleotideHbottomHstrand, "BACKBONES"), function() {
              SelfManager.self().setVariable("hidden?", true);
              SelfManager.self().tie();
            }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
          }
...
ProcedurePrims.defineCommand("attach-nucleo-tag", (function(direction, displacement) {
  R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
    ...
    R = ProcedurePrims.ask(LinkPrims.createLinkWith(SelfManager.myself(), "TAGLINES"), function() {
      SelfManager.self().setVariable("tie-mode", "fixed");
      SelfManager.self().setVariable("hidden?", true);
      SelfManager.self().tie();
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineCommand("attach-enzyme-tag", (function(direction, displacement, labelHvalue) {
  R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
    SelfManager.self().setVariable("heading", direction);
    SelfManager.self().fd(displacement);
...
ProcedurePrims.defineCommand("go", (function() {
  if (((PrimChecks.validator.checkArg('AND', 2, world.observer.getGlobal("using-time-limit")) && Prims.gt(world.observer.getGlobal("time-remaining"), 0)) || (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, world.observer.getGlobal("using-time-limit"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, world.observer.getGlobal("cell-divided?")))))) {
    R = ProcedurePrims.callCommand("check-timer"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("move-free-molecules"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("clean-up-free-phosphates"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("refill-or-remove-nucleosides"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("unzip-nucleotides"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("detect-mouse-selection-event"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("lock-polymerase-to-one-nucleotide"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("lock-topoisomerase-to-wound-primase"); if (R === DeathInterrupt) { return R; }
    if (PrimChecks.procedure.callReporter("all-base-pairs-unwound?")) {
      R = ProcedurePrims.callCommand("separate-base-pairs"); if (R === DeathInterrupt) { return R; }
    }
    R = ProcedurePrims.callCommand("visualize-agents"); if (R === DeathInterrupt) { return R; }
    world.ticker.tick();
  }
  if ((PrimChecks.validator.checkArg('AND', 2, world.observer.getGlobal("cell-divided?")) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, world.observer.getGlobal("cell-message-shown?"))))) {
    ...
    R = ProcedurePrims.callCommand("calculate-mutations"); if (R === DeathInterrupt) { return R; }
...
ProcedurePrims.defineCommand("check-timer", (function() {
...
ProcedurePrims.defineCommand("visualize-agents", (function() {
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("ENZYME-TAGS"), function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("NUCLEOTIDE-TAGS"), function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("TOPOISOMERASES"), function() {
    if (SelfManager.self().getVariable("locked?")) {
      R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("TOPOISOMERASES-GEARS"), function() {
...
ProcedurePrims.defineCommand("wind-initial-dna-into-bundle", (function() {
  for (let _index_17643_17649 = 0, _repeatcount_17643_17649 = StrictMath.floor(world.observer.getGlobal("initial-length-dna")); _index_17643_17649 < _repeatcount_17643_17649; _index_17643_17649++){
    R = ProcedurePrims.callCommand("wind-dna"); if (R === DeathInterrupt) { return R; }
  }
}))
ProcedurePrims.defineCommand("unwind-dna", (function() {
  let woundHnucleotides = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
    return PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("unwound?")));
  ...
  if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, woundHnucleotides))) {
    let maxHwoundHplace = PrimChecks.list.max(PrimChecks.validator.checkArg('MAX', 8, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, woundHnucleotides), function() { return SelfManager.self().getVariable("place"); }))); ProcedurePrims.stack().currentContext().registerStringRunVar("MAX-WOUND-PLACE", maxHwoundHplace);
    R = ProcedurePrims.ask(PrimChecks.agentset.with(PrimChecks.validator.checkArg('WITH', 112, woundHnucleotides), function() { return Prims.equality(SelfManager.self().getVariable("place"), maxHwoundHplace); }), function() {
...
ProcedurePrims.defineCommand("wind-dna", (function() {
  let unwoundHnucleotides = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
    return ((PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("unwound?")) && !Prims.equality(SelfManager.self().getVariable("class"), "copy-of-dna-bottom")) && !Prims.equality(SelfManager.self().getVariable("class"), "copy-of-dna-top"));
  ...
  if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, unwoundHnucleotides))) {
    let minHunwoundHplace = PrimChecks.list.min(PrimChecks.validator.checkArg('MIN', 8, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, unwoundHnucleotides), function() { return SelfManager.self().getVariable("place"); }))); ProcedurePrims.stack().currentContext().registerStringRunVar("MIN-UNWOUND-PLACE", minHunwoundHplace);
    R = ProcedurePrims.ask(PrimChecks.agentset.with(PrimChecks.validator.checkArg('WITH', 112, unwoundHnucleotides), function() { return Prims.equality(SelfManager.self().getVariable("place"), minHunwoundHplace); }), function() {
      SelfManager.self().right(world.observer.getGlobal("wind-angle"));
...
ProcedurePrims.defineCommand("unzip-nucleotides", (function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
    return (PrimChecks.validator.checkArg('AND', 2, PrimChecks.procedure.callReporter("next-nucleotide-unzipped-the-same?")) && Prims.gt(SelfManager.self().getVariable("unzipped-stage"), 0));
  }), function() {
    let fractionalHseparation = PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, SelfManager.self().getVariable("unzipped-stage")), 2); ProcedurePrims.stack().currentContext().registerStringRunVar("FRACTIONAL-SEPARATION", fractionalHseparation);
    if (Prims.equality(SelfManager.self().getVariable("unzipped-stage"), 3)) {
      R = ProcedurePrims.ask(LinkPrims.myLinks("OLD-STAIRS"), function() { return SelfManager.self().die(); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
      R = ProcedurePrims.ask(LinkPrims.myOutLinks("BACKBONES"), function() { return SelfManager.self().die(); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }
    if (Prims.equality(SelfManager.self().getVariable("unzipped-stage"), 1)) {
      R = ProcedurePrims.ask(LinkPrims.myOutLinks("BACKBONES"), function() { SelfManager.self().untie(); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }
    if ((Prims.gt(SelfManager.self().getVariable("unzipped-stage"), 0) && Prims.lt(SelfManager.self().getVariable("unzipped-stage"), 4))) {
      SelfManager.self().setVariable("unzipped-stage", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("unzipped-stage")), 1));
      ...
      if (Prims.equality(SelfManager.self().getVariable("class"), "original-dna-top")) {
        SelfManager.self().setVariable("ycor", fractionalHseparation);
      }
      if (Prims.equality(SelfManager.self().getVariable("class"), "original-dna-bottom")) {
        SelfManager.self().setVariable("ycor", PrimChecks.math.mult(-1, PrimChecks.validator.checkArg('*', 1, fractionalHseparation)));
      }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("HELICASES"), function() {
...
ProcedurePrims.defineCommand("separate-base-pairs", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("HELICASES"), function() {
    ...
    let unzippedHnucleotides = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() { return Prims.equality(SelfManager.self().getVariable("unzipped-stage"), 0); }); ProcedurePrims.stack().currentContext().registerStringRunVar("UNZIPPED-NUCLEOTIDES", unzippedHnucleotides);
    if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, unzippedHnucleotides))) {
      lowestHplace = PrimChecks.agentset.minOneOf(PrimChecks.validator.checkArg('MIN-ONE-OF', 112, unzippedHnucleotides), function() { return SelfManager.self().getVariable("place"); }); ProcedurePrims.stack().currentContext().updateStringRunVar("LOWEST-PLACE", lowestHplace);
    }
    ...
    if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, availableHnucleotides))) {
      let lowestHvalueHnucleotide = PrimChecks.agentset.minOneOf(PrimChecks.validator.checkArg('MIN-ONE-OF', 112, availableHnucleotides), function() { return SelfManager.self().getVariable("place"); }); ProcedurePrims.stack().currentContext().registerStringRunVar("LOWEST-VALUE-NUCLEOTIDE", lowestHvalueHnucleotide);
      R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, lowestHvalueHnucleotide), function() {
        let base = SelfManager.self(); ProcedurePrims.stack().currentContext().registerStringRunVar("BASE", base);
        let baseHplace = SelfManager.self().getVariable("place"); ProcedurePrims.stack().currentContext().registerStringRunVar("BASE-PLACE", baseHplace);
        let otherHbase = PrimChecks.agentset.otherWith(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() { return Prims.equality(SelfManager.self().getVariable("place"), baseHplace); }); ProcedurePrims.stack().currentContext().registerStringRunVar("OTHER-BASE", otherHbase);
        if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, otherHbase))) {
          SelfManager.self().setVariable("unzipped-stage", 1);
          R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, otherHbase), function() { SelfManager.self().setVariable("unzipped-stage", 1); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
        }
      }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("move-free-molecules", (function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, allHmolecules), function() {
...
ProcedurePrims.defineCommand("clean-up-free-phosphates", (function() {
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("PHOSPHATES"), function() {
...
ProcedurePrims.defineCommand("refill-or-remove-nucleosides", (function() {
  ...
  if (Prims.gt(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("NUCLEOSIDES")), world.observer.getGlobal("free-nucleosides"))) {
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.list.oneOf(world.turtleManager.turtlesOfBreed("NUCLEOSIDES"))), function() {
      R = ProcedurePrims.ask(LinkPrims.linkNeighbors("TAGLINES"), function() { return SelfManager.self().die(); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
      return SelfManager.self().die();
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
}))
ProcedurePrims.defineCommand("lock-polymerase-to-one-nucleotide", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("POLYMERASES"), function() {
    ...
    let nucleotidesHreadyHtoHgearHtoHpolymerase = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
      return (((PrimChecks.math.not(PrimChecks.agentset.any(LinkPrims.myLinks("OLD-STAIRS"))) && PrimChecks.math.not(PrimChecks.agentset.any(LinkPrims.myLinks("NEW-STAIRS")))) && (Prims.equality(SelfManager.self().getVariable("class"), "original-dna-bottom") || Prims.equality(SelfManager.self().getVariable("class"), "original-dna-top"))) && Prims.lt(SelfManager.self().distance(SelfManager.myself()), world.observer.getGlobal("lock-radius")));
    ...
    if (((PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, nucleotidesHreadyHtoHgearHtoHpolymerase)) && PrimChecks.validator.checkArg('AND', 2, PrimChecks.procedure.callReporter("all-base-pairs-unwound?"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, PrimChecks.procedure.callReporter("being-dragged-by-cursor?"))))) {
      ...
      targetHxcor = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, targetHnucleotideHreadyHtoHgearHtoHpolymerase), function() { return SelfManager.self().getVariable("xcor"); }); ProcedurePrims.stack().currentContext().updateStringRunVar("TARGET-XCOR", targetHxcor);
      targetHycor = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, targetHnucleotideHreadyHtoHgearHtoHpolymerase), function() { return SelfManager.self().getVariable("ycor"); }); ProcedurePrims.stack().currentContext().updateStringRunVar("TARGET-YCOR", targetHycor);
      targetHclass = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, targetHnucleotideHreadyHtoHgearHtoHpolymerase), function() { return SelfManager.self().getVariable("class"); }); ProcedurePrims.stack().currentContext().updateStringRunVar("TARGET-CLASS", targetHclass);
      SelfManager.self().setXY(targetHxcor, targetHycor);
    }
    ...
    if ((((!Prims.equality(targetHnucleotideHreadyHtoHgearHtoHpolymerase, Nobody) && PrimChecks.validator.checkArg('AND', 2, PrimChecks.procedure.callReporter("all-base-pairs-unwound?"))) && !Prims.equality(potentialHnucleosideHreadyHtoHgearHtoHpolymerase, Nobody)) && PrimChecks.math.not(SelfPrims._optimalAnyOther(SelfManager.self().breedHere("POLYMERASES"))))) {
      ...
      if ((PrimChecks.validator.checkArg('OR', 2, PrimChecks.procedure.callReporter("would-these-nucleotides-pair-correctly?", targetHnucleotideHreadyHtoHgearHtoHpolymerase, potentialHnucleosideHreadyHtoHgearHtoHpolymerase)) || PrimChecks.validator.checkArg('OR', 2, world.observer.getGlobal("substitutions?")))) {
        R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, potentialHnucleosideHreadyHtoHgearHtoHpolymerase), function() {
          R = ProcedurePrims.ask(LinkPrims.myInLinks("CURSOR-DRAGS"), function() { return SelfManager.self().die(); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
          R = ProcedurePrims.ask(LinkPrims.linkNeighbors("TAGLINES"), function() { return SelfManager.self().die(); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
          SelfManager.self().setVariable("breed", world.turtleManager.turtlesOfBreed("NUCLEOTIDES"));
          SelfManager.self().setVariable("shape", (workspace.dump('') + workspace.dump("nucleotide-") + workspace.dump(SelfManager.self().getVariable("value"))));
          SelfManager.self().setVariable("unwound?", true);
          ...
          SelfManager.self().setXY(targetHxcor, targetHycor);
          R = ProcedurePrims.callCommand("break-off-phosphates-from-nucleoside"); if (R === DeathInterrupt) { return R; }
          R = ProcedurePrims.ask(LinkPrims.createLinkWith(targetHnucleotideHreadyHtoHgearHtoHpolymerase, "NEW-STAIRS"), function() {
...
ProcedurePrims.defineCommand("break-off-phosphates-from-nucleoside", (function() {
  R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
...
ProcedurePrims.defineCommand("lock-topoisomerase-to-wound-primase", (function() {
  let targetHxcor = 0; ProcedurePrims.stack().currentContext().registerStringRunVar("TARGET-XCOR", targetHxcor);
  let targetHycor = 0; ProcedurePrims.stack().currentContext().registerStringRunVar("TARGET-YCOR", targetHycor);
  let targetHclass = ""; ProcedurePrims.stack().currentContext().registerStringRunVar("TARGET-CLASS", targetHclass);
  let woundHnucleotides = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
    ...
    if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, woundHnucleotides))) {
      ...
      if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, targetHprimasesHreadyHtoHgearHtoHtopoisomerase))) {
        ...
        if (PrimChecks.math.not(MousePrims.isDown())) {
          R = ProcedurePrims.callCommand("unwind-dna"); if (R === DeathInterrupt) { return R; }
          R = ProcedurePrims.ask(LinkPrims.myInLinks("CURSOR-DRAGS"), function() { return SelfManager.self().die(); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
          targetHxcor = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, targetHprimaseHreadyHtoHgearHtoHtopoisomerase), function() { return SelfManager.self().getVariable("xcor"); }); ProcedurePrims.stack().currentContext().updateStringRunVar("TARGET-XCOR", targetHxcor);
          targetHycor = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, targetHprimaseHreadyHtoHgearHtoHtopoisomerase), function() { return SelfManager.self().getVariable("ycor"); }); ProcedurePrims.stack().currentContext().updateStringRunVar("TARGET-YCOR", targetHycor);
          SelfManager.self().setXY(targetHxcor, targetHycor);
        }
      }
      else {
...
ProcedurePrims.defineCommand("calculate-mutations", (function() {
  ...
  let originalHnucleotides = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() { return Prims.equality(SelfManager.self().getVariable("class"), "original-dna-top"); }); ProcedurePrims.stack().currentContext().registerStringRunVar("ORIGINAL-NUCLEOTIDES", originalHnucleotides);
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, originalHnucleotides), function() {
  ...
  originalHnucleotides = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() { return Prims.equality(SelfManager.self().getVariable("class"), "original-dna-bottom"); }); ProcedurePrims.stack().currentContext().updateStringRunVar("ORIGINAL-NUCLEOTIDES", originalHnucleotides);
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, originalHnucleotides), function() {
    if (PrimChecks.math.not(PrimChecks.agentset.any(LinkPrims.myLinks("NEW-STAIRS")))) {
...
ProcedurePrims.defineCommand("detect-mouse-selection-event", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("MOUSE-CURSORS"), function() {
    SelfManager.self().setXY(pHmouseHxcor, pHmouseHycor);
    SelfManager.self().setVariable("hidden?", true);
    ...
    if ((((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, world.observer.getGlobal("mouse-continuous-down?"))) && PrimChecks.validator.checkArg('AND', 2, currentHmouseHdown_Q)) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, PrimChecks.procedure.callReporter("is-this-cursor-dragging-anything?")))) && PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, draggableHmolecules)))) {
      ...
      R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, targetHturtle), function() { SelfManager.self().setXY(pHmouseHxcor, pHmouseHycor); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
      R = ProcedurePrims.ask(LinkPrims.createLinkTo(targetHturtle, "CURSOR-DRAGS"), function() {
        SelfManager.self().setVariable("hidden?", false);
        SelfManager.self().tie();
      }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }
    if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, currentHmouseHdown_Q))) {
      R = ProcedurePrims.ask(LinkPrims.myOutLinks("CURSOR-DRAGS"), function() { return SelfManager.self().die(); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineReporter("random-base-letter", (function() {
...
ProcedurePrims.defineReporter("complementary-base", (function(base) {
...
ProcedurePrims.defineReporter("time-remaining-to-display", (function() {
  if (world.observer.getGlobal("using-time-limit")) {
...
ProcedurePrims.defineReporter("is-this-cursor-dragging-anything?", (function() {
...
ProcedurePrims.defineReporter("being-dragged-by-cursor?", (function() {
...
ProcedurePrims.defineReporter("all-base-pairs-unwound?", (function() {
...
ProcedurePrims.defineReporter("would-these-nucleotides-pair-correctly?", (function(nucleotideH1, nucleotideH2) {
  if (Prims.equality(PrimChecks.procedure.callReporter("complementary-base", PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, nucleotideH1), function() { return SelfManager.self().getVariable("value"); })), PrimChecks.list.item(0, PrimChecks.validator.checkArg('ITEM', 12, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, nucleotideH2), function() { return SelfManager.self().getVariable("value"); }))))) {
    return PrimChecks.procedure.report(true);
  }
  else {
    return PrimChecks.procedure.report(false);
...
ProcedurePrims.defineReporter("is-this-nucleotide-paired-correctly?", (function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, thisHstair), function() {
    ...
    if (!Prims.equality(thisHpairedHnucleotide, Nobody)) {
      if ((!Prims.equality(PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, thisHpairedHnucleotide), function() { return SelfManager.self().getVariable("class"); }), "copy-of-dna-bottom") && !Prims.equality(PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, thisHpairedHnucleotide), function() { return SelfManager.self().getVariable("class"); }), "copy-of-dna-top"))) {
        overwrite_Q = true; ProcedurePrims.stack().currentContext().updateStringRunVar("OVERWRITE?", overwrite_Q);
      }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  if ((Prims.equality(SelfManager.self().getVariable("value"), PrimChecks.procedure.callReporter("complementary-base", PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, thisHpairedHnucleotide), function() { return SelfManager.self().getVariable("value"); }))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, overwrite_Q)))) {
    return PrimChecks.procedure.report(true);
  }
  else {
    return PrimChecks.procedure.report(false);
...
ProcedurePrims.defineReporter("next-nucleotide-unzipped-the-same?", (function() {
  let myHunzippedHstage = SelfManager.self().getVariable("unzipped-stage"); ProcedurePrims.stack().currentContext().registerStringRunVar("MY-UNZIPPED-STAGE", myHunzippedHstage);
  let myHplace = SelfManager.self().getVariable("place"); ProcedurePrims.stack().currentContext().registerStringRunVar("MY-PLACE", myHplace);
  let myHclass = SelfManager.self().getVariable("class"); ProcedurePrims.stack().currentContext().registerStringRunVar("MY-CLASS", myHclass);
  let nextHnucleotidesHavailable = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
    return ((Prims.equality(SelfManager.self().getVariable("class"), myHclass) && Prims.equality(SelfManager.self().getVariable("place"), PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, myHplace), 1))) && Prims.equality(SelfManager.self().getVariable("unzipped-stage"), myHunzippedHstage));
...
ProcedurePrims.defineReporter("are-previous-nucleotides-unzipped?", (function() {
  let myHplace = SelfManager.self().getVariable("place"); ProcedurePrims.stack().currentContext().registerStringRunVar("MY-PLACE", myHplace);
  let previousHnucleotides = PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("NUCLEOTIDES"), function() {
    return Prims.equality(SelfManager.self().getVariable("place"), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, myHplace), 1));
...
ProcedurePrims.defineReporter("user-message-string-for-mutations", (function() {
...
ProcedurePrims.defineCommand("next-instruction", (function() {
  R = ProcedurePrims.callCommand("show-instruction", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("current-instruction")), 1)); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("previous-instruction", (function() {
  R = ProcedurePrims.callCommand("show-instruction", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("current-instruction")), 1)); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("show-instruction", (function(i) {
  if ((Prims.gte(i, 1) && Prims.lte(i, PrimChecks.list.length(PrimChecks.validator.checkArg('LENGTH', 12, PrimChecks.procedure.callReporter("instructions")))))) {
    ...
    OutputPrims.clear();
    R = Tasks.forEach(Tasks.commandTask(function(_0) {
