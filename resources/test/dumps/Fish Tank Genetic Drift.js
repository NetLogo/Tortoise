...
ProcedurePrims.defineCommand("set-tank-regions", 4267, 5384, (function() {
  ...
  var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(world.patches(), 4374, 4377), function() {
...
ProcedurePrims.defineCommand("distribute-fish-in-tank", 6980, 7143, (function() {
  ...
  var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH"), function() {
    PrimChecks.turtle.moveTo(7109, 7116, PrimChecks.validator.checkArg('MOVE-TO', 7109, 7116, 1792, PrimChecks.list.oneOf(7117, 7123, PrimChecks.validator.checkArg('ONE-OF', 7117, 7123, 120, waterHpatches))));
...
ProcedurePrims.defineCommand("distribute-gene-pool-to-somatic-cells", 8033, 9515, (function() {
  ...
  var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() {
    ...
    var R = PrimChecks.task.forEach(8238, 8245, [1, 2, 3, 4], PrimChecks.task.checked(8258, 8259, function(n) {
      PrimChecks.context.assertKind(14, 'run', 8258, 8509);
    ...
    var R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 8663, 8666, 1904, PrimChecks.agentset.oneOfWith(null, null, world.turtleManager.turtlesOfBreed("ALLELES"), function() {
      ...
      var R = ProcedurePrims.ask(LinkPrims.createLinkFrom(PrimChecks.validator.checkArg('CREATE-LINK-FROM', 8900, 8916, 256, thisHsomaticHcell), "LINKS"), function() {
    ...
    var R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 9106, 9109, 1904, PrimChecks.agentset.oneOfWith(null, null, world.turtleManager.turtlesOfBreed("ALLELES"), function() {
      ...
      var R = ProcedurePrims.ask(LinkPrims.createLinkFrom(PrimChecks.validator.checkArg('CREATE-LINK-FROM', 9394, 9410, 256, thisHsomaticHcell), "LINKS"), function() {
...
ProcedurePrims.defineCommand("position-and-link-alleles", 9524, 10352, (function(thisHsomaticHcell, geneHnumber, whichHside) {
  ...
  var R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 9976, 9979, 1904, PrimChecks.agentset.oneOfWith(null, null, world.turtleManager.turtlesOfBreed("ALLELES"), function() {
    ...
    var R = ProcedurePrims.ask(LinkPrims.createLinkFrom(PrimChecks.validator.checkArg('CREATE-LINK-FROM', 10245, 10261, 256, thisHsomaticHcell), "LINKS"), function() {
    ...
    if (Prims.isThrottleTimeElapsed("autoHselection_0", workspace.selfManager.self(), 0.25)) {
      ...
      if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("FISH"))) {
        var R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 11228, 11231, 1904, PrimChecks.list.oneOf(11232, 11238, world.turtleManager.turtlesOfBreed("FISH"))), function() {
          PrimChecks.context.assertKind(2, 'if', 11256, 11339);
          if (PrimChecks.procedure.callReporter(11259, 11296, "both-sexes-in-this-fishs-tank-region?")) {
            PrimChecks.context.assertKind(2, 'remove-this-fish', 11311, 11327);
...
ProcedurePrims.defineCommand("move-gametes-together", 11378, 12055, (function() {
  ...
  var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("GAMETE-CELLS"), function() {
    ...
    distanceHtoHzygote = PrimChecks.turtle.distance(11841, 11849, PrimChecks.validator.checkArg('DISTANCE', 11841, 11849, 1792, myHzygote)); ProcedurePrims.stack().currentContext().updateStringRunVar("DISTANCE-TO-ZYGOTE", distanceHtoHzygote);
...
ProcedurePrims.defineCommand("convert-zygote-into-somatic-cell", 12064, 13746, (function() {
  ...
  var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-ZYGOTES"), function() {
    ...
    if ((PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 12705, 12709, 112, maleHgamete)) && PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 12726, 12730, 112, femaleHgamete)))) {
      if ((Prims.lte(PrimChecks.turtle.distance(12755, 12763, PrimChecks.validator.checkArg('DISTANCE', 12755, 12763, 1792, PrimChecks.list.oneOf(12764, 12770, PrimChecks.validator.checkArg('ONE-OF', 12764, 12770, 120, maleHgamete)))), 0.01) && Prims.lte(PrimChecks.turtle.distance(12794, 12802, PrimChecks.validator.checkArg('DISTANCE', 12794, 12802, 1792, PrimChecks.list.oneOf(12803, 12809, PrimChecks.validator.checkArg('ONE-OF', 12803, 12809, 120, femaleHgamete)))), 0.01))) {
        var R = ProcedurePrims.callCommand("setup-new-somatic-cell-attributes"); if (R === DeathInterrupt) { return R; }
        thisHsomaticHcell = SelfManager.self(); ProcedurePrims.stack().currentContext().updateStringRunVar("THIS-SOMATIC-CELL", thisHsomaticHcell);
        var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 12972, 12975, 1904, maleHgamete), 12972, 12975), function() {
          ...
          PrimChecks.context.assertKind(10, 'die', 13069, 13072);
          return SelfManager.self().die();
        }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(12972, 12975, R); return R; }
        var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 13089, 13092, 1904, femaleHgamete), 13089, 13092), function() {
          ...
          PrimChecks.context.assertKind(10, 'die', 13190, 13193);
          return SelfManager.self().die();
        }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(13089, 13092, R); return R; }
        var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 13210, 13213, 1904, maleHsexHcellHalleles), 13210, 13213), function() {
          PrimChecks.context.assertKind(2, 'create-link-from', 13247, 13369);
          var R = ProcedurePrims.ask(LinkPrims.createLinkFrom(PrimChecks.validator.checkArg('CREATE-LINK-FROM', 13247, 13263, 256, thisHsomaticHcell), "LINKS"), function() {
        ...
        var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 13386, 13389, 1904, femaleHsexHcellHalleles), 13386, 13389), function() {
          PrimChecks.context.assertKind(2, 'create-link-from', 13425, 13547);
          var R = ProcedurePrims.ask(LinkPrims.createLinkFrom(PrimChecks.validator.checkArg('CREATE-LINK-FROM', 13425, 13441, 256, thisHsomaticHcell), "LINKS"), function() {
...
ProcedurePrims.defineCommand("align-alleles-for-this-somatic-cell", 13755, 14568, (function(thisHzygote) {
  ...
  var R = PrimChecks.task.forEach(14051, 14058, [1, 2, 3, 4, 5], PrimChecks.task.checked(14071, 14072, function(thisHgene) {
    ...
    if (Prims.gt(PrimChecks.agentset.countWith(null, null, PrimChecks.context.assertAgentSetKind(2, allHalleles, 'countwith', 14093, 14152), function() {
    ...
    if (Prims.gt(PrimChecks.agentset.countWith(null, null, PrimChecks.context.assertAgentSetKind(2, allHalleles, 'countwith', 14330, 14390), function() {
...
ProcedurePrims.defineCommand("find-potential-mates", 14577, 15719, (function() {
  ...
  if (PrimChecks.agentset.anyWith(null, null, world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() { return Prims.equality(PrimChecks.turtle.getVariable(14784, 14787, "sex"), "male"); })) {
    ...
    var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 14906, 14909, 1904, dad), 14906, 14909), function() {
      PrimChecks.context.assertKind(2, 'set', 15040, 15108);
    ...
    allHfishHandHfishHzygotes = PrimChecks.agentset.with(15172, 15176, PrimChecks.context.assertAgentSetKind(10, PrimChecks.validator.checkArg('WITH', 15172, 15176, 112, turtlesHinHthisHregion), 'with', 15149, 15227), function() {
    ...
    potentialHmates = PrimChecks.agentset.with(15275, 15279, PrimChecks.context.assertAgentSetKind(2, PrimChecks.validator.checkArg('WITH', 15275, 15279, 112, turtlesHinHthisHregion), 'with', 15252, 15334), function() {
...
ProcedurePrims.defineCommand("reproduce-offspring-from-these-two-parents", 15728, 16118, (function(mom, dad) {
  ...
  var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 15804, 15807, 1904, mom), 15804, 15807), function() {
    PrimChecks.context.assertKind(2, 'hatch', 15820, 15974);
  ...
  var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 15986, 15989, 1904, mom), 15986, 15989), function() {
    PrimChecks.context.assertKind(2, 'link-alleles-to-gametes-and-gametes-to-zygote', 15996, 16047);
  ...
  var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 16054, 16057, 1904, dad), 16054, 16057), function() {
    PrimChecks.context.assertKind(2, 'link-alleles-to-gametes-and-gametes-to-zygote', 16064, 16115);
    var R = ProcedurePrims.callCommand("link-alleles-to-gametes-and-gametes-to-zygote", child); if (R === DeathInterrupt) { return R; }
...
ProcedurePrims.defineCommand("link-alleles-to-gametes-and-gametes-to-zygote", 16127, 16760, (function(child) {
  ...
  var R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
    ...
    var R = ProcedurePrims.ask(LinkPrims.createLinkTo(PrimChecks.validator.checkArg('CREATE-LINK-TO', 16276, 16290, 256, child), "LINKS"), function() { PrimChecks.turtleOrLink.setVariable(16302, 16309, "hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(16276, 16290, R); return R; }
  ...
  var R = PrimChecks.task.forEach(16499, 16506, [1, 2, 3, 4, 5], PrimChecks.task.checked(16519, 16520, function(thisHgene) {
    ...
    var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(PrimChecks.validator.checkArg('ASK', 16538, 16541, 1904, PrimChecks.list.nOf(16542, 16546, 1, PrimChecks.agentset.with(16557, 16561, world.turtleManager.turtlesOfBreed("ALLELES"), function() {
...
ProcedurePrims.defineCommand("detect-and-move-fish-at-inside-tank-boundary", 17116, 17629, (function() {
  ...
  var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH"), function() {
    nearestHwaterHpatch = PrimChecks.agentset.minOneOf(PrimChecks.context.assertAgentSetKind(6, PrimChecks.validator.checkArg('MIN-ONE-OF', 17320, 17330, 112, waterHpatches), 'min-one-of', 17320, 17362), function() { return PrimChecks.turtle.distance(17346, 17354, SelfManager.myself()); }); ProcedurePrims.stack().currentContext().updateStringRunVar("NEAREST-WATER-PATCH", nearestHwaterHpatch);
    if ((Prims.equality(PrimChecks.patch.getVariable(17370, 17383, "type-of-patch"), "tank-wall") || Prims.equality(PrimChecks.patch.getVariable(17401, 17414, "type-of-patch"), "water-edge"))) {
      PrimChecks.turtle.setVariable(17444, 17451, "heading", PrimChecks.turtle.towards(17452, 17459, PrimChecks.validator.checkArg('TOWARDS', 17452, 17459, 1792, nearestHwaterHpatch)));
    ...
    if (PrimChecks.patch.getVariable(17580, 17593, "divider-here?")) {
      PrimChecks.turtle.moveTo(17595, 17602, PrimChecks.validator.checkArg('MOVE-TO', 17595, 17602, 1792, nearestHwaterHpatch));
    }
...
ProcedurePrims.defineCommand("remove-this-fish", 18014, 18389, (function() {
  ...
  var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(LinkPrims.outLinkNeighbors("LINKS"), 18217, 18220), function() {
    PrimChecks.context.assertKind(2, 'ask', 18343, 18373);
    var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(LinkPrims.outLinkNeighbors("LINKS"), 18343, 18346), function() {
...
ProcedurePrims.defineCommand("detect-mouse-selection-event", 18398, 20126, (function() {
  ...
  var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("MOUSE-CURSORS"), function() {
    ...
    if (mouseHwasHjustHdown_Q) {
      var R = ProcedurePrims.ask(PrimChecks.context.assertAskAllowed(SelfManager.self().breedHere("FISH"), 19430, 19433), function() { var R = ProcedurePrims.callCommand("remove-this-fish"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(19430, 19433, R); return R; }
    }
...
ProcedurePrims.defineCommand("grow-fish-parts-from-somatic-cell", 23542, 25159, (function() {
  ...
  var R = ProcedurePrims.ask(LinkPrims.createLinkFrom(PrimChecks.validator.checkArg('CREATE-LINK-FROM', 23827, 23843, 256, thisHfishHbody), "LINKS"), function() {
  ...
  var R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
    ...
    var R = ProcedurePrims.ask(LinkPrims.createLinkFrom(PrimChecks.validator.checkArg('CREATE-LINK-FROM', 24217, 24233, 256, thisHfishHbody), "LINKS"), function() {
  ...
  var R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
    ...
    var R = ProcedurePrims.ask(LinkPrims.createLinkFrom(PrimChecks.validator.checkArg('CREATE-LINK-FROM', 24584, 24600, 256, thisHfishHbody), "LINKS"), function() {
  ...
  var R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
    ...
    var R = ProcedurePrims.ask(LinkPrims.createLinkFrom(PrimChecks.validator.checkArg('CREATE-LINK-FROM', 24949, 24965, 256, thisHfishHbody), "LINKS"), function() {
...
ProcedurePrims.defineReporter("both-sexes-in-this-fishs-tank-region?", 29128, 29507, (function() {
  let fishHinHthisHregion = PrimChecks.agentset.with(29234, 29238, PrimChecks.context.assertAgentSetKind(10, PrimChecks.validator.checkArg('WITH', 29234, 29238, 112, PrimChecks.procedure.callReporter(29192, 29233, "other-turtles-in-this-turtles-tank-region")), 'with', 29192, 29253), function() {
  ...
  let maleHfishHinHthisHregion = PrimChecks.agentset.with(29305, 29309, PrimChecks.context.assertAgentSetKind(2, PrimChecks.validator.checkArg('WITH', 29305, 29309, 112, fishHinHthisHregion), 'with', 29285, 29324), function() { return Prims.equality(PrimChecks.turtle.getVariable(29311, 29314, "sex"), "male"); }); ProcedurePrims.stack().currentContext().registerStringRunVar("MALE-FISH-IN-THIS-REGION", maleHfishHinHthisHregion);
  let femaleHfishHinHthisHregion = PrimChecks.agentset.with(29378, 29382, PrimChecks.context.assertAgentSetKind(2, PrimChecks.validator.checkArg('WITH', 29378, 29382, 112, fishHinHthisHregion), 'with', 29358, 29399), function() { return Prims.equality(PrimChecks.turtle.getVariable(29384, 29387, "sex"), "female"); }); ProcedurePrims.stack().currentContext().registerStringRunVar("FEMALE-FISH-IN-THIS-REGION", femaleHfishHinHthisHregion);
