...
ProcedurePrims.defineCommand("setup", (function() {
  ...
  R = ProcedurePrims.callCommand("set-tank-regions"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("create-initial-gene-pool"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("create-initial-fish"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("visualize-tank"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("visualize-fish-and-alleles"); if (R === DeathInterrupt) { return R; }
  world.ticker.reset();
}))
ProcedurePrims.defineCommand("set-tank-regions", (function() {
...
ProcedurePrims.defineCommand("create-initial-gene-pool", (function() {
  ...
  R = ProcedurePrims.callCommand("make-initial-alleles-for-gene", 1, "B", "b", numHbigHalleles); if (R === DeathInterrupt) { return R; }
  ...
  R = ProcedurePrims.callCommand("make-initial-alleles-for-gene", 2, "T", "t", numHbigHalleles); if (R === DeathInterrupt) { return R; }
  ...
  R = ProcedurePrims.callCommand("make-initial-alleles-for-gene", 3, "F", "f", numHbigHalleles); if (R === DeathInterrupt) { return R; }
  ...
  R = ProcedurePrims.callCommand("make-initial-alleles-for-gene", 4, "G", "g", numHbigHalleles); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("make-initial-alleles-for-gene", 5, "Y", "X", world.observer.getGlobal("initial-#-males")); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("create-initial-fish", (function() {
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(world.observer.getGlobal("initial-#-males"), "SOMATIC-CELLS"), function() { SelfManager.self().setVariable("sex", "male"); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(world.observer.getGlobal("initial-#-females"), "SOMATIC-CELLS"), function() { SelfManager.self().setVariable("sex", "female"); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() {
    R = ProcedurePrims.callCommand("setup-new-somatic-cell-attributes"); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.callCommand("distribute-gene-pool-to-somatic-cells"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() {
    R = ProcedurePrims.callCommand("grow-fish-parts-from-somatic-cell"); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.callCommand("distribute-fish-in-tank"); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("setup-new-somatic-cell-attributes", (function() {
  SelfManager.self().setVariable("heading", 0);
...
ProcedurePrims.defineCommand("distribute-fish-in-tank", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH"), function() {
    SelfManager.self().moveTo(PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, waterHpatches)));
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("make-initial-alleles-for-gene", (function(geneHnumber, alleleH1, alleleH2, numHbigHalleles) {
  ...
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(PrimChecks.math.mult(2, PrimChecks.validator.checkArg('*', 1, initialHnumberHfish)), "ALLELES"), function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.list.nOf(PrimChecks.validator.checkArg('N-OF', 1, numHbigHalleles), PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("ALLELES"), function() { return Prims.equality(SelfManager.self().getVariable("gene"), geneHnumber); }))), function() {
...
ProcedurePrims.defineCommand("distribute-gene-pool-to-somatic-cells", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() {
    ...
    R = Tasks.forEach(Tasks.commandTask(function(n) {
      PrimChecks.procedure.runArgCountCheck(1, arguments.length);
      R = ProcedurePrims.callCommand("position-and-link-alleles", SelfManager.self(), n, "left"); if (R === DeathInterrupt) { return R; }
      R = ProcedurePrims.callCommand("position-and-link-alleles", SelfManager.self(), n, "right"); if (R === DeathInterrupt) { return R; }
    ...
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.agentset.oneOfWith(world.turtleManager.turtlesOfBreed("ALLELES"), function() {
      ...
      SelfManager.self().setVariable("xcor", PrimChecks.math.plus(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("inter-chromosome-pair-spacing")), 4), 0.1));
      SelfManager.self().setVariable("ycor", -0.4);
      SelfManager.self().setVariable("side", "left");
      R = ProcedurePrims.ask(LinkPrims.createLinkFrom(thisHsomaticHcell, "LINKS"), function() {
        SelfManager.self().setVariable("hidden?", true);
    ...
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.agentset.oneOfWith(world.turtleManager.turtlesOfBreed("ALLELES"), function() {
      ...
      SelfManager.self().setVariable("owned-by-fish?", true);
      SelfManager.self().setVariable("size", 1.2);
      SelfManager.self().setVariable("xcor", PrimChecks.math.plus(PrimChecks.math.plus(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("inter-chromosome-pair-spacing")), 4), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("intra-chromosome-pair-spacing"))), 0.1));
      SelfManager.self().setVariable("ycor", -0.4);
...
ProcedurePrims.defineCommand("position-and-link-alleles", (function(thisHsomaticHcell, geneHnumber, whichHside) {
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.agentset.oneOfWith(world.turtleManager.turtlesOfBreed("ALLELES"), function() {
    ...
    SelfManager.self().setVariable("size", 1.2);
    SelfManager.self().setVariable("xcor", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, thisHsomaticHcell), function() { return SelfManager.self().getVariable("xcor"); })), PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, pairHshiftHright), PrimChecks.validator.checkArg('+', 1, sideHshift))));
    SelfManager.self().setVariable("ycor", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, thisHsomaticHcell), function() { return SelfManager.self().getVariable("ycor"); })), 0.4));
    R = ProcedurePrims.ask(LinkPrims.createLinkFrom(thisHsomaticHcell, "LINKS"), function() {
      SelfManager.self().setVariable("hidden?", true);
      SelfManager.self().setVariable("tie-mode", "fixed");
      SelfManager.self().tie();
...
ProcedurePrims.defineCommand("go", (function() {
  R = ProcedurePrims.callCommand("wander"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("update-statistics"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("detect-fish-outside-the-water"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("detect-and-move-fish-at-inside-tank-boundary"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("auto-selection"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("clean-up-fish-bones"); if (R === DeathInterrupt) { return R; }
  if (world.observer.getGlobal("auto-replace?")) {
    R = ProcedurePrims.callCommand("find-potential-mates"); if (R === DeathInterrupt) { return R; }
  }
  R = ProcedurePrims.callCommand("move-gametes-together"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("convert-zygote-into-somatic-cell"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("detect-mouse-selection-event"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("visualize-fish-and-alleles"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("visualize-tank"); if (R === DeathInterrupt) { return R; }
  world.ticker.tick();
}))
ProcedurePrims.defineCommand("auto-selection", (function() {
  if (world.observer.getGlobal("auto-replace?")) {
    if (Prims.isThrottleTimeElapsed("autoHselection_0", workspace.selfManager.self(), 0.25)) {
      ...
      if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("FISH"))) {
        R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.list.oneOf(world.turtleManager.turtlesOfBreed("FISH"))), function() {
          if (PrimChecks.procedure.callReporter("both-sexes-in-this-fishs-tank-region?")) {
            R = ProcedurePrims.callCommand("remove-this-fish"); if (R === DeathInterrupt) { return R; }
          }
        }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
      }
    }
...
ProcedurePrims.defineCommand("move-gametes-together", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("GAMETE-CELLS"), function() {
    ...
    if (Prims.gt(distanceHtoHzygote, 0)) {
      SelfManager.self().face(myHzygote);
...
ProcedurePrims.defineCommand("convert-zygote-into-somatic-cell", (function() {
  ...
  let thisHsomaticHcell = Nobody; ProcedurePrims.stack().currentContext().registerStringRunVar("THIS-SOMATIC-CELL", thisHsomaticHcell);
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-ZYGOTES"), function() {
    ...
    if ((PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, maleHgamete)) && PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, femaleHgamete)))) {
      if ((Prims.lte(SelfManager.self().distance(PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, maleHgamete))), 0.01) && Prims.lte(SelfManager.self().distance(PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, femaleHgamete))), 0.01))) {
        R = ProcedurePrims.callCommand("setup-new-somatic-cell-attributes"); if (R === DeathInterrupt) { return R; }
        thisHsomaticHcell = SelfManager.self(); ProcedurePrims.stack().currentContext().updateStringRunVar("THIS-SOMATIC-CELL", thisHsomaticHcell);
        R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, maleHgamete), function() {
        ...
        R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, femaleHgamete), function() {
        ...
        R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, maleHsexHcellHalleles), function() {
          R = ProcedurePrims.ask(LinkPrims.createLinkFrom(thisHsomaticHcell, "LINKS"), function() {
            SelfManager.self().setVariable("hidden?", true);
            SelfManager.self().setVariable("tie-mode", "fixed");
            SelfManager.self().tie();
        ...
        R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, femaleHsexHcellHalleles), function() {
          R = ProcedurePrims.ask(LinkPrims.createLinkFrom(thisHsomaticHcell, "LINKS"), function() {
            SelfManager.self().setVariable("hidden?", true);
            SelfManager.self().setVariable("tie-mode", "fixed");
            SelfManager.self().tie();
        ...
        R = ProcedurePrims.callCommand("align-alleles-for-this-somatic-cell", thisHsomaticHcell); if (R === DeathInterrupt) { return R; }
...
ProcedurePrims.defineCommand("align-alleles-for-this-somatic-cell", (function(thisHzygote) {
  ...
  R = Tasks.forEach(Tasks.commandTask(function(thisHgene) {
    PrimChecks.procedure.runArgCountCheck(1, arguments.length);
    if (Prims.gt(PrimChecks.agentset.countWith(allHalleles, function() {
      ...
      R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.agentset.oneOfWith(allHalleles, function() { return Prims.equality(SelfManager.self().getVariable("gene"), thisHgene); })), function() {
...
ProcedurePrims.defineCommand("find-potential-mates", (function() {
  ...
  if (PrimChecks.agentset.anyWith(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() { return Prims.equality(SelfManager.self().getVariable("sex"), "male"); })) {
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.agentset.oneOfWith(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() { return Prims.equality(SelfManager.self().getVariable("sex"), "male"); })), function() {
      dad = SelfManager.self(); ProcedurePrims.stack().currentContext().updateStringRunVar("DAD", dad);
      xcorHdad = SelfManager.self().getVariable("xcor"); ProcedurePrims.stack().currentContext().updateStringRunVar("XCOR-DAD", xcorHdad);
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, dad), function() {
    ...
    if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, potentialHmates))) {
      R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, potentialHmates))), function() { mom = SelfManager.self(); ProcedurePrims.stack().currentContext().updateStringRunVar("MOM", mom); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
      ...
      if (Prims.lt(PrimChecks.agentset.count(PrimChecks.validator.checkArg('COUNT', 112, allHfishHandHfishHzygotes)), thisHcarryingHcapacity)) {
        R = ProcedurePrims.callCommand("reproduce-offspring-from-these-two-parents", mom, dad); if (R === DeathInterrupt) { return R; }
      }
    }
  }
}))
ProcedurePrims.defineCommand("reproduce-offspring-from-these-two-parents", (function(mom, dad) {
  let child = Nobody; ProcedurePrims.stack().currentContext().registerStringRunVar("CHILD", child);
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, mom), function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, mom), function() {
    R = ProcedurePrims.callCommand("link-alleles-to-gametes-and-gametes-to-zygote", child); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, dad), function() {
    R = ProcedurePrims.callCommand("link-alleles-to-gametes-and-gametes-to-zygote", child); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("link-alleles-to-gametes-and-gametes-to-zygote", (function(child) {
  ...
  R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
    ...
    SelfManager.self().setVariable("heading", 0);
    R = ProcedurePrims.ask(LinkPrims.createLinkTo(child, "LINKS"), function() { SelfManager.self().setVariable("hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    if (Prims.equality(SelfManager.self().getVariable("sex"), "male")) {
  ...
  R = Tasks.forEach(Tasks.commandTask(function(thisHgene) {
    PrimChecks.procedure.runArgCountCheck(1, arguments.length);
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, PrimChecks.list.nOf(1, PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("ALLELES"), function() {
      return (LinkPrims.isInLinkNeighbor("LINKS", SelfManager.myself()) && Prims.equality(SelfManager.self().getVariable("gene"), thisHgene));
    }))), function() {
      R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
        SelfManager.self().setVariable("owned-by-fish?", false);
        R = ProcedurePrims.ask(LinkPrims.createLinkFrom(thisHnewHgameteHcell, "LINKS"), function() {
          SelfManager.self().setVariable("hidden?", true);
          SelfManager.self().setVariable("tie-mode", "fixed");
          SelfManager.self().tie();
        }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineCommand("wander", (function() {
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH"), function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() { SelfManager.self().setVariable("heading", 0); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("detect-fish-outside-the-water", (function() {
  R = ProcedurePrims.ask(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("FISH"), function() {
  ...
  }), function() { R = ProcedurePrims.callCommand("remove-this-fish"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("detect-and-move-fish-at-inside-tank-boundary", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH"), function() {
    ...
    if ((Prims.equality(SelfManager.self().getPatchVariable("type-of-patch"), "tank-wall") || Prims.equality(SelfManager.self().getPatchVariable("type-of-patch"), "water-edge"))) {
      SelfManager.self().setVariable("heading", SelfManager.self().towards(nearestHwaterHpatch));
...
ProcedurePrims.defineCommand("clean-up-fish-bones", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-BONES"), function() {
...
ProcedurePrims.defineCommand("remove-this-fish", (function() {
  ...
  R = ProcedurePrims.ask(LinkPrims.outLinkNeighbors("LINKS"), function() {
    R = ProcedurePrims.ask(LinkPrims.outLinkNeighbors("LINKS"), function() { return SelfManager.self().die(); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    return SelfManager.self().die();
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  return SelfManager.self().die();
}))
ProcedurePrims.defineCommand("detect-mouse-selection-event", (function() {
  ...
  let pHtypeHofHpatch = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, world.getPatchAt(pHmouseHxcor, pHmouseHycor)), function() { return SelfManager.self().getPatchVariable("type-of-patch"); }); ProcedurePrims.stack().currentContext().registerStringRunVar("P-TYPE-OF-PATCH", pHtypeHofHpatch);
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("MOUSE-CURSORS"), function() {
    ...
    if (mouseHwasHjustHdown_Q) {
      R = ProcedurePrims.ask(SelfManager.self().breedHere("FISH"), function() { R = ProcedurePrims.callCommand("remove-this-fish"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }
    if ((((((PrimChecks.validator.checkArg('AND', 2, mouseHwasHjustHdown_Q) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, world.observer.getGlobal("mouse-continuous-down?")))) && Prims.equality(pHtypeHofHpatch, "tank-wall")) && Prims.equality(SelfManager.self().getPatchVariable("pycor"), PrimChecks.math.plus(world.topology.minPycor, 1))) && Prims.gt(SelfManager.self().getPatchVariable("pxcor"), PrimChecks.math.plus(world.topology.minPxcor, 1))) && Prims.lt(SelfManager.self().getPatchVariable("pxcor"), PrimChecks.math.minus(world.topology.maxPxcor, 1)))) {
      ...
      R = ProcedurePrims.ask(PrimChecks.agentset.with(world.patches(), function() {
...
ProcedurePrims.defineCommand("update-statistics", (function() {
...
ProcedurePrims.defineCommand("visualize-tank", (function() {
  R = ProcedurePrims.ask(PrimChecks.agentset.with(world.patches(), function() {
    return (Prims.equality(SelfManager.self().getPatchVariable("type-of-patch"), "water") || Prims.equality(SelfManager.self().getPatchVariable("type-of-patch"), "water-edge"));
  }), function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.agentset.with(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("type-of-patch"), "tank-wall"); }), function() {
    if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getPatchVariable("divider-here?")))) {
  ...
  R = ProcedurePrims.ask(PrimChecks.agentset.with(world.patches(), function() { return Prims.equality(SelfManager.self().getPatchVariable("type-of-patch"), "air"); }), function() { SelfManager.self().setPatchVariable("pcolor", PrimChecks.math.plus(5, 3)); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("visualize-fish-and-alleles", (function() {
  if (world.observer.getGlobal("see-body-cells?")) {
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() {
      SelfManager.self().setVariable("hidden?", false);
      R = ProcedurePrims.ask(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("ALLELES"), function() { return LinkPrims.isInLinkNeighbor("LINKS", SelfManager.myself()); }), function() { SelfManager.self().setVariable("hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  else {
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() {
      SelfManager.self().setVariable("hidden?", true);
      R = ProcedurePrims.ask(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("ALLELES"), function() { return LinkPrims.isInLinkNeighbor("LINKS", SelfManager.myself()); }), function() { SelfManager.self().setVariable("hidden?", true); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  if (world.observer.getGlobal("see-sex-cells?")) {
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("GAMETE-CELLS"), function() {
    ...
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-ZYGOTES"), function() { SelfManager.self().setVariable("hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  else {
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("GAMETE-CELLS"), function() {
      SelfManager.self().setVariable("hidden?", true);
    ...
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-ZYGOTES"), function() { SelfManager.self().setVariable("hidden?", true); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  if (world.observer.getGlobal("see-fish?")) {
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH"), function() { SelfManager.self().setVariable("hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-PARTS"), function() { SelfManager.self().setVariable("hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  else {
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH"), function() { SelfManager.self().setVariable("hidden?", true); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-PARTS"), function() { SelfManager.self().setVariable("hidden?", true); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
}))
ProcedurePrims.defineCommand("grow-fish-parts-from-somatic-cell", (function() {
  ...
  R = ProcedurePrims.ask(LinkPrims.createLinkFrom(thisHfishHbody, "LINKS"), function() {
    SelfManager.self().setVariable("hidden?", true);
    SelfManager.self().setVariable("tie-mode", "fixed");
    SelfManager.self().tie();
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineReporter("has-at-least-one-dominant-set-of-instructions-for", (function(dominantHallele) {
...
ProcedurePrims.defineReporter("tail-shape-phenotype", (function() {
  ...
  R = ProcedurePrims.ask(SelfManager.myself(), function() {
...
ProcedurePrims.defineReporter("rear-spots-phenotype", (function() {
...
ProcedurePrims.defineReporter("dorsal-fin-color-phenotype", (function() {
...
ProcedurePrims.defineReporter("tail-color-phenotype", (function() {
  let thisHcolor = []; ProcedurePrims.stack().currentContext().registerStringRunVar("THIS-COLOR", thisHcolor);
  let thisHfish = SelfManager.myself(); ProcedurePrims.stack().currentContext().registerStringRunVar("THIS-FISH", thisHfish);
  R = ProcedurePrims.ask(SelfManager.myself(), function() {
...
ProcedurePrims.defineReporter("sex-phenotype", (function() {
...
ProcedurePrims.defineReporter("alleles-that-belong-to-this-gamete", (function() {
...
ProcedurePrims.defineReporter("left-side-of-water-in-tank", (function() { return PrimChecks.procedure.report(PrimChecks.math.plus(world.topology.minPxcor, 2)); }))
ProcedurePrims.defineReporter("right-side-of-water-in-tank", (function() { return PrimChecks.procedure.report(PrimChecks.math.minus(world.topology.maxPxcor, 2)); }))
ProcedurePrims.defineReporter("other-turtles-in-this-turtles-tank-region", (function() {
  let turtlesHinHthisHregion = Nobody; ProcedurePrims.stack().currentContext().registerStringRunVar("TURTLES-IN-THIS-REGION", turtlesHinHthisHregion);
  let xcorHofHthisHturtle = SelfManager.self().getVariable("xcor"); ProcedurePrims.stack().currentContext().registerStringRunVar("XCOR-OF-THIS-TURTLE", xcorHofHthisHturtle);
  ...
  turtlesHinHthisHregion = PrimChecks.agentset.with(world.turtles(), function() {
    return (Prims.gte(SelfManager.self().getVariable("xcor"), thisHregionHleftHside) && Prims.lte(SelfManager.self().getVariable("xcor"), thisHregionHrightHside));
...
ProcedurePrims.defineReporter("both-sexes-in-this-fishs-tank-region?", (function() {
...
ProcedurePrims.defineReporter("carrying-capacity-in-this-region", (function(thisHxcor) {
  let thisHregionHleftHside = PrimChecks.procedure.callReporter("left-side-of-water-in-tank"); ProcedurePrims.stack().currentContext().registerStringRunVar("THIS-REGION-LEFT-SIDE", thisHregionHleftHside);
  let thisHregionHrightHside = PrimChecks.procedure.callReporter("right-side-of-water-in-tank"); ProcedurePrims.stack().currentContext().registerStringRunVar("THIS-REGION-RIGHT-SIDE", thisHregionHrightHside);
  let dividersHtoHtheHright = PrimChecks.agentset.with(world.patches(), function() {
