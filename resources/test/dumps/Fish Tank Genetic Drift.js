...
ProcedurePrims.defineCommand("create-initial-fish", 6141, 6636, (function() {
  var R = ProcedurePrims.ask(world.turtleManager.createTurtles(world.observer.getGlobal("initial-#-males"), "SOMATIC-CELLS"), function() { PrimChecks.turtle.setVariable(6247, 6250, "sex", "male"); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  var R = ProcedurePrims.ask(world.turtleManager.createTurtles(world.observer.getGlobal("initial-#-females"), "SOMATIC-CELLS"), function() { PrimChecks.turtle.setVariable(6305, 6308, "sex", "female"); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineCommand("link-alleles-to-gametes-and-gametes-to-zygote", 16127, 16760, (function(child) {
  ...
  var R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
    ...
    var R = ProcedurePrims.ask(LinkPrims.createLinkTo(child, "LINKS"), function() { PrimChecks.turtleOrLink.setVariable(16302, 16309, "hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineCommand("wander", 16769, 16964, (function() {
  ...
  var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() { PrimChecks.turtle.setVariable(16953, 16960, "heading", 0); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
...
ProcedurePrims.defineCommand("visualize-tank", 22108, 22536, (function() {
  ...
  var R = ProcedurePrims.ask(PrimChecks.agentset.with(22474, 22478, world.patches(), function() { return Prims.equality(PrimChecks.patch.getVariable(22480, 22493, "type-of-patch"), "air"); }), function() { PrimChecks.patch.setVariable(22515, 22521, "pcolor", PrimChecks.math.plus(22527, 22528, 5, 3)); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("visualize-fish-and-alleles", 22545, 23533, (function() {
  if (world.observer.getGlobal("see-body-cells?")) {
    var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() {
      ...
      var R = ProcedurePrims.ask(PrimChecks.agentset.with(22665, 22669, world.turtleManager.turtlesOfBreed("ALLELES"), function() { return LinkPrims.isInLinkNeighbor("LINKS", SelfManager.myself()); }), function() { PrimChecks.turtleOrLink.setVariable(22713, 22720, "hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  else {
    var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("SOMATIC-CELLS"), function() {
      PrimChecks.turtleOrLink.setVariable(22781, 22788, "hidden?", true);
      var R = ProcedurePrims.ask(PrimChecks.agentset.with(22812, 22816, world.turtleManager.turtlesOfBreed("ALLELES"), function() { return LinkPrims.isInLinkNeighbor("LINKS", SelfManager.myself()); }), function() { PrimChecks.turtleOrLink.setVariable(22860, 22867, "hidden?", true); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  if (world.observer.getGlobal("see-sex-cells?")) {
    var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("GAMETE-CELLS"), function() {
      PrimChecks.turtleOrLink.setVariable(22950, 22957, "hidden?", false);
      var R = ProcedurePrims.ask(PrimChecks.agentset.with(22982, 22986, world.turtleManager.turtlesOfBreed("ALLELES"), function() { return LinkPrims.isInLinkNeighbor("LINKS", SelfManager.myself()); }), function() { PrimChecks.turtleOrLink.setVariable(23030, 23037, "hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-ZYGOTES"), function() { PrimChecks.turtleOrLink.setVariable(23091, 23098, "hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  else {
    var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("GAMETE-CELLS"), function() {
      PrimChecks.turtleOrLink.setVariable(23150, 23157, "hidden?", true);
      var R = ProcedurePrims.ask(PrimChecks.agentset.with(23181, 23185, world.turtleManager.turtlesOfBreed("ALLELES"), function() { return LinkPrims.isInLinkNeighbor("LINKS", SelfManager.myself()); }), function() { PrimChecks.turtleOrLink.setVariable(23229, 23236, "hidden?", true); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-ZYGOTES"), function() { PrimChecks.turtleOrLink.setVariable(23289, 23296, "hidden?", true); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  if (world.observer.getGlobal("see-fish?")) {
    var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH"), function() { PrimChecks.turtleOrLink.setVariable(23358, 23365, "hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-PARTS"), function() { PrimChecks.turtleOrLink.setVariable(23409, 23416, "hidden?", false); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  else {
    var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH"), function() { PrimChecks.turtleOrLink.setVariable(23460, 23467, "hidden?", true); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    var R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("FISH-PARTS"), function() { PrimChecks.turtleOrLink.setVariable(23510, 23517, "hidden?", true); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
}))
