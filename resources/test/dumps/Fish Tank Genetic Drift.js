...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("FISH")).ask(function() { SelfManager.self().moveTo(ListPrims.oneOf(waterPatches)); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function(geneNumber, allele1, allele2, numBigAlleles) {
    try {
      ...
      Errors.askNobodyCheck(ListPrims.nOf(numBigAlleles, world.turtleManager.turtlesOfBreed("ALLELES").agentFilter(function() { return Prims.equality(SelfManager.self().getVariable("gene"), geneNumber); }))).ask(function() {
      ...
      if (world.observer.getGlobal("auto-replace?")) {
        if (Prims.isThrottleTimeElapsed("autoSelection_0", workspace.selfManager.self(), 0.25)) {
          ...
          if (!world.turtleManager.turtlesOfBreed("FISH").isEmpty()) {
            Errors.askNobodyCheck(ListPrims.oneOf(world.turtleManager.turtlesOfBreed("FISH"))).ask(function() {
    ...
    try {
      ...
      if (world.turtleManager.turtlesOfBreed("SOMATIC-CELLS")._optimalAnyWith(function() { return Prims.equality(SelfManager.self().getVariable("sex"), "male"); })) {
        ...
        if (!potentialMates.isEmpty()) {
          Errors.askNobodyCheck(ListPrims.oneOf(potentialMates)).ask(function() { mom = SelfManager.self(); letVars['mom'] = mom; }, true);
  ...
  temp = (function(child) {
    try {
      ...
      var _foreach_16499_16506 = Tasks.forEach(Tasks.commandTask(function(thisGene) {
        Errors.procedureArgumentsCheck(1, arguments.length);
        Errors.askNobodyCheck(ListPrims.nOf(1, world.turtleManager.turtlesOfBreed("ALLELES").agentFilter(function() {
