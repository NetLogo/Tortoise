...
modelConfig.plots = [];
var workspace = tortoise_require('engine/workspace')(modelConfig)([])([], [])(tortoise_require("extensions/all").dumpers())(["change-vote-if-tied?", "award-close-calls-to-loser?"], ["change-vote-if-tied?", "award-close-calls-to-loser?"], ["vote", "total"], -75, 75, -75, 75, 3.0, true, true, turtleShapes, linkShapes, function(){});
