    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Class Plot', 'low')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() { return Prims.equality(SelfManager.self().getVariable("color"), 15); }));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Class Plot', 'mid')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() { return Prims.equality(SelfManager.self().getVariable("color"), 55); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Class Plot', 'up')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() { return Prims.equality(SelfManager.self().getVariable("color"), 105); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Lorenz Curve', 'lorenz')(function() {
        try {
          ...
          var letVars = { };
          plotManager.resetPen();
          plotManager.setPenInterval(PrimChecks.math.div(100, PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("num-people"))));
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Gini-Index v. Time', 'default')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.div(PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("gini-index-reserve")), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("num-people"))), 0.5));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() {
        SelfManager.self().setPatchVariable("grain-here", PrimChecks.math.floor(PrimChecks.validator.checkArg('FLOOR', 1, SelfManager.self().getPatchVariable("grain-here"))));
  ...
  temp = (function() {
    try {
      ...
      SelfManager.self().setVariable("life-expectancy", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("life-expectancy-min")), PrimChecks.math.random(PrimChecks.math.plus(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("life-expectancy-max")), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("life-expectancy-min"))), 1))));
      SelfManager.self().setVariable("metabolism", PrimChecks.math.plus(1, PrimChecks.math.random(PrimChecks.validator.checkArg('RANDOM', 1, world.observer.getGlobal("metabolism-max")))));
      SelfManager.self().setVariable("wealth", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("metabolism")), RandomPrims.randomLong(50)));
      SelfManager.self().setVariable("vision", PrimChecks.math.plus(1, PrimChecks.math.random(PrimChecks.validator.checkArg('RANDOM', 1, world.observer.getGlobal("max-vision")))));
      SelfManager.self().setVariable("age", PrimChecks.math.random(PrimChecks.validator.checkArg('RANDOM', 1, SelfManager.self().getVariable("life-expectancy"))));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let maxWealth = PrimChecks.list.max(PrimChecks.validator.checkArg('MAX', 8, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("wealth"); }))); letVars['maxWealth'] = maxWealth;
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (Prims.lte(SelfManager.self().getVariable("wealth"), PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, maxWealth), 3))) {
          SelfManager.self().setVariable("color", 15);
        }
        else {
          if (Prims.lte(SelfManager.self().getVariable("wealth"), PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, maxWealth), 2), 3))) {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["TURN-TOWARDS-GRAIN"](); }, true);
      procedures["HARVEST"]();
      Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["MOVE-EAT-AGE-DIE"](); }, true);
      procedures["RECOLOR-TURTLES"]();
      if (Prims.equality(PrimChecks.math.mod(world.ticker.tickCount(), PrimChecks.validator.checkArg('MOD', 1, world.observer.getGlobal("grain-growth-interval"))), 0)) {
  ...
  temp = (function() {
    try {
      ...
      for (let _index_3989_3995 = 0, _repeatcount_3989_3995 = StrictMath.floor(SelfManager.self().getVariable("vision")); _index_3989_3995 < _repeatcount_3989_3995; _index_3989_3995++){
        total = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, total), PrimChecks.validator.checkArg('+', 1, PrimChecks.agentset.of(SelfManager.self().patchAhead(howFar), function() { return SelfManager.self().getPatchVariable("grain-here"); }))); letVars['total'] = total;
        howFar = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, howFar), 1); letVars['howFar'] = howFar;
      }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        SelfManager.self().setVariable("wealth", PrimChecks.math.floor(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("wealth")), PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, SelfManager.self().getPatchVariable("grain-here")), PrimChecks.agentset.count(SelfManager.self().turtlesHere())))));
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
  ...
  temp = (function() {
    try {
      ...
      SelfManager.self().setVariable("wealth", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("wealth")), PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("metabolism"))));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let sortedWealths = PrimChecks.list.sort(PrimChecks.validator.checkArg('SORT', 120, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("wealth"); }))); letVars['sortedWealths'] = sortedWealths;
      let totalWealth = PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, sortedWealths)); letVars['totalWealth'] = totalWealth;
      ...
      for (let _index_6015_6021 = 0, _repeatcount_6015_6021 = StrictMath.floor(world.observer.getGlobal("num-people")); _index_6015_6021 < _repeatcount_6015_6021; _index_6015_6021++){
        wealthSumSoFar = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, wealthSumSoFar), PrimChecks.validator.checkArg('+', 1, PrimChecks.list.item(PrimChecks.validator.checkArg('ITEM', 1, index), PrimChecks.validator.checkArg('ITEM', 12, sortedWealths)))); letVars['wealthSumSoFar'] = wealthSumSoFar;
        world.observer.setGlobal("lorenz-points", PrimChecks.list.lput(PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, wealthSumSoFar), PrimChecks.validator.checkArg('/', 1, totalWealth)), 100), PrimChecks.validator.checkArg('LPUT', 8, world.observer.getGlobal("lorenz-points"))));
        index = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, index), 1); letVars['index'] = index;
        world.observer.setGlobal("gini-index-reserve", PrimChecks.math.minus(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("gini-index-reserve")), PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, index), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("num-people")))), PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, wealthSumSoFar), PrimChecks.validator.checkArg('/', 1, totalWealth))));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
