    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Lorenz Curve', 'lorenz')(function() {
        try {
          ...
          var letVars = { };
          plotManager.resetPen();
          plotManager.setPenInterval(PrimChecks.math.div(100, world.observer.getGlobal("num-people")));
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Gini-Index v. Time', 'default')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.div_unchecked(PrimChecks.math.div(world.observer.getGlobal("gini-index-reserve"), world.observer.getGlobal("num-people")), 0.5));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.patches()).ask(function() {
        ...
        if (Prims.lte(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("percent-best-land"))) {
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("num-people"), "").ask(function() {
        SelfManager.self().moveTo(PrimChecks.list.oneOf_unchecked(world.patches()));
  ...
  temp = (function() {
    try {
      ...
      SelfManager.self().setVariable("life-expectancy", PrimChecks.math.plus(world.observer.getGlobal("life-expectancy-min"), PrimChecks.math.random_unchecked(PrimChecks.math.plus_unchecked(PrimChecks.math.minus(world.observer.getGlobal("life-expectancy-max"), world.observer.getGlobal("life-expectancy-min")), 1))));
      SelfManager.self().setVariable("metabolism", PrimChecks.math.plus_unchecked(1, PrimChecks.math.random(world.observer.getGlobal("metabolism-max"))));
      SelfManager.self().setVariable("wealth", PrimChecks.math.plus(SelfManager.self().getVariable("metabolism"), RandomPrims.randomLong(50)));
      SelfManager.self().setVariable("vision", PrimChecks.math.plus_unchecked(1, PrimChecks.math.random(world.observer.getGlobal("max-vision"))));
    ...
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (Prims.lte(SelfManager.self().getVariable("wealth"), PrimChecks.math.div(maxWealth, 3))) {
          ...
          if (Prims.lte(SelfManager.self().getVariable("wealth"), PrimChecks.math.div_unchecked(PrimChecks.math.mult(maxWealth, 2), 3))) {
  ...
  temp = (function() {
    try {
      ...
      for (let _index_3989_3995 = 0, _repeatcount_3989_3995 = StrictMath.floor(SelfManager.self().getVariable("vision")); _index_3989_3995 < _repeatcount_3989_3995; _index_3989_3995++){
        total = PrimChecks.math.plus(total, PrimChecks.agentset.of_unchecked(SelfManager.self().patchAhead(howFar), function() { return SelfManager.self().getPatchVariable("grain-here"); })); letVars['total'] = total;
        howFar = PrimChecks.math.plus(howFar, 1); letVars['howFar'] = howFar;
      }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.lt(SelfManager.self().getPatchVariable("grain-here"), SelfManager.self().getPatchVariable("max-grain-here"))) {
        SelfManager.self().setPatchVariable("grain-here", PrimChecks.math.plus(SelfManager.self().getPatchVariable("grain-here"), world.observer.getGlobal("num-grain-grown")));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        SelfManager.self().setVariable("wealth", PrimChecks.math.floor_unchecked(PrimChecks.math.plus(SelfManager.self().getVariable("wealth"), PrimChecks.math.div(SelfManager.self().getPatchVariable("grain-here"), PrimChecks.agentset.count_unchecked(SelfManager.self().turtlesHere())))));
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
  ...
  temp = (function() {
    try {
      ...
      SelfManager.self().setVariable("wealth", PrimChecks.math.minus(SelfManager.self().getVariable("wealth"), SelfManager.self().getVariable("metabolism")));
      SelfManager.self().setVariable("age", PrimChecks.math.plus(SelfManager.self().getVariable("age"), 1));
  ...
  temp = (function() {
    try {
      ...
      for (let _index_6015_6021 = 0, _repeatcount_6015_6021 = StrictMath.floor(world.observer.getGlobal("num-people")); _index_6015_6021 < _repeatcount_6015_6021; _index_6015_6021++){
        wealthSumSoFar = PrimChecks.math.plus(wealthSumSoFar, PrimChecks.list.item(index, sortedWealths)); letVars['wealthSumSoFar'] = wealthSumSoFar;
        world.observer.setGlobal("lorenz-points", PrimChecks.list.lput(PrimChecks.math.mult_unchecked(PrimChecks.math.div(wealthSumSoFar, totalWealth), 100), world.observer.getGlobal("lorenz-points")));
        index = PrimChecks.math.plus(index, 1); letVars['index'] = index;
        world.observer.setGlobal("gini-index-reserve", PrimChecks.math.minus_unchecked(PrimChecks.math.plus(world.observer.getGlobal("gini-index-reserve"), PrimChecks.math.div(index, world.observer.getGlobal("num-people"))), PrimChecks.math.div(wealthSumSoFar, totalWealth)));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
