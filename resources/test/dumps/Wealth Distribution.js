...
function harvest() {
  AgentSet.ask(world.turtles(), true, function() {
    AgentSet.setTurtleVariable('wealth', StrictMath.floor((AgentSet.getTurtleVariable('wealth') + (AgentSet.getPatchVariable(5) / AgentSet.count(AgentSet.self().turtlesHere())))));
  });
  AgentSet.ask(world.turtles(), true, function() {
