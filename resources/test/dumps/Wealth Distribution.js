...
var procedures = (function() {
  ...
  var setupPatches = function() {
    ...
    for (var _index_1278_1284 = 0, _repeatcount_1278_1284 = StrictMath.floor(5); _index_1278_1284 < _repeatcount_1278_1284; _index_1278_1284++){
      world.patches().agentFilter(function() { return !Prims.equality(SelfPrims.getPatchVariable("max-grain-here"), 0); }).ask(function() { SelfPrims.setPatchVariable("grain-here", SelfPrims.getPatchVariable("max-grain-here")); }, true);
  ...
  var recolorTurtles = function() {
    var maxWealth = ListPrims.max(world.turtles().projectionBy(function() { return SelfPrims.getVariable("wealth"); }));
  ...
  var updateLorenzAndGini = function() {
    var sortedWealths = ListPrims.sort(world.turtles().projectionBy(function() { return SelfPrims.getVariable("wealth"); }));
