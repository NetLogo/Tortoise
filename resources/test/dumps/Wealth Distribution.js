...
function setupPatches() {
  AgentSet.ask(world.patches(), true, function() {
    ...
    if (Prims.lte(Prims.randomFloat(100), world.observer.getGlobal('percent-best-land'))) {
      AgentSet.setPatchVariable(6, world.observer.getGlobal('max-grain'));
...
function recolorPatch() {
  AgentSet.setPatchVariable(2, Prims.scaleColor(45, AgentSet.getPatchVariable(5), 0, world.observer.getGlobal('max-grain')));
}
...
function setInitialTurtleVars() {
  ...
  AgentSet.setTurtleVariable(15, (world.observer.getGlobal('life-expectancy-min') + Prims.random(((world.observer.getGlobal('life-expectancy-max') - world.observer.getGlobal('life-expectancy-min')) + 1))));
  AgentSet.setTurtleVariable(16, (1 + Prims.random(world.observer.getGlobal('metabolism-max'))));
  AgentSet.setTurtleVariable(14, (AgentSet.getTurtleVariable(16) + Prims.random(50)));
  AgentSet.setTurtleVariable(17, (1 + Prims.random(world.observer.getGlobal('max-vision'))));
}
...
function growGrain() {
  if (Prims.lt(AgentSet.getPatchVariable(5), AgentSet.getPatchVariable(6))) {
    AgentSet.setPatchVariable(5, (AgentSet.getPatchVariable(5) + world.observer.getGlobal('num-grain-grown')));
