    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Gini-Index v. Time', 'default')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.div(PrimChecks.math.div(world.observer.getGlobal("gini-index-reserve"), world.observer.getGlobal("num-people")), 0.5));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (Prims.lte(SelfManager.self().getVariable("wealth"), PrimChecks.math.div(maxWealth, 3))) {
          ...
          if (Prims.lte(SelfManager.self().getVariable("wealth"), PrimChecks.math.div((maxWealth * 2), 3))) {
