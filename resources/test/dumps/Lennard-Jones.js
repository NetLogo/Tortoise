      ...
      return plotManager.withTemporaryContext('energy per particle', 'default')(function() {
        try {
          ...
          if (Prims.gt(world.ticker.tickCount(), 3)) {
            plotManager.plotValue(PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("v-total")), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("num-atoms"))));
          }
        } catch (e) {
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("diameter", PrimChecks.math.sqrt(PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("density")), world.topology.width), world.topology.height), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("num-atoms")))));
      world.observer.setGlobal("max-move-dist", world.observer.getGlobal("diameter"));
      world.observer.setGlobal("cutoff-dist", PrimChecks.math.mult(2.5, PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("diameter"))));
  ...
  temp = (function() {
    try {
      ...
      let deltaX = PrimChecks.math.minus(PrimChecks.math.mult(PrimChecks.math.randomFloat(2), PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("max-move-dist"))), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("max-move-dist"))); letVars['deltaX'] = deltaX;
      let deltaY = PrimChecks.math.minus(PrimChecks.math.mult(PrimChecks.math.randomFloat(2), PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("max-move-dist"))), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("max-move-dist"))); letVars['deltaY'] = deltaY;
      SelfManager.self().setXY(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("xcor")), PrimChecks.validator.checkArg('+', 1, deltaX)), PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("ycor")), PrimChecks.validator.checkArg('+', 1, deltaY)));
      let vNew = procedures["CALC-V"](); letVars['vNew'] = vNew;
      let deltaV = PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, vNew), PrimChecks.validator.checkArg('-', 1, vOld)); letVars['deltaV'] = deltaV;
      if ((Prims.lt(vNew, vOld) || Prims.lt(PrimChecks.math.randomFloat(1), PrimChecks.math.exp(PrimChecks.math.div(PrimChecks.math.unaryminus(PrimChecks.validator.checkArg('-', 1, deltaV)), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("temperature"))))))) {
        world.observer.setGlobal("total-successful-moves", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("total-successful-moves")), 1));
        world.observer.setGlobal("current-successful-moves", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("current-successful-moves")), 1));
        world.observer.setGlobal("v-total", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("v-total")), PrimChecks.validator.checkArg('+', 1, deltaV)));
      }
      else {
        SelfManager.self().setXY(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("xcor")), PrimChecks.validator.checkArg('-', 1, deltaX)), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("ycor")), PrimChecks.validator.checkArg('-', 1, deltaY)));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      return PrimChecks.math.div(PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, PrimChecks.agentset.of(world.turtles(), function() { return procedures["CALC-V"](); }))), 2);
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(SelfPrims.other(SelfManager.self().inRadius(world.turtles(), world.observer.getGlobal("cutoff-dist")))).ask(function() {
        ...
        let dsquare = PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("diameter")), PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("diameter"))); letVars['dsquare'] = dsquare;
        let attractTerm = PrimChecks.math.div(PrimChecks.math.pow(PrimChecks.validator.checkArg('^', 1, dsquare), 3), PrimChecks.math.pow(PrimChecks.validator.checkArg('^', 1, rsquare), 3)); letVars['attractTerm'] = attractTerm;
        let repelTerm = PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, attractTerm), PrimChecks.validator.checkArg('*', 1, attractTerm)); letVars['repelTerm'] = repelTerm;
        let vi = PrimChecks.math.plus(PrimChecks.math.mult(PrimChecks.math.mult(4, PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("eps"))), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, repelTerm), PrimChecks.validator.checkArg('-', 1, attractTerm))), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("pot-offset"))); letVars['vi'] = vi;
        v = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, v), PrimChecks.validator.checkArg('+', 1, vi)); letVars['v'] = v;
      }, true);
      Errors.reportInContextCheck(reporterContext);
      return v;
      Errors.missingReport();
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("current-successful-moves")), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("current-move-attempts")));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.lt(procedures["ACCEPT-RATE"](), 0.5)) {
        ...
        world.observer.setGlobal("max-move-dist", PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("max-move-dist")), 1.05));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("v-total")), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("num-atoms")));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(world.observer.getGlobal("initial-config"), "HCP")) {
        let l = PrimChecks.math.sqrt(PrimChecks.validator.checkArg('SQRT', 1, world.observer.getGlobal("num-atoms"))); letVars['l'] = l;
        let rowDist = PrimChecks.math.mult(PrimChecks.math.pow(2, PrimChecks.math.div(1, 6)), PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("diameter"))); letVars['rowDist'] = rowDist;
        let ypos = PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.math.unaryminus(PrimChecks.validator.checkArg('-', 1, l)), PrimChecks.validator.checkArg('*', 1, rowDist)), 2); letVars['ypos'] = ypos;
        let xpos = PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.math.unaryminus(PrimChecks.validator.checkArg('-', 1, l)), PrimChecks.validator.checkArg('*', 1, rowDist)), 2); letVars['xpos'] = xpos;
        let rNum = 0; letVars['rNum'] = rNum;
        Errors.askNobodyCheck(world.turtles()).ask(function() {
          if (Prims.gt(xpos, PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, l), PrimChecks.validator.checkArg('*', 1, rowDist)), 2))) {
            rNum = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, rNum), 1); letVars['rNum'] = rNum;
            xpos = PrimChecks.math.plus(PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.math.unaryminus(PrimChecks.validator.checkArg('-', 1, l)), PrimChecks.validator.checkArg('*', 1, rowDist)), 2), PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.math.mod(PrimChecks.validator.checkArg('MOD', 1, rNum), 2), PrimChecks.validator.checkArg('*', 1, rowDist)), 2)); letVars['xpos'] = xpos;
            ypos = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, ypos), PrimChecks.validator.checkArg('+', 1, rowDist)); letVars['ypos'] = ypos;
          }
          SelfManager.self().setXY(xpos, ypos);
          xpos = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, xpos), PrimChecks.validator.checkArg('+', 1, rowDist)); letVars['xpos'] = xpos;
        }, true);
      }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let rMin = PrimChecks.math.mult(0.7, PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("diameter"))); letVars['rMin'] = rMin;
      Errors.askNobodyCheck(world.turtles()).ask(function() {
