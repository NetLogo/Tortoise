      ...
      return plotManager.withTemporaryContext('energy per particle', 'default')(function() {
        try {
          ...
          if (Prims.gt(world.ticker.tickCount(), 3)) {
            plotManager.plotValue(PrimChecks.math.div(world.observer.getGlobal("v-total"), world.observer.getGlobal("num-atoms")));
          }
        } catch (e) {
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.div(world.observer.getGlobal("current-successful-moves"), world.observer.getGlobal("current-move-attempts"));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.div(world.observer.getGlobal("v-total"), world.observer.getGlobal("num-atoms"));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
