    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average Colors Over Time', 'Monarchs')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("MONARCHS"), function() { return SelfManager.self().getVariable("color"); }))));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average Colors Over Time', 'Viceroys')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("VICEROYS"), function() { return SelfManager.self().getVariable("color"); }))));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      SelfManager.self().setVariable("heading", PrimChecks.math.plus(180, RandomPrims.randomLong(180)));
  ...
  temp = (function() {
    try {
      ...
      if (!Prims.equality(birdHere, Nobody)) {
        if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, birdHere), function() {
          return procedures["COLOR-IN-MEMORY?"](PrimChecks.agentset.of(SelfManager.myself(), function() { return SelfManager.self().getVariable("color"); }));
        })))) {
          if (Prims.equality(SelfManager.self().getVariable("breed"), world.turtleManager.turtlesOfBreed("MONARCHS"))) {
            Errors.askNobodyCheck(birdHere).ask(function() {
              procedures["REMEMBER-COLOR"](PrimChecks.agentset.of(SelfManager.myself(), function() { return SelfManager.self().getVariable("color"); }));
            }, true);
          }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(SelfManager.self().getVariable("breed"), world.turtleManager.turtlesOfBreed("MONARCHS"))) {
        ...
        if (Prims.lt(PrimChecks.math.random(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("VICEROYS"))), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("carrying-capacity-viceroys")), PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("VICEROYS"))))) {
          procedures["HATCH-BUTTERFLY"]();
        }
      }
    } catch (e) {
