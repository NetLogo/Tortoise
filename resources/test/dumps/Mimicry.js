    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average Colors Over Time', 'Monarchs')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.mean(world.turtleManager.turtlesOfBreed("MONARCHS").projectionBy(function() { return SelfManager.self().getVariable("color"); })));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average Colors Over Time', 'Viceroys')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.mean(world.turtleManager.turtlesOfBreed("VICEROYS").projectionBy(function() { return SelfManager.self().getVariable("color"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
