    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average Colors Over Time', 'Monarchs')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("MONARCHS"), function() { return SelfManager.self().getVariable("color"); })));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average Colors Over Time', 'Viceroys')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("VICEROYS"), function() { return SelfManager.self().getVariable("color"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      if (Prims.equality(SelfManager.self().getVariable("breed"), world.turtleManager.turtlesOfBreed("MONARCHS"))) {
        if (Prims.lt(PrimChecks.math.random(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("MONARCHS"))), (world.observer.getGlobal("carrying-capacity-monarchs") - PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("MONARCHS"))))) {
          procedures["HATCH-BUTTERFLY"]();
        }
      }
      else {
        if (Prims.lt(PrimChecks.math.random(PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("VICEROYS"))), (world.observer.getGlobal("carrying-capacity-viceroys") - PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("VICEROYS"))))) {
          procedures["HATCH-BUTTERFLY"]();
        }
      }
    } catch (e) {
