...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('default', plotOps.makePenOps, false, new PenBundle.State(0, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Average Wait Time of Cars', 'default', function() {
      plotManager.plotValue(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("wait-time"); }))));;
    });
  })];
  var setup   = function() {};
  var update  = function() {};
  ...
  var pens    = [new PenBundle.Pen('default', plotOps.makePenOps, false, new PenBundle.State(0, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Average Speed of Cars', 'default', function() {
      plotManager.plotValue(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("speed"); }))));;
    });
  })];
  var setup   = function() {
...
ProcedurePrims.defineCommand("setup", (function() {
  ...
  R = ProcedurePrims.callCommand("make-current", PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, world.observer.getGlobal("intersections")))); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("label-current"); if (R === DeathInterrupt) { return R; }
  ...
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(world.observer.getGlobal("num-cars"), ""), function() {
    R = ProcedurePrims.callCommand("setup-cars"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("set-car-color"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("record-data"); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtles(), function() { R = ProcedurePrims.callCommand("set-car-speed"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  world.ticker.reset();
}))
...
ProcedurePrims.defineCommand("setup-patches", (function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("roads")), function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.callCommand("setup-intersections"); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("setup-intersections", (function() {
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("intersections")), function() {
    ...
    R = ProcedurePrims.callCommand("set-signal-colors"); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("setup-cars", (function() {
  ...
  R = ProcedurePrims.callCommand("put-on-empty-road"); if (R === DeathInterrupt) { return R; }
...
ProcedurePrims.defineCommand("put-on-empty-road", (function() {
...
ProcedurePrims.defineCommand("go", (function() {
  R = ProcedurePrims.callCommand("update-current"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("set-signals"); if (R === DeathInterrupt) { return R; }
  world.observer.setGlobal("num-cars-stopped", 0);
  R = ProcedurePrims.ask(world.turtles(), function() {
    R = ProcedurePrims.callCommand("set-car-speed"); if (R === DeathInterrupt) { return R; }
    SelfManager.self().fd(SelfManager.self().getVariable("speed"));
    R = ProcedurePrims.callCommand("record-data"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("set-car-color"); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.callCommand("next-phase"); if (R === DeathInterrupt) { return R; }
  world.ticker.tick();
}))
ProcedurePrims.defineCommand("choose-current", (function() {
  if (MousePrims.isDown()) {
    ...
    if (PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, world.getPatchAt(xHmouse, yHmouse)), function() { return SelfManager.self().getPatchVariable("intersection?"); })) {
      R = ProcedurePrims.callCommand("update-current"); if (R === DeathInterrupt) { return R; }
      R = ProcedurePrims.callCommand("unlabel-current"); if (R === DeathInterrupt) { return R; }
      R = ProcedurePrims.callCommand("make-current", world.getPatchAt(xHmouse, yHmouse)); if (R === DeathInterrupt) { return R; }
      R = ProcedurePrims.callCommand("label-current"); if (R === DeathInterrupt) { return R; }
      return PrimChecks.procedure.stop();
    }
  }
}))
ProcedurePrims.defineCommand("make-current", (function(light) {
...
ProcedurePrims.defineCommand("update-current", (function() {
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("current-light")), function() {
...
ProcedurePrims.defineCommand("label-current", (function() {
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("current-light")), function() {
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self()._optimalPatchNorthWest()), function() {
      SelfManager.self().setPatchVariable("plabel-color", 0);
      SelfManager.self().setPatchVariable("plabel", "current");
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("unlabel-current", (function() {
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("current-light")), function() {
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self()._optimalPatchNorthWest()), function() { SelfManager.self().setPatchVariable("plabel", ""); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("set-signals", (function() {
  R = ProcedurePrims.ask(PrimChecks.agentset.with(PrimChecks.validator.checkArg('WITH', 112, world.observer.getGlobal("intersections")), function() {
...
ProcedurePrims.defineCommand("set-signal-colors", (function() {
  if (world.observer.getGlobal("power?")) {
    if (SelfManager.self().getPatchVariable("green-light-up?")) {
      R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self()._optimalPatchWest()), function() { SelfManager.self().setPatchVariable("pcolor", 15); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
      R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self()._optimalPatchNorth()), function() { SelfManager.self().setPatchVariable("pcolor", 55); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }
    else {
      R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self()._optimalPatchWest()), function() { SelfManager.self().setPatchVariable("pcolor", 55); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
      R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self()._optimalPatchNorth()), function() { SelfManager.self().setPatchVariable("pcolor", 15); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }
  }
  else {
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self()._optimalPatchWest()), function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self()._optimalPatchNorth()), function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
}))
ProcedurePrims.defineCommand("set-car-speed", (function() {
  if (Prims.equality(SelfManager.self().getPatchVariable("pcolor"), 15)) {
    SelfManager.self().setVariable("speed", 0);
  }
  else {
    if (SelfManager.self().getVariable("up-car?")) {
      R = ProcedurePrims.callCommand("set-speed", 0, -1); if (R === DeathInterrupt) { return R; }
    }
    else {
      R = ProcedurePrims.callCommand("set-speed", 1, 0); if (R === DeathInterrupt) { return R; }
    }
  }
}))
ProcedurePrims.defineCommand("set-speed", (function(deltaHx, deltaHy) {
  ...
  if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, turtlesHahead))) {
    if (PrimChecks.agentset.anyWith(turtlesHahead, function() {
      return !Prims.equality(SelfManager.self().getVariable("up-car?"), PrimChecks.agentset.of(SelfManager.myself(), function() { return SelfManager.self().getVariable("up-car?"); }));
    })) {
      SelfManager.self().setVariable("speed", 0);
    }
    else {
      SelfManager.self().setVariable("speed", PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, turtlesHahead))), function() { return SelfManager.self().getVariable("speed"); }));
      R = ProcedurePrims.callCommand("slow-down"); if (R === DeathInterrupt) { return R; }
    }
  }
  else {
    R = ProcedurePrims.callCommand("speed-up"); if (R === DeathInterrupt) { return R; }
  }
}))
ProcedurePrims.defineCommand("slow-down", (function() {
  if (Prims.lte(SelfManager.self().getVariable("speed"), 0)) {
    SelfManager.self().setVariable("speed", 0);
  }
  else {
    SelfManager.self().setVariable("speed", PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("speed")), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("acceleration"))));
  }
}))
ProcedurePrims.defineCommand("speed-up", (function() {
  if (Prims.gt(SelfManager.self().getVariable("speed"), world.observer.getGlobal("speed-limit"))) {
    ...
    SelfManager.self().setVariable("speed", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("speed")), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("acceleration"))));
  }
}))
ProcedurePrims.defineCommand("set-car-color", (function() {
  if (Prims.lt(SelfManager.self().getVariable("speed"), PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("speed-limit")), 2))) {
...
ProcedurePrims.defineCommand("record-data", (function() {
  if (Prims.equality(SelfManager.self().getVariable("speed"), 0)) {
    ...
    SelfManager.self().setVariable("wait-time", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("wait-time")), 1));
  }
  else {
    SelfManager.self().setVariable("wait-time", 0);
  }
}))
ProcedurePrims.defineCommand("change-current", (function() {
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("current-light")), function() {
    SelfManager.self().setPatchVariable("green-light-up?", PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getPatchVariable("green-light-up?"))));
    R = ProcedurePrims.callCommand("set-signal-colors"); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("next-phase", (function() {
