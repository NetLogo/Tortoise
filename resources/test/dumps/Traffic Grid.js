...
function setupPatches() {
  AgentSet.ask(world.patches(), true, function() {
    ...
    AgentSet.setPatchVariable(10, false);
    AgentSet.setPatchVariable(6, true);
    AgentSet.setPatchVariable(7, -1);
    AgentSet.setPatchVariable(8, -1);
  ...
  world.observer.setGlobal('roads', AgentSet.agentFilter(world.patches(), function() {
    return (Prims.equality(StrictMath.floor(Prims.mod(((AgentSet.getPatchVariable(0) + world.maxPxcor) - StrictMath.floor((world.observer.getGlobal('grid-x-inc') - 1))), world.observer.getGlobal('grid-x-inc'))), 0) || Prims.equality(StrictMath.floor(Prims.mod((AgentSet.getPatchVariable(1) + world.maxPycor), world.observer.getGlobal('grid-y-inc'))), 0));
  }));
...
function setupIntersections() {
  AgentSet.ask(world.observer.getGlobal('intersections'), true, function() {
    ...
    AgentSet.setPatchVariable(7, StrictMath.floor(((AgentSet.getPatchVariable(1) + world.maxPycor) / world.observer.getGlobal('grid-y-inc'))));
    AgentSet.setPatchVariable(8, StrictMath.floor(((AgentSet.getPatchVariable(0) + world.maxPxcor) / world.observer.getGlobal('grid-x-inc'))));
...
function setupCars() {
  ...
  if (AgentSet.getPatchVariable(5)) {
    ...
    if (Prims.equality(StrictMath.floor(Prims.mod(((AgentSet.getPatchVariable(0) + world.maxPxcor) - StrictMath.floor((world.observer.getGlobal('grid-x-inc') - 1))), world.observer.getGlobal('grid-x-inc'))), 0)) {
      AgentSet.setTurtleVariable(14, true);
    }
    else {
      AgentSet.setTurtleVariable(14, false);
...
function updateCurrent() {
  AgentSet.ask(world.observer.getGlobal('current-light'), true, function() {
    AgentSet.setPatchVariable(9, world.observer.getGlobal('current-phase'));
    AgentSet.setPatchVariable(10, world.observer.getGlobal('current-auto?'));
  });
}
...
function setSignals() {
  AgentSet.ask(AgentSet.agentFilter(world.observer.getGlobal('intersections'), function() {
    return (AgentSet.getPatchVariable(10) && Prims.equality(world.observer.getGlobal('phase'), StrictMath.floor(((AgentSet.getPatchVariable(9) * world.observer.getGlobal('ticks-per-cycle')) / 100))));
  }), true, function() {
...
function setCarSpeed() {
  if (Prims.equality(AgentSet.getPatchVariable(2), 15)) {
    AgentSet.setTurtleVariable(13, 0);
  }
  else {
    if (AgentSet.getTurtleVariable(14)) {
...
function slowDown() {
  if (Prims.lte(AgentSet.getTurtleVariable(13), 0)) {
    AgentSet.setTurtleVariable(13, 0);
  }
  else {
...
function speedUp() {
  if (Prims.gt(AgentSet.getTurtleVariable(13), world.observer.getGlobal('speed-limit'))) {
    AgentSet.setTurtleVariable(13, world.observer.getGlobal('speed-limit'));
  }
  else {
    AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) + world.observer.getGlobal('acceleration')));
  }
...
function setCarColor() {
  if (Prims.lt(AgentSet.getTurtleVariable(13), (world.observer.getGlobal('speed-limit') / 2))) {
    AgentSet.setTurtleVariable(1, 105);
  }
  else {
    AgentSet.setTurtleVariable(1, (85 - 2));
  }
}
function recordData() {
