    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average Wait Time of Cars', 'default')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("wait-time"); })));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Average Speed of Cars', 'default')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.list.mean(PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("speed"); })));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
