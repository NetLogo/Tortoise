...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      procedures["MAKE-CURRENT"](PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, world.observer.getGlobal("intersections"))));
  ...
  temp = (function() {
    try {
      ...
      if (MousePrims.isDown()) {
        ...
        if (PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, world.getPatchAt(xMouse, yMouse)), function() { return SelfManager.self().getPatchVariable("intersection?"); })) {
          procedures["UPDATE-CURRENT"]();
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(PrimChecks.agentset.with(PrimChecks.validator.checkArg('WITH', 112, world.observer.getGlobal("intersections")), function() {
  ...
  temp = (function(deltaX, deltaY) {
    try {
      ...
      if (PrimChecks.agentset.any(PrimChecks.validator.checkArg('ANY?', 112, turtlesAhead))) {
        if (PrimChecks.agentset.anyWith(turtlesAhead, function() {
          ...
          SelfManager.self().setVariable("speed", PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, PrimChecks.list.oneOf(PrimChecks.validator.checkArg('ONE-OF', 120, turtlesAhead))), function() { return SelfManager.self().getVariable("speed"); }));
