...
function setup() {
  ...
  Call(setupGlobals);
  Call(setupPatches);
  Call(makeCurrent, AgentSet.oneOf(Globals.getGlobal(14)));
  Call(labelCurrent);
...
function setupGlobals() {
  Globals.setGlobal(13, Nobody);
  Globals.setGlobal(11, 0);
  Globals.setGlobal(12, 0);
  Globals.setGlobal(8, (world.width() / Globals.getGlobal(1)));
  Globals.setGlobal(9, (world.height() / Globals.getGlobal(0)));
  Globals.setGlobal(10, 0.099);
}
...
function setupIntersections() {
  AgentSet.ask(Globals.getGlobal(14), true, function() {
    AgentSet.setPatchVariable(5, true);
    AgentSet.setPatchVariable(6, true);
    AgentSet.setPatchVariable(9, 0);
    AgentSet.setPatchVariable(10, true);
    AgentSet.setPatchVariable(7, StrictMath.floor(((AgentSet.getPatchVariable(1) + world.maxPycor) / Globals.getGlobal(9))));
    AgentSet.setPatchVariable(8, StrictMath.floor(((AgentSet.getPatchVariable(0) + world.maxPxcor) / Globals.getGlobal(8))));
...
function setupCars() {
  ...
  if (AgentSet.getPatchVariable(5)) {
    ...
    if (Prims.equality(StrictMath.floor(Prims.mod(((AgentSet.getPatchVariable(0) + world.maxPxcor) - StrictMath.floor((Globals.getGlobal(8) - 1))), Globals.getGlobal(8))), 0)) {
      AgentSet.setTurtleVariable(14, true);
    }
    else {
      AgentSet.setTurtleVariable(14, false);
...
function updateCurrent() {
  AgentSet.ask(Globals.getGlobal(13), true, function() {
    AgentSet.setPatchVariable(9, Globals.getGlobal(6));
    AgentSet.setPatchVariable(10, Globals.getGlobal(7));
  });
}
...
function slowDown() {
  if (Prims.lte(AgentSet.getTurtleVariable(13), 0)) {
    ...
    AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) - Globals.getGlobal(10)));
  }
}
function speedUp() {
  if (Prims.gt(AgentSet.getTurtleVariable(13), Globals.getGlobal(4))) {
    AgentSet.setTurtleVariable(13, Globals.getGlobal(4));
  }
  else {
    AgentSet.setTurtleVariable(13, (AgentSet.getTurtleVariable(13) + Globals.getGlobal(10)));
  }
...
function setCarColor() {
  if (Prims.lt(AgentSet.getTurtleVariable(13), (Globals.getGlobal(4) / 2))) {
...
function nextPhase() {
  ...
  if (Prims.equality(Prims.mod(Globals.getGlobal(11), Globals.getGlobal(5)), 0)) {
    Globals.setGlobal(11, 0);
  }
}
Globals.setGlobal(0, 5);
Globals.setGlobal(1, 5);
Globals.setGlobal(2, true);
Globals.setGlobal(3, 200);
Globals.setGlobal(4, 1);
Globals.setGlobal(5, 20);
Globals.setGlobal(6, 0);
Globals.setGlobal(7, true);
