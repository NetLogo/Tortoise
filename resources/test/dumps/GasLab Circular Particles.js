    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Speed Histogram', undefined)(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.setXRange(0, PrimChecks.math.ceil((procedures["INIT-PARTICLE-SPEED"]() * 2)));
          plotManager.setYRange(0, PrimChecks.math.ceil(PrimChecks.math.div(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES")), 6)));
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Energy Histogram', undefined)(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.setXRange(0, PrimChecks.math.ceil((((0.5 * (procedures["INIT-PARTICLE-SPEED"]() * 2)) * (procedures["INIT-PARTICLE-SPEED"]() * 2)) * procedures["MAX-PARTICLE-MASS"]())));
          plotManager.setYRange(0, PrimChecks.math.ceil(PrimChecks.math.div(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES")), 6)));
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      if (Prims.gt(PrimChecks.math.floor(world.ticker.tickCount()), PrimChecks.math.floor((world.ticker.tickCount() - world.observer.getGlobal("tick-delta"))))) {
        procedures["UPDATE-VARIABLES"]();
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("percent-medium", (PrimChecks.math.div(world.observer.getGlobal("medium"), PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES"))) * 100));
      world.observer.setGlobal("percent-slow", (PrimChecks.math.div(world.observer.getGlobal("slow"), PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES"))) * 100));
      world.observer.setGlobal("percent-fast", (PrimChecks.math.div(world.observer.getGlobal("fast"), PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES"))) * 100));
    ...
    try {
      ...
      Errors.askNobodyCheck(SelfPrims.other(world.turtleManager.turtlesOfBreed("PARTICLES"))).ask(function() {
        ...
        if (Prims.gt(timeToCollision, 0)) {
          world.observer.setGlobal("collisions", PrimChecks.list.fput(ListPrims.list((timeToCollision + world.ticker.tickCount()), SelfManager.self(), SelfManager.myself()), world.observer.getGlobal("collisions")));
        }
      }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      ...
      if (!Prims.equality(xSpeed, 0)) {
        let rightInterval = PrimChecks.math.div((((world.observer.getGlobal("box-edge") - 0.5) - SelfManager.self().getVariable("xcor")) - PrimChecks.math.div(SelfManager.self().getVariable("size"), 2)), xSpeed); letVars['rightInterval'] = rightInterval;
        if (Prims.gt(rightInterval, 0)) {
          procedures["ASSIGN-COLLIDING-WALL"](rightInterval,"right wall");
        }
        let leftInterval = PrimChecks.math.div(((( -(world.observer.getGlobal("box-edge")) + 0.5) - SelfManager.self().getVariable("xcor")) + PrimChecks.math.div(SelfManager.self().getVariable("size"), 2)), xSpeed); letVars['leftInterval'] = leftInterval;
      ...
      if (!Prims.equality(ySpeed, 0)) {
        let topInterval = PrimChecks.math.div((((world.observer.getGlobal("box-edge") - 0.5) - SelfManager.self().getVariable("ycor")) - PrimChecks.math.div(SelfManager.self().getVariable("size"), 2)), ySpeed); letVars['topInterval'] = topInterval;
        if (Prims.gt(topInterval, 0)) {
          procedures["ASSIGN-COLLIDING-WALL"](topInterval,"top wall");
        }
        let bottomInterval = PrimChecks.math.div(((( -(world.observer.getGlobal("box-edge")) + 0.5) - SelfManager.self().getVariable("ycor")) + PrimChecks.math.div(SelfManager.self().getVariable("size"), 2)), ySpeed); letVars['bottomInterval'] = bottomInterval;
    ...
    try {
      ...
      if (NLType.checks.isString(world.observer.getGlobal("particle2"))) {
        ...
        if ((Prims.equality(world.observer.getGlobal("particle2"), "top wall") || Prims.equality(world.observer.getGlobal("particle2"), "bottom wall"))) {
          Errors.askNobodyCheck(world.observer.getGlobal("particle1")).ask(function() { SelfManager.self().setVariable("heading", (180 - SelfManager.self().getVariable("heading"))); }, true);
          throw new Exception.StopInterrupt;
        }
      }
