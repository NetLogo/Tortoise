...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("percent-medium", (PrimChecks.math.div(world.observer.getGlobal("medium"), PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("PARTICLES"))) * 100));
      world.observer.setGlobal("percent-slow", (PrimChecks.math.div(world.observer.getGlobal("slow"), PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("PARTICLES"))) * 100));
      world.observer.setGlobal("percent-fast", (PrimChecks.math.div(world.observer.getGlobal("fast"), PrimChecks.agentset.count(world.turtleManager.turtlesOfBreed("PARTICLES"))) * 100));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.list.max(PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("PARTICLES"), function() { return SelfManager.self().getVariable("mass"); }));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
