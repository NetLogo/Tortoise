    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Speed Histogram', undefined)(function() {
        try {
          ...
          plotManager.setYRange(0, PrimChecks.math.ceil(PrimChecks.math.div(world.turtleManager.turtlesOfBreed("PARTICLES").size(), 6)));
