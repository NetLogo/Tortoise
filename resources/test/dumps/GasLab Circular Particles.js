    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Speed Histogram', undefined)(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.setXRange(0, PrimChecks.math.ceil_unchecked(PrimChecks.math.mult(procedures["INIT-PARTICLE-SPEED"](), 2)));
          plotManager.setYRange(0, PrimChecks.math.ceil_unchecked(PrimChecks.math.div_unchecked(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES")), 6)));
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Energy Histogram', 'particles')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.drawHistogramFrom(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES"), function() { return SelfManager.self().getVariable("energy"); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Energy Histogram', undefined)(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.setXRange(0, PrimChecks.math.ceil_unchecked(PrimChecks.math.mult(PrimChecks.math.mult_unchecked(PrimChecks.math.mult_unchecked(0.5, PrimChecks.math.mult(procedures["INIT-PARTICLE-SPEED"](), 2)), PrimChecks.math.mult(procedures["INIT-PARTICLE-SPEED"](), 2)), procedures["MAX-PARTICLE-MASS"]())));
          plotManager.setYRange(0, PrimChecks.math.ceil_unchecked(PrimChecks.math.div_unchecked(PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES")), 6)));
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("box-edge", PrimChecks.math.minus_unchecked(world.topology.maxPxcor, 1));
      Errors.askNobodyCheck(PrimChecks.agentset.with_unchecked(world.patches(), function() {
        return (((Prims.equality(PrimChecks.math.abs(SelfManager.self().getPatchVariable("pxcor")), world.observer.getGlobal("box-edge")) || Prims.equality(PrimChecks.math.abs(SelfManager.self().getPatchVariable("pycor")), world.observer.getGlobal("box-edge"))) && Prims.lte(PrimChecks.math.abs(SelfManager.self().getPatchVariable("pxcor")), world.observer.getGlobal("box-edge"))) && Prims.lte(PrimChecks.math.abs(SelfManager.self().getPatchVariable("pycor")), world.observer.getGlobal("box-edge")));
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-number-particles"), "PARTICLES").ask(function() {
        ...
        SelfManager.self().setVariable("size", PrimChecks.math.plus(world.observer.getGlobal("smallest-particle-size"), PrimChecks.math.randomFloat_unchecked(PrimChecks.math.minus(world.observer.getGlobal("largest-particle-size"), world.observer.getGlobal("smallest-particle-size")))));
        SelfManager.self().setVariable("mass", PrimChecks.math.mult(SelfManager.self().getVariable("size"), SelfManager.self().getVariable("size")));
      ...
      }, "[ the-particle -> ask the-particle [ position-randomly while [ overlapping? ] [ position-randomly ] ] ]"), PrimChecks.list.sortBy_unchecked(Tasks.reporterTask(function(a, b) {
        Errors.procedureArgumentsCheck(2, arguments.length);
        return Prims.gt(PrimChecks.agentset.of(a, function() { return SelfManager.self().getVariable("size"); }), PrimChecks.agentset.of(b, function() { return SelfManager.self().getVariable("size"); }));
  ...
  temp = (function() {
    try {
      ...
      return PrimChecks.agentset.anyOtherWith(SelfManager.self().inRadius(world.turtleManager.turtlesOfBreed("PARTICLES"), PrimChecks.math.div_unchecked(PrimChecks.math.plus(SelfManager.self().getVariable("size"), world.observer.getGlobal("largest-particle-size")), 2)), function() {
        return Prims.lt(SelfManager.self().distance(SelfManager.myself()), PrimChecks.math.div_unchecked(PrimChecks.math.plus(SelfManager.self().getVariable("size"), PrimChecks.agentset.of_unchecked(SelfManager.myself(), function() { return SelfManager.self().getVariable("size"); })), 2));
      });
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().setXY(PrimChecks.math.mult(PrimChecks.list.oneOf_unchecked([1, -1]), PrimChecks.math.randomFloat_unchecked(PrimChecks.math.minus_unchecked(PrimChecks.math.minus(world.observer.getGlobal("box-edge"), 0.5), PrimChecks.math.div(SelfManager.self().getVariable("size"), 2)))), PrimChecks.math.mult(PrimChecks.list.oneOf_unchecked([1, -1]), PrimChecks.math.randomFloat_unchecked(PrimChecks.math.minus_unchecked(PrimChecks.math.minus(world.observer.getGlobal("box-edge"), 0.5), PrimChecks.math.div(SelfManager.self().getVariable("size"), 2)))));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("PARTICLES")).ask(function() {
        SelfManager.self().jumpIfAble(PrimChecks.math.mult(SelfManager.self().getVariable("speed"), world.observer.getGlobal("tick-delta")));
      }, true);
      ...
      if (Prims.gt(PrimChecks.math.floor_unchecked(world.ticker.tickCount()), PrimChecks.math.floor_unchecked(PrimChecks.math.minus(world.ticker.tickCount(), world.observer.getGlobal("tick-delta"))))) {
        procedures["UPDATE-VARIABLES"]();
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("percent-medium", PrimChecks.math.mult_unchecked(PrimChecks.math.div(world.observer.getGlobal("medium"), PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES"))), 100));
      world.observer.setGlobal("percent-slow", PrimChecks.math.mult_unchecked(PrimChecks.math.div(world.observer.getGlobal("slow"), PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES"))), 100));
      world.observer.setGlobal("percent-fast", PrimChecks.math.mult_unchecked(PrimChecks.math.div(world.observer.getGlobal("fast"), PrimChecks.agentset.count_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES"))), 100));
  ...
  temp = (function() {
    try {
      ...
      let myXSpeed = PrimChecks.math.mult(SelfManager.self().getVariable("speed"), SelfManager.self().dx()); letVars['myXSpeed'] = myXSpeed;
      let myYSpeed = PrimChecks.math.mult(SelfManager.self().getVariable("speed"), SelfManager.self().dy()); letVars['myYSpeed'] = myYSpeed;
      Errors.askNobodyCheck(SelfPrims.other(world.turtleManager.turtlesOfBreed("PARTICLES"))).ask(function() {
        let dpx = PrimChecks.math.minus(SelfManager.self().getVariable("xcor"), myX); letVars['dpx'] = dpx;
        let dpy = PrimChecks.math.minus(SelfManager.self().getVariable("ycor"), myY); letVars['dpy'] = dpy;
        let xSpeed = PrimChecks.math.mult(SelfManager.self().getVariable("speed"), SelfManager.self().dx()); letVars['xSpeed'] = xSpeed;
        let ySpeed = PrimChecks.math.mult(SelfManager.self().getVariable("speed"), SelfManager.self().dy()); letVars['ySpeed'] = ySpeed;
        let dvx = PrimChecks.math.minus(xSpeed, myXSpeed); letVars['dvx'] = dvx;
        let dvy = PrimChecks.math.minus(ySpeed, myYSpeed); letVars['dvy'] = dvy;
        let sumR = PrimChecks.math.plus_unchecked(PrimChecks.math.div(myParticleSize, 2), PrimChecks.math.div(PrimChecks.agentset.of_unchecked(SelfManager.self(), function() { return SelfManager.self().getVariable("size"); }), 2)); letVars['sumR'] = sumR;
        let pSquared = PrimChecks.math.minus_unchecked(PrimChecks.math.plus_unchecked(PrimChecks.math.mult(dpx, dpx), PrimChecks.math.mult(dpy, dpy)), PrimChecks.math.pow(sumR, 2)); letVars['pSquared'] = pSquared;
        let pv = PrimChecks.math.mult_unchecked(2, PrimChecks.math.plus_unchecked(PrimChecks.math.mult(dpx, dvx), PrimChecks.math.mult(dpy, dvy))); letVars['pv'] = pv;
        let vSquared = PrimChecks.math.plus_unchecked(PrimChecks.math.mult(dvx, dvx), PrimChecks.math.mult(dvy, dvy)); letVars['vSquared'] = vSquared;
        let d1 = PrimChecks.math.minus_unchecked(PrimChecks.math.pow(pv, 2), PrimChecks.math.mult(PrimChecks.math.mult(4, vSquared), pSquared)); letVars['d1'] = d1;
        let timeToCollision = -1; letVars['timeToCollision'] = timeToCollision;
        if (Prims.gt(d1, 0)) {
          timeToCollision = PrimChecks.math.div_unchecked(PrimChecks.math.minus_unchecked(PrimChecks.math.unaryminus(pv), PrimChecks.math.sqrt(d1)), PrimChecks.math.mult(2, vSquared)); letVars['timeToCollision'] = timeToCollision;
        }
        if (Prims.gt(timeToCollision, 0)) {
          world.observer.setGlobal("collisions", PrimChecks.list.fput(ListPrims.list(PrimChecks.math.plus(timeToCollision, world.ticker.tickCount()), SelfManager.self(), SelfManager.myself()), world.observer.getGlobal("collisions")));
        }
      }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
  ...
  temp = (function() {
    try {
      ...
      if (!Prims.equality(xSpeed, 0)) {
        let rightInterval = PrimChecks.math.div(PrimChecks.math.minus_unchecked(PrimChecks.math.minus(PrimChecks.math.minus(world.observer.getGlobal("box-edge"), 0.5), SelfManager.self().getVariable("xcor")), PrimChecks.math.div(SelfManager.self().getVariable("size"), 2)), xSpeed); letVars['rightInterval'] = rightInterval;
        if (Prims.gt(rightInterval, 0)) {
          procedures["ASSIGN-COLLIDING-WALL"](rightInterval,"right wall");
        }
        let leftInterval = PrimChecks.math.div(PrimChecks.math.plus_unchecked(PrimChecks.math.minus(PrimChecks.math.plus_unchecked(PrimChecks.math.unaryminus(world.observer.getGlobal("box-edge")), 0.5), SelfManager.self().getVariable("xcor")), PrimChecks.math.div(SelfManager.self().getVariable("size"), 2)), xSpeed); letVars['leftInterval'] = leftInterval;
      ...
      if (!Prims.equality(ySpeed, 0)) {
        let topInterval = PrimChecks.math.div(PrimChecks.math.minus_unchecked(PrimChecks.math.minus(PrimChecks.math.minus(world.observer.getGlobal("box-edge"), 0.5), SelfManager.self().getVariable("ycor")), PrimChecks.math.div(SelfManager.self().getVariable("size"), 2)), ySpeed); letVars['topInterval'] = topInterval;
        if (Prims.gt(topInterval, 0)) {
          procedures["ASSIGN-COLLIDING-WALL"](topInterval,"top wall");
        }
        let bottomInterval = PrimChecks.math.div(PrimChecks.math.plus_unchecked(PrimChecks.math.minus(PrimChecks.math.plus_unchecked(PrimChecks.math.unaryminus(world.observer.getGlobal("box-edge")), 0.5), SelfManager.self().getVariable("ycor")), PrimChecks.math.div(SelfManager.self().getVariable("size"), 2)), ySpeed); letVars['bottomInterval'] = bottomInterval;
  ...
  temp = (function(timeToCollision, wall) {
    try {
      var reporterContext = false;
      var letVars = { };
      let collidingPair = ListPrims.list(PrimChecks.math.plus(timeToCollision, world.ticker.tickCount()), SelfManager.self(), wall); letVars['collidingPair'] = collidingPair;
      world.observer.setGlobal("collisions", PrimChecks.list.fput(collidingPair, world.observer.getGlobal("collisions")));
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("tick-delta", PrimChecks.math.minus(dt, world.ticker.tickCount()));
  ...
  temp = (function(otherParticle) {
    try {
      var reporterContext = false;
      var letVars = { };
      let mass2 = PrimChecks.agentset.of(otherParticle, function() { return SelfManager.self().getVariable("mass"); }); letVars['mass2'] = mass2;
      let speed2 = PrimChecks.agentset.of(otherParticle, function() { return SelfManager.self().getVariable("speed"); }); letVars['speed2'] = speed2;
      let heading2 = PrimChecks.agentset.of(otherParticle, function() { return SelfManager.self().getVariable("heading"); }); letVars['heading2'] = heading2;
      let theta = SelfManager.self().towards(otherParticle); letVars['theta'] = theta;
      let v1t = PrimChecks.math.mult(SelfManager.self().getVariable("speed"), PrimChecks.math.cos_unchecked(PrimChecks.math.minus(theta, SelfManager.self().getVariable("heading")))); letVars['v1t'] = v1t;
      let v1l = PrimChecks.math.mult(SelfManager.self().getVariable("speed"), PrimChecks.math.sin_unchecked(PrimChecks.math.minus(theta, SelfManager.self().getVariable("heading")))); letVars['v1l'] = v1l;
      let v2t = PrimChecks.math.mult(speed2, PrimChecks.math.cos_unchecked(PrimChecks.math.minus(theta, heading2))); letVars['v2t'] = v2t;
      let v2l = PrimChecks.math.mult(speed2, PrimChecks.math.sin_unchecked(PrimChecks.math.minus(theta, heading2))); letVars['v2l'] = v2l;
      let vcm = PrimChecks.math.div_unchecked(PrimChecks.math.plus_unchecked(PrimChecks.math.mult(SelfManager.self().getVariable("mass"), v1t), PrimChecks.math.mult(mass2, v2t)), PrimChecks.math.plus(SelfManager.self().getVariable("mass"), mass2)); letVars['vcm'] = vcm;
      ...
      SelfManager.self().setVariable("speed", PrimChecks.math.sqrt_unchecked(PrimChecks.math.plus_unchecked(PrimChecks.math.mult(v1t, v1t), PrimChecks.math.mult(v1l, v1l))));
      SelfManager.self().setVariable("energy", procedures["KINETIC-ENERGY"]());
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (Prims.lt(SelfManager.self().getVariable("speed"), PrimChecks.math.mult(0.5, world.observer.getGlobal("avg-speed")))) {
        SelfManager.self().setVariable("color", 105);
      }
      else {
        if (Prims.gt(SelfManager.self().getVariable("speed"), PrimChecks.math.mult(1.5, world.observer.getGlobal("avg-speed")))) {
  ...
  temp = (function(n) {
    try {
      ...
      while (Prims.lt(world.ticker.tickCount(), PrimChecks.math.mult(2, oldTicks))) {
        procedures["GO"]();
      }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.list.max(PrimChecks.agentset.of_unchecked(world.turtleManager.turtlesOfBreed("PARTICLES"), function() { return SelfManager.self().getVariable("mass"); }));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.mult(PrimChecks.math.mult(PrimChecks.math.mult(0.5, SelfManager.self().getVariable("mass")), SelfManager.self().getVariable("speed")), SelfManager.self().getVariable("speed"));
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
