    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cumulative Infected and Recovered', '% infected')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((PrimChecks.math.div((PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("cured?"); }) + PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); })), world.observer.getGlobal("initial-people")) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cumulative Infected and Recovered', '% recovered')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("cured?"); }), world.observer.getGlobal("initial-people")) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
