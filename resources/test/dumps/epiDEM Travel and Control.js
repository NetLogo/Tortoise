    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'Infected')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }));
        } catch (e) {
      ...
      return plotManager.withTemporaryContext('Populations', 'Not Infected')(function() {
        try {
          ...
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() {
            return PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("infected?")));
          }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cumulative Infected and Recovered', '% recovered')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult(PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("cured?"); }), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("initial-people"))), 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(world.getPatchAt(PrimChecks.math.div(PrimChecks.math.unaryminus(world.topology.maxPxcor), 2), 0)).ask(function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true);
    ...
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-people"), "").ask(function() {
        ...
        if (Prims.lt(PrimChecks.math.randomFloat(100), 5)) {
          ...
          SelfManager.self().setVariable("infection-length", PrimChecks.math.random(PrimChecks.validator.checkArg('RANDOM', 1, SelfManager.self().getVariable("recovery-time"))));
        }
        if ((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("infected?"))) && Prims.lt(PrimChecks.math.randomFloat(100), world.observer.getGlobal("inoculation-chance")))) {
    ...
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-ambulance"), "").ask(function() {
        if (Prims.lt(RandomPrims.randomLong(2), 1)) {
          SelfManager.self().setVariable("continent", 1);
          SelfManager.self().setXY(PrimChecks.math.div(PrimChecks.math.unaryminus(world.topology.maxPxcor), 2), 0);
        }
        else {
          SelfManager.self().setVariable("continent", 2);
          SelfManager.self().setXY(PrimChecks.math.div(world.topology.maxPxcor, 2), 0);
        }
        SelfManager.self().setVariable("cured?", false);
        SelfManager.self().setVariable("isolated?", false);
        SelfManager.self().setVariable("hospitalized?", false);
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().setVariable("isolation-tendency", PrimChecks.math.div(PrimChecks.math.randomNormal(PrimChecks.validator.checkArg('RANDOM-NORMAL', 1, world.observer.getGlobal("average-isolation-tendency")), PrimChecks.validator.checkArg('RANDOM-NORMAL', 1, world.observer.getGlobal("average-isolation-tendency"))), 4));
      SelfManager.self().setVariable("hospital-going-tendency", PrimChecks.math.div(PrimChecks.math.randomNormal(PrimChecks.validator.checkArg('RANDOM-NORMAL', 1, world.observer.getGlobal("average-hospital-going-tendency")), PrimChecks.validator.checkArg('RANDOM-NORMAL', 1, world.observer.getGlobal("average-hospital-going-tendency"))), 4));
      SelfManager.self().setVariable("recovery-time", PrimChecks.math.div(PrimChecks.math.randomNormal(PrimChecks.validator.checkArg('RANDOM-NORMAL', 1, world.observer.getGlobal("average-recovery-time")), PrimChecks.validator.checkArg('RANDOM-NORMAL', 1, world.observer.getGlobal("average-recovery-time"))), 4));
      if (Prims.gt(SelfManager.self().getVariable("recovery-time"), PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("average-recovery-time")), 2))) {
        SelfManager.self().setVariable("recovery-time", PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("average-recovery-time")), 2));
      }
      if (Prims.lt(SelfManager.self().getVariable("recovery-time"), 0)) {
        SelfManager.self().setVariable("recovery-time", 0);
      }
      if (Prims.gt(SelfManager.self().getVariable("isolation-tendency"), PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("average-isolation-tendency")), 2))) {
        SelfManager.self().setVariable("isolation-tendency", PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("average-isolation-tendency")), 2));
      }
      if (Prims.lt(SelfManager.self().getVariable("isolation-tendency"), 0)) {
        SelfManager.self().setVariable("isolation-tendency", 0);
      }
      if (Prims.gt(SelfManager.self().getVariable("hospital-going-tendency"), PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("average-hospital-going-tendency")), 2))) {
        SelfManager.self().setVariable("hospital-going-tendency", PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("average-hospital-going-tendency")), 2));
      }
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("isolated?"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("hospitalized?")))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("ambulance?"))))) {
          procedures["MOVE"]();
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (((PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("infected?")) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("isolated?")))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("hospitalized?"))))) {
          procedures["INFECT"]();
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if ((((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("isolated?"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("hospitalized?")))) && PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("infected?"))) && Prims.lt(RandomPrims.randomLong(100), SelfManager.self().getVariable("isolation-tendency")))) {
          procedures["ISOLATE"]();
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if ((((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("isolated?"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("hospitalized?")))) && PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("infected?"))) && Prims.lt(RandomPrims.randomLong(100), SelfManager.self().getVariable("hospital-going-tendency")))) {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (((PrimChecks.validator.checkArg('OR', 2, SelfManager.self().getVariable("isolated?")) || PrimChecks.validator.checkArg('OR', 2, SelfManager.self().getVariable("hospitalized?"))) && PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("cured?")))) {
  ...
  temp = (function() {
    try {
      ...
      if (world.observer.getGlobal("travel?")) {
        if ((Prims.lt(RandomPrims.randomLong(100), world.observer.getGlobal("travel-tendency")) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("ambulance?"))))) {
          SelfManager.self().setVariable("xcor", PrimChecks.math.unaryminus(PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("xcor"))));
        }
      }
      if (Prims.equality(SelfManager.self().getVariable("continent"), 1)) {
        if (Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.math.unaryminus(0.5))) {
          ...
          if (Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.plus(world.topology.minPxcor, 0.5))) {
            world.observer.setGlobal("angle", PrimChecks.math.randomFloat(180));
          }
          else {
        ...
        if (Prims.lt(SelfManager.self().getVariable("xcor"), 1)) {
          ...
          if (Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.math.minus(world.topology.maxPxcor, 1))) {
            world.observer.setGlobal("angle", PrimChecks.math.randomFloat(180));
          }
          else {
            world.observer.setGlobal("angle", PrimChecks.math.randomFloat(360));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().setVariable("infection-length", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("infection-length")), 1));
      if (PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("hospitalized?")))) {
        if (Prims.gt(SelfManager.self().getVariable("infection-length"), SelfManager.self().getVariable("recovery-time"))) {
          if (Prims.lt(PrimChecks.math.randomFloat(100), world.observer.getGlobal("recovery-chance"))) {
            ...
            SelfManager.self().setVariable("nb-recovered", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("nb-recovered")), 1));
          }
        }
      }
      else {
        if (Prims.gt(SelfManager.self().getVariable("infection-length"), PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, SelfManager.self().getVariable("recovery-time")), 5))) {
          SelfManager.self().setVariable("infected?", false);
          SelfManager.self().setVariable("cured?", true);
          SelfManager.self().setVariable("nb-recovered", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("nb-recovered")), 1));
        }
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(SelfManager.self()._optimalPatchHereInternal()).ask(function() { SelfManager.self().setPatchVariable("pcolor", PrimChecks.math.minus(5, 3)); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      SelfManager.self().setVariable("isolated?", false);
      SelfManager.self().setVariable("hospitalized?", false);
      Errors.askNobodyCheck(SelfManager.self()._optimalPatchHereInternal()).ask(function() { SelfManager.self().setPatchVariable("pcolor", 0); }, true);
      Errors.askNobodyCheck(world.observer.getGlobal("border")).ask(function() { SelfManager.self().setPatchVariable("pcolor", 45); }, true);
      Errors.askNobodyCheck(world.getPatchAt(PrimChecks.math.div(PrimChecks.math.unaryminus(world.topology.maxPxcor), 2), 0)).ask(function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true);
      Errors.askNobodyCheck(world.getPatchAt(PrimChecks.math.div(world.topology.maxPxcor, 2), 0)).ask(function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true);
    } catch (e) {
  ...
  temp = (function() {
    try {
      ...
      let nearbyUninfected = PrimChecks.agentset.with(PrimChecks.agentset.turtlesOn(SelfManager.self().getNeighbors()), function() {
        return ((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("infected?"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("cured?")))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("inoculated?"))));
        ...
        Errors.askNobodyCheck(nearbyUninfected).ask(function() {
          if (LinkPrims.isLinkNeighbor("LINKS", caller)) {
            if (Prims.lt(RandomPrims.randomLong(100), PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("infection-chance")), 2))) {
              SelfManager.self().setVariable("infected?", true);
              SelfManager.self().setVariable("nb-infected", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("nb-infected")), 1));
            }
          }
          else {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      let newInfected = PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("nb-infected"); }))); letVars['newInfected'] = newInfected;
      let newRecovered = PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("nb-recovered"); }))); letVars['newRecovered'] = newRecovered;
      world.observer.setGlobal("nb-infected-previous", PrimChecks.math.minus(PrimChecks.math.plus(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), PrimChecks.validator.checkArg('+', 1, newRecovered)), PrimChecks.validator.checkArg('-', 1, newInfected)));
      let susceptibleT = PrimChecks.math.minus(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("initial-people")), PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); })), PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("cured?"); })); letVars['susceptibleT'] = susceptibleT;
      ...
      if (Prims.lt(world.observer.getGlobal("nb-infected-previous"), 10)) {
        ...
        world.observer.setGlobal("beta-n", PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, newInfected), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("nb-infected-previous"))));
      }
      if (Prims.lt(world.observer.getGlobal("nb-infected-previous"), 5)) {
        world.observer.setGlobal("gamma", 0);
      }
      else {
        world.observer.setGlobal("gamma", PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, newRecovered), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("nb-infected-previous"))));
      }
      if ((!Prims.equality(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("initial-people")), PrimChecks.validator.checkArg('-', 1, susceptibleT)), 0) && !Prims.equality(susceptibleT, 0))) {
        world.observer.setGlobal("r0", PrimChecks.math.div(PrimChecks.math.ln(PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, s0), PrimChecks.validator.checkArg('/', 1, susceptibleT))), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("initial-people")), PrimChecks.validator.checkArg('-', 1, susceptibleT))));
