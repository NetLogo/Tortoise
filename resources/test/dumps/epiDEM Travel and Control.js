    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'Not Infected')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.agentset.countWith(world.turtles(), function() { return PrimChecks.math.not(SelfManager.self().getVariable("infected?")); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Infection and Recovery Rates', 'Infection Rate')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult(world.observer.getGlobal("beta-n"), world.observer.getGlobal("nb-infected-previous")));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Infection and Recovery Rates', 'Recovery Rate')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult(world.observer.getGlobal("gamma"), world.observer.getGlobal("nb-infected-previous")));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cumulative Infected and Recovered', '% infected')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult_unchecked(PrimChecks.math.div(PrimChecks.math.plus_unchecked(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("cured?"); }), PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); })), world.observer.getGlobal("initial-people")), 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cumulative Infected and Recovered', '% recovered')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue(PrimChecks.math.mult_unchecked(PrimChecks.math.div(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("cured?"); }), world.observer.getGlobal("initial-people")), 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(world.getPatchAt(PrimChecks.math.div_unchecked(PrimChecks.math.unaryminus_unchecked(world.topology.maxPxcor), 2), 0)).ask(function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true);
      Errors.askNobodyCheck(world.getPatchAt(PrimChecks.math.div_unchecked(world.topology.maxPxcor, 2), 0)).ask(function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true);
  ...
  temp = (function() {
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-people"), "").ask(function() {
        ...
        if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), 5)) {
        ...
        if ((PrimChecks.math.not(SelfManager.self().getVariable("infected?")) && Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("inoculation-chance")))) {
    ...
    try {
      ...
      world.turtleManager.createTurtles(world.observer.getGlobal("initial-ambulance"), "").ask(function() {
        if (Prims.lt(RandomPrims.randomLong(2), 1)) {
          SelfManager.self().setVariable("continent", 1);
          SelfManager.self().setXY(PrimChecks.math.div_unchecked(PrimChecks.math.unaryminus_unchecked(world.topology.maxPxcor), 2), 0);
        }
        else {
          SelfManager.self().setVariable("continent", 2);
          SelfManager.self().setXY(PrimChecks.math.div_unchecked(world.topology.maxPxcor, 2), 0);
        }
        SelfManager.self().setVariable("cured?", false);
        SelfManager.self().setVariable("isolated?", false);
        SelfManager.self().setVariable("hospitalized?", false);
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().setVariable("isolation-tendency", PrimChecks.math.div_unchecked(PrimChecks.math.randomNormal(world.observer.getGlobal("average-isolation-tendency"), world.observer.getGlobal("average-isolation-tendency")), 4));
      SelfManager.self().setVariable("hospital-going-tendency", PrimChecks.math.div_unchecked(PrimChecks.math.randomNormal(world.observer.getGlobal("average-hospital-going-tendency"), world.observer.getGlobal("average-hospital-going-tendency")), 4));
      SelfManager.self().setVariable("recovery-time", PrimChecks.math.div_unchecked(PrimChecks.math.randomNormal(world.observer.getGlobal("average-recovery-time"), world.observer.getGlobal("average-recovery-time")), 4));
      if (Prims.gt(SelfManager.self().getVariable("recovery-time"), PrimChecks.math.mult(world.observer.getGlobal("average-recovery-time"), 2))) {
        SelfManager.self().setVariable("recovery-time", PrimChecks.math.mult(world.observer.getGlobal("average-recovery-time"), 2));
      }
      if (Prims.lt(SelfManager.self().getVariable("recovery-time"), 0)) {
        SelfManager.self().setVariable("recovery-time", 0);
      }
      if (Prims.gt(SelfManager.self().getVariable("isolation-tendency"), PrimChecks.math.mult(world.observer.getGlobal("average-isolation-tendency"), 2))) {
        SelfManager.self().setVariable("isolation-tendency", PrimChecks.math.mult(world.observer.getGlobal("average-isolation-tendency"), 2));
      }
      if (Prims.lt(SelfManager.self().getVariable("isolation-tendency"), 0)) {
        SelfManager.self().setVariable("isolation-tendency", 0);
      }
      if (Prims.gt(SelfManager.self().getVariable("hospital-going-tendency"), PrimChecks.math.mult(world.observer.getGlobal("average-hospital-going-tendency"), 2))) {
        SelfManager.self().setVariable("hospital-going-tendency", PrimChecks.math.mult(world.observer.getGlobal("average-hospital-going-tendency"), 2));
      }
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      if (PrimChecks.agentset.all_unchecked(world.turtles(), function() { return PrimChecks.math.not(SelfManager.self().getVariable("infected?")); })) {
        throw new Exception.StopInterrupt;
      }
      Errors.askNobodyCheck(world.turtles()).ask(function() { procedures["CLEAR-COUNT"](); }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (((PrimChecks.math.not(SelfManager.self().getVariable("isolated?")) && PrimChecks.math.not(SelfManager.self().getVariable("hospitalized?"))) && PrimChecks.math.not(SelfManager.self().getVariable("ambulance?")))) {
          procedures["MOVE"]();
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if ((PrimChecks.math.bool('AND', SelfManager.self().getVariable("infected?")) && PrimChecks.math.bool('AND', PrimChecks.math.not(SelfManager.self().getVariable("isolated?"))) && PrimChecks.math.not(SelfManager.self().getVariable("hospitalized?")))) {
          procedures["INFECT"]();
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if ((PrimChecks.math.bool('AND', (PrimChecks.math.not(SelfManager.self().getVariable("isolated?")) && PrimChecks.math.not(SelfManager.self().getVariable("hospitalized?")))) && PrimChecks.math.bool('AND', SelfManager.self().getVariable("infected?")) && Prims.lt(RandomPrims.randomLong(100), SelfManager.self().getVariable("isolation-tendency")))) {
          procedures["ISOLATE"]();
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if ((PrimChecks.math.bool('AND', (PrimChecks.math.not(SelfManager.self().getVariable("isolated?")) && PrimChecks.math.not(SelfManager.self().getVariable("hospitalized?")))) && PrimChecks.math.bool('AND', SelfManager.self().getVariable("infected?")) && Prims.lt(RandomPrims.randomLong(100), SelfManager.self().getVariable("hospital-going-tendency")))) {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if (PrimChecks.math.bool('AND', PrimChecks.math.bool('OR', SelfManager.self().getVariable("isolated?")) || PrimChecks.math.bool('OR', SelfManager.self().getVariable("hospitalized?"))) && PrimChecks.math.bool('AND', SelfManager.self().getVariable("cured?"))) {
  ...
  temp = (function() {
    try {
      ...
      if (world.observer.getGlobal("travel?")) {
        if ((Prims.lt(RandomPrims.randomLong(100), world.observer.getGlobal("travel-tendency")) && PrimChecks.math.not(SelfManager.self().getVariable("ambulance?")))) {
          SelfManager.self().setVariable("xcor", PrimChecks.math.unaryminus(SelfManager.self().getVariable("xcor")));
        }
      }
      if (Prims.equality(SelfManager.self().getVariable("continent"), 1)) {
        if (Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.math.unaryminus_unchecked(0.5))) {
          world.observer.setGlobal("angle", PrimChecks.math.randomFloat_unchecked(180));
          ...
          if (Prims.lt(SelfManager.self().getVariable("xcor"), PrimChecks.math.plus_unchecked(world.topology.minPxcor, 0.5))) {
            world.observer.setGlobal("angle", PrimChecks.math.randomFloat_unchecked(180));
          }
          else {
            world.observer.setGlobal("angle", PrimChecks.math.randomFloat_unchecked(360));
          }
          SelfManager.self().right(world.observer.getGlobal("angle"));
          if (SelfManager.self().getVariable("ambulance?")) {
            SelfManager.self().fd(PrimChecks.math.mult(world.observer.getGlobal("intra-mobility"), 5));
          }
          else {
        ...
        if (Prims.lt(SelfManager.self().getVariable("xcor"), 1)) {
          ...
          if (Prims.gt(SelfManager.self().getVariable("xcor"), PrimChecks.math.minus_unchecked(world.topology.maxPxcor, 1))) {
            world.observer.setGlobal("angle", PrimChecks.math.randomFloat_unchecked(180));
          }
          else {
            world.observer.setGlobal("angle", PrimChecks.math.randomFloat_unchecked(360));
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().setVariable("infection-length", PrimChecks.math.plus(SelfManager.self().getVariable("infection-length"), 1));
      if (PrimChecks.math.not(SelfManager.self().getVariable("hospitalized?"))) {
        if (Prims.gt(SelfManager.self().getVariable("infection-length"), SelfManager.self().getVariable("recovery-time"))) {
          if (Prims.lt(PrimChecks.math.randomFloat_unchecked(100), world.observer.getGlobal("recovery-chance"))) {
            SelfManager.self().setVariable("infected?", false);
            SelfManager.self().setVariable("cured?", true);
            SelfManager.self().setVariable("nb-recovered", PrimChecks.math.plus(SelfManager.self().getVariable("nb-recovered"), 1));
          }
        }
      }
      else {
        if (Prims.gt(SelfManager.self().getVariable("infection-length"), PrimChecks.math.div(SelfManager.self().getVariable("recovery-time"), 5))) {
          SelfManager.self().setVariable("infected?", false);
          SelfManager.self().setVariable("cured?", true);
          SelfManager.self().setVariable("nb-recovered", PrimChecks.math.plus(SelfManager.self().getVariable("nb-recovered"), 1));
        }
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(SelfManager.self()._optimalPatchHereInternal()).ask(function() { SelfManager.self().setPatchVariable("pcolor", PrimChecks.math.minus_unchecked(5, 3)); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(SelfManager.self().getVariable("continent"), 1)) {
        SelfManager.self().moveTo(world.getPatchAt(PrimChecks.math.div_unchecked(PrimChecks.math.unaryminus_unchecked(world.topology.maxPxcor), 2), 0));
      }
      else {
        SelfManager.self().moveTo(world.getPatchAt(PrimChecks.math.div_unchecked(world.topology.maxPxcor, 2), 0));
      }
  ...
  temp = (function() {
    try {
      ...
      let nearbyUninfected = PrimChecks.agentset.with_unchecked(PrimChecks.agentset.turtlesOn_unchecked(SelfManager.self().getNeighbors()), function() {
        return ((PrimChecks.math.not(SelfManager.self().getVariable("infected?")) && PrimChecks.math.not(SelfManager.self().getVariable("cured?"))) && PrimChecks.math.not(SelfManager.self().getVariable("inoculated?")));
      ...
      if (!Prims.equality(nearbyUninfected, Nobody)) {
        Errors.askNobodyCheck(nearbyUninfected).ask(function() {
          if (LinkPrims.isLinkNeighbor("LINKS", caller)) {
            if (Prims.lt(RandomPrims.randomLong(100), PrimChecks.math.mult(world.observer.getGlobal("infection-chance"), 2))) {
              SelfManager.self().setVariable("infected?", true);
              SelfManager.self().setVariable("nb-infected", PrimChecks.math.plus(SelfManager.self().getVariable("nb-infected"), 1));
            }
          }
          else {
  ...
  temp = (function() {
    try {
      ...
      world.observer.setGlobal("nb-infected-previous", PrimChecks.math.minus(PrimChecks.math.plus(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), newRecovered), newInfected));
      let susceptibleT = PrimChecks.math.minus_unchecked(PrimChecks.math.minus(world.observer.getGlobal("initial-people"), PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); })), PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("cured?"); })); letVars['susceptibleT'] = susceptibleT;
      ...
      if (Prims.lt(world.observer.getGlobal("nb-infected-previous"), 10)) {
        ...
        world.observer.setGlobal("beta-n", PrimChecks.math.div(newInfected, world.observer.getGlobal("nb-infected-previous")));
      }
      if (Prims.lt(world.observer.getGlobal("nb-infected-previous"), 5)) {
        world.observer.setGlobal("gamma", 0);
      }
      else {
        world.observer.setGlobal("gamma", PrimChecks.math.div(newRecovered, world.observer.getGlobal("nb-infected-previous")));
      }
      if ((!Prims.equality(PrimChecks.math.minus(world.observer.getGlobal("initial-people"), susceptibleT), 0) && !Prims.equality(susceptibleT, 0))) {
        world.observer.setGlobal("r0", PrimChecks.math.div_unchecked(PrimChecks.math.ln_unchecked(PrimChecks.math.div(s0, susceptibleT)), PrimChecks.math.minus(world.observer.getGlobal("initial-people"), susceptibleT)));
        world.observer.setGlobal("r0", PrimChecks.math.mult(world.observer.getGlobal("r0"), s0));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
