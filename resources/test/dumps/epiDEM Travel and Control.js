    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cumulative Infected and Recovered', '% infected')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((Prims.div((world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("cured?"); }) + world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("infected?"); })), world.observer.getGlobal("initial-people")) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cumulative Infected and Recovered', '% recovered')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((Prims.div(world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("cured?"); }), world.observer.getGlobal("initial-people")) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      Errors.askNobodyCheck(world.getPatchAt(Prims.div( -(world.topology.maxPxcor), 2), 0)).ask(function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true);
      Errors.askNobodyCheck(world.getPatchAt(Prims.div(world.topology.maxPxcor, 2), 0)).ask(function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true);
