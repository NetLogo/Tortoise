    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Populations', 'Infected')(function() {
        try {
          ...
          var letVars = { };
          plotManager.plotValue(world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("infected?"); }));
        } catch (e) {
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cumulative Infected and Recovered', '% infected')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((PrimChecks.math.div((world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("cured?"); }) + world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("infected?"); })), world.observer.getGlobal("initial-people")) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Cumulative Infected and Recovered', '% recovered')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotValue((PrimChecks.math.div(world.turtles()._optimalCountWith(function() { return SelfManager.self().getVariable("cured?"); }), world.observer.getGlobal("initial-people")) * 100));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      SelfManager.self().setVariable("isolation-tendency", PrimChecks.math.div(PrimChecks.math.randomNormal(world.observer.getGlobal("average-isolation-tendency"), world.observer.getGlobal("average-isolation-tendency")), 4));
      SelfManager.self().setVariable("hospital-going-tendency", PrimChecks.math.div(PrimChecks.math.randomNormal(world.observer.getGlobal("average-hospital-going-tendency"), world.observer.getGlobal("average-hospital-going-tendency")), 4));
      SelfManager.self().setVariable("recovery-time", PrimChecks.math.div(PrimChecks.math.randomNormal(world.observer.getGlobal("average-recovery-time"), world.observer.getGlobal("average-recovery-time")), 4));
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if ((((!SelfManager.self().getVariable("isolated?") && !SelfManager.self().getVariable("hospitalized?")) && SelfManager.self().getVariable("infected?")) && Prims.lt(RandomPrims.randomLong(100), SelfManager.self().getVariable("isolation-tendency")))) {
          procedures["ISOLATE"]();
        }
      }, true);
      Errors.askNobodyCheck(world.turtles()).ask(function() {
        if ((((!SelfManager.self().getVariable("isolated?") && !SelfManager.self().getVariable("hospitalized?")) && SelfManager.self().getVariable("infected?")) && Prims.lt(RandomPrims.randomLong(100), SelfManager.self().getVariable("hospital-going-tendency")))) {
  ...
  temp = (function() {
    try {
      ...
      if (world.observer.getGlobal("travel?")) {
        if ((Prims.lt(RandomPrims.randomLong(100), world.observer.getGlobal("travel-tendency")) && !SelfManager.self().getVariable("ambulance?"))) {
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(SelfManager.self()._optimalPatchHereInternal()).ask(function() { SelfManager.self().setPatchVariable("pcolor", (5 - 3)); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
      ...
      if (!Prims.equality(nearbyUninfected, Nobody)) {
        Errors.askNobodyCheck(nearbyUninfected).ask(function() {
          if (LinkPrims.isLinkNeighbor("LINKS", caller)) {
            if (Prims.lt(RandomPrims.randomLong(100), (world.observer.getGlobal("infection-chance") * 2))) {
              SelfManager.self().setVariable("infected?", true);
  ...
  temp = (function() {
    try {
      ...
      if ((!Prims.equality((world.observer.getGlobal("initial-people") - susceptibleT), 0) && !Prims.equality(susceptibleT, 0))) {
        world.observer.setGlobal("r0", PrimChecks.math.div(PrimChecks.math.ln(PrimChecks.math.div(s0, susceptibleT)), (world.observer.getGlobal("initial-people") - susceptibleT)));
