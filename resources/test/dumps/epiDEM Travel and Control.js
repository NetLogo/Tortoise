...
ProcedurePrims.defineCommand("setup", (function() {
  world.clearAll();
  R = ProcedurePrims.callCommand("setup-globals"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("setup-people"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("setup-ambulance"); if (R === DeathInterrupt) { return R; }
  world.ticker.reset();
}))
ProcedurePrims.defineCommand("setup-globals", (function() {
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.getPatchAt(PrimChecks.math.div(PrimChecks.math.unaryminus(world.topology.maxPxcor), 2), 0)), function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.getPatchAt(PrimChecks.math.div(world.topology.maxPxcor, 2), 0)), function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("border")), function() { SelfManager.self().setPatchVariable("pcolor", 45); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("setup-people", (function() {
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(world.observer.getGlobal("initial-people"), ""), function() {
    ...
    R = ProcedurePrims.callCommand("assign-tendency"); if (R === DeathInterrupt) { return R; }
    ...
    R = ProcedurePrims.callCommand("assign-color"); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  if (world.observer.getGlobal("links?")) {
    R = ProcedurePrims.callCommand("make-network"); if (R === DeathInterrupt) { return R; }
  }
}))
ProcedurePrims.defineCommand("setup-ambulance", (function() {
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(world.observer.getGlobal("initial-ambulance"), ""), function() {
...
ProcedurePrims.defineCommand("assign-tendency", (function() {
...
ProcedurePrims.defineCommand("make-network", (function() {
  R = ProcedurePrims.ask(world.turtles(), function() {
    R = ProcedurePrims.ask(LinkPrims.createLinksWith(PrimChecks.agentset.turtlesOn(SelfManager.self().getNeighbors()), "LINKS"), function() {}, false); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("go", (function() {
  ...
  R = ProcedurePrims.ask(world.turtles(), function() { R = ProcedurePrims.callCommand("clear-count"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtles(), function() {
  ...
  R = ProcedurePrims.ask(world.turtles(), function() {
    if (((PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("infected?")) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("isolated?")))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("hospitalized?"))))) {
      R = ProcedurePrims.callCommand("infect"); if (R === DeathInterrupt) { return R; }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtles(), function() {
    if ((((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("isolated?"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("hospitalized?")))) && PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("infected?"))) && Prims.lt(RandomPrims.randomLong(100), SelfManager.self().getVariable("isolation-tendency")))) {
      R = ProcedurePrims.callCommand("isolate"); if (R === DeathInterrupt) { return R; }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtles(), function() {
    if ((((PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("isolated?"))) && PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 2, SelfManager.self().getVariable("hospitalized?")))) && PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("infected?"))) && Prims.lt(RandomPrims.randomLong(100), SelfManager.self().getVariable("hospital-going-tendency")))) {
      R = ProcedurePrims.callCommand("hospitalize"); if (R === DeathInterrupt) { return R; }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtles(), function() {
    if (SelfManager.self().getVariable("ambulance?")) {
      R = ProcedurePrims.callCommand("move"); if (R === DeathInterrupt) { return R; }
      R = ProcedurePrims.ask(PrimChecks.agentset.turtlesOn(SelfManager.self().getNeighbors()), function() {
  ...
  R = ProcedurePrims.ask(world.turtles(), function() {
    if (SelfManager.self().getVariable("infected?")) {
      R = ProcedurePrims.callCommand("maybe-recover"); if (R === DeathInterrupt) { return R; }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtles(), function() {
    if (((PrimChecks.validator.checkArg('OR', 2, SelfManager.self().getVariable("isolated?")) || PrimChecks.validator.checkArg('OR', 2, SelfManager.self().getVariable("hospitalized?"))) && PrimChecks.validator.checkArg('AND', 2, SelfManager.self().getVariable("cured?")))) {
      R = ProcedurePrims.callCommand("unisolate"); if (R === DeathInterrupt) { return R; }
    }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtles(), function() {
    R = ProcedurePrims.callCommand("assign-color"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("calculate-r0"); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  world.ticker.tick();
}))
...
ProcedurePrims.defineCommand("clear-count", (function() {
  SelfManager.self().setVariable("nb-infected", 0);
  SelfManager.self().setVariable("nb-recovered", 0);
}))
ProcedurePrims.defineCommand("maybe-recover", (function() {
...
ProcedurePrims.defineCommand("isolate", (function() {
  SelfManager.self().setVariable("isolated?", true);
  SelfManager.self().moveTo(SelfManager.self().getPatchHere());
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self()._optimalPatchHereInternal()), function() { SelfManager.self().setPatchVariable("pcolor", PrimChecks.math.minus(5, 3)); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("unisolate", (function() {
  SelfManager.self().setVariable("isolated?", false);
  SelfManager.self().setVariable("hospitalized?", false);
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, SelfManager.self()._optimalPatchHereInternal()), function() { SelfManager.self().setPatchVariable("pcolor", 0); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("border")), function() { SelfManager.self().setPatchVariable("pcolor", 45); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.getPatchAt(PrimChecks.math.div(PrimChecks.math.unaryminus(world.topology.maxPxcor), 2), 0)), function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.getPatchAt(PrimChecks.math.div(world.topology.maxPxcor, 2), 0)), function() { SelfManager.self().setPatchVariable("pcolor", 9.9); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("hospitalize", (function() {
...
ProcedurePrims.defineCommand("infect", (function() {
  ...
  if (!Prims.equality(nearbyHuninfected, Nobody)) {
    R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, nearbyHuninfected), function() {
...
ProcedurePrims.defineCommand("calculate-r0", (function() {
  let newHinfected = PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("nb-infected"); }))); ProcedurePrims.stack().currentContext().registerStringRunVar("NEW-INFECTED", newHinfected);
  let newHrecovered = PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, PrimChecks.agentset.of(world.turtles(), function() { return SelfManager.self().getVariable("nb-recovered"); }))); ProcedurePrims.stack().currentContext().registerStringRunVar("NEW-RECOVERED", newHrecovered);
  world.observer.setGlobal("nb-infected-previous", PrimChecks.math.minus(PrimChecks.math.plus(PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("infected?"); }), PrimChecks.validator.checkArg('+', 1, newHrecovered)), PrimChecks.validator.checkArg('-', 1, newHinfected)));
  ...
  let s0 = PrimChecks.agentset.countWith(world.turtles(), function() { return SelfManager.self().getVariable("susceptible?"); }); ProcedurePrims.stack().currentContext().registerStringRunVar("S0", s0);
