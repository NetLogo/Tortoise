...
modelConfig.plots = [(function() {
  ...
  var pens    = [new PenBundle.Pen('% infected', plotOps.makePenOps, false, new PenBundle.State(15, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Cumulative Infected and Recovered', '% infected', function() {
      plotManager.plotValue(PrimChecks.math.mult(92, 93, PrimChecks.math.div(74, 75, PrimChecks.math.plus(38, 39, PrimChecks.agentset.countWith(null, null, world.turtles(), function() { return PrimChecks.turtle.getVariable(29, 35, "cured?"); }), PrimChecks.agentset.countWith(null, null, world.turtles(), function() { return PrimChecks.turtle.getVariable(61, 70, "infected?"); })), PrimChecks.validator.checkArg('/', 74, 75, 1, world.observer.getGlobal("initial-people"))), 100));;
    });
  }),
  new PenBundle.Pen('% recovered', plotOps.makePenOps, false, new PenBundle.State(55, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Cumulative Infected and Recovered', '% recovered', function() {
      plotManager.plotValue(PrimChecks.math.mult(55, 56, PrimChecks.math.div(37, 38, PrimChecks.agentset.countWith(null, null, world.turtles(), function() { return PrimChecks.turtle.getVariable(28, 34, "cured?"); }), PrimChecks.validator.checkArg('/', 37, 38, 1, world.observer.getGlobal("initial-people"))), 100));;
    });
  })];
  var setup   = function() {};
  var update  = function() {};
  ...
  var pens    = [new PenBundle.Pen('Infected', plotOps.makePenOps, false, new PenBundle.State(15, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Populations', 'Infected', function() {
      plotManager.plotValue(PrimChecks.agentset.countWith(null, null, world.turtles(), function() { return PrimChecks.turtle.getVariable(26, 35, "infected?"); }));;
    });
  }),
  new PenBundle.Pen('Not Infected', plotOps.makePenOps, false, new PenBundle.State(55, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Populations', 'Not Infected', function() {
      plotManager.plotValue(PrimChecks.agentset.countWith(null, null, world.turtles(), function() {
        return PrimChecks.math.not(PrimChecks.validator.checkArg('NOT', 26, 29, 2, PrimChecks.turtle.getVariable(30, 39, "infected?")));
      }));;
    });
  })];
  var setup   = function() {};
  ...
  var pens    = [new PenBundle.Pen('Infection Rate', plotOps.makePenOps, false, new PenBundle.State(15, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Infection and Recovery Rates', 'Infection Rate', function() {
      plotManager.plotValue(PrimChecks.math.mult(13, 14, PrimChecks.validator.checkArg('*', 13, 14, 1, world.observer.getGlobal("beta-n")), PrimChecks.validator.checkArg('*', 13, 14, 1, world.observer.getGlobal("nb-infected-previous"))));;
    });
  }),
  new PenBundle.Pen('Recovery Rate', plotOps.makePenOps, false, new PenBundle.State(55, 1, PenBundle.DisplayMode.Line), function() {}, function() {
    return ProcedurePrims.runInPlotContext('Infection and Recovery Rates', 'Recovery Rate', function() {
      plotManager.plotValue(PrimChecks.math.mult(12, 13, PrimChecks.validator.checkArg('*', 12, 13, 1, world.observer.getGlobal("gamma")), PrimChecks.validator.checkArg('*', 12, 13, 1, world.observer.getGlobal("nb-infected-previous"))));;
    });
  })];
  var setup   = function() {};
  var update  = function() {};
