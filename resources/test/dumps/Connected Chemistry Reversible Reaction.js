...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      })).ask(function() { SelfManager.self().setPatchVariable("pcolor", world.observer.getGlobal("wall-color")); }, true);
      Errors.askNobodyCheck(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("FLASHES"), function() {
  ...
  temp = (function() {
    try {
      ...
      if ((Prims.gte(PrimChecks.agentset.count(PrimChecks.validator.checkArg('COUNT', 112, hitHydrogen)), 3) && Prims.equality(RandomPrims.randomLong(2), 0))) {
        if (Prims.lt(SelfManager.self().getVariable("speed"), 0)) {
          SelfManager.self().setVariable("speed", 0);
        }
        let reactants = PrimChecks.list.nOf(3, PrimChecks.validator.checkArg('N-OF', 120, hitHydrogen)); letVars['reactants'] = reactants;
        let totalInputEnergy = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("energy")), PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, reactants), function() { return SelfManager.self().getVariable("energy"); })))); letVars['totalInputEnergy'] = totalInputEnergy;
        if (Prims.gt(totalInputEnergy, world.observer.getGlobal("activation-energy"))) {
          let totalOutputEnergy = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, totalInputEnergy), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("difference-bond-energies"))); letVars['totalOutputEnergy'] = totalOutputEnergy;
          SelfManager.self().setVariable("molecule-type", "nh3");
          SelfManager.self().setVariable("shape", "nh3");
          SelfManager.self().setVariable("mass", 10);
          SelfManager.self().setVariable("energy", PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, totalOutputEnergy), 10), 20));
  ...
  temp = (function() {
    try {
      ...
      if ((Prims.gte(PrimChecks.agentset.count(PrimChecks.validator.checkArg('COUNT', 112, hitNh3)), 1) && Prims.equality(RandomPrims.randomLong(2), 0))) {
        let reactants = PrimChecks.list.nOf(1, PrimChecks.validator.checkArg('N-OF', 120, hitNh3)); letVars['reactants'] = reactants;
        let totalInputEnergy = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("energy")), PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, reactants), function() { return SelfManager.self().getVariable("energy"); })))); letVars['totalInputEnergy'] = totalInputEnergy;
        if (Prims.gt(totalInputEnergy, world.observer.getGlobal("activation-energy"))) {
          let totalOutputEnergy = PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, totalInputEnergy), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("difference-bond-energies"))); letVars['totalOutputEnergy'] = totalOutputEnergy;
          SelfManager.self().setVariable("molecule-type", "nitrogen");
          SelfManager.self().setVariable("shape", "nitrogen");
          SelfManager.self().setVariable("mass", 14);
          SelfManager.self().setVariable("energy", PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, totalOutputEnergy), 14), 20));
          SelfManager.self().setVariable("speed", procedures["SPEED-FROM-ENERGY"]());
          SelfManager.self().hatch(3, "").ask(function() {
            SelfManager.self().setVariable("molecule-type", "hydrogen");
            SelfManager.self().setVariable("shape", "hydrogen");
            SelfManager.self().setVariable("mass", 2);
            SelfManager.self().setVariable("energy", PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, totalOutputEnergy), 2), 20));
            SelfManager.self().setVariable("speed", procedures["SPEED-FROM-ENERGY"]());
  ...
  temp = (function() {
    try {
      ...
      newPx = PrimChecks.math.round(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("xcor")), SelfManager.self().dx())); letVars['newPx'] = newPx;
      newPy = PrimChecks.math.round(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("ycor")), SelfManager.self().dy())); letVars['newPy'] = newPy;
      if ((Prims.equality(PrimChecks.math.abs(PrimChecks.validator.checkArg('ABS', 1, newPx)), world.observer.getGlobal("box-edge-x")) || Prims.equality(newPx, world.observer.getGlobal("piston-position")))) {
      ...
      if (Prims.equality(PrimChecks.math.abs(PrimChecks.validator.checkArg('ABS', 1, newPy)), world.observer.getGlobal("box-edge-y"))) {
      ...
      if (PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, world.getPatchAt(newPx, newPy)), function() { return procedures["ISOTHERMAL-WALL?"](); })) {
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(SelfPrims._optimalCountOther(SelfManager.self().breedHere("PARTICLES")), 1)) {
        candidate = PrimChecks.list.oneOf(PrimChecks.agentset.otherWith(SelfManager.self().breedHere("PARTICLES"), function() {
  ...
  temp = (function(otherParticle) {
    try {
      ...
      mass2 = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, otherParticle), function() { return SelfManager.self().getVariable("mass"); }); letVars['mass2'] = mass2;
      speed2 = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, otherParticle), function() { return SelfManager.self().getVariable("speed"); }); letVars['speed2'] = speed2;
      heading2 = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, otherParticle), function() { return SelfManager.self().getVariable("heading"); }); letVars['heading2'] = heading2;
      theta = PrimChecks.math.randomFloat(360); letVars['theta'] = theta;
      v1t = PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed")), PrimChecks.math.cos(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, theta), PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("heading"))))); letVars['v1t'] = v1t;
      v1l = PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed")), PrimChecks.math.sin(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, theta), PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("heading"))))); letVars['v1l'] = v1l;
      v2t = PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, speed2), PrimChecks.math.cos(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, theta), PrimChecks.validator.checkArg('-', 1, heading2)))); letVars['v2t'] = v2t;
      v2l = PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, speed2), PrimChecks.math.sin(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, theta), PrimChecks.validator.checkArg('-', 1, heading2)))); letVars['v2l'] = v2l;
      vcm = PrimChecks.math.div(PrimChecks.math.plus(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("mass")), PrimChecks.validator.checkArg('*', 1, v1t)), PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, mass2), PrimChecks.validator.checkArg('*', 1, v2t))), PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("mass")), PrimChecks.validator.checkArg('+', 1, mass2))); letVars['vcm'] = vcm;
    ...
    try {
      ...
      if ((MousePrims.isDown() && Prims.lt(MousePrims.getY(), PrimChecks.math.minus(world.topology.maxPycor, 1)))) {
        if ((Prims.gte(MousePrims.getX(), world.observer.getGlobal("piston-position")) && Prims.lt(MousePrims.getX(), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("box-edge-x")), 2)))) {
          procedures["PISTON-OUT"](PrimChecks.math.ceil(PrimChecks.math.minus(MousePrims.getX(), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("piston-position")))));
        }
        world.observer.setGlobal("run-go?", true);
        throw new Exception.StopInterrupt;
      }
  ...
  temp = (function() {
    try {
      ...
      return PrimChecks.math.sqrt(PrimChecks.math.div(PrimChecks.math.mult(2, PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("energy"))), PrimChecks.validator.checkArg('/', 1, SelfManager.self().getVariable("mass"))));
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("mass")), PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed"))), PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed"))), 2);
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
