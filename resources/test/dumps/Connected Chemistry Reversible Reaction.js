    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Number of molecules', 'H2')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotPoint(world.ticker.tickCount(), world.turtleManager.turtlesOfBreed("PARTICLES")._optimalCountWith(function() { return Prims.equality(SelfManager.self().getVariable("molecule-type"), "hydrogen"); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Number of molecules', 'N2')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotPoint(world.ticker.tickCount(), world.turtleManager.turtlesOfBreed("PARTICLES")._optimalCountWith(function() { return Prims.equality(SelfManager.self().getVariable("molecule-type"), "nitrogen"); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
    ...
    return workspace.rng.withClone(function() {
      return plotManager.withTemporaryContext('Number of molecules', 'NH3')(function() {
        try {
          var reporterContext = false;
          var letVars = { };
          plotManager.plotPoint(world.ticker.tickCount(), world.turtleManager.turtlesOfBreed("PARTICLES")._optimalCountWith(function() { return Prims.equality(SelfManager.self().getVariable("molecule-type"), "nh3"); }));
        } catch (e) {
          return Errors.stopInCommandCheck(e)
        };
      });
...
var procedures = (function() {
  ...
  temp = (function() {
    try {
      ...
      if (world.observer.getGlobal("forward-react?")) {
        Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("PARTICLES").agentFilter(function() { return Prims.equality(SelfManager.self().getVariable("molecule-type"), "nitrogen"); })).ask(function() { procedures["CHECK-FOR-FORWARD-REACTION"](); }, true);
      }
      if (world.observer.getGlobal("reverse-react?")) {
        Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("PARTICLES").agentFilter(function() { return Prims.equality(SelfManager.self().getVariable("molecule-type"), "nh3"); })).ask(function() { procedures["CHECK-FOR-REVERSE-REACTION"](); }, true);
      }
      procedures["CALCULATE-PRESSURE-AND-TEMPERATURE"]();
      procedures["CALCULATE-TICK-ADVANCE-AMOUNT"]();
  ...
  temp = (function() {
    try {
      ...
      Errors.askNobodyCheck(world.patches().agentFilter(function() { return !SelfManager.self().getPatchVariable("insulated?"); })).ask(function() { SelfManager.self().setPatchVariable("pcolor", world.observer.getGlobal("wall-color")); }, true);
      Errors.askNobodyCheck(world.turtleManager.turtlesOfBreed("FLASHES").agentFilter(function() { return Prims.gt((world.ticker.tickCount() - SelfManager.self().getVariable("birthday")), 0.4); })).ask(function() { SelfManager.self().die(); }, true);
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  });
  ...
  temp = (function() {
    try {
      ...
      if ((Prims.gte(hitHydrogen.size(), 3) && Prims.equality(RandomPrims.randomLong(2), 0))) {
        ...
        let totalInputEnergy = (SelfManager.self().getVariable("energy") + PrimChecks.list.sum(reactants.projectionBy(function() { return SelfManager.self().getVariable("energy"); }))); letVars['totalInputEnergy'] = totalInputEnergy;
        if (Prims.gt(totalInputEnergy, world.observer.getGlobal("activation-energy"))) {
          ...
          SelfManager.self().setVariable("shape", "nh3");
          SelfManager.self().setVariable("mass", 10);
          SelfManager.self().setVariable("energy", PrimChecks.math.div((totalOutputEnergy * 10), 20));
          SelfManager.self().setVariable("speed", PrimChecks.math.sqrt((2 * PrimChecks.math.div(SelfManager.self().getVariable("energy"), SelfManager.self().getVariable("mass")))));
  ...
  temp = (function() {
    try {
      ...
      if ((Prims.gte(hitNh3.size(), 1) && Prims.equality(RandomPrims.randomLong(2), 0))) {
        ...
        if (Prims.gt(totalInputEnergy, world.observer.getGlobal("activation-energy"))) {
          ...
          SelfManager.self().setVariable("shape", "nitrogen");
          SelfManager.self().setVariable("mass", 14);
          SelfManager.self().setVariable("energy", PrimChecks.math.div((totalOutputEnergy * 14), 20));
          SelfManager.self().setVariable("speed", procedures["SPEED-FROM-ENERGY"]());
          SelfManager.self().hatch(3, "").ask(function() {
            SelfManager.self().setVariable("molecule-type", "hydrogen");
            SelfManager.self().setVariable("shape", "hydrogen");
            SelfManager.self().setVariable("mass", 2);
            SelfManager.self().setVariable("energy", PrimChecks.math.div((totalOutputEnergy * 2), 20));
            SelfManager.self().setVariable("speed", procedures["SPEED-FROM-ENERGY"]());
  ...
  temp = (function() {
    try {
      var reporterContext = false;
      var letVars = { };
      world.observer.setGlobal("pressure", (15 * PrimChecks.list.sum(world.turtleManager.turtlesOfBreed("PARTICLES").projectionBy(function() { return SelfManager.self().getVariable("momentum-difference"); }))));
      if (Prims.gt(PrimChecks.list.length(world.observer.getGlobal("pressure-history")), 10)) {
      ...
      if (!world.turtleManager.turtlesOfBreed("PARTICLES").isEmpty()) {
        world.observer.setGlobal("temperature", (PrimChecks.list.mean(world.turtleManager.turtlesOfBreed("PARTICLES").projectionBy(function() { return SelfManager.self().getVariable("energy"); })) * world.observer.getGlobal("scale-factor-energy-to-temp")));
      }
    } catch (e) {
      return Errors.stopInCommandCheck(e)
    }
  ...
  temp = (function() {
    try {
      ...
      if (Prims.equality(SelfPrims._optimalCountOther(SelfManager.self().breedHere("PARTICLES")), 1)) {
        candidate = PrimChecks.list.oneOf(SelfManager.self().breedHere("PARTICLES")._optimalOtherWith(function() {
  ...
  temp = (function() {
    try {
      ...
      var letVars = { };
      Errors.reportInContextCheck(reporterContext);
      return PrimChecks.math.div(((SelfManager.self().getVariable("mass") * SelfManager.self().getVariable("speed")) * SelfManager.self().getVariable("speed")), 2);
      Errors.missingReport();
    } catch (e) {
      Errors.stopInReportCheck(e)
    }
