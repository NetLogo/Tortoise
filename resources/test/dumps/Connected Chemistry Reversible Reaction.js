...
ProcedurePrims.defineCommand("setup", (function() {
  ...
  R = ProcedurePrims.callCommand("draw-box-piston"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("recalculate-wall-color"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("calculate-volume"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("make-particles"); if (R === DeathInterrupt) { return R; }
  world.observer.setGlobal("pressure-history", []);
  R = ProcedurePrims.callCommand("calculate-pressure-and-temperature"); if (R === DeathInterrupt) { return R; }
  world.ticker.reset();
}))
ProcedurePrims.defineCommand("make-particles", (function() {
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(world.observer.getGlobal("#-h2"), "PARTICLES"), function() { R = ProcedurePrims.callCommand("setup-hydrogen-particle"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(world.observer.getGlobal("#-n2"), "PARTICLES"), function() { R = ProcedurePrims.callCommand("setup-nitrogen-particle"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.ask(world.turtleManager.createTurtles(world.observer.getGlobal("#-nh3"), "PARTICLES"), function() { R = ProcedurePrims.callCommand("setup-ammonia-particle"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  R = ProcedurePrims.callCommand("calculate-tick-advance-amount"); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("setup-hydrogen-particle", (function() {
  ...
  R = ProcedurePrims.callCommand("set-other-particle-attributes"); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("setup-nitrogen-particle", (function() {
...
ProcedurePrims.defineCommand("setup-ammonia-particle", (function() {
  SelfManager.self().setVariable("shape", "nh3");
  SelfManager.self().setVariable("molecule-type", "nh3");
  SelfManager.self().setVariable("mass", 10);
  R = ProcedurePrims.callCommand("set-other-particle-attributes"); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("set-other-particle-attributes", (function() {
  SelfManager.self().setVariable("size", world.observer.getGlobal("particle-size"));
  SelfManager.self().setVariable("last-collision", Nobody);
  SelfManager.self().setVariable("energy", PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("initial-gas-temp")), PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("scale-factor-temp-to-energy"))));
  SelfManager.self().setVariable("speed", PrimChecks.procedure.callReporter("speed-from-energy"));
  R = ProcedurePrims.callCommand("random-position"); if (R === DeathInterrupt) { return R; }
}))
ProcedurePrims.defineCommand("random-position", (function() {
  SelfManager.self().setXY(PrimChecks.math.plus(PrimChecks.math.minus(1, PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("box-edge-x"))), PrimChecks.math.randomFloat(PrimChecks.math.minus(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("box-edge-x")), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("piston-position"))), 3))), PrimChecks.math.plus(PrimChecks.math.minus(1, PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("box-edge-y"))), PrimChecks.math.randomFloat(PrimChecks.math.minus(PrimChecks.math.mult(2, PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("box-edge-y"))), 2))));
...
ProcedurePrims.defineCommand("go", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("PARTICLES"), function() {
    R = ProcedurePrims.callCommand("bounce"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("move"); if (R === DeathInterrupt) { return R; }
    R = ProcedurePrims.callCommand("check-for-collision"); if (R === DeathInterrupt) { return R; }
  }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  if (world.observer.getGlobal("forward-react?")) {
    R = ProcedurePrims.ask(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("PARTICLES"), function() { return Prims.equality(SelfManager.self().getVariable("molecule-type"), "nitrogen"); }), function() {
      R = ProcedurePrims.callCommand("check-for-forward-reaction"); if (R === DeathInterrupt) { return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  if (world.observer.getGlobal("reverse-react?")) {
    R = ProcedurePrims.ask(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("PARTICLES"), function() { return Prims.equality(SelfManager.self().getVariable("molecule-type"), "nh3"); }), function() {
      R = ProcedurePrims.callCommand("check-for-reverse-reaction"); if (R === DeathInterrupt) { return R; }
    }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  }
  R = ProcedurePrims.callCommand("calculate-pressure-and-temperature"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.callCommand("calculate-tick-advance-amount"); if (R === DeathInterrupt) { return R; }
...
ProcedurePrims.defineCommand("calculate-tick-advance-amount", (function() {
...
ProcedurePrims.defineCommand("move", (function() {
  if (!Prims.equality(SelfManager.self().patchAhead(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed")), PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("tick-advance-amount")))), SelfManager.self().getPatchHere())) {
    SelfManager.self().setVariable("last-collision", Nobody);
  }
  SelfManager.self().jumpIfAble(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed")), PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("tick-advance-amount"))));
}))
ProcedurePrims.defineCommand("recalculate-wall-color", (function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.agentset.with(world.turtleManager.turtlesOfBreed("FLASHES"), function() {
...
ProcedurePrims.defineCommand("check-for-forward-reaction", (function() {
  ...
  if ((Prims.gte(PrimChecks.agentset.count(PrimChecks.validator.checkArg('COUNT', 112, hitHhydrogen)), 3) && Prims.equality(RandomPrims.randomLong(2), 0))) {
    ...
    let totalHinputHenergy = PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("energy")), PrimChecks.list.sum(PrimChecks.validator.checkArg('SUM', 8, PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, reactants), function() { return SelfManager.self().getVariable("energy"); })))); ProcedurePrims.stack().currentContext().registerStringRunVar("TOTAL-INPUT-ENERGY", totalHinputHenergy);
    if (Prims.gt(totalHinputHenergy, world.observer.getGlobal("activation-energy"))) {
      ...
      SelfManager.self().setVariable("shape", "nh3");
      SelfManager.self().setVariable("mass", 10);
      SelfManager.self().setVariable("energy", PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, totalHoutputHenergy), 10), 20));
      SelfManager.self().setVariable("speed", PrimChecks.math.sqrt(PrimChecks.math.mult(2, PrimChecks.math.div(PrimChecks.validator.checkArg('/', 1, SelfManager.self().getVariable("energy")), PrimChecks.validator.checkArg('/', 1, SelfManager.self().getVariable("mass"))))));
      R = ProcedurePrims.ask(SelfManager.self().hatch(1, ""), function() {
        SelfManager.self().setVariable("heading", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("heading")), 180));
      }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
      R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, reactants), function() { return SelfManager.self().die(); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
...
ProcedurePrims.defineCommand("check-for-reverse-reaction", (function() {
  ...
  if ((Prims.gte(PrimChecks.agentset.count(PrimChecks.validator.checkArg('COUNT', 112, hitHnh3)), 1) && Prims.equality(RandomPrims.randomLong(2), 0))) {
    ...
    if (Prims.gt(totalHinputHenergy, world.observer.getGlobal("activation-energy"))) {
      ...
      SelfManager.self().setVariable("shape", "nitrogen");
      SelfManager.self().setVariable("mass", 14);
      SelfManager.self().setVariable("energy", PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, totalHoutputHenergy), 14), 20));
      SelfManager.self().setVariable("speed", PrimChecks.procedure.callReporter("speed-from-energy"));
      R = ProcedurePrims.ask(SelfManager.self().hatch(3, ""), function() {
        SelfManager.self().setVariable("molecule-type", "hydrogen");
        SelfManager.self().setVariable("shape", "hydrogen");
        SelfManager.self().setVariable("mass", 2);
        SelfManager.self().setVariable("energy", PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, totalHoutputHenergy), 2), 20));
        SelfManager.self().setVariable("speed", PrimChecks.procedure.callReporter("speed-from-energy"));
...
ProcedurePrims.defineCommand("cool", (function() {
  ...
  R = ProcedurePrims.callCommand("recalculate-wall-color"); if (R === DeathInterrupt) { return R; }
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("heatable-walls")), function() { SelfManager.self().setPatchVariable("pcolor", world.observer.getGlobal("wall-color")); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("heat", (function() {
...
ProcedurePrims.defineCommand("calculate-pressure-and-temperature", (function() {
  ...
  R = ProcedurePrims.ask(world.turtleManager.turtlesOfBreed("PARTICLES"), function() { SelfManager.self().setVariable("momentum-difference", 0); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
  if (PrimChecks.agentset.any(world.turtleManager.turtlesOfBreed("PARTICLES"))) {
    world.observer.setGlobal("temperature", PrimChecks.math.mult(PrimChecks.list.mean(PrimChecks.validator.checkArg('MEAN', 8, PrimChecks.agentset.of(world.turtleManager.turtlesOfBreed("PARTICLES"), function() { return SelfManager.self().getVariable("energy"); }))), PrimChecks.validator.checkArg('*', 1, world.observer.getGlobal("scale-factor-energy-to-temp"))));
  }
}))
ProcedurePrims.defineCommand("calculate-volume", (function() {
...
ProcedurePrims.defineCommand("reset-reaction-counters", (function() {
  world.observer.setGlobal("number-forward-reactions", 0);
  world.observer.setGlobal("number-reverse-reactions", 0);
}))
ProcedurePrims.defineCommand("bounce", (function() {
  ...
  newHpx = PrimChecks.math.round(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("xcor")), SelfManager.self().dx())); ProcedurePrims.stack().currentContext().updateStringRunVar("NEW-PX", newHpx);
  newHpy = PrimChecks.math.round(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("ycor")), SelfManager.self().dy())); ProcedurePrims.stack().currentContext().updateStringRunVar("NEW-PY", newHpy);
  if ((Prims.equality(PrimChecks.math.abs(PrimChecks.validator.checkArg('ABS', 1, newHpx)), world.observer.getGlobal("box-edge-x")) || Prims.equality(newHpx, world.observer.getGlobal("piston-position")))) {
    ...
    SelfManager.self().setVariable("momentum-difference", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("momentum-difference")), PrimChecks.math.div(PrimChecks.math.abs(PrimChecks.math.mult(PrimChecks.math.mult(PrimChecks.math.mult(PrimChecks.math.sin(PrimChecks.validator.checkArg('SIN', 1, SelfManager.self().getVariable("heading"))), 2), PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("mass"))), PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed")))), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("length-vertical-surface")))));
  }
  if (Prims.equality(PrimChecks.math.abs(PrimChecks.validator.checkArg('ABS', 1, newHpy)), world.observer.getGlobal("box-edge-y"))) {
    ...
    SelfManager.self().setVariable("momentum-difference", PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("momentum-difference")), PrimChecks.math.div(PrimChecks.math.abs(PrimChecks.math.mult(PrimChecks.math.mult(PrimChecks.math.mult(PrimChecks.math.cos(PrimChecks.validator.checkArg('COS', 1, SelfManager.self().getVariable("heading"))), 2), PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("mass"))), PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed")))), PrimChecks.validator.checkArg('/', 1, world.observer.getGlobal("length-horizontal-surface")))));
  }
  if (PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, world.getPatchAt(newHpx, newHpy)), function() { return PrimChecks.procedure.callReporter("isothermal-wall?"); })) {
    SelfManager.self().setVariable("energy", PrimChecks.math.div(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("energy")), PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("outside-energy"))), 2));
    SelfManager.self().setVariable("speed", PrimChecks.procedure.callReporter("speed-from-energy"));
  }
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.getPatchAt(newHpx, newHpy)), function() { R = ProcedurePrims.callCommand("make-a-flash"); if (R === DeathInterrupt) { return R; } }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineCommand("make-a-flash", (function() {
  R = ProcedurePrims.ask(SelfManager.self().sprout(1, "TURTLES"), function() {
...
ProcedurePrims.defineCommand("check-for-collision", (function() {
  ...
  if (Prims.equality(SelfPrims._optimalCountOther(SelfManager.self().breedHere("PARTICLES")), 1)) {
    ...
    if ((!Prims.equality(candidate, Nobody) && (Prims.gt(SelfManager.self().getVariable("speed"), 0) || Prims.gt(PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, candidate), function() { return SelfManager.self().getVariable("speed"); }), 0)))) {
      R = ProcedurePrims.callCommand("collide-with", candidate); if (R === DeathInterrupt) { return R; }
      SelfManager.self().setVariable("last-collision", candidate);
      R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, candidate), function() { SelfManager.self().setVariable("last-collision", SelfManager.myself()); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
    }
  }
}))
ProcedurePrims.defineCommand("collide-with", (function(otherHparticle) {
  ...
  mass2 = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, otherHparticle), function() { return SelfManager.self().getVariable("mass"); }); ProcedurePrims.stack().currentContext().updateStringRunVar("MASS2", mass2);
  speed2 = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, otherHparticle), function() { return SelfManager.self().getVariable("speed"); }); ProcedurePrims.stack().currentContext().updateStringRunVar("SPEED2", speed2);
  heading2 = PrimChecks.agentset.of(PrimChecks.validator.checkArg('OF', 1904, otherHparticle), function() { return SelfManager.self().getVariable("heading"); }); ProcedurePrims.stack().currentContext().updateStringRunVar("HEADING2", heading2);
  theta = PrimChecks.math.randomFloat(360); ProcedurePrims.stack().currentContext().updateStringRunVar("THETA", theta);
  v1t = PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed")), PrimChecks.math.cos(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, theta), PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("heading"))))); ProcedurePrims.stack().currentContext().updateStringRunVar("V1T", v1t);
  v1l = PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed")), PrimChecks.math.sin(PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, theta), PrimChecks.validator.checkArg('-', 1, SelfManager.self().getVariable("heading"))))); ProcedurePrims.stack().currentContext().updateStringRunVar("V1L", v1l);
  ...
  vcm = PrimChecks.math.div(PrimChecks.math.plus(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("mass")), PrimChecks.validator.checkArg('*', 1, v1t)), PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, mass2), PrimChecks.validator.checkArg('*', 1, v2t))), PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, SelfManager.self().getVariable("mass")), PrimChecks.validator.checkArg('+', 1, mass2))); ProcedurePrims.stack().currentContext().updateStringRunVar("VCM", vcm);
  ...
  SelfManager.self().setVariable("speed", PrimChecks.math.sqrt(PrimChecks.math.plus(PrimChecks.math.pow(PrimChecks.validator.checkArg('^', 1, v1t), 2), PrimChecks.math.pow(PrimChecks.validator.checkArg('^', 1, v1l), 2))));
  SelfManager.self().setVariable("energy", PrimChecks.math.mult(PrimChecks.math.mult(0.5, PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("mass"))), PrimChecks.math.pow(PrimChecks.validator.checkArg('^', 1, SelfManager.self().getVariable("speed")), 2)));
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, otherHparticle), function() {
...
ProcedurePrims.defineCommand("check-move-piston", (function() {
  ...
  if ((MousePrims.isDown() && Prims.lt(MousePrims.getY(), PrimChecks.math.minus(world.topology.maxPycor, 1)))) {
    if ((Prims.gte(MousePrims.getX(), world.observer.getGlobal("piston-position")) && Prims.lt(MousePrims.getX(), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("box-edge-x")), 2)))) {
      R = ProcedurePrims.callCommand("piston-out", PrimChecks.math.ceil(PrimChecks.math.minus(MousePrims.getX(), PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("piston-position"))))); if (R === DeathInterrupt) { return R; }
    }
    world.observer.setGlobal("run-go?", true);
    return PrimChecks.procedure.stop();
  }
}))
ProcedurePrims.defineCommand("piston-out", (function(dist) {
  if (Prims.gt(dist, 0)) {
    if (Prims.lt(PrimChecks.math.plus(PrimChecks.validator.checkArg('+', 1, world.observer.getGlobal("piston-position")), PrimChecks.validator.checkArg('+', 1, dist)), PrimChecks.math.minus(PrimChecks.validator.checkArg('-', 1, world.observer.getGlobal("box-edge-x")), 1))) {
      R = ProcedurePrims.callCommand("undraw-piston"); if (R === DeathInterrupt) { return R; }
...
ProcedurePrims.defineCommand("draw-box-piston", (function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("heatable-walls")), function() {
  ...
  R = ProcedurePrims.ask(PrimChecks.validator.checkArg('ASK', 1904, world.observer.getGlobal("piston-wall")), function() {
...
ProcedurePrims.defineCommand("undraw-piston", (function() {
  R = ProcedurePrims.ask(PrimChecks.agentset.with(world.patches(), function() {
    return (Prims.equality(SelfManager.self().getPatchVariable("pxcor"), PrimChecks.math.round(PrimChecks.validator.checkArg('ROUND', 1, world.observer.getGlobal("piston-position")))) && Prims.lt(PrimChecks.math.abs(PrimChecks.validator.checkArg('ABS', 1, SelfManager.self().getPatchVariable("pycor"))), world.observer.getGlobal("box-edge-y")));
  }), function() { SelfManager.self().setPatchVariable("pcolor", 0); }, true); if (R !== undefined) { PrimChecks.procedure.preReturnCheck(R); return R; }
}))
ProcedurePrims.defineReporter("speed-from-energy", (function() {
  return PrimChecks.procedure.report(PrimChecks.math.sqrt(PrimChecks.math.div(PrimChecks.math.mult(2, PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("energy"))), PrimChecks.validator.checkArg('/', 1, SelfManager.self().getVariable("mass")))));
}))
ProcedurePrims.defineReporter("energy-from-speed", (function() {
  return PrimChecks.procedure.report(PrimChecks.math.div(PrimChecks.math.mult(PrimChecks.math.mult(PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("mass")), PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed"))), PrimChecks.validator.checkArg('*', 1, SelfManager.self().getVariable("speed"))), 2));
}))
ProcedurePrims.defineReporter("isothermal-wall?", (function() {
