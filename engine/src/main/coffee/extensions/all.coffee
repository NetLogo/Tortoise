...
extensionPaths = ['array', 'bitmap', 'codap', 'csv', 'encode', 'dialog', 'export-the', 'fetch', 'fp', 'gis', 'http-req', 'import-a', 'logging', 'matrix', 'mini-csv', 'nlmap', 'nt', 'nw', 'palette', 'resource', 'rnd', 'send-to', 'sound', 'store', 'string', 'table']
