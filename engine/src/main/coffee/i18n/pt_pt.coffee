...
bundle = {
  ...
  identifier: 'pt_pt'
    ...
    , 'REPORT can only be used inside TO-REPORT.': () -> 
        "#{undefined} só pode ser usado dentro de TO-REPORT." 

    , 'STOP is not allowed inside TO-REPORT.': () -> 
        "#{undefined} não é permitido dentro de TO-REPORT." 
    ...
    , 'All the list arguments to _ must be the same length.': (primName) -> 
        "Todos os argumentos de lista para FOREACH devem ter o mesmo comprimento." 
