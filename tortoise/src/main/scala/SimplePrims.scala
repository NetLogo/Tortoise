  ...
  object NormalReporter {
    def unapply(r: Reporter): Option[String] =
      PartialFunction.condOpt(r) {
        ...
        case _: prim.etc._reduce            => "ListPrims.reduce"
        ...
        case _: prim.etc._int              => "middlePrims.int_number"
        ...
        case _: prim.etc._sqrt             => "middlePrims.sqrt_number"
        ...
        case _: prim._turtle                => "middlePrims.turtle_number"
        ...
        case _: prim._random                => "middlePrims.random_number"
