...
// We're trying to work out here if something really needs a check.  For instance `forward` is annotated "-T--" whether
// it sits in `ask turtles [ ... ]` or in `ask some-variable [ ... ]`, but only the second one needs a runtime
// verification.
//
