...
implicit object ButtonReader extends JsonReader[TortoiseJson.JsObject, org.nlogo.core.Button] {
  def apply(jsObject: TortoiseJson.JsObject): ValidationNel[String, org.nlogo.core.Button] = {
    ...
    val v7 = JsonReader.readField[scala.Boolean](jsObject, "forever")
    val v8 = JsonReader.readField[org.nlogo.core.AgentKind](jsObject, "buttonKind")
    val v9 = JsonReader.readField[scala.Option[scala.Char]](jsObject, "actionKey")
    val v10 = JsonReader.readField[scala.Boolean](jsObject, "disableUntilTicksStart")
                    ...
                    (c6) => v7.flatMap(
                      (c7) => v8.flatMap(
                        (c8) => v9.flatMap(
                          (c9) => v10.map(
                            (c10) =>
                              new org.nlogo.core.Button(c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10)
                          )
                        )
                      )
                    )
