...
implicit object InputBoxWriter extends JsonWriter[org.nlogo.core.InputBox] {
  import collection.immutable.ListMap

  def apply(o: org.nlogo.core.InputBox): TortoiseJson.JsObject = {
    val map = ListMap(
      ...
      ("boxedValue" -> org.nlogo.tortoise.compiler.json.WidgetWrite.boxedValue2Json.write(o.boxedValue)),
      ("type" -> Some(TortoiseJson.JsString("inputBox")))
