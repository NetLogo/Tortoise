...
implicit object InputBoxReader extends JsonReader[TortoiseJson.JsObject, org.nlogo.core.InputBox] {
  def apply(jsObject: TortoiseJson.JsObject): ValidationNel[String, org.nlogo.core.InputBox] = {
    ...
    val v6 = JsonReader.readField[org.nlogo.core.BoxedValue](jsObject, "boxedValue")
            ...
            (c2) => v3.flatMap(
              (c3) => v4.flatMap(
                (c4) => v5.flatMap(
                  (c5) => v6.map(
                    (c6) =>
                      new org.nlogo.core.InputBox(c0, c1, c2, c3, c4, c5, c6)
                  )
                )
              )
            )
