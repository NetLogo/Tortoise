...
implicit object SwitchReader extends JsonReader[TortoiseJson.JsObject, org.nlogo.core.Switch] {
  def apply(jsObject: TortoiseJson.JsObject): ValidationNel[String, org.nlogo.core.Switch] = {
    ...
    val v7 = JsonReader.readField[scala.Boolean](jsObject, "on")
              ...
              (c3) => v4.flatMap(
                (c4) => v5.flatMap(
                  (c5) => v6.flatMap(
                    (c6) => v7.map(
                      (c7) =>
                        new org.nlogo.core.Switch(c0, c1, c2, c3, c4, c5, c6, c7)
                    )
                  )
                )
              )
