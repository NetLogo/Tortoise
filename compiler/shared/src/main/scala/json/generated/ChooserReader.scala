...
implicit object ChooserReader extends JsonReader[TortoiseJson.JsObject, org.nlogo.core.Chooser] {
  def apply(jsObject: TortoiseJson.JsObject): ValidationNel[String, org.nlogo.core.Chooser] = {
    ...
    val v7 = JsonReader.readField[scala.collection.immutable.List[org.nlogo.core.Chooseable]](jsObject, "choices")
    val v8 = JsonReader.readField[scala.Int](jsObject, "currentChoice")
                ...
                (c4) => v5.flatMap(
                  (c5) => v6.flatMap(
                    (c6) => v7.flatMap(
                      (c7) => v8.map(
                        (c8) =>
                          new org.nlogo.core.Chooser(c0, c1, c2, c3, c4, c5, c6, c7, c8)
                      )
                    )
                  )
                )
