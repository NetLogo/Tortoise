...
implicit object MonitorWriter extends JsonWriter[org.nlogo.core.Monitor] {
  import collection.immutable.ListMap

  def apply(o: org.nlogo.core.Monitor): TortoiseJson.JsObject = {
    val map = ListMap(
      ...
      ("precision" -> org.nlogo.tortoise.compiler.json.JsonWriter.int2TortoiseJs.write(o.precision)),
      ...
      ("type" -> Some(TortoiseJson.JsString("monitor")))
